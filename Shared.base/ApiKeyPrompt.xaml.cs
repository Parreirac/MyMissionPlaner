...
namespace MyMissionPlaner
{
    public partial class ApiKeyPrompt : UserControl
    {
        ...
        {
            CurrentKeyText.Text = Esri.MyMissionPlaner.ArcGISRuntimeEnvironment.ApiKey;
        ...
        private void SetKeyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ArcGISRuntime.Samples.Shared.Managers.ApiKeyManager.ArcGISDeveloperApiKey = KeyEntryBox.Text;
            ArcGISRuntime.Samples.Shared.Managers.ApiKeyManager.StoreCurrentKey();
            _ = UpdateValidityText();
        }
