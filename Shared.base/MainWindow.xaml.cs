...
//using Esri.MyMissionPlaner.Security;
//using MyMissionPlaner.Samples.Managers;
//using MyMissionPlaner.Samples.Shared.Managers;
//using MyMissionPlaner.Samples.Shared.Models;
using System;
...
namespace MyMissionPlaner.Samples.Desktop
{
    public partial class MainWindow
    {
        ...
        private async Task CheckApiKey()
        {
            ...
            await ArcGISRuntime.Samples.Shared.Managers.ApiKeyManager.TrySetLocalKey();

            // Check that the current API key is valid.
            ArcGISRuntime.Samples.Shared.Managers.ApiKeyStatus status = await ApiKeyManager.CheckKeyValidity();
