...
namespace NC1 {
   ...
   public interface BaseObjectType_derivations
   {
       ...
       */
       void decode(XmlTextReader reader,  com.objsys.xbinder.runtime.XBContext xbContext, 
       ...
       */
       void encode(XBXmlEncoder encoder, 
         com.objsys.xbinder.runtime.XBContext xbContext, 
         XBQualifiedName elemDeclType, bool ignoreContent) ;
   }

   public interface LocalisedObjectType_derivations : 
       BaseObjectType_derivations
   {


   }

   public interface PhysicalObjectType_derivations : 
       LocalisedObjectType_derivations
   {


   }

   public interface ParticipantType_derivations : 
       PhysicalObjectType_derivations
   {


   }

   public interface TrackType_derivations : 
       PhysicalObjectType_derivations
   {
   ...
   public interface AgentType_derivations : 
       PhysicalObjectType_derivations
   {
   ...
   public interface _2DCoordinationMeanType_derivations : 
       LocalisedObjectType_derivations
   {
   ...
   public class _Commun_Derivations {
      ...
      public static readonly String NS_URI = "";
      public static readonly String NS_PREFIX = "";
 ...
 */
      ...
      public _Commun_Derivations() {
      }
      static _Commun_Derivations() {
         XBUtil.license = _Commun_Derivations.license;
      }
   }
}
