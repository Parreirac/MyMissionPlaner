...
namespace NC1.Health {

   using System.IO;
   using System.Xml;

   public class PersonnelCasualtiesType : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:common:health",
          "PersonnelCasualtiesType");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","nationality"),
         new XBQualifiedName("","injuredCount"),
         new XBQualifiedName("","killedCount")
      };
      static PersonnelCasualtiesType() {
         XBUtil.license =  _Health.license;
      }
      ...
      protected bool _set_nationality = false;
      protected ushort injuredCount;
      protected bool _set_injuredCount = false;
      protected ushort killedCount;
      protected bool _set_killedCount = false;
      ...
      public string Nationality
      {
         ...
         {
            if (!_set_nationality)
                throw new XBException("field nationality not set");
         ...
         set
         {
            ...
            _set_nationality = true;
         }
      }

      public ushort InjuredCount
      {
         get
         {
            if (!_set_injuredCount)
                throw new XBException("field injuredCount not set");

            return this.injuredCount;
         }
         set
         {
            this.injuredCount = value;
            _set_injuredCount = true;
         }
      }

      public ushort KilledCount
      {
         get
         {
            if (!_set_killedCount)
                throw new XBException("field killedCount not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.category = Dictionnaries.L112_1Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.nationality =  ShortTextObjectType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.injuredCount =  Int0To999Type.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.killedCount =  Int0To999Type.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_category)  {
            ...
            String text_4;
            text_4 = Dictionnaries.L112_1Code.encode(this.category, xbContext);
         ...
         // nationality
         if (_set_nationality)  {
            encoder.encodeStartElement("nationality", "", "");
            String text_4;
            text_4 =  ShortTextObjectType.encode(this.nationality, xbContext);
         ...
         // injuredCount
         if (_set_injuredCount)  {
            encoder.encodeStartElement("injuredCount", "", "");
            String text_4;
            text_4 =  Int0To999Type.encode(this.injuredCount, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // killedCount
         if (_set_killedCount)  {
            encoder.encodeStartElement("killedCount", "", "");
            String text_4;
            text_4 =  Int0To999Type.encode(this.killedCount, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class InjurySeverityCode
   {
      static InjurySeverityCode() {
         XBUtil.license =  _Health.license;
      }

      //constructor
      private InjurySeverityCode() {} 
   ...
   public class _Health {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:common:health";
      public static readonly String NS_PREFIX = "nc1medical";
