...
namespace NC1.Logistics {
      ...
      com.objsys.xbinder.runtime.XBComplexType
   {
      ...
      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:common:logistics",
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","effectif"),
         new XBQualifiedName("","personnelTiredness"),
         new XBQualifiedName("","equipment"),
         new XBQualifiedName("","fuel"),
         new XBQualifiedName("","ammunitions")
      };
      static OperationalStatusType() {
         XBUtil.license =  _Logistics.license;
      }
      ...
      protected bool _set_effectif = false;
      protected int personnelTiredness;
      protected bool _set_personnelTiredness = false;
      protected int equipment;
      protected bool _set_equipment = false;
      protected int fuel;
      protected bool _set_fuel = false;
      protected int ammunitions;
      protected bool _set_ammunitions = false;
      ...
      public int Effectif
      {
         ...
         {
            if (!_set_effectif)
                throw new XBException("field effectif not set");
      ...
      public int PersonnelTiredness
      {
         get
         {
            if (!_set_personnelTiredness)
                throw new XBException("field personnelTiredness not set");

            return this.personnelTiredness;
         }
         set
         {
            this.personnelTiredness = value;
            _set_personnelTiredness = true;
         }
      }
      ...
      public int Ammunitions
      {
         ...
         {
            if (!_set_ammunitions)
                throw new XBException("field ammunitions not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.effectif = Dictionnaries.L125_17Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.personnelTiredness = Dictionnaries.L125_16Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.equipment = Dictionnaries.L125_17Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.fuel =  L125_17Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.ammunitions =  L125_17Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // effectif
         if (_set_effectif)  {
            encoder.encodeStartElement("effectif", "", "");
            String text_4;
            text_4 =  L125_17Code.encode(this.effectif, xbContext);
         ...
         // personnelTiredness
         if (_set_personnelTiredness)  {
            encoder.encodeStartElement("personnelTiredness", "", "");
            String text_4;
            text_4 =  L125_16Code.encode(this.personnelTiredness, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_equipment)  {
            ...
            String text_4;
            text_4 =  L125_17Code.encode(this.equipment, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_fuel)  {
            ...
            String text_4;
            text_4 =  L125_17Code.encode(this.fuel, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // ammunitions
         if (_set_ammunitions)  {
            encoder.encodeStartElement("ammunitions", "", "");
            String text_4;
            text_4 =  L125_17Code.encode(this.ammunitions, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class LogisticStatusType : com.objsys.xbinder.runtime.XBComplexType
   {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.count =  Int0To2147483647Type.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         text_3 =  Int0To2147483647Type.encode(this.count, xbContext);
   ...
   public class StatusType : com.objsys.xbinder.runtime.XBComplexType
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","operationalStatus"),
      ...
      //content fields
      protected  OperationalStatusType operationalStatus;   //optional
      ...
      public  OperationalStatusType OperationalStatus
      {
         get
         {
            if (this.operationalStatus == null)
                throw new XBException("field operationalStatus not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.operationalStatus = new  OperationalStatusType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.operationalStatus.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // operationalStatus
         if (this.operationalStatus != null)  {
            encoder.encodeStartElement("operationalStatus", "", "");
            this.operationalStatus.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class MobilityCategoryCode
   {
      static MobilityCategoryCode() {
         XBUtil.license =  _Logistics.license;
      }

      //constructor
      private MobilityCategoryCode() {} 
   ...
   public class _Logistics {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:common:logistics";
      public static readonly String NS_PREFIX = "nc1logistics";
