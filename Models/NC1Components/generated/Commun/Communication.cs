...
namespace NC1.Communication {

   using System.IO;
   using System.Xml;

   public class ComDataType : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:common:communication",
          "ComDataType");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","pocName"),
         new XBQualifiedName("","comment"),
         new XBQualifiedName("","extVersion")
      };
      static ComDataType() {
         XBUtil.license =  _Communication.license;
      }
      ...
      protected bool _set_pocName = false;
      ...
      public string PocName
      {
         get
         {
            if (!_set_pocName) throw new XBException("field pocName not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.pocName =  MediumTextObjectType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // pocName
         if (_set_pocName)  {
            encoder.encodeStartElement("pocName", "", "");
            String text_4;
            text_4 =  MediumTextObjectType.encode(this.pocName, xbContext);
   ...
   public class ParticipantNumberType
   {
      private static XBPatternValidator patternValidator;

      static ParticipantNumberType() {
         XBUtil.license =  _Communication.license;
   ...
   public class _Communication {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:common:communication";
      public static readonly String NS_PREFIX = "nc1com";
