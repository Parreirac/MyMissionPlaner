...
namespace NC1.Participant {
   ...
   using System.Xml;
    ...
    public class ParticipantType :  PhysicalObjectType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:participant",
          "ParticipantType");
      static ParticipantType() {
         XBUtil.license =  _Participant.license;
      }
       ...
       * Factory method
       */
      public static new  ParticipantType createObject(XBQualifiedName type) 
      {
         if ( type == null || type.equals( ParticipantType.XSD_TYPE ) ) 
   ...
   public class TacticalDataType_aggregatorParticipant : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:participant",
          "TacticalDataType_aggregatorParticipant");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","presence"),
         new XBQualifiedName("","idParticipant")
      };
      static TacticalDataType_aggregatorParticipant() {
         XBUtil.license =  _Participant.license;
      }
      ...
      protected  Nc1ObjectRefType idParticipant;   //optional
      ...
      public  Nc1ObjectRefType IdParticipant
      {
         get
         {
            if (this.idParticipant == null)
                throw new XBException("field idParticipant not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.presence = XBSimpleType.parseBoolean(text);
               ...
               else throw new XBOccurrencesException(0, "presence");

               // idParticipant
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.idParticipant = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.idParticipant.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // presence
         encoder.encodeStartElement("presence", "", "");
         String text_3;
         text_3 = this.presence.ToString().ToLower();
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // idParticipant
         if (this.idParticipant != null)  {
            encoder.encodeStartElement("idParticipant", "", "");
            this.idParticipant.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class TacticalDataType : com.objsys.xbinder.runtime.XBComplexType
   {
      ...
      protected int loadIndicator;
      protected bool _set_loadIndicator = false;
      ...
      protected  TacticalDataType_aggregatorParticipant aggregatorParticipant;
            //optional
      ...
      public int LoadIndicator
      {
         get
         {
            if (!_set_loadIndicator)
                throw new XBException("field loadIndicator not set");
      ...
      public  TacticalDataType_aggregatorParticipant AggregatorParticipant
      {
         get
         {
            if (this.aggregatorParticipant == null)
                throw new XBException("field aggregatorParticipant not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.distressIndicator =  L135_5Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.loadIndicator =  L104_16Code.decode(text, xbContext);
               ...
               {
                  this.aggregatorParticipant = new  TacticalDataType_aggregatorParticipant();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.aggregatorParticipant.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_distressIndicator)  {
            ...
            text_3 =  L135_5Code.encode(this.distressIndicator, xbContext);
            encoder.encodeCharsNoEscaping(text_3);
            encoder.encodeEndElement();
         }
         ...
         // loadIndicator
         if (_set_loadIndicator)  {
            encoder.encodeStartElement("loadIndicator", "", "");
            text_3 =  L104_16Code.encode(this.loadIndicator, xbContext);
            encoder.encodeCharsNoEscaping(text_3);
            encoder.encodeEndElement();
         }
         ...
         // aggregatorParticipant
         if (this.aggregatorParticipant != null)  {
            encoder.encodeStartElement("aggregatorParticipant", "", "");
            this.aggregatorParticipant.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
   ...
   public class _Participant {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:participant";
      public static readonly String NS_PREFIX = "nc1participant";
