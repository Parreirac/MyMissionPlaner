...
namespace NC1.Tracks {
   ...
   using System.Xml;
    ...
    public class TrackType :  PhysicalObjectType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:track",
          "TrackType");
      static TrackType() {
         XBUtil.license =  _Track.license;
      }
       ...
       * Factory method
       */
      public static new  TrackType createObject(XBQualifiedName type) {
         if ( type == null || type.equals( TrackType.XSD_TYPE ) ) 
   ...
   public class TacticalDataType : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:track",
          "TacticalDataType");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","referenceUnitId"),
      ...
      protected  Nc1ObjectRefType referenceUnitId;   //optional
      ...
      public  Nc1ObjectRefType ReferenceUnitId
      {
         get
         {
            if (this.referenceUnitId == null)
                throw new XBException("field referenceUnitId not set");

            return this.referenceUnitId;
         }
         set
         {
            this.referenceUnitId = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  this.size =  L104_2Code.decode(text, xbContext);
               ...
               {
                  this.referenceUnitId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.referenceUnitId.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_size)  {
            ...
            text_3 =  L104_2Code.encode(this.size, xbContext);
         ...
         // referenceUnitId
         if (this.referenceUnitId != null)  {
            encoder.encodeStartElement("referenceUnitId", "", "");
            this.referenceUnitId.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class LocationType : com.objsys.xbinder.runtime.XBComplexType
   {
      ...
      protected string name;
      protected bool _set_name = false;
      protected  PointType point;   //optional
   ...
   public class _Track {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:track";
      public static readonly String NS_PREFIX = "nc1track";
