...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_StAcmConduite_ELEM_2_typedACMs : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:stacmconduite",
          "NC1_StAcmConduite_ELEM_2_typedACMs");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","acm")
      };
      static NC1_StAcmConduite_ELEM_2_typedACMs() {
         XBUtil.license =  _NC1_StAcmConduite.license;
      }
      ...
      //content fields
      protected  AcmWezType acm;

      //attribute methods

      //content methods

      public  AcmWezType Acm
      {
         get
         {
            if (this.acm == null) throw new XBException("field acm not set");
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.acm = new  AcmWezType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.acm.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "acm");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("acm", "", "");
         this.acm.encode(encoder, xbContext, null, false);
   ...
   public class ShortTimeAcmCode
   {
      static ShortTimeAcmCode() {
         XBUtil.license =  _NC1_StAcmConduite.license;
      }

      //constructor
      private ShortTimeAcmCode() {} 
   ...
   public class NC1_StAcmConduite_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:stacmconduite",
          "NC1_StAcmConduite_ELEM");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","typedACMs"),
         new XBQualifiedName("","type"),
         new XBQualifiedName("","comment")
      };
      static NC1_StAcmConduite_ELEM() {
         XBUtil.license =  _NC1_StAcmConduite.license;
      }
      ...
      //content fields
      protected System.Collections.Generic.IList< NC1_StAcmConduite_ELEM_2_typedACMs> typedACMs;
      ...
      public System.Collections.Generic.IList< NC1_StAcmConduite_ELEM_2_typedACMs> TypedACMs
      {
         get
         {
            if (this.typedACMs == null) {
               this.typedACMs = 
                  new List< NC1_StAcmConduite_ELEM_2_typedACMs>();
            }
            return this.typedACMs;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                   NC1_StAcmConduite_ELEM_2_typedACMs _tmp_typedACMs;
                  _tmp_typedACMs = new  NC1_StAcmConduite_ELEM_2_typedACMs();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_typedACMs.decode(reader, xbContext, false, false);
                  this.typedACMs.Add(_tmp_typedACMs);
               ...
               if ( this.typedACMs.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.typedACMs.Count, "typedACMs");
               else if (this.typedACMs.Count == 0 && moreContent_4) 
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  this.type =  ShortTimeAcmCode.decode(text, xbContext);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // typedACMs
         if (this.typedACMs == null || this.typedACMs.Count < 1) 
            throw new XBOccurrencesException( (this.typedACMs == null ? 0 : this.typedACMs.Count ) );

         foreach ( NC1_StAcmConduite_ELEM_2_typedACMs _tmp_typedACMs in this.typedACMs)
         {
            encoder.encodeStartElement("typedACMs", "", "");
            _tmp_typedACMs.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
         ...
         String text_3;
         text_3 =  ShortTimeAcmCode.encode(this.type, xbContext);
   ...
   public class NC1_StAcmConduite_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:stacmconduite","NC1_StAcmConduite")
      };
      static NC1_StAcmConduite_CC() {
         XBUtil.license =  _NC1_StAcmConduite.license;
      }
      ...
      //content fields
      protected  NC1_StAcmConduite_ELEM nC1_StAcmConduite;

      //content methods

      public  NC1_StAcmConduite_ELEM NC1_StAcmConduite
      {
         get
         {
            if (this.nC1_StAcmConduite == null)
                throw new XBException("field nC1_StAcmConduite not set");

            return this.nC1_StAcmConduite;
         }
         set
         {
            this.nC1_StAcmConduite = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_StAcmConduite.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_StAcmConduite = new  NC1_StAcmConduite_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_StAcmConduite.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_StAcmConduite");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_StAcmConduite",  _NC1_StAcmConduite.NS_URI,  _NC1_StAcmConduite.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_StAcmConduite.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_StAcmConduite {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:stacmconduite";
      public static readonly String NS_PREFIX = "nc1stacmconduite";
 ...
 */
      ...
      public _NC1_StAcmConduite() {
      }
      static _NC1_StAcmConduite() {
         XBUtil.license = _NC1_StAcmConduite.license;
      }
   }
}
