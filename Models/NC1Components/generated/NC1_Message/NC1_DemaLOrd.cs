...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    using NC1.Logistics;
    public class StageOfConfirmationCode
   {
      static StageOfConfirmationCode() {
         XBUtil.license =  _NC1_DemaLOrd.license;
      }

      //constructor
      private StageOfConfirmationCode() {} 
   ...
   public class DebarkationLocationTypeCode
   {
      static DebarkationLocationTypeCode() {
         XBUtil.license =  _NC1_DemaLOrd.license;
      }

      //constructor
      private DebarkationLocationTypeCode() {} 
   ...
   public class NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest_transport : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:demalord",
          "NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest_transport");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","stageOfConfirmation"),
         new XBQualifiedName("","type"),
         new XBQualifiedName("","locationName"),
         new XBQualifiedName("","point"),
         new XBQualifiedName("","obstruction"),
         new XBQualifiedName("","refuelingPoint"),
         new XBQualifiedName("","additionalServices"),
         new XBQualifiedName("","nonSupplyImpact"),
         new XBQualifiedName("","reimbursement")
      };
      static NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest_transport() {
         XBUtil.license =  _NC1_DemaLOrd.license;
      }
      ...
      //content fields
      protected int stageOfConfirmation;
      protected int type;
      protected string locationName;
      protected  PointType point;
      protected System.Collections.Generic.IList< ObstacleType> obstruction;
         
      protected System.Collections.Generic.IList< TacPointType> refuelingPoint;
         
      protected string additionalServices;
      protected bool _set_additionalServices = false;
      protected string nonSupplyImpact;
      protected string reimbursement;

      //attribute methods

      //content methods

      public int StageOfConfirmation
      {
         get { return this.stageOfConfirmation; }
         set { this.stageOfConfirmation = value; }
      }
      ...
      public System.Collections.Generic.IList< ObstacleType> Obstruction
      {
         get
         {
            if (this.obstruction == null) {
               this.obstruction = new List< ObstacleType>();
            }
            return this.obstruction;
         }
      }

      public System.Collections.Generic.IList< TacPointType> RefuelingPoint
      {
         get
         {
            if (this.refuelingPoint == null) {
               this.refuelingPoint = new List< TacPointType>();
            }
      ...
      public string AdditionalServices
      {
         get
         {
            if (!_set_additionalServices)
                throw new XBException("field additionalServices not set");
         ...
         set
         {
            ...
            _set_additionalServices = true;
         }
      }

      public string NonSupplyImpact
      {
         get { return this.nonSupplyImpact; }
         set { this.nonSupplyImpact = value; }
      }

      public string Reimbursement
      {
         get { return this.reimbursement; }
         set { this.reimbursement = value; }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.stageOfConfirmation =  StageOfConfirmationCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "stageOfConfirmation");
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.type =  DebarkationLocationTypeCode.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.locationName =  Text1To30Type.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "locationName");
               ...
               {
                   ObstacleType _tmp_obstruction;
                  _tmp_obstruction = new  ObstacleType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_obstruction.decode(reader, xbContext, false, false);
                  this.obstruction.Add(_tmp_obstruction);
               ...
               {
                   TacPointType _tmp_refuelingPoint;
                  _tmp_refuelingPoint = new  TacPointType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_refuelingPoint.decode(reader, xbContext, false, false);
                  this.refuelingPoint.Add(_tmp_refuelingPoint);
                  ...
                  (XBQualifiedName)particleInfo[6], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.additionalServices =  MediumTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[7], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.nonSupplyImpact =  MediumTextType.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "nonSupplyImpact");
                  ...
                  (XBQualifiedName)particleInfo[8], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.reimbursement =  MediumTextType.decode(text, xbContext);

                  moreContent_4 = 
                     XMLStreamHelper.moveToContentElement(reader);
               }
               else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
               else throw new XBOccurrencesException(0, "reimbursement");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // stageOfConfirmation
         encoder.encodeStartElement("stageOfConfirmation", "", "");
         String text_3;
         text_3 =  StageOfConfirmationCode.encode(this.stageOfConfirmation, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // type
         encoder.encodeStartElement("type", "", "");
         text_3 =  DebarkationLocationTypeCode.encode(this.type, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // locationName
         encoder.encodeStartElement("locationName", "", "");
         text_3 =  Text1To30Type.encode(this.locationName, xbContext);
         ...
         // obstruction
         if ( this.obstruction != null ){
            foreach ( ObstacleType _tmp_obstruction in this.obstruction)
            {
               encoder.encodeStartElement("obstruction", "", "");
               _tmp_obstruction.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
         ...
         // refuelingPoint
         if ( this.refuelingPoint != null ){
            foreach ( TacPointType _tmp_refuelingPoint in this.refuelingPoint)
            {
               encoder.encodeStartElement("refuelingPoint", "", "");
               _tmp_refuelingPoint.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
         ...
         // additionalServices
         if (_set_additionalServices)  {
            encoder.encodeStartElement("additionalServices", "", "");
            text_3 =  MediumTextType.encode(this.additionalServices, xbContext);
            encoder.encodeChars(text_3);
            encoder.encodeEndElement();
         }

         // nonSupplyImpact
         encoder.encodeStartElement("nonSupplyImpact", "", "");
         text_3 =  MediumTextType.encode(this.nonSupplyImpact, xbContext);
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();

         // reimbursement
         encoder.encodeStartElement("reimbursement", "", "");
         text_3 =  MediumTextType.encode(this.reimbursement, xbContext);
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();
      }
   ...
   public class NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:demalord",
          "NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","quantityOnHand"),
         new XBQualifiedName("","requestingUnit"),
         new XBQualifiedName("","targetDatetime"),
         new XBQualifiedName("","transport")
      };
      static NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest() {
         XBUtil.license =  _NC1_DemaLOrd.license;
      }
      ...
      //content fields
      protected  LogisticStatusType requestedItem;
      protected ulong quantityOnHand;
      protected  UnitType requestingUnit;   //optional
      protected string targetDatetime;
      protected  NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest_transport transport;
            //optional
      ...
      public  LogisticStatusType RequestedItem
      {
         get
         {
            if (this.requestedItem == null)
                throw new XBException("field requestedItem not set");
      ...
      public ulong QuantityOnHand
      {
         get { return this.quantityOnHand; }
         set { this.quantityOnHand = value; }
      }

      public  UnitType RequestingUnit
      {
         get
         {
            if (this.requestingUnit == null)
                throw new XBException("field requestingUnit not set");
      ...
      {
         get { return this.targetDatetime; }
         set { this.targetDatetime = value; }
      }

      public  NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest_transport Transport
      {
         get
         {
            if (this.transport == null)
                throw new XBException("field transport not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.requestedItem = new  LogisticStatusType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.requestedItem.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "requestedItem");
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.quantityOnHand =  Int0To2147483647Type.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "quantityOnHand");

               // requestingUnit
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.requestingUnit = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.requestingUnit.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "targetDatetime");

               // transport
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  this.transport = new  NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest_transport();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.transport.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         this.requestedItem.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // quantityOnHand
         encoder.encodeStartElement("quantityOnHand", "", "");
         String text_3;
         text_3 =  Int0To2147483647Type.encode(this.quantityOnHand, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // requestingUnit
         if (this.requestingUnit != null)  {
            encoder.encodeStartElement("requestingUnit", "", "");
            this.requestingUnit.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // targetDatetime
         encoder.encodeStartElement("targetDatetime", "", "");
         text_3 = this.targetDatetime;
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();

         // transport
         if (this.transport != null)  {
            encoder.encodeStartElement("transport", "", "");
            this.transport.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_DemaLOrd_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:demalord",
          "NC1_DemaLOrd_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","POC"),
         new XBQualifiedName("","logisticAssistanceRequest"),
         new XBQualifiedName("","comment")
      };
      static NC1_DemaLOrd_ELEM() {
         XBUtil.license =  _NC1_DemaLOrd.license;
      }
      ...
      //content fields
      protected  UnitType pOC;
      protected System.Collections.Generic.IList< NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest> logisticAssistanceRequest;
      ...
      public  UnitType POC
      {
         get
         {
            if (this.pOC == null) throw new XBException("field pOC not set");
      ...
      public System.Collections.Generic.IList< NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest> LogisticAssistanceRequest
      {
         get
         {
            if (this.logisticAssistanceRequest == null) {
               this.logisticAssistanceRequest = 
                  new List< NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest>()
                  ;
            }
            return this.logisticAssistanceRequest;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.pOC = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.pOC.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "pOC");

               // logisticAssistanceRequest
               this.logisticAssistanceRequest = 
                  new List< NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest>()
                  ;
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                   NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest _tmp_logisticAssistanceRequest;
                  _tmp_logisticAssistanceRequest = new  NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_logisticAssistanceRequest.decode(reader, xbContext, false, false);
                  this.logisticAssistanceRequest.Add(
                     _tmp_logisticAssistanceRequest);
               ...
               if ( this.logisticAssistanceRequest.Count < 1 && !moreContent_4
                  ) 
                  throw new XBOccurrencesException(this.logisticAssistanceRequest.Count, "logisticAssistanceRequest");
               else if (this.logisticAssistanceRequest.Count == 0 && moreContent_4) 
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("POC", "", "");
         this.pOC.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // logisticAssistanceRequest
         if (this.logisticAssistanceRequest == null || 
            this.logisticAssistanceRequest.Count < 1) 
            throw new XBOccurrencesException( (this.logisticAssistanceRequest == null ? 0 : this.logisticAssistanceRequest.Count ) );

         foreach ( NC1_DemaLOrd_ELEM_2_logisticAssistanceRequest _tmp_logisticAssistanceRequest in this.logisticAssistanceRequest)
         {
            encoder.encodeStartElement("logisticAssistanceRequest", "", "");
            _tmp_logisticAssistanceRequest.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_DemaLOrd_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:demalord","NC1_DemaLOrd")
      };
      static NC1_DemaLOrd_CC() {
         XBUtil.license =  _NC1_DemaLOrd.license;
      }
      ...
      //content fields
      protected  NC1_DemaLOrd_ELEM nC1_DemaLOrd;

      //content methods

      public  NC1_DemaLOrd_ELEM NC1_DemaLOrd
      {
         get
         {
            if (this.nC1_DemaLOrd == null)
                throw new XBException("field nC1_DemaLOrd not set");

            return this.nC1_DemaLOrd;
         }
         set
         {
            this.nC1_DemaLOrd = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_DemaLOrd.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_DemaLOrd = new  NC1_DemaLOrd_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_DemaLOrd.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_DemaLOrd");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_DemaLOrd",  _NC1_DemaLOrd.NS_URI,  _NC1_DemaLOrd.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_DemaLOrd.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_DemaLOrd {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:demalord";
      public static readonly String NS_PREFIX = "nc1demalord";
 ...
 */
      ...
      public _NC1_DemaLOrd() {
      }
      static _NC1_DemaLOrd() {
         XBUtil.license = _NC1_DemaLOrd.license;
      }
   }
}
