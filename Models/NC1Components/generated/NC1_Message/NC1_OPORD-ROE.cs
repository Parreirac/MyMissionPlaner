...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    using NC1.Msg;
    public class NC1_OPORD_ROE_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordroe",
          "NC1_OPORD-ROE_ELEM");
      ...
      static NC1_OPORD_ROE_ELEM() {
         XBUtil.license =  _NC1_OPORD_ROE.license;
      }
      ...
      public  MixedAnyType Roe
      {
         get
         {
            if (this.roe == null) throw new XBException("field roe not set");
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.roe = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.roe.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "roe");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         this.roe.encode(encoder, xbContext, null, false);
   ...
   public class NC1_OPORD_ROE_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:opordroe","NC1_OPORD-ROE")
      };
      static NC1_OPORD_ROE_CC() {
         XBUtil.license =  _NC1_OPORD_ROE.license;
      }
      ...
      //content fields
      protected  NC1_OPORD_ROE_ELEM nC1_OPORD_ROE;

      //content methods

      public  NC1_OPORD_ROE_ELEM NC1_OPORD_ROE
      {
         get
         {
            if (this.nC1_OPORD_ROE == null)
                throw new XBException("field nC1_OPORD_ROE not set");

            return this.nC1_OPORD_ROE;
         }
         set
         {
            this.nC1_OPORD_ROE = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_OPORD_ROE.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_OPORD_ROE = new  NC1_OPORD_ROE_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_OPORD_ROE.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_OPORD_ROE");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_OPORD-ROE",  _NC1_OPORD_ROE.NS_URI,  _NC1_OPORD_ROE.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_OPORD_ROE.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_OPORD_ROE {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:opordroe";
      public static readonly String NS_PREFIX = "nc1opordroe";
 ...
 */
      ...
      public _NC1_OPORD_ROE() {
      }
      static _NC1_OPORD_ROE() {
         XBUtil.license = _NC1_OPORD_ROE.license;
      }
   }
}
