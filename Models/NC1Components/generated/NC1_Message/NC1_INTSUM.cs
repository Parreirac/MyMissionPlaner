...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_INTSUM_ELEM_2_intsumSummary : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:intsum",
          "NC1_INTSUM_ELEM_2_intsumSummary");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","highlights"),
         new XBQualifiedName("","generalAssessment")
      };
      static NC1_INTSUM_ELEM_2_intsumSummary() {
         XBUtil.license =  _NC1_INTSUM.license;
      }
      ...
      protected string generalAssessment;
      protected bool _set_generalAssessment = false;
      ...
      {
         get { return this.highlights; }
         set { this.highlights = value; }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  this.highlights =  WideTextType.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "highlights");
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.generalAssessment =  WideTextType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // highlights
         encoder.encodeStartElement("highlights", "", "");
         String text_3;
         text_3 =  WideTextType.encode(this.highlights, xbContext);
         ...
         if (_set_generalAssessment)  {
            ...
            text_3 =  WideTextType.encode(this.generalAssessment, xbContext);
            encoder.encodeChars(text_3);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_INTSUM_ELEM_2_intsumSituationReport : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:intsum",
          "NC1_INTSUM_ELEM_2_intsumSituationReport");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","relatedArea"),
         new XBQualifiedName("","generalSituationDescription"),
         new XBQualifiedName("","geographicalSituationDescription"),
         new XBQualifiedName("","militarySituationDescription"),
         new XBQualifiedName("","landSituationDescription"),
         new XBQualifiedName("","maritimeSituationDescription"),
         new XBQualifiedName("","airSituationDescription"),
         new XBQualifiedName("","ciAndSecuritySituationDescription"),
         new XBQualifiedName("","otherIntelDescription")
      };
      static NC1_INTSUM_ELEM_2_intsumSituationReport() {
         XBUtil.license =  _NC1_INTSUM.license;
      }
      ...
      //content fields
      protected  MixedAnyType relatedArea;   //optional
      protected string generalSituationDescription;
      protected bool _set_generalSituationDescription = false;
      protected string geographicalSituationDescription;
      protected bool _set_geographicalSituationDescription = false;
      protected string militarySituationDescription;
      protected bool _set_militarySituationDescription = false;
      protected string landSituationDescription;
      protected bool _set_landSituationDescription = false;
      protected string maritimeSituationDescription;
      protected bool _set_maritimeSituationDescription = false;
      protected string airSituationDescription;
      protected bool _set_airSituationDescription = false;
      protected string ciAndSecuritySituationDescription;
      protected bool _set_ciAndSecuritySituationDescription = false;
      protected string otherIntelDescription;
      protected bool _set_otherIntelDescription = false;

      //attribute methods

      //content methods

      public  MixedAnyType RelatedArea
      {
         get
         {
            if (this.relatedArea == null)
                throw new XBException("field relatedArea not set");

            return this.relatedArea;
         }
         set
         {
            this.relatedArea = value;
         }
      }

      public string GeneralSituationDescription
      {
         get
         {
            if (!_set_generalSituationDescription)
                throw new XBException("field generalSituationDescription not set");

            return this.generalSituationDescription;
         }
         set
         {
            this.generalSituationDescription = value;
            _set_generalSituationDescription = true;
         }
      }

      public string GeographicalSituationDescription
      {
         get
         {
            if (!_set_geographicalSituationDescription)
                throw new XBException("field geographicalSituationDescription not set");

            return this.geographicalSituationDescription;
         }
         set
         {
            this.geographicalSituationDescription = value;
            _set_geographicalSituationDescription = true;
         }
      }

      public string MilitarySituationDescription
      {
         get
         {
            if (!_set_militarySituationDescription)
                throw new XBException("field militarySituationDescription not set");

            return this.militarySituationDescription;
         }
         set
         {
            this.militarySituationDescription = value;
            _set_militarySituationDescription = true;
         }
      }

      public string LandSituationDescription
      {
         get
         {
            if (!_set_landSituationDescription)
                throw new XBException("field landSituationDescription not set");

            return this.landSituationDescription;
         }
         set
         {
            this.landSituationDescription = value;
            _set_landSituationDescription = true;
         }
      }

      public string MaritimeSituationDescription
      {
         get
         {
            if (!_set_maritimeSituationDescription)
                throw new XBException("field maritimeSituationDescription not set");

            return this.maritimeSituationDescription;
         }
         set
         {
            this.maritimeSituationDescription = value;
            _set_maritimeSituationDescription = true;
         }
      }

      public string AirSituationDescription
      {
         get
         {
            if (!_set_airSituationDescription)
                throw new XBException("field airSituationDescription not set");

            return this.airSituationDescription;
         }
         set
         {
            this.airSituationDescription = value;
            _set_airSituationDescription = true;
         }
      }

      public string CiAndSecuritySituationDescription
      {
         get
         {
            if (!_set_ciAndSecuritySituationDescription)
                throw new XBException("field ciAndSecuritySituationDescription not set");

            return this.ciAndSecuritySituationDescription;
         }
         set
         {
            this.ciAndSecuritySituationDescription = value;
            _set_ciAndSecuritySituationDescription = true;
         }
      }

      public string OtherIntelDescription
      {
         get
         {
            if (!_set_otherIntelDescription)
                throw new XBException("field otherIntelDescription not set");

            return this.otherIntelDescription;
         }
         set
         {
            this.otherIntelDescription = value;
            _set_otherIntelDescription = true;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.relatedArea = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.relatedArea.decode(reader, xbContext, false, false);
               ...
               // generalSituationDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.generalSituationDescription =  WideTextType.decode(text, xbContext);
               ...
               // geographicalSituationDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.geographicalSituationDescription =  WideTextType.decode(text, xbContext);
               ...
               // militarySituationDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.militarySituationDescription =  WideTextType.decode(text, xbContext);
               ...
               // landSituationDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.landSituationDescription =  WideTextType.decode(text, xbContext);
               ...
               // maritimeSituationDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[5], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.maritimeSituationDescription =  WideTextType.decode(text, xbContext);
               ...
               // airSituationDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[6], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.airSituationDescription =  WideTextType.decode(text, xbContext);
               ...
               // ciAndSecuritySituationDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[7], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.ciAndSecuritySituationDescription =  WideTextType.decode(text, xbContext);
               ...
               // otherIntelDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[8], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.otherIntelDescription =  WideTextType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // relatedArea
         if (this.relatedArea != null)  {
            encoder.encodeStartElement("relatedArea", "", "");
            this.relatedArea.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // generalSituationDescription
         if (_set_generalSituationDescription)  {
            encoder.encodeStartElement("generalSituationDescription", "", "");
            String text_4;
            text_4 =  WideTextType.encode(this.generalSituationDescription, xbContext);
         ...
         // geographicalSituationDescription
         if (_set_geographicalSituationDescription)  {
            encoder.encodeStartElement("geographicalSituationDescription", "", "");
            String text_4;
            text_4 =  WideTextType.encode(this.geographicalSituationDescription, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // militarySituationDescription
         if (_set_militarySituationDescription)  {
            encoder.encodeStartElement("militarySituationDescription", "", "");
            String text_4;
            text_4 =  WideTextType.encode(this.militarySituationDescription, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // landSituationDescription
         if (_set_landSituationDescription)  {
            encoder.encodeStartElement("landSituationDescription", "", "");
            String text_4;
            text_4 =  WideTextType.encode(this.landSituationDescription, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // maritimeSituationDescription
         if (_set_maritimeSituationDescription)  {
            encoder.encodeStartElement("maritimeSituationDescription", "", "");
            String text_4;
            text_4 =  WideTextType.encode(this.maritimeSituationDescription, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // airSituationDescription
         if (_set_airSituationDescription)  {
            encoder.encodeStartElement("airSituationDescription", "", "");
            String text_4;
            text_4 =  WideTextType.encode(this.airSituationDescription, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // ciAndSecuritySituationDescription
         if (_set_ciAndSecuritySituationDescription)  {
            encoder.encodeStartElement("ciAndSecuritySituationDescription", "", "");
            String text_4;
            text_4 =  WideTextType.encode(this.ciAndSecuritySituationDescription, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // otherIntelDescription
         if (_set_otherIntelDescription)  {
            encoder.encodeStartElement("otherIntelDescription", "", "");
            String text_4;
            text_4 =  WideTextType.encode(this.otherIntelDescription, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_INTSUM_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:intsum",
          "NC1_INTSUM_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","intsumSummary"),
         new XBQualifiedName("","intsumSituationReport"),
         new XBQualifiedName("","comment")
      };
      static NC1_INTSUM_ELEM() {
         XBUtil.license =  _NC1_INTSUM.license;
      }
      ...
      //content fields
      protected  NC1_INTSUM_ELEM_2_intsumSummary intsumSummary;
            //optional
      protected  NC1_INTSUM_ELEM_2_intsumSituationReport intsumSituationReport;
      ...
      public  NC1_INTSUM_ELEM_2_intsumSummary IntsumSummary
      {
         get
         {
            if (this.intsumSummary == null)
                throw new XBException("field intsumSummary not set");

            return this.intsumSummary;
         }
         set
         {
            this.intsumSummary = value;
         }
      }

      public  NC1_INTSUM_ELEM_2_intsumSituationReport IntsumSituationReport
      {
         get
         {
            if (this.intsumSituationReport == null)
                throw new XBException("field intsumSituationReport not set");

            return this.intsumSituationReport;
         }
         set
         {
            this.intsumSituationReport = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.intsumSummary = new  NC1_INTSUM_ELEM_2_intsumSummary();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.intsumSummary.decode(reader, xbContext, false, false);
               ...
               // intsumSituationReport
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.intsumSituationReport = new  NC1_INTSUM_ELEM_2_intsumSituationReport();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.intsumSituationReport.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "intsumSituationReport");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // intsumSummary
         if (this.intsumSummary != null)  {
            encoder.encodeStartElement("intsumSummary", "", "");
            this.intsumSummary.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
         ...
         encoder.encodeStartElement("intsumSituationReport", "", "");
         this.intsumSituationReport.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_INTSUM_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:intsum","NC1_INTSUM")
      };
      static NC1_INTSUM_CC() {
         XBUtil.license =  _NC1_INTSUM.license;
      }
      ...
      //content fields
      protected  NC1_INTSUM_ELEM nC1_INTSUM;

      //content methods

      public  NC1_INTSUM_ELEM NC1_INTSUM
      {
         get
         {
            if (this.nC1_INTSUM == null)
                throw new XBException("field nC1_INTSUM not set");

            return this.nC1_INTSUM;
         }
         set
         {
            this.nC1_INTSUM = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_INTSUM.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_INTSUM = new  NC1_INTSUM_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_INTSUM.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_INTSUM");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_INTSUM",  _NC1_INTSUM.NS_URI,  _NC1_INTSUM.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_INTSUM.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_INTSUM {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:intsum";
      public static readonly String NS_PREFIX = "nc1intsum";
