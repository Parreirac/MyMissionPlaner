...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_CBRN_SITREP_ELEM_2__1_situation : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrnsitrep",
          "NC1_CBRN-SITREP_ELEM_2__1_situation");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","A_cbrn2To5Summary"),
         new XBQualifiedName("","B_consequences")
      };
      static NC1_CBRN_SITREP_ELEM_2__1_situation() {
         XBUtil.license =  _NC1_CBRN_SITREP.license;
      }
      ...
      //content fields
      protected  MixedAnyType a_cbrn2To5Summary;   //optional
      protected  MixedAnyType b_consequences;   //optional

      //attribute methods

      //content methods

      public  MixedAnyType A_cbrn2To5Summary
      {
         get
         {
            if (this.a_cbrn2To5Summary == null)
                throw new XBException("field a_cbrn2To5Summary not set");

            return this.a_cbrn2To5Summary;
         }
         set
         {
            this.a_cbrn2To5Summary = value;
         }
      }

      public  MixedAnyType B_consequences
      {
         get
         {
            if (this.b_consequences == null)
                throw new XBException("field b_consequences not set");

            return this.b_consequences;
         }
         set
         {
            this.b_consequences = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.a_cbrn2To5Summary = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.a_cbrn2To5Summary.decode(reader, xbContext, false, false);
               ...
               {
                  this.b_consequences = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.b_consequences.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // a_cbrn2To5Summary
         if (this.a_cbrn2To5Summary != null)  {
            encoder.encodeStartElement("A_cbrn2To5Summary", "", "");
            this.a_cbrn2To5Summary.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // b_consequences
         if (this.b_consequences != null)  {
            encoder.encodeStartElement("B_consequences", "", "");
            this.b_consequences.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_CBRN_SITREP_ELEM_2__2_intelligence : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrnsitrep",
          "NC1_CBRN-SITREP_ELEM_2__2_intelligence");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","A_capacitiesAndIntents"),
         new XBQualifiedName("","B_threatLevel"),
         new XBQualifiedName("","C_cbrnAgentThreatLevel")
      };
      static NC1_CBRN_SITREP_ELEM_2__2_intelligence() {
         XBUtil.license =  _NC1_CBRN_SITREP.license;
      }
      ...
      //content fields
      protected  MixedAnyType a_capacitiesAndIntents;   //optional
      protected  MixedAnyType b_threatLevel;   //optional
      protected  MixedAnyType c_cbrnAgentThreatLevel;   //optional

      //attribute methods

      //content methods

      public  MixedAnyType A_capacitiesAndIntents
      {
         get
         {
            if (this.a_capacitiesAndIntents == null)
                throw new XBException("field a_capacitiesAndIntents not set");

            return this.a_capacitiesAndIntents;
         }
         set
         {
            this.a_capacitiesAndIntents = value;
         }
      }

      public  MixedAnyType B_threatLevel
      {
         get
         {
            if (this.b_threatLevel == null)
                throw new XBException("field b_threatLevel not set");

            return this.b_threatLevel;
         }
         set
         {
            this.b_threatLevel = value;
         }
      }

      public  MixedAnyType C_cbrnAgentThreatLevel
      {
         get
         {
            if (this.c_cbrnAgentThreatLevel == null)
                throw new XBException("field c_cbrnAgentThreatLevel not set");

            return this.c_cbrnAgentThreatLevel;
         }
         set
         {
            this.c_cbrnAgentThreatLevel = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // a_capacitiesAndIntents
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.a_capacitiesAndIntents = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.a_capacitiesAndIntents.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.b_threatLevel = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.b_threatLevel.decode(reader, xbContext, false, false);
               ...
               // c_cbrnAgentThreatLevel
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.c_cbrnAgentThreatLevel = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.c_cbrnAgentThreatLevel.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // a_capacitiesAndIntents
         if (this.a_capacitiesAndIntents != null)  {
            encoder.encodeStartElement("A_capacitiesAndIntents", "", "");
            this.a_capacitiesAndIntents.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
         ...
         // b_threatLevel
         if (this.b_threatLevel != null)  {
            encoder.encodeStartElement("B_threatLevel", "", "");
            this.b_threatLevel.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // c_cbrnAgentThreatLevel
         if (this.c_cbrnAgentThreatLevel != null)  {
            encoder.encodeStartElement("C_cbrnAgentThreatLevel", "", "");
            this.c_cbrnAgentThreatLevel.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_CBRN_SITREP_ELEM_2__3_operations : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrnsitrep",
          "NC1_CBRN-SITREP_ELEM_2__3_operations");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","A_influenceOnOperations"),
         new XBQualifiedName("","B_cbrnWearLevel")
      };
      static NC1_CBRN_SITREP_ELEM_2__3_operations() {
         XBUtil.license =  _NC1_CBRN_SITREP.license;
      }
      ...
      //content fields
      protected  MixedAnyType a_influenceOnOperations;   //optional
      protected  MixedAnyType b_cbrnWearLevel;   //optional

      //attribute methods

      //content methods

      public  MixedAnyType A_influenceOnOperations
      {
         get
         {
            if (this.a_influenceOnOperations == null)
                throw new XBException("field a_influenceOnOperations not set");

            return this.a_influenceOnOperations;
         }
         set
         {
            this.a_influenceOnOperations = value;
         }
      }

      public  MixedAnyType B_cbrnWearLevel
      {
         get
         {
            if (this.b_cbrnWearLevel == null)
                throw new XBException("field b_cbrnWearLevel not set");

            return this.b_cbrnWearLevel;
         }
         set
         {
            this.b_cbrnWearLevel = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // a_influenceOnOperations
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.a_influenceOnOperations = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.a_influenceOnOperations.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.b_cbrnWearLevel = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.b_cbrnWearLevel.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // a_influenceOnOperations
         if (this.a_influenceOnOperations != null)  {
            encoder.encodeStartElement("A_influenceOnOperations", "", "");
            this.a_influenceOnOperations.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
         ...
         // b_cbrnWearLevel
         if (this.b_cbrnWearLevel != null)  {
            encoder.encodeStartElement("B_cbrnWearLevel", "", "");
            this.b_cbrnWearLevel.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_CBRN_SITREP_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrnsitrep",
          "NC1_CBRN-SITREP_ELEM");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","cbrnInfo"),
         new XBQualifiedName("","_1_situation"),
         new XBQualifiedName("","_2_intelligence"),
         new XBQualifiedName("","_3_operations"),
         new XBQualifiedName("","_4_logistics"),
         new XBQualifiedName("","_5_communications"),
         new XBQualifiedName("","_6_staff"),
         new XBQualifiedName("","_7_cimic"),
         new XBQualifiedName("","_8_lawAndInternationalOrganizations"),
         new XBQualifiedName("","_9_recommendations")
      };
      static NC1_CBRN_SITREP_ELEM() {
         XBUtil.license =  _NC1_CBRN_SITREP.license;
      }
      ...
      //content fields
      protected  MixedAnyType cbrnInfo;
      protected  NC1_CBRN_SITREP_ELEM_2__1_situation _1_situation;
            //optional
      protected  NC1_CBRN_SITREP_ELEM_2__2_intelligence _2_intelligence;
            //optional
      protected  NC1_CBRN_SITREP_ELEM_2__3_operations _3_operations;
            //optional
      protected  MixedAnyType _4_logistics;   //optional
      protected  MixedAnyType _5_communications;   //optional
      protected  MixedAnyType _6_staff;   //optional
      protected  MixedAnyType _7_cimic;   //optional
      protected  MixedAnyType _8_lawAndInternationalOrganizations;
            //optional
      protected string _9_recommendations;
      protected bool _set__9_recommendations = false;

      //attribute methods

      //content methods

      public  MixedAnyType CbrnInfo
      {
         get
         {
            if (this.cbrnInfo == null)
                throw new XBException("field cbrnInfo not set");

            return this.cbrnInfo;
         }
         set
         {
            this.cbrnInfo = value;
      ...
      public  NC1_CBRN_SITREP_ELEM_2__1_situation _1_situationProperty
      {
         get
         {
      ...
      public  NC1_CBRN_SITREP_ELEM_2__2_intelligence _2_intelligenceProperty
      {
         get
         {
            if (this._2_intelligence == null)
                throw new XBException("field _2_intelligence not set");

            return this._2_intelligence;
         }
         set
         {
            this._2_intelligence = value;
         }
      }

      public  NC1_CBRN_SITREP_ELEM_2__3_operations _3_operationsProperty
      {
         get
         {
            if (this._3_operations == null)
                throw new XBException("field _3_operations not set");

            return this._3_operations;
         }
         set
         {
            this._3_operations = value;
         }
      }

      public  MixedAnyType _4_logisticsProperty
      {
         get
         {
            if (this._4_logistics == null)
                throw new XBException("field _4_logistics not set");

            return this._4_logistics;
         }
         set
         {
            this._4_logistics = value;
         }
      }

      public  MixedAnyType _5_communicationsProperty
      {
         get
         {
            if (this._5_communications == null)
                throw new XBException("field _5_communications not set");

            return this._5_communications;
         }
         set
         {
            this._5_communications = value;
         }
      }

      public  MixedAnyType _6_staffProperty
      {
         get
         {
            if (this._6_staff == null)
                throw new XBException("field _6_staff not set");

            return this._6_staff;
         }
         set
         {
            this._6_staff = value;
      ...
      public  MixedAnyType _7_cimicProperty
      {
         get
         {
            if (this._7_cimic == null)
                throw new XBException("field _7_cimic not set");

            return this._7_cimic;
         }
         set
         {
            this._7_cimic = value;
      ...
      public  MixedAnyType _8_lawAndInternationalOrganizationsProperty
      {
         get
         {
            if (this._8_lawAndInternationalOrganizations == null)
                throw new XBException("field _8_lawAndInternationalOrganizations not set");

            return this._8_lawAndInternationalOrganizations;
         }
         set
         {
            this._8_lawAndInternationalOrganizations = value;
         }
      }

      public string _9_recommendationsProperty
      {
         get
         {
            if (!_set__9_recommendations)
                throw new XBException("field _9_recommendations not set");

            return this._9_recommendations;
         }
         set
         {
            this._9_recommendations = value;
            _set__9_recommendations = true;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.cbrnInfo = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.cbrnInfo.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "cbrnInfo");

               // _1_situation
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this._1_situation = new  NC1_CBRN_SITREP_ELEM_2__1_situation();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this._2_intelligence = new  NC1_CBRN_SITREP_ELEM_2__2_intelligence();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._2_intelligence.decode(reader, xbContext, false, false);
               ...
               {
                  this._3_operations = new  NC1_CBRN_SITREP_ELEM_2__3_operations();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._3_operations.decode(reader, xbContext, false, false);
               ...
               {
                  this._4_logistics = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._4_logistics.decode(reader, xbContext, false, false);
               ...
               {
                  this._5_communications = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._5_communications.decode(reader, xbContext, false, false);
               ...
               {
                  this._6_staff = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._6_staff.decode(reader, xbContext, false, false);
               ...
               {
                  this._7_cimic = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._7_cimic.decode(reader, xbContext, false, false);
               ...
               // _8_lawAndInternationalOrganizations
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[8], elemNs, elemLocalName) )
               {
                  this._8_lawAndInternationalOrganizations = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._8_lawAndInternationalOrganizations.decode(reader, xbContext, false, false);
                  ...
                  (XBQualifiedName)particleInfo[9], elemNs, elemLocalName) )
               {
                  ...
                  this._9_recommendations =  LongTextType.decode(text, xbContext);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("cbrnInfo", "", "");
         this.cbrnInfo.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         // _2_intelligence
         if (this._2_intelligence != null)  {
            encoder.encodeStartElement("_2_intelligence", "", "");
            this._2_intelligence.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // _3_operations
         if (this._3_operations != null)  {
            encoder.encodeStartElement("_3_operations", "", "");
            this._3_operations.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // _4_logistics
         if (this._4_logistics != null)  {
            encoder.encodeStartElement("_4_logistics", "", "");
            this._4_logistics.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // _5_communications
         if (this._5_communications != null)  {
            encoder.encodeStartElement("_5_communications", "", "");
            this._5_communications.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // _6_staff
         if (this._6_staff != null)  {
            encoder.encodeStartElement("_6_staff", "", "");
            this._6_staff.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // _7_cimic
         if (this._7_cimic != null)  {
            encoder.encodeStartElement("_7_cimic", "", "");
            this._7_cimic.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // _8_lawAndInternationalOrganizations
         if (this._8_lawAndInternationalOrganizations != null)  {
            encoder.encodeStartElement("_8_lawAndInternationalOrganizations", "", "");
            this._8_lawAndInternationalOrganizations.encode(encoder, xbContext, 
               null, false);
            encoder.encodeEndElement();
         }
         ...
         // _9_recommendations
         if (_set__9_recommendations)  {
            encoder.encodeStartElement("_9_recommendations", "", "");
            String text_4;
            text_4 =  LongTextType.encode(this._9_recommendations, xbContext);
   ...
   public class NC1_CBRN_SITREP_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:cbrnsitrep","NC1_CBRN-SITREP")
      };
      static NC1_CBRN_SITREP_CC() {
         XBUtil.license =  _NC1_CBRN_SITREP.license;
      }
      ...
      //content fields
      protected  NC1_CBRN_SITREP_ELEM nC1_CBRN_SITREP;

      //content methods

      public  NC1_CBRN_SITREP_ELEM NC1_CBRN_SITREP
      {
         get
         {
            if (this.nC1_CBRN_SITREP == null)
                throw new XBException("field nC1_CBRN_SITREP not set");

            return this.nC1_CBRN_SITREP;
         }
         set
         {
            this.nC1_CBRN_SITREP = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CBRN_SITREP.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CBRN_SITREP = new  NC1_CBRN_SITREP_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CBRN_SITREP.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CBRN_SITREP");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CBRN-SITREP",  _NC1_CBRN_SITREP.NS_URI,  _NC1_CBRN_SITREP.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CBRN_SITREP.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CBRN_SITREP {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:cbrnsitrep";
      public static readonly String NS_PREFIX = "nc1cbrnsitrep";
 ...
 */
      ...
      public _NC1_CBRN_SITREP() {
      }
      static _NC1_CBRN_SITREP() {
         XBUtil.license = _NC1_CBRN_SITREP.license;
      }
   }
}
