...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_CBRN_1_CHEM_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrn1chem",
          "NC1_CBRN-1-CHEM_ELEM");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","bravo"),
         new XBQualifiedName("","crbnInfo")
      };
      static NC1_CBRN_1_CHEM_ELEM() {
         XBUtil.license =  _NC1_CBRN_1_CHEM.license;
      }
      ...
      public  BravoType Bravo
      {
         get
         {
            if (this.bravo == null)
                throw new XBException("field bravo not set");
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.bravo = new  BravoType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.bravo.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "bravo");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // bravo
         if (this.bravo == null) throw new XBException("field bravo not set");

         encoder.encodeStartElement("bravo", "", "");
         this.bravo.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_CBRN_1_CHEM_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:cbrn1chem","NC1_CBRN-1-CHEM")
      };
      static NC1_CBRN_1_CHEM_CC() {
         XBUtil.license =  _NC1_CBRN_1_CHEM.license;
      }
      ...
      //content fields
      protected  NC1_CBRN_1_CHEM_ELEM nC1_CBRN_1_CHEM;

      //content methods

      public  NC1_CBRN_1_CHEM_ELEM NC1_CBRN_1_CHEM
      {
         get
         {
            if (this.nC1_CBRN_1_CHEM == null)
                throw new XBException("field nC1_CBRN_1_CHEM not set");

            return this.nC1_CBRN_1_CHEM;
         }
         set
         {
            this.nC1_CBRN_1_CHEM = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CBRN_1_CHEM.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CBRN_1_CHEM = new  NC1_CBRN_1_CHEM_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CBRN_1_CHEM.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CBRN_1_CHEM");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CBRN-1-CHEM",  _NC1_CBRN_1_CHEM.NS_URI,  _NC1_CBRN_1_CHEM.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CBRN_1_CHEM.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CBRN_1_CHEM {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:cbrn1chem";
      public static readonly String NS_PREFIX = "nc1cbrn1chem";
 ...
 */
      ...
      public _NC1_CBRN_1_CHEM() {
      }
      static _NC1_CBRN_1_CHEM() {
         XBUtil.license = _NC1_CBRN_1_CHEM.license;
      }
   }
}
