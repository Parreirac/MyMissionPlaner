...
namespace NC1.Msg
{
   ...
   public class NC1_BFT_ELEM_2_locations : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:bft",
          "NC1_BFT_ELEM_2_locations");
      ...
      public enum Choice  {
         None, track, participant}
      protected Choice _whichField;
      static NC1_BFT_ELEM_2_locations() {
         XBUtil.license =  _NC1_BFT.license;
      }
      ...
      public  TrackType Track
      {
         get
         {
            if (_whichField != Choice.track ) 
               throw new XBException("field track not set");
            return this.track;
         }
         set
         {
            this.track = value;
            _whichField = Choice.track;
         }
      }
      ...
      public  ParticipantType Participant
      {
         get
         {
            if (_whichField != Choice.participant ) 
               throw new XBException("field participant not set");
            return this.participant;
         }
         set
         {
            this.participant = value;
            _whichField = Choice.participant;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.track =  TrackType.createObject(
                     XMLStreamHelper.readXsiType(reader) );
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.track.decode(reader, xbContext, false, false);
                  _whichField = Choice.track;
               ...
               {
                  this.participant =  ParticipantType.createObject(
                     XMLStreamHelper.readXsiType(reader) );
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.participant.decode(reader, xbContext, false, false);
                  _whichField = Choice.participant;
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            case Choice.track: {
               ...
               this.track.encode(encoder, xbContext, 
            ...
            // participant
            case Choice.participant: {
               if (_whichField != Choice.participant ) 
                  throw new XBException("field participant not set");
               encoder.encodeStartElement("participant", "", "");
               this.participant.encode(encoder, xbContext, 
   ...
   public class NC1_BFT_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:bft",
          "NC1_BFT_ELEM");
      ...
      //content fields
      protected System.Collections.Generic.IList< NC1_BFT_ELEM_2_locations> locations;
      ...
      public System.Collections.Generic.IList< NC1_BFT_ELEM_2_locations> Locations
      {
         get
         {
            if (this.locations == null) {
               this.locations = new List< NC1_BFT_ELEM_2_locations>();
            }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                   NC1_BFT_ELEM_2_locations _tmp_locations;
                  _tmp_locations = new  NC1_BFT_ELEM_2_locations();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_locations.decode(reader, xbContext, false, false);
                  this.locations.Add(_tmp_locations);
               ...
               if ( this.locations.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.locations.Count, "locations");
               else if (this.locations.Count == 0 && moreContent_4) 
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // locations
         if (this.locations == null || this.locations.Count < 1) 
            throw new XBOccurrencesException( (this.locations == null ? 0 : this.locations.Count ) );

         foreach ( NC1_BFT_ELEM_2_locations _tmp_locations in this.locations)
         {
            encoder.encodeStartElement("locations", "", "");
            _tmp_locations.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_BFT_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:bft","NC1_BFT")
      };
      static NC1_BFT_CC() {
         XBUtil.license =  _NC1_BFT.license;
      }
      ...
      //content fields
      protected  NC1_BFT_ELEM nC1_BFT;

      //content methods

      public  NC1_BFT_ELEM NC1_BFT
      {
         get
         {
            if (this.nC1_BFT == null)
                throw new XBException("field nC1_BFT not set");
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_BFT.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_BFT = new  NC1_BFT_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_BFT.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_BFT");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_BFT",  _NC1_BFT.NS_URI,  _NC1_BFT.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_BFT.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_BFT {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:bft";
      public static readonly String NS_PREFIX = "nc1bft";
