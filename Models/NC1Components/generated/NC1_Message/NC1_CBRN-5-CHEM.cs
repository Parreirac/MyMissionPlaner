...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_CBRN_5_CHEM_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrn5chem",
          "NC1_CBRN-5-CHEM_ELEM");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","xraya"),
         new XBQualifiedName("","crbnInfo")
      };
      static NC1_CBRN_5_CHEM_ELEM() {
         XBUtil.license =  _NC1_CBRN_5_CHEM.license;
      }
      ...
      protected  DeltaType delta;   //optional
      protected  IndiaType india;
      protected  OscarType oscar;
      protected  XrayaType xraya;
      ...
      public  XrayaType Xraya
      {
         get
         {
            if (this.xraya == null)
                throw new XBException("field xraya not set");
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               else throw new XBOccurrencesException(0, "oscar");

               // xraya
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  this.xraya = new  XrayaType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.xraya.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "xraya");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // oscar
         if (this.oscar == null) throw new XBException("field oscar not set");
         ...
         // xraya
         if (this.xraya == null) throw new XBException("field xraya not set");

         encoder.encodeStartElement("xraya", "", "");
         this.xraya.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_CBRN_5_CHEM_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:cbrn5chem","NC1_CBRN-5-CHEM")
      };
      static NC1_CBRN_5_CHEM_CC() {
         XBUtil.license =  _NC1_CBRN_5_CHEM.license;
      }
      ...
      //content fields
      protected  NC1_CBRN_5_CHEM_ELEM nC1_CBRN_5_CHEM;

      //content methods

      public  NC1_CBRN_5_CHEM_ELEM NC1_CBRN_5_CHEM
      {
         get
         {
            if (this.nC1_CBRN_5_CHEM == null)
                throw new XBException("field nC1_CBRN_5_CHEM not set");

            return this.nC1_CBRN_5_CHEM;
         }
         set
         {
            this.nC1_CBRN_5_CHEM = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CBRN_5_CHEM.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CBRN_5_CHEM = new  NC1_CBRN_5_CHEM_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CBRN_5_CHEM.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CBRN_5_CHEM");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CBRN-5-CHEM",  _NC1_CBRN_5_CHEM.NS_URI,  _NC1_CBRN_5_CHEM.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CBRN_5_CHEM.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CBRN_5_CHEM {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:cbrn5chem";
      public static readonly String NS_PREFIX = "nc1cbrn5chem";
 ...
 */
      ...
      public _NC1_CBRN_5_CHEM() {
      }
      static _NC1_CBRN_5_CHEM() {
         XBUtil.license = _NC1_CBRN_5_CHEM.license;
      }
   }
}
