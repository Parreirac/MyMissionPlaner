...
namespace NC1.Msg {
   ...
   public class AdmitOrExitCode
   {
      static AdmitOrExitCode() {
         XBUtil.license =  _NC1_AdmitExitRep.license;
      }

      //constructor
      private AdmitOrExitCode() {} 
   ...
   public class OrganisationOrUnitIdentificationType_1
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:admitexitrep",
          "OrganisationOrUnitIdentificationType_1");
      ...
      protected static  Object[] particleInfo = {
         ...
         new XBQualifiedName("","organisationId"),
         new XBQualifiedName("","identification")
      };
      ...
      public enum Choice  {
         None, unitId, organisationId, identification}
      protected Choice _whichField;
      static OrganisationOrUnitIdentificationType_1() {
         XBUtil.license =  _NC1_AdmitExitRep.license;
      }
      ...
      protected  Nc1ObjectRefType organisationId;
      ...
      public  Nc1ObjectRefType OrganisationId
      {
         get
         {
            if (_whichField != Choice.organisationId ) 
               throw new XBException("field organisationId not set");
            return this.organisationId;
         }
         set
         {
            this.organisationId = value;
            _whichField = Choice.organisationId;
         }
      }
      ...
      public string Identification
      {
         get
         {
            if (_whichField != Choice.identification ) 
               throw new XBException("field identification not set");
            return this.identification;
         }
         set
         {
            this.identification = value;
            _whichField = Choice.identification;
         }
      }
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            // organisationId
               ...
               (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
            {
               this.organisationId = new  Nc1ObjectRefType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.organisationId.decode(reader, xbContext, false, false);
               _whichField = Choice.organisationId;
               ...
               (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
            {
               ...
               this.identification =  MediumTextType.decode(text, xbContext);
               _whichField = Choice.identification;
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            // organisationId
            case Choice.organisationId: {
               if (_whichField != Choice.organisationId ) 
                  throw new XBException("field organisationId not set");
               encoder.encodeStartElement("organisationId", "", "");
               this.organisationId.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
               break;
            }

            // identification
            case Choice.identification: {
               if (_whichField != Choice.identification ) 
                  throw new XBException("field identification not set");
               encoder.encodeStartElement("identification", "", "");
               String text_5;
               text_5 =  MediumTextType.encode(this.identification, xbContext);
   ...
   public class OrganisationOrUnitIdentificationType : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:admitexitrep",
          "OrganisationOrUnitIdentificationType");
      ...
      static OrganisationOrUnitIdentificationType() {
         XBUtil.license =  _NC1_AdmitExitRep.license;
      }
      ...
      //content fields
      protected  OrganisationOrUnitIdentificationType_1 organisationOrUnitIdentificationType_1;
      ...
      public  OrganisationOrUnitIdentificationType_1 OrganisationOrUnitIdentificationType_1
      {
         get
         {
            if (this.organisationOrUnitIdentificationType_1 == null)
                throw new XBException("field organisationOrUnitIdentificationType_1 not set");

            return this.organisationOrUnitIdentificationType_1;
         }
         set
         {
            this.organisationOrUnitIdentificationType_1 = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // organisationOrUnitIdentificationType_1
               if( moreContent_4 && 
                   OrganisationOrUnitIdentificationType_1.acceptsElem(elemNs, elemLocalName)
                   )
               {
                  this.organisationOrUnitIdentificationType_1 = new  OrganisationOrUnitIdentificationType_1();
                  this.organisationOrUnitIdentificationType_1.decode(reader, xbContext);
               ...
               else throw new XBOccurrencesException(0, "organisationOrUnitIdentificationType_1");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         this.organisationOrUnitIdentificationType_1.encode(encoder, xbContext);
      }
   ...
   public class NC1_AdmitExitRep_ELEM_2_admitExitReport : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:admitexitrep",
          "NC1_AdmitExitRep_ELEM_2_admitExitReport");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","admitOrExit"),
         new XBQualifiedName("","facility"),
         new XBQualifiedName("","patient"),
         new XBQualifiedName("","stayPeriod"),
         new XBQualifiedName("","injuryDescription"),
         new XBQualifiedName("","formerOrganisation"),
         new XBQualifiedName("","newOrganisation")
      };
      static NC1_AdmitExitRep_ELEM_2_admitExitReport() {
         XBUtil.license =  _NC1_AdmitExitRep.license;
      }
      ...
      //content fields
      protected int admitOrExit;
      protected  FacilityType facility;
      protected  IndividualType patient;
      protected  PeriodType stayPeriod;
      protected int injuryDescription;
      protected bool _set_injuryDescription = false;
      protected  OrganisationOrUnitIdentificationType formerOrganisation;
            //optional
      protected  OrganisationOrUnitIdentificationType newOrganisation;
            //optional
      ...
      public int AdmitOrExit
      {
         get { return this.admitOrExit; }
         set { this.admitOrExit = value; }
      }
      ...
      public  IndividualType Patient
      {
         get
         {
            if (this.patient == null)
                throw new XBException("field patient not set");
      ...
      public  PeriodType StayPeriod
      {
         get
         {
            if (this.stayPeriod == null)
                throw new XBException("field stayPeriod not set");
      ...
      public int InjuryDescription
      {
         get
         {
            if (!_set_injuryDescription)
                throw new XBException("field injuryDescription not set");
         ...
         set
         {
            ...
            _set_injuryDescription = true;
         }
      }

      public  OrganisationOrUnitIdentificationType FormerOrganisation
      {
         get
         {
            if (this.formerOrganisation == null)
                throw new XBException("field formerOrganisation not set");

            return this.formerOrganisation;
         }
         set
         {
            this.formerOrganisation = value;
         }
      }

      public  OrganisationOrUnitIdentificationType NewOrganisation
      {
         get
         {
            if (this.newOrganisation == null)
                throw new XBException("field newOrganisation not set");

            return this.newOrganisation;
         }
         set
         {
            this.newOrganisation = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.admitOrExit =  AdmitOrExitCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "admitOrExit");
               ...
               else throw new XBOccurrencesException(0, "facility");

               // patient
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.patient = new  IndividualType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.patient.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "patient");

               // stayPeriod
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.stayPeriod = new  PeriodType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.stayPeriod.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "stayPeriod");
                  ...
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.injuryDescription =  InjurySeverityCode.decode(text, xbContext);
               ...
               {
                  this.formerOrganisation = new  OrganisationOrUnitIdentificationType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.formerOrganisation.decode(reader, xbContext, false, false);
               ...
               {
                  this.newOrganisation = new  OrganisationOrUnitIdentificationType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.newOrganisation.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // admitOrExit
         encoder.encodeStartElement("admitOrExit", "", "");
         String text_3;
         text_3 =  AdmitOrExitCode.encode(this.admitOrExit, xbContext);
         ...
         encoder.encodeStartElement("patient", "", "");
         this.patient.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("stayPeriod", "", "");
         this.stayPeriod.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // injuryDescription
         if (_set_injuryDescription)  {
            encoder.encodeStartElement("injuryDescription", "", "");
            text_3 =  InjurySeverityCode.encode(this.injuryDescription, xbContext);
            encoder.encodeCharsNoEscaping(text_3);
            encoder.encodeEndElement();
         }
         ...
         // formerOrganisation
         if (this.formerOrganisation != null)  {
            encoder.encodeStartElement("formerOrganisation", "", "");
            this.formerOrganisation.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // newOrganisation
         if (this.newOrganisation != null)  {
            encoder.encodeStartElement("newOrganisation", "", "");
            this.newOrganisation.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_AdmitExitRep_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:admitexitrep",
          "NC1_AdmitExitRep_ELEM");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","admitExitReport"),
         new XBQualifiedName("","comment")
      };
      static NC1_AdmitExitRep_ELEM() {
         XBUtil.license =  _NC1_AdmitExitRep.license;
      }
      ...
      //content fields
      protected System.Collections.Generic.IList< NC1_AdmitExitRep_ELEM_2_admitExitReport> admitExitReport;
      ...
      public System.Collections.Generic.IList< NC1_AdmitExitRep_ELEM_2_admitExitReport> AdmitExitReport
      {
         get
         {
            if (this.admitExitReport == null) {
               this.admitExitReport = 
                  new List< NC1_AdmitExitRep_ELEM_2_admitExitReport>();
            }
            return this.admitExitReport;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                   NC1_AdmitExitRep_ELEM_2_admitExitReport _tmp_admitExitReport;
                  _tmp_admitExitReport = new  NC1_AdmitExitRep_ELEM_2_admitExitReport();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_admitExitReport.decode(reader, xbContext, false, false);
                  this.admitExitReport.Add(_tmp_admitExitReport);
               ...
               if ( this.admitExitReport.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.admitExitReport.Count, "admitExitReport");
               else if (this.admitExitReport.Count == 0 && moreContent_4) 
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // admitExitReport
         if (this.admitExitReport == null || this.admitExitReport.Count < 1) 
            throw new XBOccurrencesException( (this.admitExitReport == null ? 0 : this.admitExitReport.Count ) );

         foreach ( NC1_AdmitExitRep_ELEM_2_admitExitReport _tmp_admitExitReport in this.admitExitReport)
         {
            encoder.encodeStartElement("admitExitReport", "", "");
            _tmp_admitExitReport.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_AdmitExitRep_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:admitexitrep","NC1_AdmitExitRep")
      };
      static NC1_AdmitExitRep_CC() {
         XBUtil.license =  _NC1_AdmitExitRep.license;
      }
      ...
      //content fields
      protected  NC1_AdmitExitRep_ELEM nC1_AdmitExitRep;

      //content methods

      public  NC1_AdmitExitRep_ELEM NC1_AdmitExitRep
      {
         get
         {
            if (this.nC1_AdmitExitRep == null)
                throw new XBException("field nC1_AdmitExitRep not set");

            return this.nC1_AdmitExitRep;
         }
         set
         {
            this.nC1_AdmitExitRep = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_AdmitExitRep.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_AdmitExitRep = new  NC1_AdmitExitRep_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_AdmitExitRep.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_AdmitExitRep");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_AdmitExitRep",  _NC1_AdmitExitRep.NS_URI,  _NC1_AdmitExitRep.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_AdmitExitRep.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_AdmitExitRep {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:admitexitrep";
      public static readonly String NS_PREFIX = "nc1admitexitrep";
 ...
 */
      ...
      public _NC1_AdmitExitRep() {
      }
      static _NC1_AdmitExitRep() {
         XBUtil.license = _NC1_AdmitExitRep.license;
      }
   }
}
