...
namespace NC1.Msg
{
   ...
   public class NC1_SuppressionItsAts_ELEM_2_deletedITSorATS : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:suppressionitsats",
          "NC1_SuppressionItsAts_ELEM_2_deletedITSorATS");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","deletedITSorATSId"),
         new XBQualifiedName("","is3DAckRequested")
      };
      static NC1_SuppressionItsAts_ELEM_2_deletedITSorATS() {
         XBUtil.license =  _NC1_SuppressionItsAts.license;
      }
      ...
      //content fields
      protected  Nc1ObjectRefType deletedITSorATSId;
      ...
      public  Nc1ObjectRefType DeletedITSorATSId
      {
         get
         {
            if (this.deletedITSorATSId == null)
                throw new XBException("field deletedITSorATSId not set");

            return this.deletedITSorATSId;
         }
         set
         {
            this.deletedITSorATSId = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.deletedITSorATSId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.deletedITSorATSId.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "deletedITSorATSId");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("deletedITSorATSId", "", "");
         this.deletedITSorATSId.encode(encoder, xbContext, null, false);
   ...
   public class NC1_SuppressionItsAts_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:suppressionitsats",
          "NC1_SuppressionItsAts_ELEM");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","deletedITSorATS"),
         new XBQualifiedName("","comment")
      };
      static NC1_SuppressionItsAts_ELEM() {
         XBUtil.license =  _NC1_SuppressionItsAts.license;
      }
      ...
      //content fields
      protected  NC1_SuppressionItsAts_ELEM_2_deletedITSorATS deletedITSorATS;
      ...
      public  NC1_SuppressionItsAts_ELEM_2_deletedITSorATS DeletedITSorATS
      {
         get
         {
            if (this.deletedITSorATS == null)
                throw new XBException("field deletedITSorATS not set");

            return this.deletedITSorATS;
         }
         set
         {
            this.deletedITSorATS = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.deletedITSorATS = new  NC1_SuppressionItsAts_ELEM_2_deletedITSorATS();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.deletedITSorATS.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "deletedITSorATS");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("deletedITSorATS", "", "");
         this.deletedITSorATS.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_SuppressionItsAts_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:suppressionitsats","NC1_SuppressionItsAts")
      };
      static NC1_SuppressionItsAts_CC() {
         XBUtil.license =  _NC1_SuppressionItsAts.license;
      }
      ...
      //content fields
      protected  NC1_SuppressionItsAts_ELEM nC1_SuppressionItsAts;

      //content methods

      public  NC1_SuppressionItsAts_ELEM NC1_SuppressionItsAts
      {
         get
         {
            if (this.nC1_SuppressionItsAts == null)
                throw new XBException("field nC1_SuppressionItsAts not set");

            return this.nC1_SuppressionItsAts;
         }
         set
         {
            this.nC1_SuppressionItsAts = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_SuppressionItsAts.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            // nC1_SuppressionItsAts
            bool moreContent_4 = true;
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_SuppressionItsAts = new  NC1_SuppressionItsAts_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_SuppressionItsAts.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_SuppressionItsAts");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_SuppressionItsAts",  _NC1_SuppressionItsAts.NS_URI,  _NC1_SuppressionItsAts.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_SuppressionItsAts.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_SuppressionItsAts {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:suppressionitsats";
      public static readonly String NS_PREFIX = "nc1suppritsats";
 ...
 */
      ...
      public _NC1_SuppressionItsAts() {
      }
      static _NC1_SuppressionItsAts() {
         XBUtil.license = _NC1_SuppressionItsAts.license;
      }
   }
}
