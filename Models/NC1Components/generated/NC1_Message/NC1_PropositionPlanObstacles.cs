...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_PropositionPlanObstacles_ELEM_2_obstaclesAndWorks : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:propplanobstacles",
          "NC1_PropositionPlanObstacles_ELEM_2_obstaclesAndWorks");
      ...
      static NC1_PropositionPlanObstacles_ELEM_2_obstaclesAndWorks() {
         XBUtil.license =  _NC1_PropositionPlanObstacles.license;
      }
   ...
   public class NC1_PropositionPlanObstacles_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:propplanobstacles",
          "NC1_PropositionPlanObstacles_ELEM");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","obstaclesAndWorks"),
         new XBQualifiedName("","comment")
      };
      static NC1_PropositionPlanObstacles_ELEM() {
         XBUtil.license =  _NC1_PropositionPlanObstacles.license;
      }
      ...
      //content fields
      protected  NC1_PropositionPlanObstacles_ELEM_2_obstaclesAndWorks obstaclesAndWorks;
      ...
      public  NC1_PropositionPlanObstacles_ELEM_2_obstaclesAndWorks ObstaclesAndWorks
      {
         get
         {
            if (this.obstaclesAndWorks == null)
                throw new XBException("field obstaclesAndWorks not set");

            return this.obstaclesAndWorks;
         }
         set
         {
            this.obstaclesAndWorks = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.obstaclesAndWorks = new  NC1_PropositionPlanObstacles_ELEM_2_obstaclesAndWorks();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.obstaclesAndWorks.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "obstaclesAndWorks");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("obstaclesAndWorks", "", "");
         this.obstaclesAndWorks.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_PropositionPlanObstacles_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:propplanobstacles","NC1_PropositionPlanObstacles")
      };
      static NC1_PropositionPlanObstacles_CC() {
         XBUtil.license =  _NC1_PropositionPlanObstacles.license;
      }
      ...
      //content fields
      protected  NC1_PropositionPlanObstacles_ELEM nC1_PropositionPlanObstacles;
         

      //content methods

      public  NC1_PropositionPlanObstacles_ELEM NC1_PropositionPlanObstacles
      {
         get
         {
            if (this.nC1_PropositionPlanObstacles == null)
                throw new XBException("field nC1_PropositionPlanObstacles not set");

            return this.nC1_PropositionPlanObstacles;
         }
         set
         {
            this.nC1_PropositionPlanObstacles = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_PropositionPlanObstacles.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            // nC1_PropositionPlanObstacles
            bool moreContent_4 = true;
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_PropositionPlanObstacles = new  NC1_PropositionPlanObstacles_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_PropositionPlanObstacles.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_PropositionPlanObstacles");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_PropositionPlanObstacles",  _NC1_PropositionPlanObstacles.NS_URI,  _NC1_PropositionPlanObstacles.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_PropositionPlanObstacles.encode(encoder, xbContext, null, 
            false);
         encoder.encodeEndElement();
      }
   }
   ...
   public class _NC1_PropositionPlanObstacles {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:propplanobstacles";
      public static readonly String NS_PREFIX = "nc1propplanobst";
 ...
 */
      ...
      public _NC1_PropositionPlanObstacles() {
      }
      static _NC1_PropositionPlanObstacles() {
         XBUtil.license = _NC1_PropositionPlanObstacles.license;
      }
   }
}
