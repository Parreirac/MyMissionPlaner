...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    using NC1.Msg;
    public class NC1_OPORD_MVT_ELEM_2__3_execution : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordmvt",
          "NC1_OPORD-MVT_ELEM_2__3_execution");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","A_movementConcept"),
         new XBQualifiedName("","B_subordinatesMissions"),
         new XBQualifiedName("","C_coordinationMeans")
      };
      static NC1_OPORD_MVT_ELEM_2__3_execution() {
         XBUtil.license =  _NC1_OPORD_MVT.license;
      }
      ...
      //content fields
      protected  MixedAnyType a_movementConcept;   //optional
      protected  MixedAnyType b_subordinatesMissions;   //optional
      ...
      public  MixedAnyType A_movementConcept
      {
         get
         {
            if (this.a_movementConcept == null)
                throw new XBException("field a_movementConcept not set");

            return this.a_movementConcept;
         }
         set
         {
            this.a_movementConcept = value;
         }
      }

      public  MixedAnyType B_subordinatesMissions
      {
         get
         {
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.a_movementConcept = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.a_movementConcept.decode(reader, xbContext, false, false);
               ...
               {
                  this.b_subordinatesMissions = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // a_movementConcept
         if (this.a_movementConcept != null)  {
            encoder.encodeStartElement("A_movementConcept", "", "");
            this.a_movementConcept.encode(encoder, xbContext, null, false);
   ...
   public class NC1_OPORD_MVT_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordmvt",
          "NC1_OPORD-MVT_ELEM");
      ...
      protected  NC1_OPORD_MVT_ELEM_2__3_execution _3_execution;
            //optional
      ...
      public  NC1_OPORD_MVT_ELEM_2__3_execution _3_executionProperty
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this._3_execution = new  NC1_OPORD_MVT_ELEM_2__3_execution();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_OPORD_MVT_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:opordmvt","NC1_OPORD-MVT")
      };
      static NC1_OPORD_MVT_CC() {
         XBUtil.license =  _NC1_OPORD_MVT.license;
      }
      ...
      //content fields
      protected  NC1_OPORD_MVT_ELEM nC1_OPORD_MVT;

      //content methods

      public  NC1_OPORD_MVT_ELEM NC1_OPORD_MVT
      {
         get
         {
            if (this.nC1_OPORD_MVT == null)
                throw new XBException("field nC1_OPORD_MVT not set");

            return this.nC1_OPORD_MVT;
         }
         set
         {
            this.nC1_OPORD_MVT = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_OPORD_MVT.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_OPORD_MVT = new  NC1_OPORD_MVT_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_OPORD_MVT.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_OPORD_MVT");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_OPORD-MVT",  _NC1_OPORD_MVT.NS_URI,  _NC1_OPORD_MVT.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_OPORD_MVT.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_OPORD_MVT {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:opordmvt";
      public static readonly String NS_PREFIX = "nc1opordmvt";
 ...
 */
      ...
      public _NC1_OPORD_MVT() {
      }
      static _NC1_OPORD_MVT() {
         XBUtil.license = _NC1_OPORD_MVT.license;
      }
   }
}
