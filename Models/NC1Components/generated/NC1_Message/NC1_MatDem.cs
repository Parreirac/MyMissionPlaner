...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class CodedPriorityCode
   {
      static CodedPriorityCode() {
         XBUtil.license =  _NC1_MatDem.license;
      }

      //constructor
      private CodedPriorityCode() {} 
   ...
   public class DeliveryMethodCode
   {
      static DeliveryMethodCode() {
         XBUtil.license =  _NC1_MatDem.license;
      }
   ...
   public class NC1_MatDem_ELEM_2_requestedItem_deliveryCriteria : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:matdem",
          "NC1_MatDem_ELEM_2_requestedItem_deliveryCriteria");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","priorityCode"),
         new XBQualifiedName("","latestTarget"),
         new XBQualifiedName("","methodOfDelivery"),
         new XBQualifiedName("","impactOfNonCompliance"),
         new XBQualifiedName("","location")
      };
      static NC1_MatDem_ELEM_2_requestedItem_deliveryCriteria() {
         XBUtil.license =  _NC1_MatDem.license;
      }
      ...
      protected string latestTarget;
      protected int methodOfDelivery;
      protected string impactOfNonCompliance;
      protected  TacPointType location;   //optional
      ...
      {
         get { return this.priorityCode; }
         set { this.priorityCode = value; }
      }

      public string LatestTarget
      {
         get { return this.latestTarget; }
         set { this.latestTarget = value; }
      }

      public int MethodOfDelivery
      {
         get { return this.methodOfDelivery; }
         set { this.methodOfDelivery = value; }
      }

      public string ImpactOfNonCompliance
      {
         get { return this.impactOfNonCompliance; }
         set { this.impactOfNonCompliance = value; }
      }

      public  TacPointType Location
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.priorityCode =  CodedPriorityCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "priorityCode");
               ...
               else throw new XBOccurrencesException(0, "latestTarget");
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.methodOfDelivery =  DeliveryMethodCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "methodOfDelivery");

               // impactOfNonCompliance
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.impactOfNonCompliance =  MediumTextType.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "impactOfNonCompliance");

               // location
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  this.location = new  TacPointType();
                  xbContext.decodeSchemaLocationAttrs(reader);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // priorityCode
         encoder.encodeStartElement("priorityCode", "", "");
         String text_3;
         text_3 =  CodedPriorityCode.encode(this.priorityCode, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // latestTarget
         encoder.encodeStartElement("latestTarget", "", "");
         text_3 = this.latestTarget;
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();

         // methodOfDelivery
         encoder.encodeStartElement("methodOfDelivery", "", "");
         text_3 =  DeliveryMethodCode.encode(this.methodOfDelivery, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // impactOfNonCompliance
         encoder.encodeStartElement("impactOfNonCompliance", "", "");
         text_3 =  MediumTextType.encode(this.impactOfNonCompliance, xbContext);
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();
   ...
   public class NC1_MatDem_ELEM_2_requestedItem : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:matdem",
          "NC1_MatDem_ELEM_2_requestedItem");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","requiredQuantity"),
         new XBQualifiedName("","stocksOnHand"),
         new XBQualifiedName("","deliveryCriteria")
      };
      static NC1_MatDem_ELEM_2_requestedItem() {
         XBUtil.license =  _NC1_MatDem.license;
      }
      ...
      protected int stocksOnHand;
      protected bool _set_stocksOnHand = false;
      protected  NC1_MatDem_ELEM_2_requestedItem_deliveryCriteria deliveryCriteria;
      ...
      public int RequiredQuantity
      {
         ...
         set { this.requiredQuantity = value; }
      }

      public int StocksOnHand
      {
         get
         {
            if (!_set_stocksOnHand)
                throw new XBException("field stocksOnHand not set");

            return this.stocksOnHand;
         }
         set
         {
            this.stocksOnHand = value;
            _set_stocksOnHand = true;
         }
      }

      public  NC1_MatDem_ELEM_2_requestedItem_deliveryCriteria DeliveryCriteria
      {
         get
         {
            if (this.deliveryCriteria == null)
                throw new XBException("field deliveryCriteria not set");

            return this.deliveryCriteria;
         }
         set
         {
            this.deliveryCriteria = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.requiredQuantity = XBSimpleType.parseInt32(text);
               ...
               else throw new XBOccurrencesException(0, "requiredQuantity");
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.stocksOnHand = XBSimpleType.parseInt32(text);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.deliveryCriteria = new  NC1_MatDem_ELEM_2_requestedItem_deliveryCriteria();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.deliveryCriteria.decode(reader, xbContext, false, false);

                  moreContent_4 = 
                     XMLStreamHelper.moveToContentElement(reader);
               }
               else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
               else throw new XBOccurrencesException(0, "deliveryCriteria");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // requiredQuantity
         encoder.encodeStartElement("requiredQuantity", "", "");
         text_3 = this.requiredQuantity.ToString();
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // stocksOnHand
         if (_set_stocksOnHand)  {
            encoder.encodeStartElement("stocksOnHand", "", "");
            text_3 = this.stocksOnHand.ToString();
            encoder.encodeCharsNoEscaping(text_3);
            encoder.encodeEndElement();
         }
         ...
         encoder.encodeStartElement("deliveryCriteria", "", "");
         this.deliveryCriteria.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   ...
   public class NC1_MatDem_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:matdem",
          "NC1_MatDem_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","requestedItem"),
         new XBQualifiedName("","comment")
      };
      static NC1_MatDem_ELEM() {
         XBUtil.license =  _NC1_MatDem.license;
      }
      ...
      //content fields
      protected System.Collections.Generic.IList< NC1_MatDem_ELEM_2_requestedItem> requestedItem;
         
      protected  CommentSectionType comment;

      //attribute methods

      //content methods

      public System.Collections.Generic.IList< NC1_MatDem_ELEM_2_requestedItem> RequestedItem
      {
         get
         {
            if (this.requestedItem == null) {
               this.requestedItem = 
                  new List< NC1_MatDem_ELEM_2_requestedItem>();
            }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                   NC1_MatDem_ELEM_2_requestedItem _tmp_requestedItem;
                  _tmp_requestedItem = new  NC1_MatDem_ELEM_2_requestedItem();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_requestedItem.decode(reader, xbContext, false, false);
                  this.requestedItem.Add(_tmp_requestedItem);
               ...
               if ( this.requestedItem.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.requestedItem.Count, "requestedItem");
               else if (this.requestedItem.Count == 0 && moreContent_4) 
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // requestedItem
         if (this.requestedItem == null || this.requestedItem.Count < 1) 
            throw new XBOccurrencesException( (this.requestedItem == null ? 0 : this.requestedItem.Count ) );

         foreach ( NC1_MatDem_ELEM_2_requestedItem _tmp_requestedItem in this.requestedItem)
         {
            encoder.encodeStartElement("requestedItem", "", "");
            _tmp_requestedItem.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_MatDem_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:matdem","NC1_MatDem")
      };
      static NC1_MatDem_CC() {
         XBUtil.license =  _NC1_MatDem.license;
      }
      ...
      //content fields
      protected  NC1_MatDem_ELEM nC1_MatDem;

      //content methods

      public  NC1_MatDem_ELEM NC1_MatDem
      {
         get
         {
            if (this.nC1_MatDem == null)
                throw new XBException("field nC1_MatDem not set");

            return this.nC1_MatDem;
         }
         set
         {
            this.nC1_MatDem = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_MatDem.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_MatDem = new  NC1_MatDem_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_MatDem.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_MatDem");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_MatDem",  _NC1_MatDem.NS_URI,  _NC1_MatDem.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_MatDem.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_MatDem {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:matdem";
      public static readonly String NS_PREFIX = "nc1matdem";
