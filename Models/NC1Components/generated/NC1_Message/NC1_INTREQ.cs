...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_INTREQ_ELEM_2_intelligenceRequest : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:intreq",
          "NC1_INTREQ_ELEM_2_intelligenceRequest");
      ...
      static NC1_INTREQ_ELEM_2_intelligenceRequest() {
         XBUtil.license =  _NC1_INTREQ.license;
      }
   ...
   public class NC1_INTREQ_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:intreq",
          "NC1_INTREQ_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","intelligenceRequest"),
         new XBQualifiedName("","comment"),
         new XBQualifiedName("","url")
      };
      static NC1_INTREQ_ELEM() {
         XBUtil.license =  _NC1_INTREQ.license;
      }
      ...
      //content fields
      protected  NC1_INTREQ_ELEM_2_intelligenceRequest intelligenceRequest;
      ...
      public  NC1_INTREQ_ELEM_2_intelligenceRequest IntelligenceRequest
      {
         get
         {
            if (this.intelligenceRequest == null)
                throw new XBException("field intelligenceRequest not set");

            return this.intelligenceRequest;
         }
         set
         {
            this.intelligenceRequest = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.intelligenceRequest = new  NC1_INTREQ_ELEM_2_intelligenceRequest();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.intelligenceRequest.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "intelligenceRequest");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("intelligenceRequest", "", "");
         this.intelligenceRequest.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_INTREQ_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:intreq","NC1_INTREQ")
      };
      static NC1_INTREQ_CC() {
         XBUtil.license =  _NC1_INTREQ.license;
      }
      ...
      //content fields
      protected  NC1_INTREQ_ELEM nC1_INTREQ;

      //content methods

      public  NC1_INTREQ_ELEM NC1_INTREQ
      {
         get
         {
            if (this.nC1_INTREQ == null)
                throw new XBException("field nC1_INTREQ not set");

            return this.nC1_INTREQ;
         }
         set
         {
            this.nC1_INTREQ = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_INTREQ.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_INTREQ = new  NC1_INTREQ_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_INTREQ.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_INTREQ");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_INTREQ",  _NC1_INTREQ.NS_URI,  _NC1_INTREQ.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_INTREQ.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_INTREQ {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:intreq";
      public static readonly String NS_PREFIX = "nc1intreq";
