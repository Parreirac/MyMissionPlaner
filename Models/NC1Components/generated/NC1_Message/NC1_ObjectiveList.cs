...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class ObjectiveListConfirmationStatusCode
   {
      static ObjectiveListConfirmationStatusCode() {
         XBUtil.license =  _NC1_ObjectiveList.license;
      }

      //constructor
      private ObjectiveListConfirmationStatusCode() {} 
   ...
   public class NC1_ObjectiveList_ELEM_2_fireObjectives : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:objectivelist",
          "NC1_ObjectiveList_ELEM_2_fireObjectives");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","confirmationStatus"),
         new XBQualifiedName("","fireObjective")
      };
      static NC1_ObjectiveList_ELEM_2_fireObjectives() {
         XBUtil.license =  _NC1_ObjectiveList.license;
      }
      ...
      //content fields
      protected int confirmationStatus;
      protected System.Collections.Generic.IList< FireObjectiveType> fireObjective;
      ...
      {
         get { return this.confirmationStatus; }
         set { this.confirmationStatus = value; }
      }

      public System.Collections.Generic.IList< FireObjectiveType> FireObjective
      {
         get
         {
            if (this.fireObjective == null) {
               this.fireObjective = new List< FireObjectiveType>();
            }
            return this.fireObjective;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.confirmationStatus =  ObjectiveListConfirmationStatusCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "confirmationStatus");
               ...
               {
                   FireObjectiveType _tmp_fireObjective;
                  _tmp_fireObjective = new  FireObjectiveType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_fireObjective.decode(reader, xbContext, false, false);
                  this.fireObjective.Add(_tmp_fireObjective);
               ...
               if ( this.fireObjective.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.fireObjective.Count, "fireObjective");
               else if (this.fireObjective.Count == 0 && moreContent_4) 
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // confirmationStatus
         encoder.encodeStartElement("confirmationStatus", "", "");
         String text_3;
         text_3 =  ObjectiveListConfirmationStatusCode.encode(this.confirmationStatus, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // fireObjective
         if (this.fireObjective == null || this.fireObjective.Count < 1) 
            throw new XBOccurrencesException( (this.fireObjective == null ? 0 : this.fireObjective.Count ) );

         foreach ( FireObjectiveType _tmp_fireObjective in this.fireObjective)
         {
            encoder.encodeStartElement("fireObjective", "", "");
            _tmp_fireObjective.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_ObjectiveList_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:objectivelist",
          "NC1_ObjectiveList_ELEM");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","fireObjectives"),
         new XBQualifiedName("","comment")
      };
      static NC1_ObjectiveList_ELEM() {
         XBUtil.license =  _NC1_ObjectiveList.license;
      }
      ...
      protected  NC1_ObjectiveList_ELEM_2_fireObjectives fireObjectives;
      ...
      public  NC1_ObjectiveList_ELEM_2_fireObjectives FireObjectives
      {
         get
         {
            if (this.fireObjectives == null)
                throw new XBException("field fireObjectives not set");

            return this.fireObjectives;
         }
         set
         {
            this.fireObjectives = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.fireObjectives = new  NC1_ObjectiveList_ELEM_2_fireObjectives();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.fireObjectives.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "fireObjectives");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("fireObjectives", "", "");
         this.fireObjectives.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_ObjectiveList_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:objectivelist","NC1_ObjectiveList")
      };
      static NC1_ObjectiveList_CC() {
         XBUtil.license =  _NC1_ObjectiveList.license;
      }
      ...
      //content fields
      protected  NC1_ObjectiveList_ELEM nC1_ObjectiveList;

      //content methods

      public  NC1_ObjectiveList_ELEM NC1_ObjectiveList
      {
         get
         {
            if (this.nC1_ObjectiveList == null)
                throw new XBException("field nC1_ObjectiveList not set");

            return this.nC1_ObjectiveList;
         }
         set
         {
            this.nC1_ObjectiveList = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_ObjectiveList.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_ObjectiveList = new  NC1_ObjectiveList_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_ObjectiveList.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_ObjectiveList");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_ObjectiveList",  _NC1_ObjectiveList.NS_URI,  _NC1_ObjectiveList.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_ObjectiveList.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_ObjectiveList {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:objectivelist";
      public static readonly String NS_PREFIX = "nc1objectivelist";
 ...
 */
      ...
      public _NC1_ObjectiveList() {
      }
      static _NC1_ObjectiveList() {
         XBUtil.license = _NC1_ObjectiveList.license;
      }
   }
}
