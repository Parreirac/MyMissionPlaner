...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_AnnulerTirInterdit_ELEM_7_volume_geometricalShape : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:annultirinterdit",
          "NC1_AnnulerTirInterdit_ELEM_7_volume_geometricalShape");
      ...
      static NC1_AnnulerTirInterdit_ELEM_7_volume_geometricalShape() {
         XBUtil.license =  _NC1_AnnulerTirInterdit.license;
      }
      ...
      protected  CorridorType corridor;  // TODO PRA
   ...
   public class NC1_AnnulerTirInterdit_ELEM_7_volume : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:annultirinterdit",
          "NC1_AnnulerTirInterdit_ELEM_7_volume");
      ...
      static NC1_AnnulerTirInterdit_ELEM_7_volume() {
         XBUtil.license =  _NC1_AnnulerTirInterdit.license;
      }
      ...
      //content fields
      protected  NC1_AnnulerTirInterdit_ELEM_7_volume_geometricalShape geometricalShape;
         
      protected Obj.acm.LevelsType levels;

      //attribute methods

      //content methods

      public  NC1_AnnulerTirInterdit_ELEM_7_volume_geometricalShape GeometricalShape
      {
         get
         {
      ...
      public Obj.acm.LevelsType Levels
      {
         get
         {
            if (this.levels == null)
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.geometricalShape = new  NC1_AnnulerTirInterdit_ELEM_7_volume_geometricalShape();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_AnnulerTirInterdit_ELEM_7
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:annultirinterdit",
          "NC1_AnnulerTirInterdit_ELEM_7");
      ...
      protected Choice _whichField;
      static NC1_AnnulerTirInterdit_ELEM_7() {
         XBUtil.license =  _NC1_AnnulerTirInterdit.license;
      }
      ...
      protected  NC1_AnnulerTirInterdit_ELEM_7_volume volume;
      ...
      public  NC1_AnnulerTirInterdit_ELEM_7_volume Volume
      {
         get
         {
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            // volume
               ...
               (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
            {
               this.volume = new  NC1_AnnulerTirInterdit_ELEM_7_volume();
               xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_AnnulerTirInterdit_ELEM_4_zone : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:annultirinterdit",
          "NC1_AnnulerTirInterdit_ELEM_4_zone");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","cancelDatetime")
      };
      static NC1_AnnulerTirInterdit_ELEM_4_zone() {
         XBUtil.license =  _NC1_AnnulerTirInterdit.license;
      }
      ...
      protected bool _set_cancelDatetime = false;
      protected  NC1_AnnulerTirInterdit_ELEM_7 nC1_AnnulerTirInterdit_ELEM_7;
      ...
      public string CancelDatetime
      {
         get
         {
            if (!_set_cancelDatetime)
                throw new XBException("field cancelDatetime not set");
         ...
         set
         {
            ...
            _set_cancelDatetime = true;
         }
      }

      public  NC1_AnnulerTirInterdit_ELEM_7 NC1_AnnulerTirInterdit_ELEM_7
      {
         get
         {
            if (this.nC1_AnnulerTirInterdit_ELEM_7 == null)
                throw new XBException("field nC1_AnnulerTirInterdit_ELEM_7 not set");

            return this.nC1_AnnulerTirInterdit_ELEM_7;
         }
         set
         {
            this.nC1_AnnulerTirInterdit_ELEM_7 = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // nC1_AnnulerTirInterdit_ELEM_7
               if( moreContent_4 && 
                   NC1_AnnulerTirInterdit_ELEM_7.acceptsElem(elemNs, elemLocalName)
                   )
               {
                  this.nC1_AnnulerTirInterdit_ELEM_7 = new  NC1_AnnulerTirInterdit_ELEM_7();
                  this.nC1_AnnulerTirInterdit_ELEM_7.decode(reader, xbContext);
                  moreContent_4 = !XMLStreamHelper.isEndContent(reader);
               }
               else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
               else throw new XBOccurrencesException(0, "nC1_AnnulerTirInterdit_ELEM_7");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // cancelDatetime
         if (_set_cancelDatetime)  {
            encoder.encodeStartElement("cancelDatetime", "", "");
            String text_4;
            text_4 = this.cancelDatetime;
         ...
         this.nC1_AnnulerTirInterdit_ELEM_7.encode(encoder, xbContext);
      }
   ...
   public class NC1_AnnulerTirInterdit_ELEM_4
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:annultirinterdit",
          "NC1_AnnulerTirInterdit_ELEM_4");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("","actionCancelDatetime"),
      ...
      public enum Choice  {
         None, actionCancelDatetime, zone}
      protected Choice _whichField;
      static NC1_AnnulerTirInterdit_ELEM_4() {
         XBUtil.license =  _NC1_AnnulerTirInterdit.license;
      }
      ...
      //content fields
      protected string actionCancelDatetime;
      protected System.Collections.Generic.IList< NC1_AnnulerTirInterdit_ELEM_4_zone> zone;
         

      //content methods

      public string ActionCancelDatetime
      {
         get
         {
            if (_whichField != Choice.actionCancelDatetime ) 
               throw new XBException("field actionCancelDatetime not set");
            return this.actionCancelDatetime;
         }
         set
         {
            this.actionCancelDatetime = value;
            _whichField = Choice.actionCancelDatetime;
         }
      }

      public System.Collections.Generic.IList< NC1_AnnulerTirInterdit_ELEM_4_zone> Zone
      {
         get
         {
            if (_whichField != Choice.zone ) 
               throw new XBException("field zone not set");
            if (_whichField  != Choice.zone) {
               this.zone = 
                  new List< NC1_AnnulerTirInterdit_ELEM_4_zone>();
               _whichField = Choice.zone;
            }
            return this.zone;
         }
      }
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
               ...
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               ...
               String text = reader.ReadString();
               text = XBSimpleType.whitespaceCollapse(text);
               this.actionCancelDatetime = text;
               _whichField = Choice.actionCancelDatetime;
               ...
               (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
            {
               this.zone = 
                  new List< NC1_AnnulerTirInterdit_ELEM_4_zone>();
               do  {
                   NC1_AnnulerTirInterdit_ELEM_4_zone _tmp_zone;
                  _tmp_zone = new  NC1_AnnulerTirInterdit_ELEM_4_zone();
                  xbContext.decodeSchemaLocationAttrs(reader);
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            // actionCancelDatetime
            case Choice.actionCancelDatetime: {
               if (_whichField != Choice.actionCancelDatetime ) 
                  throw new XBException("field actionCancelDatetime not set");
               encoder.encodeStartElement("actionCancelDatetime", "", "");
               String text_5;
               text_5 = this.actionCancelDatetime;
               encoder.encodeChars(text_5);
               encoder.encodeEndElement();
               break;
            }
            ...
            case Choice.zone: {
               ...
               foreach ( NC1_AnnulerTirInterdit_ELEM_4_zone _tmp_zone in this.zone)
               {
   ...
   public class NC1_AnnulerTirInterdit_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:annultirinterdit",
          "NC1_AnnulerTirInterdit_ELEM");
      ...
      static NC1_AnnulerTirInterdit_ELEM() {
         XBUtil.license =  _NC1_AnnulerTirInterdit.license;
      }
      ...
      protected  NC1_AnnulerTirInterdit_ELEM_4 nC1_AnnulerTirInterdit_ELEM_4;
      ...
      public  NC1_AnnulerTirInterdit_ELEM_4 NC1_AnnulerTirInterdit_ELEM_4
      {
         get
         {
            if (this.nC1_AnnulerTirInterdit_ELEM_4 == null)
                throw new XBException("field nC1_AnnulerTirInterdit_ELEM_4 not set");

            return this.nC1_AnnulerTirInterdit_ELEM_4;
         }
         set
         {
            this.nC1_AnnulerTirInterdit_ELEM_4 = value;
         }
      }
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // nC1_AnnulerTirInterdit_ELEM_4
               if( moreContent_4 && 
                   NC1_AnnulerTirInterdit_ELEM_4.acceptsElem(elemNs, elemLocalName)
                   )
               {
                  this.nC1_AnnulerTirInterdit_ELEM_4 = new  NC1_AnnulerTirInterdit_ELEM_4();
                  this.nC1_AnnulerTirInterdit_ELEM_4.decode(reader, xbContext);
                  moreContent_4 = !XMLStreamHelper.isEndContent(reader);
                  if (moreContent_4) {
                     elemLocalName = reader.LocalName;
                     elemNs = reader.NamespaceURI;
               ...
               else throw new XBOccurrencesException(0, "nC1_AnnulerTirInterdit_ELEM_4");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_alertNumber)  {
            ...
            String text_4;
            text_4 =  ShortTextType.encode(this.alertNumber, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         this.nC1_AnnulerTirInterdit_ELEM_4.encode(encoder, xbContext);
   ...
   public class NC1_AnnulerTirInterdit_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:annultirinterdit","NC1_AnnulerTirInterdit")
      };
      static NC1_AnnulerTirInterdit_CC() {
         XBUtil.license =  _NC1_AnnulerTirInterdit.license;
      }
      ...
      //content fields
      protected  NC1_AnnulerTirInterdit_ELEM nC1_AnnulerTirInterdit;

      //content methods

      public  NC1_AnnulerTirInterdit_ELEM NC1_AnnulerTirInterdit
      {
         get
         {
            if (this.nC1_AnnulerTirInterdit == null)
                throw new XBException("field nC1_AnnulerTirInterdit not set");

            return this.nC1_AnnulerTirInterdit;
         }
         set
         {
            this.nC1_AnnulerTirInterdit = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_AnnulerTirInterdit.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            // nC1_AnnulerTirInterdit
            bool moreContent_4 = true;
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_AnnulerTirInterdit = new  NC1_AnnulerTirInterdit_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_AnnulerTirInterdit.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_AnnulerTirInterdit");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_AnnulerTirInterdit",  _NC1_AnnulerTirInterdit.NS_URI,  _NC1_AnnulerTirInterdit.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_AnnulerTirInterdit.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_AnnulerTirInterdit {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:annultirinterdit";
      public static readonly String NS_PREFIX = "nc1annultirinterdit";
 ...
 */
      ...
      public _NC1_AnnulerTirInterdit() {
      }
      static _NC1_AnnulerTirInterdit() {
         XBUtil.license = _NC1_AnnulerTirInterdit.license;
      }
   }
}
