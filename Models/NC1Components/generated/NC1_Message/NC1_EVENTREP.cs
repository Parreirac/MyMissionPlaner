...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class EventReportTypeCode
   {
      static EventReportTypeCode() {
         XBUtil.license =  _NC1_EVENTREP.license;
      }

      //constructor
      private EventReportTypeCode() {} 
   ...
   public class NC1_EVENTREP_ELEM_2_eventReport : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:eventrep",
          "NC1_EVENTREP_ELEM_2_eventReport");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","purposeOfReport"),
         new XBQualifiedName("","event"),
         new XBQualifiedName("","relatedSituation")
      };
      static NC1_EVENTREP_ELEM_2_eventReport() {
         XBUtil.license =  _NC1_EVENTREP.license;
      }
      ...
      //content fields
      protected int type;
      protected string purposeOfReport;
      protected  EventType event_;
      protected  MixedAnyType relatedSituation;
      ...
      public string PurposeOfReport
      {
         get { return this.purposeOfReport; }
         set { this.purposeOfReport = value; }
      }

      public  EventType Event_
      {
         get
         {
            if (this.event_ == null)
                throw new XBException("field event_ not set");
      ...
      public  MixedAnyType RelatedSituation
      {
         get
         {
            if (this.relatedSituation == null)
                throw new XBException("field relatedSituation not set");

            return this.relatedSituation;
         }
         set
         {
            this.relatedSituation = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.type =  EventReportTypeCode.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.purposeOfReport =  WideTextType.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "purposeOfReport");

               // event_
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.event_ = new  EventType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.event_.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "event_");

               // relatedSituation
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.relatedSituation = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.relatedSituation.decode(reader, xbContext, false, false);

                  moreContent_4 = 
                     XMLStreamHelper.moveToContentElement(reader);
               }
               else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
               else throw new XBOccurrencesException(0, "relatedSituation");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         String text_3;
         text_3 =  EventReportTypeCode.encode(this.type, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // purposeOfReport
         encoder.encodeStartElement("purposeOfReport", "", "");
         text_3 =  WideTextType.encode(this.purposeOfReport, xbContext);
         ...
         this.event_.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("relatedSituation", "", "");
         this.relatedSituation.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   ...
   public class NC1_EVENTREP_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:eventrep",
          "NC1_EVENTREP_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","eventReport"),
         new XBQualifiedName("","comment")
      };
      static NC1_EVENTREP_ELEM() {
         XBUtil.license =  _NC1_EVENTREP.license;
      }
      ...
      //content fields
      protected System.Collections.Generic.IList< NC1_EVENTREP_ELEM_2_eventReport> eventReport;
      ...
      public System.Collections.Generic.IList< NC1_EVENTREP_ELEM_2_eventReport> EventReport
      {
         get
         {
            if (this.eventReport == null) {
               this.eventReport = 
                  new List< NC1_EVENTREP_ELEM_2_eventReport>();
            }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                   NC1_EVENTREP_ELEM_2_eventReport _tmp_eventReport;
                  _tmp_eventReport = new  NC1_EVENTREP_ELEM_2_eventReport();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_eventReport.decode(reader, xbContext, false, false);
                  this.eventReport.Add(_tmp_eventReport);
               ...
               if ( this.eventReport.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.eventReport.Count, "eventReport");
               else if (this.eventReport.Count == 0 && moreContent_4) 
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // eventReport
         if (this.eventReport == null || this.eventReport.Count < 1) 
            throw new XBOccurrencesException( (this.eventReport == null ? 0 : this.eventReport.Count ) );

         foreach ( NC1_EVENTREP_ELEM_2_eventReport _tmp_eventReport in this.eventReport)
         {
            encoder.encodeStartElement("eventReport", "", "");
            _tmp_eventReport.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_EVENTREP_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:eventrep","NC1_EVENTREP")
      };
      static NC1_EVENTREP_CC() {
         XBUtil.license =  _NC1_EVENTREP.license;
      }
      ...
      //content fields
      protected  NC1_EVENTREP_ELEM nC1_EVENTREP;

      //content methods

      public  NC1_EVENTREP_ELEM NC1_EVENTREP
      {
         get
         {
            if (this.nC1_EVENTREP == null)
                throw new XBException("field nC1_EVENTREP not set");

            return this.nC1_EVENTREP;
         }
         set
         {
            this.nC1_EVENTREP = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_EVENTREP.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_EVENTREP = new  NC1_EVENTREP_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_EVENTREP.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_EVENTREP");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_EVENTREP",  _NC1_EVENTREP.NS_URI,  _NC1_EVENTREP.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_EVENTREP.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_EVENTREP {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:eventrep";
      public static readonly String NS_PREFIX = "nc1eventrep";
 ...
 */
      ...
      public _NC1_EVENTREP() {
      }
      static _NC1_EVENTREP() {
         XBUtil.license = _NC1_EVENTREP.license;
      }
   }
}
