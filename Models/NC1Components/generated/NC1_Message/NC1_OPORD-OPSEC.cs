...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    using NC1.Msg;
    public class NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_threatAndSubversionCapacities
       : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordopsec",
          "NC1_OPORD-OPSEC_ELEM_2__1_situation_A_enemyForces_threatAndSubversionCapacities");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","intelligence"),
         new XBQualifiedName("","spying")
      };
      static NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_threatAndSubversionCapacities() 
      {
         XBUtil.license =  _NC1_OPORD_OPSEC.license;
      }
      ...
      //content fields
      protected  MixedAnyType intelligence;   //optional
      protected  MixedAnyType spying;   //optional

      //attribute methods

      //content methods

      public  MixedAnyType Intelligence
      {
         get
         {
            if (this.intelligence == null)
                throw new XBException("field intelligence not set");
      ...
      public  MixedAnyType Spying
      {
         get
         {
            if (this.spying == null)
                throw new XBException("field spying not set");
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.intelligence = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.intelligence.decode(reader, xbContext, false, false);
               ...
               {
                  this.spying = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.spying.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // intelligence
         if (this.intelligence != null)  {
            encoder.encodeStartElement("intelligence", "", "");
            this.intelligence.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // spying
         if (this.spying != null)  {
            encoder.encodeStartElement("spying", "", "");
            this.spying.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_electronicWarfare
       : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordopsec",
          "NC1_OPORD-OPSEC_ELEM_2__1_situation_A_enemyForces_electronicWarfare");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","supportMeasures"),
         new XBQualifiedName("","counterMeasures")
      };
      static NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_electronicWarfare() 
      {
         XBUtil.license =  _NC1_OPORD_OPSEC.license;
      }
      ...
      //content fields
      protected  MixedAnyType supportMeasures;   //optional
      protected  MixedAnyType counterMeasures;   //optional

      //attribute methods

      //content methods

      public  MixedAnyType SupportMeasures
      {
         get
         {
            if (this.supportMeasures == null)
                throw new XBException("field supportMeasures not set");

            return this.supportMeasures;
         }
         set
         {
            this.supportMeasures = value;
         }
      }

      public  MixedAnyType CounterMeasures
      {
         get
         {
            if (this.counterMeasures == null)
                throw new XBException("field counterMeasures not set");

            return this.counterMeasures;
         }
         set
         {
            this.counterMeasures = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.supportMeasures = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.supportMeasures.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.counterMeasures = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.counterMeasures.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // supportMeasures
         if (this.supportMeasures != null)  {
            encoder.encodeStartElement("supportMeasures", "", "");
            this.supportMeasures.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // counterMeasures
         if (this.counterMeasures != null)  {
            encoder.encodeStartElement("counterMeasures", "", "");
            this.counterMeasures.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordopsec",
          "NC1_OPORD-OPSEC_ELEM_2__1_situation_A_enemyForces");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","threatAndSubversionCapacities"),
         new XBQualifiedName("","electronicWarfare"),
         new XBQualifiedName("","ground"),
         new XBQualifiedName("","meteo"),
         new XBQualifiedName("","timeAndSpace"),
         new XBQualifiedName("","enemyWeaknesses")
      };
      static NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces() {
         XBUtil.license =  _NC1_OPORD_OPSEC.license;
      }
      ...
      //content fields
      protected  NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_threatAndSubversionCapacities threatAndSubversionCapacities;
            //optional
      protected  NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_electronicWarfare electronicWarfare;
            //optional
      protected  MixedAnyType ground;   //optional
      protected string meteo;
      protected bool _set_meteo = false;
      protected  MixedAnyType timeAndSpace;   //optional
      protected  MixedAnyType enemyWeaknesses;   //optional

      //attribute methods

      //content methods

      public  NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_threatAndSubversionCapacities ThreatAndSubversionCapacities
      {
         get
         {
            if (this.threatAndSubversionCapacities == null)
                throw new XBException("field threatAndSubversionCapacities not set");

            return this.threatAndSubversionCapacities;
         }
         set
         {
            this.threatAndSubversionCapacities = value;
         }
      }

      public  NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_electronicWarfare ElectronicWarfare
      {
         get
         {
            if (this.electronicWarfare == null)
                throw new XBException("field electronicWarfare not set");

            return this.electronicWarfare;
         }
         set
         {
            this.electronicWarfare = value;
         }
      }

      public  MixedAnyType Ground
      {
         get
         {
            if (this.ground == null)
                throw new XBException("field ground not set");
      ...
      public string Meteo
      {
         get
         {
            if (!_set_meteo) throw new XBException("field meteo not set");
      ...
      public  MixedAnyType TimeAndSpace
      {
         get
         {
            if (this.timeAndSpace == null)
                throw new XBException("field timeAndSpace not set");

            return this.timeAndSpace;
         }
         set
         {
            this.timeAndSpace = value;
         }
      }

      public  MixedAnyType EnemyWeaknesses
      {
         get
         {
            if (this.enemyWeaknesses == null)
                throw new XBException("field enemyWeaknesses not set");

            return this.enemyWeaknesses;
         }
         set
         {
            this.enemyWeaknesses = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // threatAndSubversionCapacities
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.threatAndSubversionCapacities = new  NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_threatAndSubversionCapacities();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.threatAndSubversionCapacities.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.electronicWarfare = new  NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces_electronicWarfare();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.electronicWarfare.decode(reader, xbContext, false, false);
               ...
               {
                  this.ground = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.ground.decode(reader, xbContext, false, false);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  this.meteo =  LongTextType.decode(text, xbContext);
               ...
               {
                  this.timeAndSpace = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.timeAndSpace.decode(reader, xbContext, false, false);
               ...
               {
                  this.enemyWeaknesses = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.enemyWeaknesses.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // threatAndSubversionCapacities
         if (this.threatAndSubversionCapacities != null)  {
            encoder.encodeStartElement("threatAndSubversionCapacities", "", "");
            this.threatAndSubversionCapacities.encode(encoder, xbContext, 
               null, false);
            encoder.encodeEndElement();
         }
         ...
         // electronicWarfare
         if (this.electronicWarfare != null)  {
            encoder.encodeStartElement("electronicWarfare", "", "");
            this.electronicWarfare.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
         ...
         if (this.ground != null)  {
            ...
            this.ground.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
         ...
         if (_set_meteo)  {
            ...
            String text_4;
            text_4 =  LongTextType.encode(this.meteo, xbContext);
         ...
         // timeAndSpace
         if (this.timeAndSpace != null)  {
            encoder.encodeStartElement("timeAndSpace", "", "");
            this.timeAndSpace.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // enemyWeaknesses
         if (this.enemyWeaknesses != null)  {
            encoder.encodeStartElement("enemyWeaknesses", "", "");
            this.enemyWeaknesses.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_OPSEC_ELEM_2__1_situation : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordopsec",
          "NC1_OPORD-OPSEC_ELEM_2__1_situation");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","A_enemyForces")
      };
      static NC1_OPORD_OPSEC_ELEM_2__1_situation() {
         XBUtil.license =  _NC1_OPORD_OPSEC.license;
      }
      ...
      //content fields
      protected  NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces a_enemyForces;
            //optional
      ...
      public  NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces A_enemyForces
      {
         get
         {
            if (this.a_enemyForces == null)
                throw new XBException("field a_enemyForces not set");

            return this.a_enemyForces;
         }
         set
         {
            this.a_enemyForces = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.a_enemyForces = new  NC1_OPORD_OPSEC_ELEM_2__1_situation_A_enemyForces();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.a_enemyForces.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // a_enemyForces
         if (this.a_enemyForces != null)  {
            encoder.encodeStartElement("A_enemyForces", "", "");
            this.a_enemyForces.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_OPSEC_ELEM_2__3_execution : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordopsec",
          "NC1_OPORD-OPSEC_ELEM_2__3_execution");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","B_opsecMissions"),
         new XBQualifiedName("","C_opsecMeasures"),
         new XBQualifiedName("","D_coordinationMeans"),
         new XBQualifiedName("","E_counterIntelligence"),
         new XBQualifiedName("","F_other"),
         new XBQualifiedName("","G_counterIntelligenceCommand")
      };
      static NC1_OPORD_OPSEC_ELEM_2__3_execution() {
         XBUtil.license =  _NC1_OPORD_OPSEC.license;
      }
      ...
      //content fields
      protected string a_intention;
      protected bool _set_a_intention = false;
      protected  MixedAnyType b_opsecMissions;   //optional
      protected  MixedAnyType c_opsecMeasures;   //optional
      protected  MixedAnyType d_coordinationMeans;   //optional
      protected  MixedAnyType e_counterIntelligence;   //optional
      protected  MixedAnyType f_other;   //optional
      protected string g_counterIntelligenceCommand;
      protected bool _set_g_counterIntelligenceCommand = false;

      //attribute methods

      //content methods

      public string A_intention
      {
         get
         {
            if (!_set_a_intention)
         ...
         set
         {
            ...
            _set_a_intention = true;
         }
      }

      public  MixedAnyType B_opsecMissions
      {
         get
         {
            if (this.b_opsecMissions == null)
                throw new XBException("field b_opsecMissions not set");

            return this.b_opsecMissions;
         }
         set
         {
            this.b_opsecMissions = value;
         }
      }

      public  MixedAnyType C_opsecMeasures
      {
         get
         {
            if (this.c_opsecMeasures == null)
                throw new XBException("field c_opsecMeasures not set");

            return this.c_opsecMeasures;
         }
         set
         {
            this.c_opsecMeasures = value;
         }
      }

      public  MixedAnyType D_coordinationMeans
      {
         get
         {
            if (this.d_coordinationMeans == null)
                throw new XBException("field d_coordinationMeans not set");

            return this.d_coordinationMeans;
         }
         set
         {
            this.d_coordinationMeans = value;
         }
      }

      public  MixedAnyType E_counterIntelligence
      {
         get
         {
            if (this.e_counterIntelligence == null)
                throw new XBException("field e_counterIntelligence not set");

            return this.e_counterIntelligence;
         }
         set
         {
            this.e_counterIntelligence = value;
         }
      }

      public  MixedAnyType F_other
      {
         get
         {
            if (this.f_other == null)
                throw new XBException("field f_other not set");
      ...
      public string G_counterIntelligenceCommand
      {
         get
         {
            if (!_set_g_counterIntelligenceCommand)
                throw new XBException("field g_counterIntelligenceCommand not set");

            return this.g_counterIntelligenceCommand;
         }
         set
         {
            this.g_counterIntelligenceCommand = value;
            _set_g_counterIntelligenceCommand = true;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.a_intention =  LongTextType.decode(text, xbContext);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.b_opsecMissions = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.b_opsecMissions.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.c_opsecMeasures = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.c_opsecMeasures.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.d_coordinationMeans = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.d_coordinationMeans.decode(reader, xbContext, false, false);
               ...
               // e_counterIntelligence
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  this.e_counterIntelligence = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.e_counterIntelligence.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[5], elemNs, elemLocalName) )
               {
                  this.f_other = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.f_other.decode(reader, xbContext, false, false);
               ...
               // g_counterIntelligenceCommand
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[6], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.g_counterIntelligenceCommand =  LongTextType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_a_intention)  {
            ...
            String text_4;
            text_4 =  LongTextType.encode(this.a_intention, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // b_opsecMissions
         if (this.b_opsecMissions != null)  {
            encoder.encodeStartElement("B_opsecMissions", "", "");
            this.b_opsecMissions.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // c_opsecMeasures
         if (this.c_opsecMeasures != null)  {
            encoder.encodeStartElement("C_opsecMeasures", "", "");
            this.c_opsecMeasures.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // d_coordinationMeans
         if (this.d_coordinationMeans != null)  {
            encoder.encodeStartElement("D_coordinationMeans", "", "");
            this.d_coordinationMeans.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // e_counterIntelligence
         if (this.e_counterIntelligence != null)  {
            encoder.encodeStartElement("E_counterIntelligence", "", "");
            this.e_counterIntelligence.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
         ...
         // f_other
         if (this.f_other != null)  {
            encoder.encodeStartElement("F_other", "", "");
            this.f_other.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // g_counterIntelligenceCommand
         if (_set_g_counterIntelligenceCommand)  {
            encoder.encodeStartElement("G_counterIntelligenceCommand", "", "");
            String text_4;
            text_4 =  LongTextType.encode(this.g_counterIntelligenceCommand, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_OPSEC_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordopsec",
          "NC1_OPORD-OPSEC_ELEM");
      ...
      //content fields
      protected  NC1_OPORD_OPSEC_ELEM_2__1_situation _1_situation;
            //optional
      protected  MixedAnyType _2_mission;   //optional
      protected  NC1_OPORD_OPSEC_ELEM_2__3_execution _3_execution;
            //optional
      ...
      public  NC1_OPORD_OPSEC_ELEM_2__1_situation _1_situationProperty
      {
         get
         {
      ...
      public  NC1_OPORD_OPSEC_ELEM_2__3_execution _3_executionProperty
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this._1_situation = new  NC1_OPORD_OPSEC_ELEM_2__1_situation();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this._3_execution = new  NC1_OPORD_OPSEC_ELEM_2__3_execution();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_OPORD_OPSEC_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:opordopsec","NC1_OPORD-OPSEC")
      };
      static NC1_OPORD_OPSEC_CC() {
         XBUtil.license =  _NC1_OPORD_OPSEC.license;
      }
      ...
      //content fields
      protected  NC1_OPORD_OPSEC_ELEM nC1_OPORD_OPSEC;

      //content methods

      public  NC1_OPORD_OPSEC_ELEM NC1_OPORD_OPSEC
      {
         get
         {
            if (this.nC1_OPORD_OPSEC == null)
                throw new XBException("field nC1_OPORD_OPSEC not set");

            return this.nC1_OPORD_OPSEC;
         }
         set
         {
            this.nC1_OPORD_OPSEC = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_OPORD_OPSEC.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_OPORD_OPSEC = new  NC1_OPORD_OPSEC_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_OPORD_OPSEC.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_OPORD_OPSEC");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_OPORD-OPSEC",  _NC1_OPORD_OPSEC.NS_URI,  _NC1_OPORD_OPSEC.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_OPORD_OPSEC.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_OPORD_OPSEC {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:opordopsec";
      public static readonly String NS_PREFIX = "nc1opordopsec";
 ...
 */
      ...
      public _NC1_OPORD_OPSEC() {
      }
      static _NC1_OPORD_OPSEC() {
         XBUtil.license = _NC1_OPORD_OPSEC.license;
      }
   }
}
