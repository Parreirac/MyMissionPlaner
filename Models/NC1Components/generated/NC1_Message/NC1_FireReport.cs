...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    using AmmunitionType = NC1.Obj.fire.AmmunitionType;
    using FireType = NC1.Obj.fire.FireType;

    public class NC1_FireReport_ELEM_2_reportedFire_involvedUnit : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:firereport",
          "NC1_FireReport_ELEM_2_reportedFire_involvedUnit");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","involvedUnitId"),
         new XBQualifiedName("","artilleryPiecesCount"),
         new XBQualifiedName("","firedAmmunition")
      };
      static NC1_FireReport_ELEM_2_reportedFire_involvedUnit() {
         XBUtil.license =  _NC1_FireReport.license;
      }
      ...
      //content fields
      protected  Nc1ObjectRefType involvedUnitId;
      protected byte artilleryPiecesCount;
      protected bool _set_artilleryPiecesCount = false;
      protected System.Collections.Generic.IList< AmmunitionType> firedAmmunition;
      ...
      public  Nc1ObjectRefType InvolvedUnitId
      {
         get
         {
            if (this.involvedUnitId == null)
                throw new XBException("field involvedUnitId not set");

            return this.involvedUnitId;
         }
         set
         {
            this.involvedUnitId = value;
         }
      }

      public byte ArtilleryPiecesCount
      {
         get
         {
            if (!_set_artilleryPiecesCount)
                throw new XBException("field artilleryPiecesCount not set");

            return this.artilleryPiecesCount;
         }
         set
         {
            this.artilleryPiecesCount = value;
            _set_artilleryPiecesCount = true;
         }
      }

      public System.Collections.Generic.IList< AmmunitionType> FiredAmmunition
      {
         get
         {
            if (this.firedAmmunition == null) {
               this.firedAmmunition = new List< AmmunitionType>();
            }
            return this.firedAmmunition;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.involvedUnitId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.involvedUnitId.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "involvedUnitId");

               // artilleryPiecesCount
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  this.artilleryPiecesCount =  Int0To99Type.decode(text, xbContext);
               ...
               {
                   AmmunitionType _tmp_firedAmmunition;
                  _tmp_firedAmmunition = new  AmmunitionType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_firedAmmunition.decode(reader, xbContext, false, false);
                  this.firedAmmunition.Add(_tmp_firedAmmunition);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("involvedUnitId", "", "");
         this.involvedUnitId.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // artilleryPiecesCount
         if (_set_artilleryPiecesCount)  {
            encoder.encodeStartElement("artilleryPiecesCount", "", "");
            String text_4;
            text_4 =  Int0To99Type.encode(this.artilleryPiecesCount, xbContext);
         ...
         // firedAmmunition
         if ( this.firedAmmunition != null ){
            foreach ( AmmunitionType _tmp_firedAmmunition in this.firedAmmunition)
            {
               encoder.encodeStartElement("firedAmmunition", "", "");
               _tmp_firedAmmunition.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
      }
   ...
   public class NC1_FireReport_ELEM_2_reportedFire : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:firereport",
          "NC1_FireReport_ELEM_2_reportedFire");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","fire"),
         new XBQualifiedName("","fireMissionCommandAccepted"),
         new XBQualifiedName("","involvedUnit"),
         new XBQualifiedName("","firedAmmunitionSummary")
      };
      static NC1_FireReport_ELEM_2_reportedFire() {
         XBUtil.license =  _NC1_FireReport.license;
      }
      ...
      //content fields
      protected  FireType fire;
      protected int fireMissionCommandAccepted;
      protected bool _set_fireMissionCommandAccepted = false;
      protected System.Collections.Generic.IList< NC1_FireReport_ELEM_2_reportedFire_involvedUnit> involvedUnit;
         
      protected System.Collections.Generic.IList< AmmunitionType> firedAmmunitionSummary;
      ...
      public  FireType Fire
      {
         ...
         {
            if (this.fire == null)
                throw new XBException("field fire not set");
      ...
      public int FireMissionCommandAccepted
      {
         get
         {
            if (!_set_fireMissionCommandAccepted)
                throw new XBException("field fireMissionCommandAccepted not set");

            return this.fireMissionCommandAccepted;
         }
         set
         {
            this.fireMissionCommandAccepted = value;
            _set_fireMissionCommandAccepted = true;
         }
      }

      public System.Collections.Generic.IList< NC1_FireReport_ELEM_2_reportedFire_involvedUnit> InvolvedUnit
      {
         get
         {
            if (this.involvedUnit == null) {
               this.involvedUnit = 
                  new List< NC1_FireReport_ELEM_2_reportedFire_involvedUnit>()
                  ;
            }
      ...
      public System.Collections.Generic.IList< AmmunitionType> FiredAmmunitionSummary
      {
         get
         {
            if (this.firedAmmunitionSummary == null) {
               this.firedAmmunitionSummary = new List< AmmunitionType>()
                  ;
            }
            return this.firedAmmunitionSummary;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.fire = new  FireType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.fire.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "fire");

               // fireMissionCommandAccepted
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.fireMissionCommandAccepted =  L114_27Code.decode(text, xbContext);
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                   NC1_FireReport_ELEM_2_reportedFire_involvedUnit _tmp_involvedUnit;
                  _tmp_involvedUnit = new  NC1_FireReport_ELEM_2_reportedFire_involvedUnit();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_involvedUnit.decode(reader, xbContext, false, false);
                  this.involvedUnit.Add(_tmp_involvedUnit);
               ...
               // firedAmmunitionSummary
               this.firedAmmunitionSummary = new List< AmmunitionType>()
                  ;
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                   AmmunitionType _tmp_firedAmmunitionSummary;
                  _tmp_firedAmmunitionSummary = new  AmmunitionType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_firedAmmunitionSummary.decode(reader, xbContext, false, false);
                  this.firedAmmunitionSummary.Add(_tmp_firedAmmunitionSummary
                     );
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // fire
         if (this.fire == null) throw new XBException("field fire not set");

         encoder.encodeStartElement("fire", "", "");
         this.fire.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // fireMissionCommandAccepted
         if (_set_fireMissionCommandAccepted)  {
            encoder.encodeStartElement("fireMissionCommandAccepted", "", "");
            String text_4;
            text_4 =  L114_27Code.encode(this.fireMissionCommandAccepted, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // involvedUnit
         if ( this.involvedUnit != null ){
            foreach ( NC1_FireReport_ELEM_2_reportedFire_involvedUnit _tmp_involvedUnit in this.involvedUnit)
            {
               encoder.encodeStartElement("involvedUnit", "", "");
               _tmp_involvedUnit.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
         ...
         // firedAmmunitionSummary
         if ( this.firedAmmunitionSummary != null ){
            foreach ( AmmunitionType _tmp_firedAmmunitionSummary in this.firedAmmunitionSummary)
            {
               encoder.encodeStartElement("firedAmmunitionSummary", "", "");
               _tmp_firedAmmunitionSummary.encode(encoder, xbContext, null, 
                  false);
               encoder.encodeEndElement();
            }
         }
   ...
   public class NC1_FireReport_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:firereport",
          "NC1_FireReport_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","reportedFire"),
         new XBQualifiedName("","comment")
      };
      static NC1_FireReport_ELEM() {
         XBUtil.license =  _NC1_FireReport.license;
      }
      ...
      //content fields
      protected  NC1_FireReport_ELEM_2_reportedFire reportedFire;
      ...
      public  NC1_FireReport_ELEM_2_reportedFire ReportedFire
      {
         get
         {
            if (this.reportedFire == null)
                throw new XBException("field reportedFire not set");

            return this.reportedFire;
         }
         set
         {
            this.reportedFire = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.reportedFire = new  NC1_FireReport_ELEM_2_reportedFire();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.reportedFire.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "reportedFire");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("reportedFire", "", "");
         this.reportedFire.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_FireReport_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:firereport","NC1_FireReport")
      };
      static NC1_FireReport_CC() {
         XBUtil.license =  _NC1_FireReport.license;
      }
      ...
      //content fields
      protected  NC1_FireReport_ELEM nC1_FireReport;

      //content methods

      public  NC1_FireReport_ELEM NC1_FireReport
      {
         get
         {
            if (this.nC1_FireReport == null)
                throw new XBException("field nC1_FireReport not set");

            return this.nC1_FireReport;
         }
         set
         {
            this.nC1_FireReport = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_FireReport.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_FireReport = new  NC1_FireReport_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_FireReport.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_FireReport");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_FireReport",  _NC1_FireReport.NS_URI,  _NC1_FireReport.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_FireReport.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_FireReport {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:firereport";
      public static readonly String NS_PREFIX = "nc1firereport";
 ...
 */
      ...
      public _NC1_FireReport() {
      }
      static _NC1_FireReport() {
         XBUtil.license = _NC1_FireReport.license;
      }
   }
}
