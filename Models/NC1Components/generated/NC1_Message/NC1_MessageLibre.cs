...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    using NC1.Msg;
    using NC1.Obj;
    public class NC1_MessageLibre_ELEM_2_objectsGlobal : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:messagelibre",
          "NC1_MessageLibre_ELEM_2_objectsGlobal");
      ...
      static NC1_MessageLibre_ELEM_2_objectsGlobal() {
         XBUtil.license =  _NC1_MessageLibre.license;
      }
   ...
   public class NC1_MessageLibre_ELEM_2_body : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:messagelibre",
          "NC1_MessageLibre_ELEM_2_body");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","title"),
         new XBQualifiedName("","hierarchyLevel"),
         new XBQualifiedName("","content")
      };
      static NC1_MessageLibre_ELEM_2_body() {
         XBUtil.license =  _NC1_MessageLibre.license;
      }
      ...
      protected bool _set_title = false;
      protected string hierarchyLevel;
      protected bool _set_hierarchyLevel = false;
      protected  MixedAnyType content;
      ...
      public string Title
      {
         get
         {
            if (!_set_title) throw new XBException("field title not set");
      ...
      public string HierarchyLevel
      {
         get
         {
            if (!_set_hierarchyLevel)
                throw new XBException("field hierarchyLevel not set");
         ...
         set
         {
            ...
            _set_hierarchyLevel = true;
         }
      }

      public  MixedAnyType Content
      {
         get
         {
            if (this.content == null)
                throw new XBException("field content not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.title =  MediumTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.hierarchyLevel =  HierarchyLevelType.decode(text, xbContext);
               ...
               {
                  this.content = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.content.decode(reader, xbContext, false, false);

                  moreContent_4 = 
                     XMLStreamHelper.moveToContentElement(reader);
               }
               else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
               else throw new XBOccurrencesException(0, "content");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // title
         if (_set_title)  {
            encoder.encodeStartElement("title", "", "");
            String text_4;
            text_4 =  MediumTextType.encode(this.title, xbContext);
         ...
         // hierarchyLevel
         if (_set_hierarchyLevel)  {
            encoder.encodeStartElement("hierarchyLevel", "", "");
            String text_4;
            text_4 =  HierarchyLevelType.encode(this.hierarchyLevel, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         encoder.encodeStartElement("content", "", "");
         this.content.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   ...
   public class NC1_MessageLibre_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:messagelibre",
          "NC1_MessageLibre_ELEM");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","subject"),
         new XBQualifiedName("","isTemplate"),
         new XBQualifiedName("","body")
      };
      static NC1_MessageLibre_ELEM() {
         XBUtil.license =  _NC1_MessageLibre.license;
      }
      ...
      //content fields
      protected  NC1_MessageLibre_ELEM_2_objectsGlobal objectsGlobal;
            //optional
      protected string type;
      protected string nature;
      protected bool _set_nature = false;
      protected string subject;
      protected bool _set_subject = false;
      protected bool isTemplate;
      protected System.Collections.Generic.IList< NC1_MessageLibre_ELEM_2_body> body;
      ...
      public  NC1_MessageLibre_ELEM_2_objectsGlobal ObjectsGlobal
      {
         get
         {
      ...
      public string Subject
      {
         get
         {
            if (!_set_subject) throw new XBException("field subject not set");
      ...
      public System.Collections.Generic.IList< NC1_MessageLibre_ELEM_2_body> Body
      {
         get
         {
            if (this.body == null) {
               this.body = new List< NC1_MessageLibre_ELEM_2_body>();
            }
            return this.body;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.objectsGlobal = new  NC1_MessageLibre_ELEM_2_objectsGlobal();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.nature =  ShortTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.subject =  MediumTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  ...
                  this.isTemplate = XBSimpleType.parseBoolean(text);
               ...
               else throw new XBOccurrencesException(0, "isTemplate");
               ...
               {
                   NC1_MessageLibre_ELEM_2_body _tmp_body;
                  _tmp_body = new  NC1_MessageLibre_ELEM_2_body();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_body.decode(reader, xbContext, false, false);
                  this.body.Add(_tmp_body);
               ...
               if ( this.body.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.body.Count, "body");
               else if (this.body.Count == 0 && moreContent_4) 
                  throw new XBUnexpectedElementException(elemNs, elemLocalName);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_nature)  {
            ...
            text_3 =  ShortTextType.encode(this.nature, xbContext);
            encoder.encodeChars(text_3);
            encoder.encodeEndElement();
         }
         ...
         // subject
         if (_set_subject)  {
            encoder.encodeStartElement("subject", "", "");
            text_3 =  MediumTextType.encode(this.subject, xbContext);
            encoder.encodeChars(text_3);
            encoder.encodeEndElement();
         }

         // isTemplate
         encoder.encodeStartElement("isTemplate", "", "");
         text_3 = this.isTemplate.ToString().ToLower();
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // body
         if (this.body == null || this.body.Count < 1) 
            throw new XBOccurrencesException( (this.body == null ? 0 : this.body.Count ) );

         foreach ( NC1_MessageLibre_ELEM_2_body _tmp_body in this.body){
            encoder.encodeStartElement("body", "", "");
            _tmp_body.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_MessageLibre_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:messagelibre","NC1_MessageLibre")
      };
      static NC1_MessageLibre_CC() {
         XBUtil.license =  _NC1_MessageLibre.license;
      }
      ...
      //content fields
      protected  NC1_MessageLibre_ELEM nC1_MessageLibre;

      //content methods

      public  NC1_MessageLibre_ELEM NC1_MessageLibre
      {
         get
         {
            if (this.nC1_MessageLibre == null)
                throw new XBException("field nC1_MessageLibre not set");

            return this.nC1_MessageLibre;
         }
         set
         {
            this.nC1_MessageLibre = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_MessageLibre.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_MessageLibre = new  NC1_MessageLibre_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_MessageLibre.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_MessageLibre");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_MessageLibre",  _NC1_MessageLibre.NS_URI,  _NC1_MessageLibre.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_MessageLibre.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_MessageLibre {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:messagelibre";
      public static readonly String NS_PREFIX = "nc1messagelibre";
 ...
 */
      ...
      public _NC1_MessageLibre() {
      }
      static _NC1_MessageLibre() {
         XBUtil.license = _NC1_MessageLibre.license;
      }
   }
}
