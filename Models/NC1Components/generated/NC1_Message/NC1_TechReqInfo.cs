...
namespace NC1.Msg
{
   ...
   public class NC1_TechReqInfo_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:service:reqinfo",
          "NC1_TechReqInfo_ELEM");
      static NC1_TechReqInfo_ELEM() {
         XBUtil.license =  _NC1_TechReqInfo.license;
      }

      //attribute fields
      protected string objectId;
      protected string objectInstance;
      protected bool _set_objectInstance = false;
      ...
      public string ObjectInstance
      {
         get
         {
            if (!_set_objectInstance)
                throw new XBException("field objectInstance not set");
      ...
      protected override void validateAttrs(bool[] _attrPresenceFlags){
         if (!_attrPresenceFlags[8]) 
            throw new XBValidationException("missing attribute objectId");
      ...
      protected override bool decodeAttr(String name, String ns, 
         ...
         /*    objectId    */
         if (name.CompareTo("objectId") == 0  && ns.CompareTo("") == 0 ) {
            this.objectId =  Nc1ObjectIdType.decode(text, xbContext);
            _attrPresenceFlags[8] = true;
            return true;
         }

         /*    objectInstance    */
         else if (name.CompareTo("objectInstance") == 0  && 
            ns.CompareTo("") == 0 ) {
            this.objectInstance =  ShortTextObjectType.decode(text, xbContext);
            _set_objectInstance = true;
            return true;
         }
         else 
      ...
      protected override void encodeAttrs(XBXmlEncoder encoder, 
         ...
         /* objectId -> objectId    */
         String text_3;
         text_3 =  Nc1ObjectIdType.encode(this.objectId, xbContext);
         encoder.encodeAttr("objectId", "", "", text_3);

         /* objectInstance -> objectInstance    */
         if (_set_objectInstance) {
            text_3 =  ShortTextObjectType.encode(this.objectInstance, xbContext);
            encoder.encodeAttr("objectInstance", "", "", text_3);
         }
      }
      ...
      public override void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         bool[] _attrPresenceFlags = new bool[9];
   ...
   public class NC1_TechReqInfo_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:service:reqinfo","NC1_TechReqInfo")
      };
      static NC1_TechReqInfo_CC() {
         XBUtil.license =  _NC1_TechReqInfo.license;
      }
      ...
      //content fields
      protected  NC1_TechReqInfo_ELEM nC1_TechReqInfo;

      //content methods

      public  NC1_TechReqInfo_ELEM NC1_TechReqInfo
      {
         get
         {
            if (this.nC1_TechReqInfo == null)
                throw new XBException("field nC1_TechReqInfo not set");

            return this.nC1_TechReqInfo;
         }
         set
         {
            this.nC1_TechReqInfo = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_TechReqInfo.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            {
               this.nC1_TechReqInfo = new  NC1_TechReqInfo_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_TechReqInfo.decode(reader, xbContext, false, false);
            ...
            else throw new XBOccurrencesException(0, "nC1_TechReqInfo");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_TechReqInfo",  _NC1_TechReqInfo.NS_URI,  _NC1_TechReqInfo.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_TechReqInfo.encode(encoder, xbContext, null, false);
   ...
   public class _NC1_TechReqInfo {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:service:reqinfo";
      public static readonly String NS_PREFIX = "nc1techreqinfo";
 ...
 */
      ...
      public _NC1_TechReqInfo() {
      }
      static _NC1_TechReqInfo() {
         XBUtil.license = _NC1_TechReqInfo.license;
      }
   }
}
