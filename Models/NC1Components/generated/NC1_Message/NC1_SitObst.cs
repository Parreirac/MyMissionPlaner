...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_SitObst_ELEM_2_obstaclesAndWorks : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:sitobst",
          "NC1_SitObst_ELEM_2_obstaclesAndWorks");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","bypassRoute"),
         new XBQualifiedName("","facility"),
         new XBQualifiedName("","groundEntity")
      };
      static NC1_SitObst_ELEM_2_obstaclesAndWorks() {
         XBUtil.license =  _NC1_SitObst.license;
      }
      ...
      protected System.Collections.Generic.IList< RouteType> bypassRoute;
      ...
      public System.Collections.Generic.IList< RouteType> BypassRoute
      {
         get
         {
            if (this.bypassRoute == null) {
               this.bypassRoute = new List< RouteType>();
            }
            return this.bypassRoute;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                   RouteType _tmp_bypassRoute;
                  _tmp_bypassRoute = new  RouteType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_bypassRoute.decode(reader, xbContext, false, false);
                  this.bypassRoute.Add(_tmp_bypassRoute);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // bypassRoute
         if ( this.bypassRoute != null ){
            foreach ( RouteType _tmp_bypassRoute in this.bypassRoute){
               encoder.encodeStartElement("bypassRoute", "", "");
               _tmp_bypassRoute.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
   ...
   public class NC1_SitObst_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:sitobst",
          "NC1_SitObst_ELEM");
      ...
      //content fields
      protected  NC1_SitObst_ELEM_2_obstaclesAndWorks obstaclesAndWorks;
      ...
      public  NC1_SitObst_ELEM_2_obstaclesAndWorks ObstaclesAndWorks
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.obstaclesAndWorks = new  NC1_SitObst_ELEM_2_obstaclesAndWorks();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_SitObst_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:sitobst","NC1_SitObst")
      };
      static NC1_SitObst_CC() {
         XBUtil.license =  _NC1_SitObst.license;
      }
      ...
      //content fields
      protected  NC1_SitObst_ELEM nC1_SitObst;

      //content methods

      public  NC1_SitObst_ELEM NC1_SitObst
      {
         get
         {
            if (this.nC1_SitObst == null)
                throw new XBException("field nC1_SitObst not set");

            return this.nC1_SitObst;
         }
         set
         {
            this.nC1_SitObst = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_SitObst.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_SitObst = new  NC1_SitObst_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_SitObst.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_SitObst");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_SitObst",  _NC1_SitObst.NS_URI,  _NC1_SitObst.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_SitObst.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_SitObst {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:sitobst";
      public static readonly String NS_PREFIX = "nc1sitobst";
