...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence_friendlyUnit
       : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:ownsitrep",
          "NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence_friendlyUnit");
      ...
      static NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence_friendlyUnit() 
      {
         XBUtil.license =  _NC1_OWNSITREP.license;
      }
      ...
      protected System.Collections.Generic.IList< UnitType> enemyUnit;
      ...
      public System.Collections.Generic.IList< UnitType> EnemyUnit
      {
         get
         {
            if (this.enemyUnit == null) {
               this.enemyUnit = new List< UnitType>();
            }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                   UnitType _tmp_enemyUnit;
                  _tmp_enemyUnit = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // enemyUnit
         if ( this.enemyUnit != null ){
            foreach ( UnitType _tmp_enemyUnit in this.enemyUnit){
   ...
   public class NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:ownsitrep",
          "NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","friendlyUnit"),
         new XBQualifiedName("","mission"),
         new XBQualifiedName("","description"),
         new XBQualifiedName("","track"),
         new XBQualifiedName("","participant")
      };
      static NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence() {
         XBUtil.license =  _NC1_OWNSITREP.license;
      }
      ...
      //content fields
      protected System.Collections.Generic.IList< NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence_friendlyUnit> friendlyUnit;
      ...
      protected System.Collections.Generic.IList< ParticipantType> participant;
      ...
      public System.Collections.Generic.IList< NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence_friendlyUnit> FriendlyUnit
      {
         get
         {
            if (this.friendlyUnit == null) {
               this.friendlyUnit = 
                  new List< NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence_friendlyUnit>()
                  ;
            }
      ...
      public System.Collections.Generic.IList< ParticipantType> Participant
      {
         get
         {
            if (this.participant == null) {
               this.participant = new List< ParticipantType>();
            }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                   NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence_friendlyUnit _tmp_friendlyUnit;
                  _tmp_friendlyUnit = new  NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence_friendlyUnit();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_friendlyUnit.decode(reader, xbContext, false, false);
                  this.friendlyUnit.Add(_tmp_friendlyUnit);
               ...
               {
                   ParticipantType _tmp_participant;
                  _tmp_participant =  ParticipantType.createObject(
                     XMLStreamHelper.readXsiType(reader) );
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_participant.decode(reader, xbContext, false, false);
                  this.participant.Add(_tmp_participant);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // friendlyUnit
         if ( this.friendlyUnit != null ){
            foreach ( NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence_friendlyUnit _tmp_friendlyUnit in this.friendlyUnit)
            {
               encoder.encodeStartElement("friendlyUnit", "", "");
               _tmp_friendlyUnit.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
         ...
         // participant
         if ( this.participant != null ){
            foreach ( ParticipantType _tmp_participant in this.participant)
            {
               encoder.encodeStartElement("participant", "", "");
               _tmp_participant.encode(encoder, xbContext, 
   ...
   public class NC1_OWNSITREP_ELEM_2_controlAndCoordinationMeans : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:ownsitrep",
          "NC1_OWNSITREP_ELEM_2_controlAndCoordinationMeans");
      ...
      static NC1_OWNSITREP_ELEM_2_controlAndCoordinationMeans() {
         XBUtil.license =  _NC1_OWNSITREP.license;
      }
   ...
   public class NC1_OWNSITREP_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:ownsitrep",
          "NC1_OWNSITREP_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","ownForcesTaskOrganizationAndPresence"),
         new XBQualifiedName("","ownForcesAssessment"),
         new XBQualifiedName("","controlAndCoordinationMeans"),
         new XBQualifiedName("","controlAndCoordinationLinesAssessment"),
         new XBQualifiedName("","comment")
      };
      static NC1_OWNSITREP_ELEM() {
         XBUtil.license =  _NC1_OWNSITREP.license;
      }
      ...
      //content fields
      protected  NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence ownForcesTaskOrganizationAndPresence;
         
      protected string ownForcesAssessment;
      protected bool _set_ownForcesAssessment = false;
      protected  NC1_OWNSITREP_ELEM_2_controlAndCoordinationMeans controlAndCoordinationMeans;
         
      protected string controlAndCoordinationLinesAssessment;
      protected bool _set_controlAndCoordinationLinesAssessment = false;
      ...
      public  NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence OwnForcesTaskOrganizationAndPresence
      {
         get
         {
            if (this.ownForcesTaskOrganizationAndPresence == null)
                throw new XBException("field ownForcesTaskOrganizationAndPresence not set");

            return this.ownForcesTaskOrganizationAndPresence;
         }
         set
         {
            this.ownForcesTaskOrganizationAndPresence = value;
         }
      }

      public string OwnForcesAssessment
      {
         get
         {
            if (!_set_ownForcesAssessment)
         ...
         set
         {
            ...
            _set_ownForcesAssessment = true;
         }
      }

      public  NC1_OWNSITREP_ELEM_2_controlAndCoordinationMeans ControlAndCoordinationMeans
      {
         get
         {
      ...
      public string ControlAndCoordinationLinesAssessment
      {
         get
         {
            if (!_set_controlAndCoordinationLinesAssessment)
                throw new XBException("field controlAndCoordinationLinesAssessment not set");

            return this.controlAndCoordinationLinesAssessment;
         }
         set
         {
            this.controlAndCoordinationLinesAssessment = value;
            _set_controlAndCoordinationLinesAssessment = true;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.ownForcesTaskOrganizationAndPresence = new  NC1_OWNSITREP_ELEM_2_ownForcesTaskOrganizationAndPresence();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.ownForcesTaskOrganizationAndPresence.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "ownForcesTaskOrganizationAndPresence");
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.ownForcesAssessment =  WideTextType.decode(text, xbContext);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.controlAndCoordinationMeans = new  NC1_OWNSITREP_ELEM_2_controlAndCoordinationMeans();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               // controlAndCoordinationLinesAssessment
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.controlAndCoordinationLinesAssessment =  WideTextType.decode(text, xbContext);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("ownForcesTaskOrganizationAndPresence", "", "");
         this.ownForcesTaskOrganizationAndPresence.encode(encoder, xbContext, 
            null, false);
         encoder.encodeEndElement();
         ...
         if (_set_ownForcesAssessment)  {
            ...
            String text_4;
            text_4 =  WideTextType.encode(this.ownForcesAssessment, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // controlAndCoordinationLinesAssessment
         if (_set_controlAndCoordinationLinesAssessment)  {
            encoder.encodeStartElement("controlAndCoordinationLinesAssessment", "", "");
            String text_4;
            text_4 =  WideTextType.encode(this.controlAndCoordinationLinesAssessment, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_comment)  {
            ...
            String text_4;
            text_4 =  WideTextType.encode(this.comment, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OWNSITREP_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:ownsitrep","NC1_OWNSITREP")
      };
      static NC1_OWNSITREP_CC() {
         XBUtil.license =  _NC1_OWNSITREP.license;
      }
      ...
      //content fields
      protected  NC1_OWNSITREP_ELEM nC1_OWNSITREP;

      //content methods

      public  NC1_OWNSITREP_ELEM NC1_OWNSITREP
      {
         get
         {
            if (this.nC1_OWNSITREP == null)
                throw new XBException("field nC1_OWNSITREP not set");

            return this.nC1_OWNSITREP;
         }
         set
         {
            this.nC1_OWNSITREP = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_OWNSITREP.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_OWNSITREP = new  NC1_OWNSITREP_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_OWNSITREP.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_OWNSITREP");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_OWNSITREP",  _NC1_OWNSITREP.NS_URI,  _NC1_OWNSITREP.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_OWNSITREP.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_OWNSITREP {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:ownsitrep";
      public static readonly String NS_PREFIX = "nc1ownsitrep";
 ...
 */
      ...
      public _NC1_OWNSITREP() {
      }
      static _NC1_OWNSITREP() {
         XBUtil.license = _NC1_OWNSITREP.license;
      }
   }
}
