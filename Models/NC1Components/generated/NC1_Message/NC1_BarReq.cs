...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_BarReq_ELEM_2_friendlyObstacles : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:barreq",
          "NC1_BarReq_ELEM_2_friendlyObstacles");
      ...
      static NC1_BarReq_ELEM_2_friendlyObstacles() {
         XBUtil.license =  _NC1_BarReq.license;
      }
   ...
   public class NC1_BarReq_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:barreq",
          "NC1_BarReq_ELEM");
      ...
      //content fields
      protected  NC1_BarReq_ELEM_2_friendlyObstacles friendlyObstacles;
      ...
      public  NC1_BarReq_ELEM_2_friendlyObstacles FriendlyObstacles
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.friendlyObstacles = new  NC1_BarReq_ELEM_2_friendlyObstacles();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_BarReq_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:barreq","NC1_BarReq")
      };
      static NC1_BarReq_CC() {
         XBUtil.license =  _NC1_BarReq.license;
      }
      ...
      //content fields
      protected  NC1_BarReq_ELEM nC1_BarReq;

      //content methods

      public  NC1_BarReq_ELEM NC1_BarReq
      {
         get
         {
            if (this.nC1_BarReq == null)
                throw new XBException("field nC1_BarReq not set");

            return this.nC1_BarReq;
         }
         set
         {
            this.nC1_BarReq = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_BarReq.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_BarReq = new  NC1_BarReq_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_BarReq.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_BarReq");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_BarReq",  _NC1_BarReq.NS_URI,  _NC1_BarReq.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_BarReq.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_BarReq {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:barreq";
      public static readonly String NS_PREFIX = "nc1barreq";
