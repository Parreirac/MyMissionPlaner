...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_ENGRECCEORD_ELEM_2_recceCharacteristics_rectimes : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:engrecceord",
          "NC1_ENGRECCEORD_ELEM_2_recceCharacteristics_rectimes");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","beginDatetime"),
         new XBQualifiedName("","endDatetime"),
         new XBQualifiedName("","reportDatetime")
      };
      static NC1_ENGRECCEORD_ELEM_2_recceCharacteristics_rectimes() {
         XBUtil.license =  _NC1_ENGRECCEORD.license;
      }
      ...
      protected bool _set_beginDatetime = false;
      ...
      public string BeginDatetime
      {
         get
         {
            if (!_set_beginDatetime)
                throw new XBException("field beginDatetime not set");
      ...
      {
         get { return this.reportDatetime; }
         set { this.reportDatetime = value; }
      }
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // beginDatetime
         if (_set_beginDatetime)  {
            encoder.encodeStartElement("beginDatetime", "", "");
            String text_4;
            text_4 = this.beginDatetime;
         ...
         // reportDatetime
         encoder.encodeStartElement("reportDatetime", "", "");
         String text_3;
         text_3 = this.reportDatetime;
   ...
   public class NC1_ENGRECCEORD_ELEM_2_recceCharacteristics : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:engrecceord",
          "NC1_ENGRECCEORD_ELEM_2_recceCharacteristics");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","rectimes"),
         new XBQualifiedName("","aim"),
         new XBQualifiedName("","mission")
      };
      static NC1_ENGRECCEORD_ELEM_2_recceCharacteristics() {
         XBUtil.license =  _NC1_ENGRECCEORD.license;
      }
      ...
      //content fields
      protected  NC1_ENGRECCEORD_ELEM_2_recceCharacteristics_rectimes rectimes;
      ...
      public  NC1_ENGRECCEORD_ELEM_2_recceCharacteristics_rectimes Rectimes
      {
         get
         {
            if (this.rectimes == null)
                throw new XBException("field rectimes not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.rectimes = new  NC1_ENGRECCEORD_ELEM_2_recceCharacteristics_rectimes();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.rectimes.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "rectimes");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("rectimes", "", "");
         this.rectimes.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class EngineerMissionTypeCode
   {
      static EngineerMissionTypeCode() {
         XBUtil.license =  _NC1_ENGRECCEORD.license;
      }

      //constructor
      private EngineerMissionTypeCode() {} 
   ...
   public class NC1_ENGRECCEORD_ELEM_2_recceOrder : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:engrecceord",
          "NC1_ENGRECCEORD_ELEM_2_recceOrder");
      ...
      static NC1_ENGRECCEORD_ELEM_2_recceOrder() {
         XBUtil.license =  _NC1_ENGRECCEORD.license;
      }
   ...
   public class NC1_ENGRECCEORD_ELEM_2_engineerMeans : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:engrecceord",
          "NC1_ENGRECCEORD_ELEM_2_engineerMeans");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","personnelMeans"),
         new XBQualifiedName("","equipmentMeans"),
         new XBQualifiedName("","materialMeans")
      };
      static NC1_ENGRECCEORD_ELEM_2_engineerMeans() {
         XBUtil.license =  _NC1_ENGRECCEORD.license;
      }
      ...
      //content fields
      protected string personnelMeans;
      protected bool _set_personnelMeans = false;
      protected string equipmentMeans;
      protected bool _set_equipmentMeans = false;
      protected string materialMeans;
      protected bool _set_materialMeans = false;

      //attribute methods

      //content methods

      public string PersonnelMeans
      {
         get
         {
            if (!_set_personnelMeans)
                throw new XBException("field personnelMeans not set");

            return this.personnelMeans;
         }
         set
         {
            this.personnelMeans = value;
            _set_personnelMeans = true;
         }
      }

      public string EquipmentMeans
      {
         get
         {
            if (!_set_equipmentMeans)
                throw new XBException("field equipmentMeans not set");

            return this.equipmentMeans;
         }
         set
         {
            this.equipmentMeans = value;
            _set_equipmentMeans = true;
         }
      }

      public string MaterialMeans
      {
         get
         {
            if (!_set_materialMeans)
                throw new XBException("field materialMeans not set");

            return this.materialMeans;
         }
         set
         {
            this.materialMeans = value;
            _set_materialMeans = true;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.personnelMeans =  MediumTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.equipmentMeans =  MediumTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.materialMeans =  MediumTextType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // personnelMeans
         if (_set_personnelMeans)  {
            encoder.encodeStartElement("personnelMeans", "", "");
            String text_4;
            text_4 =  MediumTextType.encode(this.personnelMeans, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // equipmentMeans
         if (_set_equipmentMeans)  {
            encoder.encodeStartElement("equipmentMeans", "", "");
            String text_4;
            text_4 =  MediumTextType.encode(this.equipmentMeans, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // materialMeans
         if (_set_materialMeans)  {
            encoder.encodeStartElement("materialMeans", "", "");
            String text_4;
            text_4 =  MediumTextType.encode(this.materialMeans, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_ENGRECCEORD_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:engrecceord",
          "NC1_ENGRECCEORD_ELEM");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","recceOrder"),
         new XBQualifiedName("","engineerMeans"),
         new XBQualifiedName("","acknowledgement"),
         new XBQualifiedName("","comment")
      };
      static NC1_ENGRECCEORD_ELEM() {
         XBUtil.license =  _NC1_ENGRECCEORD.license;
      }
      ...
      //content fields
      protected  NC1_ENGRECCEORD_ELEM_2_recceCharacteristics recceCharacteristics;
            //optional
      protected System.Collections.Generic.IList< NC1_ENGRECCEORD_ELEM_2_recceOrder> recceOrder;
         
      protected  NC1_ENGRECCEORD_ELEM_2_engineerMeans engineerMeans;
            //optional
      ...
      public  NC1_ENGRECCEORD_ELEM_2_recceCharacteristics RecceCharacteristics
      {
         get
         {
      ...
      public System.Collections.Generic.IList< NC1_ENGRECCEORD_ELEM_2_recceOrder> RecceOrder
      {
         get
         {
            if (this.recceOrder == null) {
               this.recceOrder = 
                  new List< NC1_ENGRECCEORD_ELEM_2_recceOrder>();
            }
            return this.recceOrder;
         }
      }

      public  NC1_ENGRECCEORD_ELEM_2_engineerMeans EngineerMeans
      {
         get
         {
            if (this.engineerMeans == null)
                throw new XBException("field engineerMeans not set");

            return this.engineerMeans;
         }
         set
         {
            this.engineerMeans = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.recceCharacteristics = new  NC1_ENGRECCEORD_ELEM_2_recceCharacteristics();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                   NC1_ENGRECCEORD_ELEM_2_recceOrder _tmp_recceOrder;
                  _tmp_recceOrder = new  NC1_ENGRECCEORD_ELEM_2_recceOrder();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_recceOrder.decode(reader, xbContext, false, false);
                  this.recceOrder.Add(_tmp_recceOrder);
               ...
               if ( this.recceOrder.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.recceOrder.Count, "recceOrder");
               else if (this.recceOrder.Count == 0 && moreContent_4) 
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.engineerMeans = new  NC1_ENGRECCEORD_ELEM_2_engineerMeans();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.engineerMeans.decode(reader, xbContext, false, false);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // recceOrder
         if (this.recceOrder == null || this.recceOrder.Count < 1) 
            throw new XBOccurrencesException( (this.recceOrder == null ? 0 : this.recceOrder.Count ) );

         foreach ( NC1_ENGRECCEORD_ELEM_2_recceOrder _tmp_recceOrder in this.recceOrder)
         {
            encoder.encodeStartElement("recceOrder", "", "");
            _tmp_recceOrder.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // engineerMeans
         if (this.engineerMeans != null)  {
            encoder.encodeStartElement("engineerMeans", "", "");
            this.engineerMeans.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_ENGRECCEORD_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:engrecceord","NC1_ENGRECCEORD")
      };
      static NC1_ENGRECCEORD_CC() {
         XBUtil.license =  _NC1_ENGRECCEORD.license;
      }
      ...
      //content fields
      protected  NC1_ENGRECCEORD_ELEM nC1_ENGRECCEORD;

      //content methods

      public  NC1_ENGRECCEORD_ELEM NC1_ENGRECCEORD
      {
         get
         {
            if (this.nC1_ENGRECCEORD == null)
                throw new XBException("field nC1_ENGRECCEORD not set");

            return this.nC1_ENGRECCEORD;
         }
         set
         {
            this.nC1_ENGRECCEORD = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_ENGRECCEORD.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_ENGRECCEORD = new  NC1_ENGRECCEORD_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_ENGRECCEORD.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_ENGRECCEORD");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_ENGRECCEORD",  _NC1_ENGRECCEORD.NS_URI,  _NC1_ENGRECCEORD.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_ENGRECCEORD.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_ENGRECCEORD {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:engrecceord";
      public static readonly String NS_PREFIX = "nc1engrecceord";
 ...
 */
      ...
      public _NC1_ENGRECCEORD() {
      }
      static _NC1_ENGRECCEORD() {
         XBUtil.license = _NC1_ENGRECCEORD.license;
      }
   }
}
