...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_IGen_ELEM_2_generalOrder_acmWezId : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:igen",
          "NC1_IGen_ELEM_2_generalOrder_acmWezId");
      ...
      static NC1_IGen_ELEM_2_generalOrder_acmWezId() {
         XBUtil.license =  _NC1_IGen.license;
      }
   ...
   public class NC1_IGen_ELEM_2_generalOrder : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:igen",
          "NC1_IGen_ELEM_2_generalOrder");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","acmWezId"),
         new XBQualifiedName("","requestingUnitLocation")
      };

      public enum Choice  {
         None, fireObjectiveId, tacAreaId, acmWezId, requestingUnitLocation}
      protected Choice _whichField;
      static NC1_IGen_ELEM_2_generalOrder() {
         XBUtil.license =  _NC1_IGen.license;
      }
      ...
      //content fields
      protected System.Collections.Generic.IList< Nc1ObjectRefType> fireObjectiveId;
         
      protected System.Collections.Generic.IList< Nc1ObjectRefType> tacAreaId;
         
      protected  NC1_IGen_ELEM_2_generalOrder_acmWezId acmWezId;
      protected  PointType requestingUnitLocation;

      //attribute methods

      //content methods

      public System.Collections.Generic.IList< Nc1ObjectRefType> FireObjectiveId
      {
         get
         {
            ...
            if (_whichField  != Choice.fireObjectiveId) {
               this.fireObjectiveId = new List< Nc1ObjectRefType>();
      ...
      public System.Collections.Generic.IList< Nc1ObjectRefType> TacAreaId
      {
         get
         {
            ...
            if (_whichField  != Choice.tacAreaId) {
               this.tacAreaId = new List< Nc1ObjectRefType>();
      ...
      public  NC1_IGen_ELEM_2_generalOrder_acmWezId AcmWezId
      {
         get
         {
            if (_whichField != Choice.acmWezId ) 
               throw new XBException("field acmWezId not set");
            return this.acmWezId;
         }
         set
         {
            this.acmWezId = value;
            _whichField = Choice.acmWezId;
         }
      }

      public  PointType RequestingUnitLocation
      {
         get
         {
            if (_whichField != Choice.requestingUnitLocation ) 
               throw new XBException("field requestingUnitLocation not set");
            return this.requestingUnitLocation;
         }
         set
         {
            this.requestingUnitLocation = value;
            _whichField = Choice.requestingUnitLocation;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.fireObjectiveId = new List< Nc1ObjectRefType>();
                  do  {
                      Nc1ObjectRefType _tmp_fireObjectiveId;
                     _tmp_fireObjectiveId = new  Nc1ObjectRefType();
                     xbContext.decodeSchemaLocationAttrs(reader);
                     _tmp_fireObjectiveId.decode(reader, xbContext, false, false);
                     this.fireObjectiveId.Add(_tmp_fireObjectiveId);
                     _whichField = Choice.fireObjectiveId;
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.tacAreaId = new List< Nc1ObjectRefType>();
                  do  {
                      Nc1ObjectRefType _tmp_tacAreaId;
                     _tmp_tacAreaId = new  Nc1ObjectRefType();
                     xbContext.decodeSchemaLocationAttrs(reader);
                     _tmp_tacAreaId.decode(reader, xbContext, false, false);
                     this.tacAreaId.Add(_tmp_tacAreaId);
                     _whichField = Choice.tacAreaId;
               ...
               {
                  this.acmWezId = new  NC1_IGen_ELEM_2_generalOrder_acmWezId();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.acmWezId.decode(reader, xbContext, false, false);
                  _whichField = Choice.acmWezId;
               ...
               {
                  this.requestingUnitLocation = new  PointType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.requestingUnitLocation.decode(reader, xbContext, false, false);
                  _whichField = Choice.requestingUnitLocation;
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            case Choice.fireObjectiveId: {
               if (this.fireObjectiveId == null || 
                  this.fireObjectiveId.Count < 1) 
                  throw new XBOccurrencesException( (this.fireObjectiveId == null ? 0 : this.fireObjectiveId.Count ) );

               foreach ( Nc1ObjectRefType _tmp_fireObjectiveId in this.fireObjectiveId)
               {
                  encoder.encodeStartElement("fireObjectiveId", "", "");
                  _tmp_fireObjectiveId.encode(encoder, xbContext, null, 
                     false);
                  encoder.encodeEndElement();
               }
               break;
            ...
            case Choice.tacAreaId: {
               if (this.tacAreaId == null || this.tacAreaId.Count < 1) 
                  throw new XBOccurrencesException( (this.tacAreaId == null ? 0 : this.tacAreaId.Count ) );

               foreach ( Nc1ObjectRefType _tmp_tacAreaId in this.tacAreaId)
               {
                  encoder.encodeStartElement("tacAreaId", "", "");
                  _tmp_tacAreaId.encode(encoder, xbContext, null, false);
                  encoder.encodeEndElement();
               }
               break;
            }
            ...
            // acmWezId
            case Choice.acmWezId: {
               if (_whichField != Choice.acmWezId ) 
                  throw new XBException("field acmWezId not set");
               encoder.encodeStartElement("acmWezId", "", "");
               this.acmWezId.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
               break;
            }

            // requestingUnitLocation
            case Choice.requestingUnitLocation: {
               if (_whichField != Choice.requestingUnitLocation ) 
                  throw new XBException("field requestingUnitLocation not set");
               encoder.encodeStartElement("requestingUnitLocation", "", "");
               this.requestingUnitLocation.encode(encoder, xbContext, null, 
                  false);
               encoder.encodeEndElement();
               break;
            }
   ...
   public class GeneralOrderStatusCode
   {
      static GeneralOrderStatusCode() {
         XBUtil.license =  _NC1_IGen.license;
      }

      //constructor
      private GeneralOrderStatusCode() {} 
   ...
   public class NC1_IGen_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:igen",
          "NC1_IGen_ELEM");
      ...
      //content fields
      protected  NC1_IGen_ELEM_2_generalOrder generalOrder;
      ...
      public  NC1_IGen_ELEM_2_generalOrder GeneralOrder
      {
         get
         {
            if (this.generalOrder == null)
                throw new XBException("field generalOrder not set");

            return this.generalOrder;
         }
         set
         {
            this.generalOrder = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.generalOrder = new  NC1_IGen_ELEM_2_generalOrder();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.generalOrder.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "generalOrder");
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  this.status =  GeneralOrderStatusCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "status");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("generalOrder", "", "");
         this.generalOrder.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // status
         encoder.encodeStartElement("status", "", "");
         String text_3;
         text_3 =  GeneralOrderStatusCode.encode(this.status, xbContext);
   ...
   public class NC1_IGen_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:igen","NC1_IGen")
      };
      static NC1_IGen_CC() {
         XBUtil.license =  _NC1_IGen.license;
      }
      ...
      //content fields
      protected  NC1_IGen_ELEM nC1_IGen;

      //content methods

      public  NC1_IGen_ELEM NC1_IGen
      {
         get
         {
            if (this.nC1_IGen == null)
                throw new XBException("field nC1_IGen not set");

            return this.nC1_IGen;
         }
         set
         {
            this.nC1_IGen = value;
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_IGen.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_IGen = new  NC1_IGen_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_IGen.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_IGen");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_IGen",  _NC1_IGen.NS_URI,  _NC1_IGen.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_IGen.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_IGen {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:igen";
      public static readonly String NS_PREFIX = "nc1igen";
