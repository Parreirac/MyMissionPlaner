...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    using NC1.Msg;
    using NC1.Obj.unit;
   using ModeOfTransportationCode = NC1.Obj.route.ModeOfTransportationCode;
    using TacPointType = NC1.Obj.tacpoint.TacPointType;


    public class NC1_DEPLOYREP_ELEM_2_deployment : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:deployrep",
          "NC1_DEPLOYREP_ELEM_2_deployment");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","localizedUnit"),
         new XBQualifiedName("","startPoint"),
         new XBQualifiedName("","startDatetime"),
         new XBQualifiedName("","startPocUnit"),
         new XBQualifiedName("","endPoint"),
         new XBQualifiedName("","endDatetime"),
         new XBQualifiedName("","endPocUnit"),
         new XBQualifiedName("","finalLocalizedUnit"),
         new XBQualifiedName("","modeOfTransportation"),
         new XBQualifiedName("","otherInformation")
      };
      static NC1_DEPLOYREP_ELEM_2_deployment() {
         XBUtil.license =  _NC1_DEPLOYREP.license;
      }
      ...
      //content fields
      protected System.Collections.Generic.IList< UnitType> localizedUnit;
         
      protected  TacPointType startPoint;
      protected string startDatetime;
      protected  UnitType startPocUnit;   //optional
      protected  TacPointType endPoint;
      protected string endDatetime;
      protected  UnitType endPocUnit;   //optional
      protected System.Collections.Generic.IList< UnitType> finalLocalizedUnit;
         
      protected int modeOfTransportation;
      protected bool _set_modeOfTransportation = false;
      protected string otherInformation;
      protected bool _set_otherInformation = false;

      //attribute methods

      //content methods

      public System.Collections.Generic.IList< UnitType> LocalizedUnit
      {
         get
         {
            if (this.localizedUnit == null) {
               this.localizedUnit = new List< UnitType>();
            }
            return this.localizedUnit;
         }
      }

      public  TacPointType StartPoint
      {
         get
         {
      ...
      public  UnitType StartPocUnit
      {
         get
         {
            if (this.startPocUnit == null)
                throw new XBException("field startPocUnit not set");

            return this.startPocUnit;
         }
         set
         {
            this.startPocUnit = value;
         }
      }

      public  TacPointType EndPoint
      {
         get
         {
      ...
      public  UnitType EndPocUnit
      {
         get
         {
            if (this.endPocUnit == null)
                throw new XBException("field endPocUnit not set");

            return this.endPocUnit;
         }
         set
         {
            this.endPocUnit = value;
         }
      }

      public System.Collections.Generic.IList< UnitType> FinalLocalizedUnit
      {
         get
         {
            if (this.finalLocalizedUnit == null) {
               this.finalLocalizedUnit = new List< UnitType>();
            }
            return this.finalLocalizedUnit;
         }
      }
      ...
      public string OtherInformation
      {
         get
         {
            if (!_set_otherInformation)
                throw new XBException("field otherInformation not set");
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                   UnitType _tmp_localizedUnit;
                  _tmp_localizedUnit = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_localizedUnit.decode(reader, xbContext, false, false);
                  this.localizedUnit.Add(_tmp_localizedUnit);
               ...
               if ( this.localizedUnit.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.localizedUnit.Count, "localizedUnit");
               else if (this.localizedUnit.Count == 0 && moreContent_4) 
               ...
               {
                  this.startPoint = new  TacPointType();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               {
                  this.startPocUnit = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.startPocUnit.decode(reader, xbContext, false, false);
               ...
               {
                  this.endPoint = new  TacPointType();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               {
                  this.endPocUnit = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.endPocUnit.decode(reader, xbContext, false, false);
               ...
               {
                   UnitType _tmp_finalLocalizedUnit;
                  _tmp_finalLocalizedUnit = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_finalLocalizedUnit.decode(reader, xbContext, false, false);
                  this.finalLocalizedUnit.Add(_tmp_finalLocalizedUnit);
               ...
               if ( this.finalLocalizedUnit.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.finalLocalizedUnit.Count, "finalLocalizedUnit");
               else if (this.finalLocalizedUnit.Count == 0 && moreContent_4) 
                  throw new XBUnexpectedElementException(elemNs, elemLocalName);
                  ...
                  (XBQualifiedName)particleInfo[9], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.otherInformation =  MediumTextType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // localizedUnit
         if (this.localizedUnit == null || this.localizedUnit.Count < 1) 
            throw new XBOccurrencesException( (this.localizedUnit == null ? 0 : this.localizedUnit.Count ) );

         foreach ( UnitType _tmp_localizedUnit in this.localizedUnit){
            encoder.encodeStartElement("localizedUnit", "", "");
            _tmp_localizedUnit.encode(encoder, xbContext, null, false);
         ...
         // startPocUnit
         if (this.startPocUnit != null)  {
            encoder.encodeStartElement("startPocUnit", "", "");
            this.startPocUnit.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
         ...
         // endPocUnit
         if (this.endPocUnit != null)  {
            encoder.encodeStartElement("endPocUnit", "", "");
            this.endPocUnit.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // finalLocalizedUnit
         if (this.finalLocalizedUnit == null || 
            this.finalLocalizedUnit.Count < 1) 
            throw new XBOccurrencesException( (this.finalLocalizedUnit == null ? 0 : this.finalLocalizedUnit.Count ) );

         foreach ( UnitType _tmp_finalLocalizedUnit in this.finalLocalizedUnit)
         {
            encoder.encodeStartElement("finalLocalizedUnit", "", "");
            _tmp_finalLocalizedUnit.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
         ...
         if (_set_modeOfTransportation)  {
            ...
            text_3 =  ModeOfTransportationCode.encode(this.modeOfTransportation, xbContext);
         ...
         // otherInformation
         if (_set_otherInformation)  {
            encoder.encodeStartElement("otherInformation", "", "");
            text_3 =  MediumTextType.encode(this.otherInformation, xbContext);
            encoder.encodeChars(text_3);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_DEPLOYREP_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:deployrep",
          "NC1_DEPLOYREP_ELEM");
      ...
      //content fields
      protected System.Collections.Generic.IList< NC1_DEPLOYREP_ELEM_2_deployment> deployment;
      ...
      public System.Collections.Generic.IList< NC1_DEPLOYREP_ELEM_2_deployment> Deployment
      {
         get
         {
            if (this.deployment == null) {
               this.deployment = 
                  new List< NC1_DEPLOYREP_ELEM_2_deployment>();
            }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                   NC1_DEPLOYREP_ELEM_2_deployment _tmp_deployment;
                  _tmp_deployment = new  NC1_DEPLOYREP_ELEM_2_deployment();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_deployment.decode(reader, xbContext, false, false);
                  this.deployment.Add(_tmp_deployment);
               ...
               if ( this.deployment.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.deployment.Count, "deployment");
               else if (this.deployment.Count == 0 && moreContent_4) 
                  throw new XBUnexpectedElementException(elemNs, elemLocalName);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // deployment
         if (this.deployment == null || this.deployment.Count < 1) 
            throw new XBOccurrencesException( (this.deployment == null ? 0 : this.deployment.Count ) );

         foreach ( NC1_DEPLOYREP_ELEM_2_deployment _tmp_deployment in this.deployment)
         {
            encoder.encodeStartElement("deployment", "", "");
            _tmp_deployment.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_DEPLOYREP_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:deployrep","NC1_DEPLOYREP")
      };
      static NC1_DEPLOYREP_CC() {
         XBUtil.license =  _NC1_DEPLOYREP.license;
      }
      ...
      //content fields
      protected  NC1_DEPLOYREP_ELEM nC1_DEPLOYREP;

      //content methods

      public  NC1_DEPLOYREP_ELEM NC1_DEPLOYREP
      {
         get
         {
            if (this.nC1_DEPLOYREP == null)
                throw new XBException("field nC1_DEPLOYREP not set");

            return this.nC1_DEPLOYREP;
         }
         set
         {
            this.nC1_DEPLOYREP = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_DEPLOYREP.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_DEPLOYREP = new  NC1_DEPLOYREP_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_DEPLOYREP.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_DEPLOYREP");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_DEPLOYREP",  _NC1_DEPLOYREP.NS_URI,  _NC1_DEPLOYREP.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_DEPLOYREP.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_DEPLOYREP {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:deployrep";
      public static readonly String NS_PREFIX = "nc1deployrep";
 ...
 */
      ...
      public _NC1_DEPLOYREP() {
      }
      static _NC1_DEPLOYREP() {
         XBUtil.license = _NC1_DEPLOYREP.license;
      }
   }
}
