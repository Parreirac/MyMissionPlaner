...
namespace NC1.Msg
{
   ...
   public class NC1_TechStcUpdate_ELEM_2_updatedObjects : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:service:stcupdate",
          "NC1_TechStcUpdate_ELEM_2_updatedObjects");
      ...
      static NC1_TechStcUpdate_ELEM_2_updatedObjects() {
         XBUtil.license =  _NC1_TechStcUpdate.license;
      }
   ...
   public class NC1_TechStcUpdate_ELEM_2_desactivatedObjects : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:service:stcupdate",
          "NC1_TechStcUpdate_ELEM_2_desactivatedObjects");
      ...
      static NC1_TechStcUpdate_ELEM_2_desactivatedObjects() {
         XBUtil.license =  _NC1_TechStcUpdate.license;
      }
   ...
   {
      static InformationTypeCode() {
         XBUtil.license =  _NC1_TechStcUpdate.license;
      }

      //constructor
      private InformationTypeCode() {} 
   ...
   public class NC1_TechStcUpdate_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:service:stcupdate",
          "NC1_TechStcUpdate_ELEM");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","isFull"),
         new XBQualifiedName("","updatedObjects"),
         new XBQualifiedName("","desactivatedObjects"),
         new XBQualifiedName("","type")
      };
      static NC1_TechStcUpdate_ELEM() {
         XBUtil.license =  _NC1_TechStcUpdate.license;
      }
      ...
      protected  NC1_TechStcUpdate_ELEM_2_updatedObjects updatedObjects;
            //optional
      protected  NC1_TechStcUpdate_ELEM_2_desactivatedObjects desactivatedObjects;
            //optional
      protected int type;
      ...
      public  NC1_TechStcUpdate_ELEM_2_updatedObjects UpdatedObjects
      {
         get
         {
            if (this.updatedObjects == null)
                throw new XBException("field updatedObjects not set");

            return this.updatedObjects;
         }
         set
         {
            this.updatedObjects = value;
         }
      }

      public  NC1_TechStcUpdate_ELEM_2_desactivatedObjects DesactivatedObjects
      {
         get
         {
            if (this.desactivatedObjects == null)
                throw new XBException("field desactivatedObjects not set");

            return this.desactivatedObjects;
         }
         set
         {
            this.desactivatedObjects = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.isFull = XBSimpleType.parseBoolean(text);
               ...
               else throw new XBOccurrencesException(0, "isFull");

               // updatedObjects
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.updatedObjects = new  NC1_TechStcUpdate_ELEM_2_updatedObjects();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.updatedObjects.decode(reader, xbContext, false, false);
               ...
               {
                  this.desactivatedObjects = new  NC1_TechStcUpdate_ELEM_2_desactivatedObjects();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.desactivatedObjects.decode(reader, xbContext, false, false);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.type =  InformationTypeCode.decode(text, xbContext);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // isFull
         encoder.encodeStartElement("isFull", "", "");
         String text_3;
         text_3 = this.isFull.ToString().ToLower();
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // updatedObjects
         if (this.updatedObjects != null)  {
            encoder.encodeStartElement("updatedObjects", "", "");
            this.updatedObjects.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // desactivatedObjects
         if (this.desactivatedObjects != null)  {
            encoder.encodeStartElement("desactivatedObjects", "", "");
            this.desactivatedObjects.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
         ...
         if (_set_type)  {
            ...
            text_3 =  InformationTypeCode.encode(this.type, xbContext);
            encoder.encodeCharsNoEscaping(text_3);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_TechStcUpdate_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:service:stcupdate","NC1_TechStcUpdate")
      };
      static NC1_TechStcUpdate_CC() {
         XBUtil.license =  _NC1_TechStcUpdate.license;
      }
      ...
      //content fields
      protected  NC1_TechStcUpdate_ELEM nC1_TechStcUpdate;

      //content methods

      public  NC1_TechStcUpdate_ELEM NC1_TechStcUpdate
      {
         get
         {
            if (this.nC1_TechStcUpdate == null)
                throw new XBException("field nC1_TechStcUpdate not set");

            return this.nC1_TechStcUpdate;
         }
         set
         {
            this.nC1_TechStcUpdate = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_TechStcUpdate.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_TechStcUpdate = new  NC1_TechStcUpdate_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_TechStcUpdate.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_TechStcUpdate");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_TechStcUpdate",  _NC1_TechStcUpdate.NS_URI,  _NC1_TechStcUpdate.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_TechStcUpdate.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_TechStcUpdate {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:service:stcupdate";
      public static readonly String NS_PREFIX = "nc1stcupdate";
 ...
 */
      ...
      public _NC1_TechStcUpdate() {
      }
      static _NC1_TechStcUpdate() {
         XBUtil.license = _NC1_TechStcUpdate.license;
      }
   }
}
