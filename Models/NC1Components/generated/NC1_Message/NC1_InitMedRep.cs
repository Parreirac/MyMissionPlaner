...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_InitMedRep_ELEM_2_medicalFacilityReport : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:initmedrep",
          "NC1_InitMedRep_ELEM_2_medicalFacilityReport");
      ...
      static NC1_InitMedRep_ELEM_2_medicalFacilityReport() {
         XBUtil.license =  _NC1_InitMedRep.license;
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if ( this.facility.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.facility.Count, "facility");
               else if (this.facility.Count == 0 && moreContent_4) 
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // facility
         if (this.facility == null || this.facility.Count < 1) 
            throw new XBOccurrencesException( (this.facility == null ? 0 : this.facility.Count ) );
   ...
   public class NC1_InitMedRep_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:initmedrep",
          "NC1_InitMedRep_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","medicalFacilityReport"),
         new XBQualifiedName("","comment")
      };
      static NC1_InitMedRep_ELEM() {
         XBUtil.license =  _NC1_InitMedRep.license;
      }
      ...
      //content fields
      protected  NC1_InitMedRep_ELEM_2_medicalFacilityReport medicalFacilityReport;
      ...
      public  NC1_InitMedRep_ELEM_2_medicalFacilityReport MedicalFacilityReport
      {
         get
         {
            if (this.medicalFacilityReport == null)
                throw new XBException("field medicalFacilityReport not set");

            return this.medicalFacilityReport;
         }
         set
         {
            this.medicalFacilityReport = value;
         }
      }
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // medicalFacilityReport
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.medicalFacilityReport = new  NC1_InitMedRep_ELEM_2_medicalFacilityReport();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.medicalFacilityReport.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "medicalFacilityReport");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("medicalFacilityReport", "", "");
         this.medicalFacilityReport.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_InitMedRep_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:initmedrep","NC1_InitMedRep")
      };
      static NC1_InitMedRep_CC() {
         XBUtil.license =  _NC1_InitMedRep.license;
      }
      ...
      //content fields
      protected  NC1_InitMedRep_ELEM nC1_InitMedRep;

      //content methods

      public  NC1_InitMedRep_ELEM NC1_InitMedRep
      {
         get
         {
            if (this.nC1_InitMedRep == null)
                throw new XBException("field nC1_InitMedRep not set");

            return this.nC1_InitMedRep;
         }
         set
         {
            this.nC1_InitMedRep = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_InitMedRep.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_InitMedRep = new  NC1_InitMedRep_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_InitMedRep.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_InitMedRep");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_InitMedRep",  _NC1_InitMedRep.NS_URI,  _NC1_InitMedRep.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_InitMedRep.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_InitMedRep {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:initmedrep";
      public static readonly String NS_PREFIX = "nc1initmedrep";
 ...
 */
      ...
      public _NC1_InitMedRep() {
      }
      static _NC1_InitMedRep() {
         XBUtil.license = _NC1_InitMedRep.license;
      }
   }
}
