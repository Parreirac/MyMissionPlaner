...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_OPORD_ALAT_ELEM_2_taskOrganisation : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordalat",
          "NC1_OPORD-ALAT_ELEM_2_taskOrganisation");
      ...
      static NC1_OPORD_ALAT_ELEM_2_taskOrganisation() {
         XBUtil.license =  _NC1_OPORD_ALAT.license;
      }
   ...
   public class NC1_OPORD_ALAT_ELEM_2__1_situation_C_reinforcements : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordalat",
          "NC1_OPORD-ALAT_ELEM_2__1_situation_C_reinforcements");
      ...
      static NC1_OPORD_ALAT_ELEM_2__1_situation_C_reinforcements() {
         XBUtil.license =  _NC1_OPORD_ALAT.license;
      }
      ...
      protected System.Collections.Generic.IList< UnitType> ownUnit;
      ...
      public System.Collections.Generic.IList< UnitType> OwnUnit
      {
         get
         {
            if (this.ownUnit == null) {
               this.ownUnit = new List< UnitType>();
            }
            return this.ownUnit;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                   UnitType _tmp_ownUnit;
                  _tmp_ownUnit = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_ownUnit.decode(reader, xbContext, false, false);
                  this.ownUnit.Add(_tmp_ownUnit);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // ownUnit
         if ( this.ownUnit != null ){
            foreach ( UnitType _tmp_ownUnit in this.ownUnit){
               encoder.encodeStartElement("ownUnit", "", "");
               _tmp_ownUnit.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
      }
   ...
   public class NC1_OPORD_ALAT_ELEM_2__1_situation : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordalat",
          "NC1_OPORD-ALAT_ELEM_2__1_situation");
      ...
      static NC1_OPORD_ALAT_ELEM_2__1_situation() {
         XBUtil.license =  _NC1_OPORD_ALAT.license;
      }
      ...
      protected  NC1_OPORD_ALAT_ELEM_2__1_situation_C_reinforcements c_reinforcements;
            //optional
      ...
      public  NC1_OPORD_ALAT_ELEM_2__1_situation_C_reinforcements C_reinforcements
      {
         get
         {
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.c_reinforcements = new  NC1_OPORD_ALAT_ELEM_2__1_situation_C_reinforcements();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_OPORD_ALAT_ELEM_2__3_execution_A_intention : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordalat",
          "NC1_OPORD-ALAT_ELEM_2__3_execution_A_intention");
      ...
      static NC1_OPORD_ALAT_ELEM_2__3_execution_A_intention() {
         XBUtil.license =  _NC1_OPORD_ALAT.license;
      }
   ...
   public class NC1_OPORD_ALAT_ELEM_2__3_execution : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordalat",
          "NC1_OPORD-ALAT_ELEM_2__3_execution");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","B_armyAviationMissions"),
         new XBQualifiedName("","C_coordinationMeans")
      };
      static NC1_OPORD_ALAT_ELEM_2__3_execution() {
         XBUtil.license =  _NC1_OPORD_ALAT.license;
      }
      ...
      //content fields
      protected  NC1_OPORD_ALAT_ELEM_2__3_execution_A_intention a_intention;
            //optional
      protected  MixedAnyType b_armyAviationMissions;   //optional
      ...
      public  NC1_OPORD_ALAT_ELEM_2__3_execution_A_intention A_intention
      {
         get
         {
      ...
      public  MixedAnyType B_armyAviationMissions
      {
         get
         {
            if (this.b_armyAviationMissions == null)
                throw new XBException("field b_armyAviationMissions not set");

            return this.b_armyAviationMissions;
         }
         set
         {
            this.b_armyAviationMissions = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.a_intention = new  NC1_OPORD_ALAT_ELEM_2__3_execution_A_intention();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               // b_armyAviationMissions
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.b_armyAviationMissions = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.b_armyAviationMissions.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // b_armyAviationMissions
         if (this.b_armyAviationMissions != null)  {
            encoder.encodeStartElement("B_armyAviationMissions", "", "");
            this.b_armyAviationMissions.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_OPORD_ALAT_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordalat",
          "NC1_OPORD-ALAT_ELEM");
      ...
      //content fields
      protected  NC1_OPORD_ALAT_ELEM_2_taskOrganisation taskOrganisation;
            //optional
      protected  NC1_OPORD_ALAT_ELEM_2__1_situation _1_situation;
            //optional
      protected  MixedAnyType _2_mission;   //optional
      protected  NC1_OPORD_ALAT_ELEM_2__3_execution _3_execution;
            //optional
      protected  MixedAnyType _4_administrativeAndLogisticsServices;
            //optional
      protected  MixedAnyType _5_commandAndTransmissions;   //optional
      ...
      public  NC1_OPORD_ALAT_ELEM_2_taskOrganisation TaskOrganisation
      {
         get
         {
      ...
      public  NC1_OPORD_ALAT_ELEM_2__1_situation _1_situationProperty
      {
         get
         {
      ...
      public  NC1_OPORD_ALAT_ELEM_2__3_execution _3_executionProperty
      {
         get
         {
      ...
      public  MixedAnyType _4_administrativeAndLogisticsServicesProperty
      {
         get
         {
      ...
      public  MixedAnyType _5_commandAndTransmissionsProperty
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.taskOrganisation = new  NC1_OPORD_ALAT_ELEM_2_taskOrganisation();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this._1_situation = new  NC1_OPORD_ALAT_ELEM_2__1_situation();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this._3_execution = new  NC1_OPORD_ALAT_ELEM_2__3_execution();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  this._4_administrativeAndLogisticsServices = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               {
                  this._5_commandAndTransmissions = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_OPORD_ALAT_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:opordalat","NC1_OPORD-ALAT")
      };
      static NC1_OPORD_ALAT_CC() {
         XBUtil.license =  _NC1_OPORD_ALAT.license;
      }
      ...
      //content fields
      protected  NC1_OPORD_ALAT_ELEM nC1_OPORD_ALAT;

      //content methods

      public  NC1_OPORD_ALAT_ELEM NC1_OPORD_ALAT
      {
         get
         {
            if (this.nC1_OPORD_ALAT == null)
                throw new XBException("field nC1_OPORD_ALAT not set");

            return this.nC1_OPORD_ALAT;
         }
         set
         {
            this.nC1_OPORD_ALAT = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_OPORD_ALAT.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_OPORD_ALAT = new  NC1_OPORD_ALAT_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_OPORD_ALAT.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_OPORD_ALAT");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_OPORD-ALAT",  _NC1_OPORD_ALAT.NS_URI,  _NC1_OPORD_ALAT.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_OPORD_ALAT.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_OPORD_ALAT {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:opordalat";
      public static readonly String NS_PREFIX = "nc1opordalat";
 ...
 */
      ...
      public _NC1_OPORD_ALAT() {
      }
      static _NC1_OPORD_ALAT() {
         XBUtil.license = _NC1_OPORD_ALAT.license;
      }
   }
}
