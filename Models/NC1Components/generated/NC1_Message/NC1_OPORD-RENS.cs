...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    using NC1.Msg;
    public class NC1_OPORD_RENS_ELEM_2__1_situation_A_enemySituation : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM_2__1_situation_A_enemySituation");
      ...
      static NC1_OPORD_RENS_ELEM_2__1_situation_A_enemySituation() {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
      ...
      //content fields
      protected  MixedAnyType enemyForces;   //optional
      ...
      public  MixedAnyType EnemyForces
      {
         get
         {
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.enemyForces = new  MixedAnyType();
   ...
   public class NC1_OPORD_RENS_ELEM_2__1_situation_B_intelAssessment : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM_2__1_situation_B_intelAssessment");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","enemyCourseOfAction")
      };
      static NC1_OPORD_RENS_ELEM_2__1_situation_B_intelAssessment() {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
      ...
      //content fields
      protected System.Collections.Generic.IList< MixedAnyType> enemyCourseOfAction;
      ...
      public System.Collections.Generic.IList< MixedAnyType> EnemyCourseOfAction
      {
         get
         {
            if (this.enemyCourseOfAction == null) {
               this.enemyCourseOfAction = new List< MixedAnyType>();
            }
            return this.enemyCourseOfAction;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if (moreContent_4) while( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                   MixedAnyType _tmp_enemyCourseOfAction;
                  _tmp_enemyCourseOfAction = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_enemyCourseOfAction.decode(reader, xbContext, false, false);
                  this.enemyCourseOfAction.Add(_tmp_enemyCourseOfAction);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // enemyCourseOfAction
         if ( this.enemyCourseOfAction != null ){
            foreach ( MixedAnyType _tmp_enemyCourseOfAction in this.enemyCourseOfAction)
            {
               encoder.encodeStartElement("enemyCourseOfAction", "", "");
               _tmp_enemyCourseOfAction.encode(encoder, xbContext, null, 
                  false);
               encoder.encodeEndElement();
            }
         }
   ...
   public class NC1_OPORD_RENS_ELEM_2__1_situation : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM_2__1_situation");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","B_intelAssessment")
      };
      static NC1_OPORD_RENS_ELEM_2__1_situation() {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
      ...
      //content fields
      protected  NC1_OPORD_RENS_ELEM_2__1_situation_A_enemySituation a_enemySituation;
            //optional
      protected  NC1_OPORD_RENS_ELEM_2__1_situation_B_intelAssessment b_intelAssessment;
            //optional
      ...
      public  NC1_OPORD_RENS_ELEM_2__1_situation_A_enemySituation A_enemySituation
      {
         get
         {
      ...
      public  NC1_OPORD_RENS_ELEM_2__1_situation_B_intelAssessment B_intelAssessment
      {
         get
         {
            if (this.b_intelAssessment == null)
                throw new XBException("field b_intelAssessment not set");

            return this.b_intelAssessment;
         }
         set
         {
            this.b_intelAssessment = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.a_enemySituation = new  NC1_OPORD_RENS_ELEM_2__1_situation_A_enemySituation();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.b_intelAssessment = new  NC1_OPORD_RENS_ELEM_2__1_situation_B_intelAssessment();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.b_intelAssessment.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // b_intelAssessment
         if (this.b_intelAssessment != null)  {
            encoder.encodeStartElement("B_intelAssessment", "", "");
            this.b_intelAssessment.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_RENS_ELEM_2__3_execution_B_intelMissions : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM_2__3_execution_B_intelMissions");
      ...
      static NC1_OPORD_RENS_ELEM_2__3_execution_B_intelMissions() {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
   ...
   public class NC1_OPORD_RENS_ELEM_2__3_execution_C_counterIntel : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM_2__3_execution_C_counterIntel");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","permanentInstructions"),
         new XBQualifiedName("","specialMeasures"),
         new XBQualifiedName("","commandChain")
      };
      static NC1_OPORD_RENS_ELEM_2__3_execution_C_counterIntel() {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
      ...
      //content fields
      protected string permanentInstructions;
      protected bool _set_permanentInstructions = false;
      protected string specialMeasures;
      protected bool _set_specialMeasures = false;
      protected string commandChain;
      protected bool _set_commandChain = false;

      //attribute methods

      //content methods

      public string PermanentInstructions
      {
         get
         {
            if (!_set_permanentInstructions)
                throw new XBException("field permanentInstructions not set");

            return this.permanentInstructions;
         }
         set
         {
            this.permanentInstructions = value;
            _set_permanentInstructions = true;
         }
      }

      public string SpecialMeasures
      {
         get
         {
            if (!_set_specialMeasures)
      ...
      public string CommandChain
      {
         get
         {
            if (!_set_commandChain)
                throw new XBException("field commandChain not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.permanentInstructions =  LongTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.specialMeasures =  LongTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.commandChain =  LongTextType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // permanentInstructions
         if (_set_permanentInstructions)  {
            encoder.encodeStartElement("permanentInstructions", "", "");
            String text_4;
            text_4 =  LongTextType.encode(this.permanentInstructions, xbContext);
         ...
         if (_set_specialMeasures)  {
            ...
            String text_4;
            text_4 =  LongTextType.encode(this.specialMeasures, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // commandChain
         if (_set_commandChain)  {
            encoder.encodeStartElement("commandChain", "", "");
            String text_4;
            text_4 =  LongTextType.encode(this.commandChain, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_assetsMeasures
       : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM_2__3_execution_D_coordinationInstructions_assetsMeasures");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","staff"),
         new XBQualifiedName("","documents"),
         new XBQualifiedName("","equipment")
      };
      static NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_assetsMeasures() 
      {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
      ...
      protected bool _set_staff = false;
      protected string documents;
      protected bool _set_documents = false;
      protected string equipment;
      protected bool _set_equipment = false;
      ...
      public string Staff
      {
         get
         {
            if (!_set_staff) throw new XBException("field staff not set");
      ...
      public string Documents
      {
         ...
         {
            if (!_set_documents)
                throw new XBException("field documents not set");
      ...
      public string Equipment
      {
         ...
         {
            if (!_set_equipment)
                throw new XBException("field equipment not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.staff =  LongTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.documents =  LongTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.equipment =  LongTextType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // staff
         if (_set_staff)  {
            encoder.encodeStartElement("staff", "", "");
            String text_4;
            text_4 =  LongTextType.encode(this.staff, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // documents
         if (_set_documents)  {
            encoder.encodeStartElement("documents", "", "");
            String text_4;
            text_4 =  LongTextType.encode(this.documents, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_equipment)  {
            ...
            String text_4;
            text_4 =  LongTextType.encode(this.equipment, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_reporting
       : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM_2__3_execution_D_coordinationInstructions_reporting");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","specialReporting"),
         new XBQualifiedName("","meetings"),
         new XBQualifiedName("","reviewsDisclosure")
      };
      static NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_reporting() 
      {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
      ...
      protected bool _set_frequency = false;
      protected string specialReporting;
      protected bool _set_specialReporting = false;
      protected string meetings;
      protected bool _set_meetings = false;
      protected string reviewsDisclosure;
      protected bool _set_reviewsDisclosure = false;
      ...
      public string SpecialReporting
      {
         get
         {
            if (!_set_specialReporting)
                throw new XBException("field specialReporting not set");

            return this.specialReporting;
         }
         set
         {
            this.specialReporting = value;
            _set_specialReporting = true;
         }
      }
      ...
      public string Meetings
      {
         ...
         {
            if (!_set_meetings)
                throw new XBException("field meetings not set");
      ...
      public string ReviewsDisclosure
      {
         get
         {
            if (!_set_reviewsDisclosure)
                throw new XBException("field reviewsDisclosure not set");

            return this.reviewsDisclosure;
         }
         set
         {
            this.reviewsDisclosure = value;
            _set_reviewsDisclosure = true;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.frequency =  LongTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.specialReporting =  LongTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.meetings =  LongTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.reviewsDisclosure =  LongTextType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_frequency)  {
            ...
            String text_4;
            text_4 =  LongTextType.encode(this.frequency, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // specialReporting
         if (_set_specialReporting)  {
            encoder.encodeStartElement("specialReporting", "", "");
            String text_4;
            text_4 =  LongTextType.encode(this.specialReporting, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // meetings
         if (_set_meetings)  {
            encoder.encodeStartElement("meetings", "", "");
            String text_4;
            text_4 =  LongTextType.encode(this.meetings, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // reviewsDisclosure
         if (_set_reviewsDisclosure)  {
            encoder.encodeStartElement("reviewsDisclosure", "", "");
            String text_4;
            text_4 =  LongTextType.encode(this.reviewsDisclosure, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions
       : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM_2__3_execution_D_coordinationInstructions");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","intelNeed"),
         new XBQualifiedName("","intelAcquisition"),
         new XBQualifiedName("","assetsMeasures"),
         new XBQualifiedName("","informationAndEquipmentNeed"),
         new XBQualifiedName("","reporting"),
         new XBQualifiedName("","link"),
         new XBQualifiedName("","miscellaneous")
      };
      static NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions() {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
      ...
      //content fields
      protected  MixedAnyType intelNeed;   //optional
      protected  MixedAnyType intelAcquisition;   //optional
      protected  NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_assetsMeasures assetsMeasures;
            //optional
      protected  MixedAnyType informationAndEquipmentNeed;   //optional
      protected  NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_reporting reporting;
            //optional
      ...
      public  MixedAnyType IntelNeed
      {
         get
         {
            if (this.intelNeed == null)
                throw new XBException("field intelNeed not set");

            return this.intelNeed;
         }
         set
         {
            this.intelNeed = value;
         }
      }

      public  MixedAnyType IntelAcquisition
      {
         get
         {
            if (this.intelAcquisition == null)
                throw new XBException("field intelAcquisition not set");

            return this.intelAcquisition;
         }
         set
         {
            this.intelAcquisition = value;
         }
      }

      public  NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_assetsMeasures AssetsMeasures
      {
         get
         {
            if (this.assetsMeasures == null)
                throw new XBException("field assetsMeasures not set");

            return this.assetsMeasures;
         }
         set
         {
            this.assetsMeasures = value;
         }
      }

      public  MixedAnyType InformationAndEquipmentNeed
      {
         get
         {
            if (this.informationAndEquipmentNeed == null)
                throw new XBException("field informationAndEquipmentNeed not set");

            return this.informationAndEquipmentNeed;
         }
         set
         {
            this.informationAndEquipmentNeed = value;
         }
      }

      public  NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_reporting Reporting
      {
         get
         {
            if (this.reporting == null)
                throw new XBException("field reporting not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.intelNeed = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.intelNeed.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.intelAcquisition = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.intelAcquisition.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.assetsMeasures = new  NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_assetsMeasures();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.assetsMeasures.decode(reader, xbContext, false, false);
               ...
               // informationAndEquipmentNeed
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.informationAndEquipmentNeed = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.informationAndEquipmentNeed.decode(reader, xbContext, false, false);
               ...
               {
                  this.reporting = new  NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions_reporting();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.reporting.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // intelNeed
         if (this.intelNeed != null)  {
            encoder.encodeStartElement("intelNeed", "", "");
            this.intelNeed.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // intelAcquisition
         if (this.intelAcquisition != null)  {
            encoder.encodeStartElement("intelAcquisition", "", "");
            this.intelAcquisition.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // assetsMeasures
         if (this.assetsMeasures != null)  {
            encoder.encodeStartElement("assetsMeasures", "", "");
            this.assetsMeasures.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // informationAndEquipmentNeed
         if (this.informationAndEquipmentNeed != null)  {
            encoder.encodeStartElement("informationAndEquipmentNeed", "", "");
            this.informationAndEquipmentNeed.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
         ...
         // reporting
         if (this.reporting != null)  {
            encoder.encodeStartElement("reporting", "", "");
            this.reporting.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_OPORD_RENS_ELEM_2__3_execution : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM_2__3_execution");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","A_supportPlan"),
         new XBQualifiedName("","B_intelMissions"),
         new XBQualifiedName("","C_counterIntel"),
         new XBQualifiedName("","D_coordinationInstructions")
      };
      static NC1_OPORD_RENS_ELEM_2__3_execution() {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
      ...
      //content fields
      protected  MixedAnyType a_supportPlan;   //optional
      protected  NC1_OPORD_RENS_ELEM_2__3_execution_B_intelMissions b_intelMissions;
            //optional
      protected  NC1_OPORD_RENS_ELEM_2__3_execution_C_counterIntel c_counterIntel;
            //optional
      protected  NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions d_coordinationInstructions;
            //optional
      ...
      public  MixedAnyType A_supportPlan
      {
         get
         {
            if (this.a_supportPlan == null)
                throw new XBException("field a_supportPlan not set");

            return this.a_supportPlan;
         }
         set
         {
            this.a_supportPlan = value;
         }
      }

      public  NC1_OPORD_RENS_ELEM_2__3_execution_B_intelMissions B_intelMissions
      {
         get
         {
            if (this.b_intelMissions == null)
                throw new XBException("field b_intelMissions not set");

            return this.b_intelMissions;
         }
         set
         {
            this.b_intelMissions = value;
         }
      }

      public  NC1_OPORD_RENS_ELEM_2__3_execution_C_counterIntel C_counterIntel
      {
         get
         {
            if (this.c_counterIntel == null)
                throw new XBException("field c_counterIntel not set");

            return this.c_counterIntel;
         }
         set
         {
            this.c_counterIntel = value;
         }
      }

      public  NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions D_coordinationInstructions
      {
         get
         {
            if (this.d_coordinationInstructions == null)
                throw new XBException("field d_coordinationInstructions not set");

            return this.d_coordinationInstructions;
         }
         set
         {
            this.d_coordinationInstructions = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.a_supportPlan = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.a_supportPlan.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.b_intelMissions = new  NC1_OPORD_RENS_ELEM_2__3_execution_B_intelMissions();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.b_intelMissions.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.c_counterIntel = new  NC1_OPORD_RENS_ELEM_2__3_execution_C_counterIntel();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.c_counterIntel.decode(reader, xbContext, false, false);
               ...
               // d_coordinationInstructions
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.d_coordinationInstructions = new  NC1_OPORD_RENS_ELEM_2__3_execution_D_coordinationInstructions();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.d_coordinationInstructions.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // a_supportPlan
         if (this.a_supportPlan != null)  {
            encoder.encodeStartElement("A_supportPlan", "", "");
            this.a_supportPlan.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // b_intelMissions
         if (this.b_intelMissions != null)  {
            encoder.encodeStartElement("B_intelMissions", "", "");
            this.b_intelMissions.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // c_counterIntel
         if (this.c_counterIntel != null)  {
            encoder.encodeStartElement("C_counterIntel", "", "");
            this.c_counterIntel.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // d_coordinationInstructions
         if (this.d_coordinationInstructions != null)  {
            encoder.encodeStartElement("D_coordinationInstructions", "", "");
            this.d_coordinationInstructions.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_OPORD_RENS_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:opordrens",
          "NC1_OPORD-RENS_ELEM");
      ...
      //content fields
      protected  NC1_OPORD_RENS_ELEM_2__1_situation _1_situation;
            //optional
      protected  MixedAnyType _2_mission;   //optional
      protected  NC1_OPORD_RENS_ELEM_2__3_execution _3_execution;
            //optional
      ...
      public  NC1_OPORD_RENS_ELEM_2__1_situation _1_situationProperty
      {
         get
         {
      ...
      public  NC1_OPORD_RENS_ELEM_2__3_execution _3_executionProperty
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this._1_situation = new  NC1_OPORD_RENS_ELEM_2__1_situation();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this._3_execution = new  NC1_OPORD_RENS_ELEM_2__3_execution();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_OPORD_RENS_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:opordrens","NC1_OPORD-RENS")
      };
      static NC1_OPORD_RENS_CC() {
         XBUtil.license =  _NC1_OPORD_RENS.license;
      }
      ...
      //content fields
      protected  NC1_OPORD_RENS_ELEM nC1_OPORD_RENS;

      //content methods

      public  NC1_OPORD_RENS_ELEM NC1_OPORD_RENS
      {
         get
         {
            if (this.nC1_OPORD_RENS == null)
                throw new XBException("field nC1_OPORD_RENS not set");

            return this.nC1_OPORD_RENS;
         }
         set
         {
            this.nC1_OPORD_RENS = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_OPORD_RENS.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_OPORD_RENS = new  NC1_OPORD_RENS_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_OPORD_RENS.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_OPORD_RENS");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_OPORD-RENS",  _NC1_OPORD_RENS.NS_URI,  _NC1_OPORD_RENS.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_OPORD_RENS.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_OPORD_RENS {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:opordrens";
      public static readonly String NS_PREFIX = "nc1opordrens";
 ...
 */
      ...
      public _NC1_OPORD_RENS() {
      }
      static _NC1_OPORD_RENS() {
         XBUtil.license = _NC1_OPORD_RENS.license;
      }
   }
}
