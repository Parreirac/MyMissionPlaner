...
namespace NC1.Msg
{
   ...
   public class NC1_PlanDeVol_ELEM_2_flightPlan : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:plandevol",
          "NC1_PlanDeVol_ELEM_2_flightPlan");
      static NC1_PlanDeVol_ELEM_2_flightPlan() {
         XBUtil.license =  _NC1_PlanDeVol.license;
      }
   ...
   public class NC1_PlanDeVol_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:plandevol",
          "NC1_PlanDeVol_ELEM");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","flightPlan"),
         new XBQualifiedName("","comment")
      };
      static NC1_PlanDeVol_ELEM() {
         XBUtil.license =  _NC1_PlanDeVol.license;
      }
      ...
      //content fields
      protected  NC1_PlanDeVol_ELEM_2_flightPlan flightPlan;
      ...
      public  NC1_PlanDeVol_ELEM_2_flightPlan FlightPlan
      {
         get
         {
            if (this.flightPlan == null)
                throw new XBException("field flightPlan not set");
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.flightPlan = new  NC1_PlanDeVol_ELEM_2_flightPlan();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.flightPlan.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "flightPlan");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("flightPlan", "", "");
         this.flightPlan.encode(encoder, xbContext, null, false);
   ...
   public class NC1_PlanDeVol_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:plandevol","NC1_PlanDeVol")
      };
      static NC1_PlanDeVol_CC() {
         XBUtil.license =  _NC1_PlanDeVol.license;
      }
      ...
      //content fields
      protected  NC1_PlanDeVol_ELEM nC1_PlanDeVol;

      //content methods

      public  NC1_PlanDeVol_ELEM NC1_PlanDeVol
      {
         get
         {
            if (this.nC1_PlanDeVol == null)
                throw new XBException("field nC1_PlanDeVol not set");

            return this.nC1_PlanDeVol;
         }
         set
         {
            this.nC1_PlanDeVol = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_PlanDeVol.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_PlanDeVol = new  NC1_PlanDeVol_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_PlanDeVol.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_PlanDeVol");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_PlanDeVol",  _NC1_PlanDeVol.NS_URI,  _NC1_PlanDeVol.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_PlanDeVol.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_PlanDeVol {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:plandevol";
      public static readonly String NS_PREFIX = "nc1plandevol";
 ...
 */
      ...
      public _NC1_PlanDeVol() {
      }
      static _NC1_PlanDeVol() {
         XBUtil.license = _NC1_PlanDeVol.license;
      }
   }
}
