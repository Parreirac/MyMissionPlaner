...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_CBRN_3_CHEM_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrn3chem",
          "NC1_CBRN-3-CHEM_ELEM");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","cbrnEvent"),
         new XBQualifiedName("","papaa"),
         new XBQualifiedName("","papax"),
         new XBQualifiedName("","xrayb"),
         new XBQualifiedName("","oscar"),
         new XBQualifiedName("","crbnInfo")
      };
      static NC1_CBRN_3_CHEM_ELEM() {
         XBUtil.license =  _NC1_CBRN_3_CHEM.license;
      }
      ...
      //content fields
      protected  CbrnEventType cbrnEvent;
      protected  PapaaType papaa;
      protected  PapaxType papax;
      protected  XraybType xrayb;   //optional
      protected  OscarType oscar;   //optional
      ...
      public  CbrnEventType CbrnEvent
      {
         get
         {
            if (this.cbrnEvent == null)
                throw new XBException("field cbrnEvent not set");

            return this.cbrnEvent;
         }
         set
         {
            this.cbrnEvent = value;
         }
      }

      public  PapaaType Papaa
      {
         get
         {
            if (this.papaa == null)
                throw new XBException("field papaa not set");
      ...
      public  PapaxType Papax
      {
         get
         {
            if (this.papax == null)
                throw new XBException("field papax not set");
      ...
      public  XraybType Xrayb
      {
         get
         {
            if (this.xrayb == null)
                throw new XBException("field xrayb not set");
      ...
      public  OscarType Oscar
      {
         get
         {
            if (this.oscar == null)
                throw new XBException("field oscar not set");
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.cbrnEvent = new  CbrnEventType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.cbrnEvent.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "cbrnEvent");

               // papaa
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.papaa = new  PapaaType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.papaa.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "papaa");

               // papax
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.papax = new  PapaxType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.papax.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "papax");

               // xrayb
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.xrayb = new  XraybType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.xrayb.decode(reader, xbContext, false, false);
               ...
               {
                  this.oscar = new  OscarType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.oscar.decode(reader, xbContext, false, false);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("cbrnEvent", "", "");
         this.cbrnEvent.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // papaa
         if (this.papaa == null) throw new XBException("field papaa not set");

         encoder.encodeStartElement("papaa", "", "");
         this.papaa.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // papax
         if (this.papax == null) throw new XBException("field papax not set");

         encoder.encodeStartElement("papax", "", "");
         this.papax.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // xrayb
         if (this.xrayb != null)  {
            encoder.encodeStartElement("xrayb", "", "");
            this.xrayb.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // oscar
         if (this.oscar != null)  {
            encoder.encodeStartElement("oscar", "", "");
            this.oscar.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_CBRN_3_CHEM_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:cbrn3chem","NC1_CBRN-3-CHEM")
      };
      static NC1_CBRN_3_CHEM_CC() {
         XBUtil.license =  _NC1_CBRN_3_CHEM.license;
      }
      ...
      //content fields
      protected  NC1_CBRN_3_CHEM_ELEM nC1_CBRN_3_CHEM;

      //content methods

      public  NC1_CBRN_3_CHEM_ELEM NC1_CBRN_3_CHEM
      {
         get
         {
            if (this.nC1_CBRN_3_CHEM == null)
                throw new XBException("field nC1_CBRN_3_CHEM not set");

            return this.nC1_CBRN_3_CHEM;
         }
         set
         {
            this.nC1_CBRN_3_CHEM = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CBRN_3_CHEM.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CBRN_3_CHEM = new  NC1_CBRN_3_CHEM_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CBRN_3_CHEM.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CBRN_3_CHEM");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CBRN-3-CHEM",  _NC1_CBRN_3_CHEM.NS_URI,  _NC1_CBRN_3_CHEM.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CBRN_3_CHEM.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CBRN_3_CHEM {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:cbrn3chem";
      public static readonly String NS_PREFIX = "nc1cbrn3chem";
 ...
 */
      ...
      public _NC1_CBRN_3_CHEM() {
      }
      static _NC1_CBRN_3_CHEM() {
         XBUtil.license = _NC1_CBRN_3_CHEM.license;
      }
   }
}
