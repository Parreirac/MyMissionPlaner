...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_CBRN_4_CHEM_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrn4chem",
          "NC1_CBRN-4-CHEM_ELEM");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","alfa"),
         new XBQualifiedName("","india"),
         new XBQualifiedName("","indiac"),
         new XBQualifiedName("","quebec"),
         new XBQualifiedName("","romeo"),
         new XBQualifiedName("","sierra"),
         new XBQualifiedName("","tango"),
         new XBQualifiedName("","whiskey"),
         new XBQualifiedName("","yankee"),
         new XBQualifiedName("","zulu"),
         new XBQualifiedName("","crbnInfo")
      };
      static NC1_CBRN_4_CHEM_ELEM() {
         XBUtil.license =  _NC1_CBRN_4_CHEM.license;
      }
      ...
      //content fields
      protected  AlfaType alfa;   //optional
      protected  IndiaType india;
      protected  IndiacType indiac;   //optional
      protected  QuebecType quebec;
      protected  RomeoType romeo;   //optional
      protected  SierraType sierra;
      protected  TangoType tango;   //optional
      protected  WhiskeyType whiskey;   //optional
      protected  YankeeType yankee;   //optional
      protected  ZuluType zulu;   //optional
      protected  MixedAnyType crbnInfo;   //optional

      //attribute methods

      //content methods

      public  AlfaType Alfa
      {
         get
         {
            if (this.alfa == null)
                throw new XBException("field alfa not set");
      ...
      public  IndiaType India
      {
         get
         {
            if (this.india == null)
                throw new XBException("field india not set");
      ...
      public  IndiacType Indiac
      {
         get
         {
            if (this.indiac == null)
                throw new XBException("field indiac not set");
      ...
      public  QuebecType Quebec
      {
         get
         {
            if (this.quebec == null)
                throw new XBException("field quebec not set");
      ...
      public  RomeoType Romeo
      {
         get
         {
            if (this.romeo == null)
                throw new XBException("field romeo not set");
      ...
      public  SierraType Sierra
      {
         get
         {
            if (this.sierra == null)
                throw new XBException("field sierra not set");
      ...
      public  TangoType Tango
      {
         get
         {
            if (this.tango == null)
                throw new XBException("field tango not set");
      ...
      public  WhiskeyType Whiskey
      {
         get
         {
            if (this.whiskey == null)
                throw new XBException("field whiskey not set");
      ...
      public  YankeeType Yankee
      {
         get
         {
            if (this.yankee == null)
                throw new XBException("field yankee not set");
      ...
      public  ZuluType Zulu
      {
         get
         {
            if (this.zulu == null)
                throw new XBException("field zulu not set");
      ...
      public  MixedAnyType CrbnInfo
      {
         get
         {
            if (this.crbnInfo == null)
                throw new XBException("field crbnInfo not set");

            return this.crbnInfo;
         }
         set
         {
            this.crbnInfo = value;
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.alfa = new  AlfaType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.alfa.decode(reader, xbContext, false, false);
               ...
               {
                  this.india = new  IndiaType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.india.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "india");

               // indiac
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.indiac = new  IndiacType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.indiac.decode(reader, xbContext, false, false);
               ...
               {
                  this.quebec = new  QuebecType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.quebec.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "quebec");

               // romeo
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  this.romeo = new  RomeoType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.romeo.decode(reader, xbContext, false, false);
               ...
               {
                  this.sierra = new  SierraType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.sierra.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "sierra");

               // tango
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[6], elemNs, elemLocalName) )
               {
                  this.tango = new  TangoType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.tango.decode(reader, xbContext, false, false);
               ...
               {
                  this.whiskey = new  WhiskeyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.whiskey.decode(reader, xbContext, false, false);
               ...
               {
                  this.yankee = new  YankeeType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.yankee.decode(reader, xbContext, false, false);
               ...
               {
                  this.zulu = new  ZuluType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.zulu.decode(reader, xbContext, false, false);
               ...
               {
                  this.crbnInfo = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.crbnInfo.decode(reader, xbContext, false, false);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // alfa
         if (this.alfa != null)  {
            encoder.encodeStartElement("alfa", "", "");
            this.alfa.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // india
         if (this.india == null) throw new XBException("field india not set");

         encoder.encodeStartElement("india", "", "");
         this.india.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // indiac
         if (this.indiac != null)  {
            encoder.encodeStartElement("indiac", "", "");
            this.indiac.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
         ...
         encoder.encodeStartElement("quebec", "", "");
         this.quebec.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // romeo
         if (this.romeo != null)  {
            encoder.encodeStartElement("romeo", "", "");
            this.romeo.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
         ...
         encoder.encodeStartElement("sierra", "", "");
         this.sierra.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // tango
         if (this.tango != null)  {
            encoder.encodeStartElement("tango", "", "");
            this.tango.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // whiskey
         if (this.whiskey != null)  {
            encoder.encodeStartElement("whiskey", "", "");
            this.whiskey.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // yankee
         if (this.yankee != null)  {
            encoder.encodeStartElement("yankee", "", "");
            this.yankee.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // zulu
         if (this.zulu != null)  {
            encoder.encodeStartElement("zulu", "", "");
            this.zulu.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // crbnInfo
         if (this.crbnInfo != null)  {
            encoder.encodeStartElement("crbnInfo", "", "");
            this.crbnInfo.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_CBRN_4_CHEM_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:cbrn4chem","NC1_CBRN-4-CHEM")
      };
      static NC1_CBRN_4_CHEM_CC() {
         XBUtil.license =  _NC1_CBRN_4_CHEM.license;
      }
      ...
      //content fields
      protected  NC1_CBRN_4_CHEM_ELEM nC1_CBRN_4_CHEM;

      //content methods

      public  NC1_CBRN_4_CHEM_ELEM NC1_CBRN_4_CHEM
      {
         get
         {
            if (this.nC1_CBRN_4_CHEM == null)
                throw new XBException("field nC1_CBRN_4_CHEM not set");

            return this.nC1_CBRN_4_CHEM;
         }
         set
         {
            this.nC1_CBRN_4_CHEM = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CBRN_4_CHEM.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CBRN_4_CHEM = new  NC1_CBRN_4_CHEM_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CBRN_4_CHEM.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CBRN_4_CHEM");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CBRN-4-CHEM",  _NC1_CBRN_4_CHEM.NS_URI,  _NC1_CBRN_4_CHEM.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CBRN_4_CHEM.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CBRN_4_CHEM {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:cbrn4chem";
      public static readonly String NS_PREFIX = "nc1cbrn4chem";
 ...
 */
      ...
      public _NC1_CBRN_4_CHEM() {
      }
      static _NC1_CBRN_4_CHEM() {
         XBUtil.license = _NC1_CBRN_4_CHEM.license;
      }
   }
}
