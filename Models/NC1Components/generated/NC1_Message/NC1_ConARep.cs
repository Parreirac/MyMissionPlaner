...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_ConARep_ELEM_2_movementArrivalReport : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:conarep",
          "NC1_ConARep_ELEM_2_movementArrivalReport");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","convoy"),
         new XBQualifiedName("","associatedRoute"),
         new XBQualifiedName("","event"),
         new XBQualifiedName("","reportingUnit")
      };
      static NC1_ConARep_ELEM_2_movementArrivalReport() {
         XBUtil.license =  _NC1_ConARep.license;
      }
      ...
      protected  ConvoyType convoy;   //optional
      protected  RouteType associatedRoute;   //optional
      protected System.Collections.Generic.IList< EventType> event_;
      protected  UnitType reportingUnit;   //optional
      ...
      public  ConvoyType Convoy
      {
         get
         {
            if (this.convoy == null)
                throw new XBException("field convoy not set");
      ...
      public  RouteType AssociatedRoute
      {
         get
         {
            if (this.associatedRoute == null)
                throw new XBException("field associatedRoute not set");

            return this.associatedRoute;
         }
         set
         {
            this.associatedRoute = value;
         }
      }

      public System.Collections.Generic.IList< EventType> Event_
      {
         get
         {
            if (this.event_ == null) {
               this.event_ = new List< EventType>();
            }
            return this.event_;
         }
      }

      public  UnitType ReportingUnit
      {
         get
         {
            if (this.reportingUnit == null)
                throw new XBException("field reportingUnit not set");
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               else throw new XBOccurrencesException(0, "arrivalDatetime");

               // convoy
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.convoy = new  ConvoyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.convoy.decode(reader, xbContext, false, false);
               ...
               {
                  this.associatedRoute = new  RouteType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.associatedRoute.decode(reader, xbContext, false, false);
               ...
               {
                   EventType _tmp_event_;
                  _tmp_event_ = new  EventType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_event_.decode(reader, xbContext, false, false);
                  this.event_.Add(_tmp_event_);
               ...
               {
                  this.reportingUnit = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.reportingUnit.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         String text_3;
         text_3 = this.arrivalDatetime;
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();

         // convoy
         if (this.convoy != null)  {
            encoder.encodeStartElement("convoy", "", "");
            this.convoy.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // associatedRoute
         if (this.associatedRoute != null)  {
            encoder.encodeStartElement("associatedRoute", "", "");
            this.associatedRoute.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // event_
         if ( this.event_ != null ){
            foreach ( EventType _tmp_event_ in this.event_){
               encoder.encodeStartElement("event", "", "");
               _tmp_event_.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
         ...
         // reportingUnit
         if (this.reportingUnit != null)  {
            encoder.encodeStartElement("reportingUnit", "", "");
            this.reportingUnit.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_ConARep_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:conarep",
          "NC1_ConARep_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","movementArrivalReport"),
         new XBQualifiedName("","comment")
      };
      static NC1_ConARep_ELEM() {
         XBUtil.license =  _NC1_ConARep.license;
      }
      ...
      //content fields
      protected  NC1_ConARep_ELEM_2_movementArrivalReport movementArrivalReport;
      ...
      public  NC1_ConARep_ELEM_2_movementArrivalReport MovementArrivalReport
      {
         get
         {
            if (this.movementArrivalReport == null)
                throw new XBException("field movementArrivalReport not set");

            return this.movementArrivalReport;
         }
         set
         {
            this.movementArrivalReport = value;
         }
      }
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // movementArrivalReport
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.movementArrivalReport = new  NC1_ConARep_ELEM_2_movementArrivalReport();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.movementArrivalReport.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "movementArrivalReport");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("movementArrivalReport", "", "");
         this.movementArrivalReport.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_ConARep_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:conarep","NC1_ConARep")
      };
      static NC1_ConARep_CC() {
         XBUtil.license =  _NC1_ConARep.license;
      }
      ...
      //content fields
      protected  NC1_ConARep_ELEM nC1_ConARep;

      //content methods

      public  NC1_ConARep_ELEM NC1_ConARep
      {
         get
         {
            if (this.nC1_ConARep == null)
                throw new XBException("field nC1_ConARep not set");

            return this.nC1_ConARep;
         }
         set
         {
            this.nC1_ConARep = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_ConARep.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_ConARep = new  NC1_ConARep_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_ConARep.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_ConARep");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_ConARep",  _NC1_ConARep.NS_URI,  _NC1_ConARep.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_ConARep.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_ConARep {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:conarep";
      public static readonly String NS_PREFIX = "nc1conarep";
