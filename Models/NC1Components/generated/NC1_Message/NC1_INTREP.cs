...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class IntrepTypeCode
   {
      static IntrepTypeCode() {
         XBUtil.license =  _NC1_INTREP.license;
      }

      //constructor
      private IntrepTypeCode() {} 
   ...
   public class IntrepCategoryCode
   {
      static IntrepCategoryCode() {
         XBUtil.license =  _NC1_INTREP.license;
      }

      //constructor
      private IntrepCategoryCode() {} 
   ...
   public class NC1_INTREP_ELEM_2_intelligenceReport : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:intrep",
          "NC1_INTREP_ELEM_2_intelligenceReport");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","report"),
         new XBQualifiedName("","assessment")
      };
      static NC1_INTREP_ELEM_2_intelligenceReport() {
         XBUtil.license =  _NC1_INTREP.license;
      }
      ...
      public  MixedAnyType Report
      {
         get
         {
            if (this.report == null)
                throw new XBException("field report not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.type =  IntrepTypeCode.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.category =  IntrepCategoryCode.decode(text, xbContext);
               ...
               {
                  this.report = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.report.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "report");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         String text_3;
         text_3 =  IntrepTypeCode.encode(this.type, xbContext);
         ...
         if (_set_category)  {
            ...
            text_3 =  IntrepCategoryCode.encode(this.category, xbContext);
            encoder.encodeCharsNoEscaping(text_3);
            encoder.encodeEndElement();
         }
         ...
         encoder.encodeStartElement("report", "", "");
         this.report.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_INTREP_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:intrep",
          "NC1_INTREP_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","intelligenceReport"),
         new XBQualifiedName("","comment")
      };
      static NC1_INTREP_ELEM() {
         XBUtil.license =  _NC1_INTREP.license;
      }
      ...
      //content fields
      protected  NC1_INTREP_ELEM_2_intelligenceReport intelligenceReport;
      ...
      public  NC1_INTREP_ELEM_2_intelligenceReport IntelligenceReport
      {
         get
         {
            if (this.intelligenceReport == null)
                throw new XBException("field intelligenceReport not set");

            return this.intelligenceReport;
         }
         set
         {
            this.intelligenceReport = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.intelligenceReport = new  NC1_INTREP_ELEM_2_intelligenceReport();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.intelligenceReport.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "intelligenceReport");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("intelligenceReport", "", "");
         this.intelligenceReport.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_INTREP_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:intrep","NC1_INTREP")
      };
      static NC1_INTREP_CC() {
         XBUtil.license =  _NC1_INTREP.license;
      }
      ...
      //content fields
      protected  NC1_INTREP_ELEM nC1_INTREP;

      //content methods

      public  NC1_INTREP_ELEM NC1_INTREP
      {
         get
         {
            if (this.nC1_INTREP == null)
                throw new XBException("field nC1_INTREP not set");

            return this.nC1_INTREP;
         }
         set
         {
            this.nC1_INTREP = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_INTREP.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_INTREP = new  NC1_INTREP_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_INTREP.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_INTREP");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_INTREP",  _NC1_INTREP.NS_URI,  _NC1_INTREP.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_INTREP.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_INTREP {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:intrep";
      public static readonly String NS_PREFIX = "nc1intrep";
