...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_CCA_CARD_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:ccacard",
          "NC1_CCA-CARD_ELEM");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","observer"),
         new XBQualifiedName("","target"),
         new XBQualifiedName("","additionalInformation")
      };
      static NC1_CCA_CARD_ELEM() {
         XBUtil.license =  _NC1_CCA_CARD.license;
      }
      ...
      //content fields
      protected  AgentType observer;
      protected  LocalisedObjectType target;
      protected  MixedAnyType additionalInformation;   //optional

      //attribute methods

      //content methods

      public  AgentType Observer
      {
         get
         {
            if (this.observer == null)
                throw new XBException("field observer not set");
      ...
      public  LocalisedObjectType Target
      {
         get
         {
            if (this.target == null)
      ...
      public  MixedAnyType AdditionalInformation
      {
         get
         {
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.observer =  AgentType.createObject(
                     XMLStreamHelper.readXsiType(reader) );
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.observer.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "observer");

               // target
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.target =  LocalisedObjectType.createObject(
                     XMLStreamHelper.readXsiType(reader) );
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               else throw new XBOccurrencesException(0, "target");

               // additionalInformation
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.additionalInformation = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("observer", "", "");
         this.observer.encode(encoder, xbContext,  AgentType.XSD_TYPE, 
            false);
         ...
         this.target.encode(encoder, xbContext, 
             LocalisedObjectType.XSD_TYPE, false);
         encoder.encodeEndElement();

         // additionalInformation
         if (this.additionalInformation != null)  {
            encoder.encodeStartElement("additionalInformation", "", "");
            this.additionalInformation.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_CCA_CARD_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:ccacard","NC1_CCA-CARD")
      };
      static NC1_CCA_CARD_CC() {
         XBUtil.license =  _NC1_CCA_CARD.license;
      }
      ...
      //content fields
      protected  NC1_CCA_CARD_ELEM nC1_CCA_CARD;

      //content methods

      public  NC1_CCA_CARD_ELEM NC1_CCA_CARD
      {
         get
         {
            if (this.nC1_CCA_CARD == null)
                throw new XBException("field nC1_CCA_CARD not set");

            return this.nC1_CCA_CARD;
         }
         set
         {
            this.nC1_CCA_CARD = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CCA_CARD.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CCA_CARD = new  NC1_CCA_CARD_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CCA_CARD.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CCA_CARD");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CCA-CARD",  _NC1_CCA_CARD.NS_URI,  _NC1_CCA_CARD.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CCA_CARD.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CCA_CARD {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:ccacard";
      public static readonly String NS_PREFIX = "nc1ccacard";
 ...
 */
      ...
      public _NC1_CCA_CARD() {
      }
      static _NC1_CCA_CARD() {
         XBUtil.license = _NC1_CCA_CARD.license;
      }
   }
}
