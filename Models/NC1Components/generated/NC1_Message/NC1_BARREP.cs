...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_BARREP_ELEM_2_friendlyObstacles : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:barrep",
          "NC1_BARREP_ELEM_2_friendlyObstacles");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","friendlyObstacle")
      };
      static NC1_BARREP_ELEM_2_friendlyObstacles() {
         XBUtil.license =  _NC1_BARREP.license;
      }
      ...
      //content fields
      protected System.Collections.Generic.IList< ObstacleType> friendlyObstacle;
      ...
      public System.Collections.Generic.IList< ObstacleType> FriendlyObstacle
      {
         get
         {
            if (this.friendlyObstacle == null) {
               this.friendlyObstacle = new List< ObstacleType>();
            }
            return this.friendlyObstacle;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                   ObstacleType _tmp_friendlyObstacle;
                  _tmp_friendlyObstacle = new  ObstacleType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_friendlyObstacle.decode(reader, xbContext, false, false);
                  this.friendlyObstacle.Add(_tmp_friendlyObstacle);
               ...
               if ( this.friendlyObstacle.Count < 1 && !moreContent_4) 
                  throw new XBOccurrencesException(this.friendlyObstacle.Count, "friendlyObstacle");
               else if (this.friendlyObstacle.Count == 0 && moreContent_4) 
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // friendlyObstacle
         if (this.friendlyObstacle == null || this.friendlyObstacle.Count < 1) 
            throw new XBOccurrencesException( (this.friendlyObstacle == null ? 0 : this.friendlyObstacle.Count ) );

         foreach ( ObstacleType _tmp_friendlyObstacle in this.friendlyObstacle)
         {
            encoder.encodeStartElement("friendlyObstacle", "", "");
            _tmp_friendlyObstacle.encode(encoder, xbContext, null, false);
   ...
   public class NC1_BARREP_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:barrep",
          "NC1_BARREP_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","friendlyObstacles"),
         new XBQualifiedName("","comment")
      };
      static NC1_BARREP_ELEM() {
         XBUtil.license =  _NC1_BARREP.license;
      }
      ...
      //content fields
      protected  NC1_BARREP_ELEM_2_friendlyObstacles friendlyObstacles;
      ...
      public  NC1_BARREP_ELEM_2_friendlyObstacles FriendlyObstacles
      {
         get
         {
            if (this.friendlyObstacles == null)
                throw new XBException("field friendlyObstacles not set");

            return this.friendlyObstacles;
         }
         set
         {
            this.friendlyObstacles = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.friendlyObstacles = new  NC1_BARREP_ELEM_2_friendlyObstacles();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.friendlyObstacles.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "friendlyObstacles");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("friendlyObstacles", "", "");
         this.friendlyObstacles.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_BARREP_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:barrep","NC1_BARREP")
      };
      static NC1_BARREP_CC() {
         XBUtil.license =  _NC1_BARREP.license;
      }
      ...
      //content fields
      protected  NC1_BARREP_ELEM nC1_BARREP;

      //content methods

      public  NC1_BARREP_ELEM NC1_BARREP
      {
         get
         {
            if (this.nC1_BARREP == null)
                throw new XBException("field nC1_BARREP not set");

            return this.nC1_BARREP;
         }
         set
         {
            this.nC1_BARREP = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_BARREP.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_BARREP = new  NC1_BARREP_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_BARREP.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_BARREP");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_BARREP",  _NC1_BARREP.NS_URI,  _NC1_BARREP.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_BARREP.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_BARREP {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:barrep";
      public static readonly String NS_PREFIX = "nc1barrep";
