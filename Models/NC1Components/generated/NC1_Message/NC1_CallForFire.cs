...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    using Point2DType = NC1.Location.Point2DType;



    public class SecurityType : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:callforfire",
          "SecurityType");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","protectionLevel")
      };
      static SecurityType() {
         XBUtil.license =  _NC1_CallForFire.license;
      }
      ...
      //content fields
      protected  Point2DType point;
      protected int protectionLevel;
      protected bool _set_protectionLevel = false;

      //attribute methods

      //content methods

      public  Point2DType Point
      {
         get
         {
            if (this.point == null)
      ...
      public int ProtectionLevel
      {
         get
         {
            if (!_set_protectionLevel)
                throw new XBException("field protectionLevel not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  this.protectionLevel =  L114_24Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // protectionLevel
         if (_set_protectionLevel)  {
            encoder.encodeStartElement("protectionLevel", "", "");
            String text_4;
            text_4 =  L114_24Code.encode(this.protectionLevel, xbContext);
   ...
   public class NC1_CallForFire_ELEM_2_fireRequested : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:callforfire",
          "NC1_CallForFire_ELEM_2_fireRequested");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","security")
      };
      static NC1_CallForFire_ELEM_2_fireRequested() {
         XBUtil.license =  _NC1_CallForFire.license;
      }
      ...
      protected  SecurityType security;   //optional
      ...
      public  SecurityType Security
      {
         get
         {
            if (this.security == null)
                throw new XBException("field security not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.priority =  L114_29Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.security.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_priority)  {
            ...
            String text_4;
            text_4 =  L114_29Code.encode(this.priority, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // security
         if (this.security != null)  {
            encoder.encodeStartElement("security", "", "");
            this.security.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_CallForFire_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:callforfire",
          "NC1_CallForFire_ELEM");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","fireRequested")
      };
      static NC1_CallForFire_ELEM() {
         XBUtil.license =  _NC1_CallForFire.license;
      }
      ...
      //content fields
      protected  NC1_CallForFire_ELEM_2_fireRequested fireRequested;

      //attribute methods

      //content methods

      public  NC1_CallForFire_ELEM_2_fireRequested FireRequested
      {
         get
         {
            if (this.fireRequested == null)
                throw new XBException("field fireRequested not set");

            return this.fireRequested;
         }
         set
         {
            this.fireRequested = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.fireRequested = new  NC1_CallForFire_ELEM_2_fireRequested();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.fireRequested.decode(reader, xbContext, false, false);

                  moreContent_4 = 
                     XMLStreamHelper.moveToContentElement(reader);
               }
               else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
               else throw new XBOccurrencesException(0, "fireRequested");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("fireRequested", "", "");
         this.fireRequested.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   ...
   public class NC1_CallForFire_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:callforfire","NC1_CallForFire")
      };
      static NC1_CallForFire_CC() {
         XBUtil.license =  _NC1_CallForFire.license;
      }
      ...
      //content fields
      protected  NC1_CallForFire_ELEM nC1_CallForFire;

      //content methods

      public  NC1_CallForFire_ELEM NC1_CallForFire
      {
         get
         {
            if (this.nC1_CallForFire == null)
                throw new XBException("field nC1_CallForFire not set");

            return this.nC1_CallForFire;
         }
         set
         {
            this.nC1_CallForFire = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CallForFire.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CallForFire = new  NC1_CallForFire_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CallForFire.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CallForFire");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CallForFire",  _NC1_CallForFire.NS_URI,  _NC1_CallForFire.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CallForFire.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CallForFire {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:callforfire";
      public static readonly String NS_PREFIX = "nc1cff";
 ...
 */
      ...
      public _NC1_CallForFire() {
      }
      static _NC1_CallForFire() {
         XBUtil.license = _NC1_CallForFire.license;
      }
   }
}
