...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_CBRN_5_BIO_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrn5bio",
          "NC1_CBRN-5-BIO_ELEM");
      ...
      static NC1_CBRN_5_BIO_ELEM() {
         XBUtil.license =  _NC1_CBRN_5_BIO.license;
      }
   ...
   public class NC1_CBRN_5_BIO_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:cbrn5bio","NC1_CBRN-5-BIO")
      };
      static NC1_CBRN_5_BIO_CC() {
         XBUtil.license =  _NC1_CBRN_5_BIO.license;
      }
      ...
      //content fields
      protected  NC1_CBRN_5_BIO_ELEM nC1_CBRN_5_BIO;

      //content methods

      public  NC1_CBRN_5_BIO_ELEM NC1_CBRN_5_BIO
      {
         get
         {
            if (this.nC1_CBRN_5_BIO == null)
                throw new XBException("field nC1_CBRN_5_BIO not set");

            return this.nC1_CBRN_5_BIO;
         }
         set
         {
            this.nC1_CBRN_5_BIO = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CBRN_5_BIO.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CBRN_5_BIO = new  NC1_CBRN_5_BIO_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CBRN_5_BIO.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CBRN_5_BIO");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CBRN-5-BIO",  _NC1_CBRN_5_BIO.NS_URI,  _NC1_CBRN_5_BIO.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CBRN_5_BIO.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CBRN_5_BIO {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:cbrn5bio";
      public static readonly String NS_PREFIX = "nc1cbrn5bio";
 ...
 */
      ...
      public _NC1_CBRN_5_BIO() {
      }
      static _NC1_CBRN_5_BIO() {
         XBUtil.license = _NC1_CBRN_5_BIO.license;
      }
   }
}
