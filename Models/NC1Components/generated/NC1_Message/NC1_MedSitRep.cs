...
namespace NC1.Msg {
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_MedSitRep_ELEM_2_medicalFacilityReport : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:medsitrep",
          "NC1_MedSitRep_ELEM_2_medicalFacilityReport");
      ...
      static NC1_MedSitRep_ELEM_2_medicalFacilityReport() {
         XBUtil.license =  _NC1_MedSitRep.license;
      }
   ...
   public class NC1_MedSitRep_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:medsitrep",
          "NC1_MedSitRep_ELEM");
      ...
      //content fields
      protected  NC1_MedSitRep_ELEM_2_medicalFacilityReport medicalFacilityReport;
      ...
      public  NC1_MedSitRep_ELEM_2_medicalFacilityReport MedicalFacilityReport
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.medicalFacilityReport = new  NC1_MedSitRep_ELEM_2_medicalFacilityReport();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_MedSitRep_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:medsitrep","NC1_MedSitRep")
      };
      static NC1_MedSitRep_CC() {
         XBUtil.license =  _NC1_MedSitRep.license;
      }
      ...
      //content fields
      protected  NC1_MedSitRep_ELEM nC1_MedSitRep;

      //content methods

      public  NC1_MedSitRep_ELEM NC1_MedSitRep
      {
         get
         {
            if (this.nC1_MedSitRep == null)
                throw new XBException("field nC1_MedSitRep not set");

            return this.nC1_MedSitRep;
         }
         set
         {
            this.nC1_MedSitRep = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_MedSitRep.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_MedSitRep = new  NC1_MedSitRep_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_MedSitRep.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_MedSitRep");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_MedSitRep",  _NC1_MedSitRep.NS_URI,  _NC1_MedSitRep.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_MedSitRep.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_MedSitRep {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:medsitrep";
      public static readonly String NS_PREFIX = "nc1medsitrep";
 ...
 */
      ...
      public _NC1_MedSitRep() {
      }
      static _NC1_MedSitRep() {
         XBUtil.license = _NC1_MedSitRep.license;
      }
   }
}
