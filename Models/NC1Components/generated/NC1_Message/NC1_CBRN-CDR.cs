...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_CBRN_CDR_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:cbrncdr",
          "NC1_CBRN-CDR_ELEM");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","aream"),
         new XBQualifiedName("","whiskeym"),
         new XBQualifiedName("","xraym"),
         new XBQualifiedName("","yankeem"),
         new XBQualifiedName("","zulum")
      };
      static NC1_CBRN_CDR_ELEM() {
         XBUtil.license =  _NC1_CBRN_CDR.license;
      }
      ...
      //content fields
      protected  AreamType aream;
      protected  WhiskeymType whiskeym;
      protected  XraymType xraym;   //optional
      protected  YankeemType yankeem;   //optional
      protected  ZulumType zulum;

      //attribute methods

      //content methods

      public  AreamType Aream
      {
         get
         {
            if (this.aream == null)
                throw new XBException("field aream not set");
      ...
      public  WhiskeymType Whiskeym
      {
         get
         {
            if (this.whiskeym == null)
                throw new XBException("field whiskeym not set");

            return this.whiskeym;
         }
         set
         {
            this.whiskeym = value;
      ...
      public  XraymType Xraym
      {
         get
         {
            if (this.xraym == null)
                throw new XBException("field xraym not set");
      ...
      public  YankeemType Yankeem
      {
         get
         {
            if (this.yankeem == null)
                throw new XBException("field yankeem not set");
      ...
      public  ZulumType Zulum
      {
         get
         {
            if (this.zulum == null)
                throw new XBException("field zulum not set");
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.aream = new  AreamType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.aream.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "aream");

               // whiskeym
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.whiskeym = new  WhiskeymType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.whiskeym.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "whiskeym");

               // xraym
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.xraym = new  XraymType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.xraym.decode(reader, xbContext, false, false);
               ...
               {
                  this.yankeem = new  YankeemType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.yankeem.decode(reader, xbContext, false, false);
               ...
               {
                  this.zulum = new  ZulumType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.zulum.decode(reader, xbContext, false, false);

                  moreContent_4 = 
                     XMLStreamHelper.moveToContentElement(reader);
               }
               else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
               else throw new XBOccurrencesException(0, "zulum");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // aream
         if (this.aream == null) throw new XBException("field aream not set");

         encoder.encodeStartElement("aream", "", "");
         this.aream.encode(encoder, xbContext, null, false);
         ...
         encoder.encodeStartElement("whiskeym", "", "");
         this.whiskeym.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // xraym
         if (this.xraym != null)  {
            encoder.encodeStartElement("xraym", "", "");
            this.xraym.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // yankeem
         if (this.yankeem != null)  {
            encoder.encodeStartElement("yankeem", "", "");
            this.yankeem.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // zulum
         if (this.zulum == null) throw new XBException("field zulum not set");

         encoder.encodeStartElement("zulum", "", "");
         this.zulum.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   ...
   public class NC1_CBRN_CDR_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:cbrncdr","NC1_CBRN-CDR")
      };
      static NC1_CBRN_CDR_CC() {
         XBUtil.license =  _NC1_CBRN_CDR.license;
      }
      ...
      //content fields
      protected  NC1_CBRN_CDR_ELEM nC1_CBRN_CDR;

      //content methods

      public  NC1_CBRN_CDR_ELEM NC1_CBRN_CDR
      {
         get
         {
            if (this.nC1_CBRN_CDR == null)
                throw new XBException("field nC1_CBRN_CDR not set");

            return this.nC1_CBRN_CDR;
         }
         set
         {
            this.nC1_CBRN_CDR = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CBRN_CDR.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CBRN_CDR = new  NC1_CBRN_CDR_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CBRN_CDR.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CBRN_CDR");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CBRN-CDR",  _NC1_CBRN_CDR.NS_URI,  _NC1_CBRN_CDR.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CBRN_CDR.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CBRN_CDR {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:cbrncdr";
      public static readonly String NS_PREFIX = "nc1cbrncdr";
 ...
 */
      ...
      public _NC1_CBRN_CDR() {
      }
      static _NC1_CBRN_CDR() {
         XBUtil.license = _NC1_CBRN_CDR.license;
      }
   }
}
