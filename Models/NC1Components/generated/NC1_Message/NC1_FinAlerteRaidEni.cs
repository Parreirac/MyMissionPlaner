...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_FinAlerteRaidEni_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:finalerteraideni",
          "NC1_FinAlerteRaidEni_ELEM");
      ...
      static NC1_FinAlerteRaidEni_ELEM() {
         XBUtil.license =  _NC1_FinAlerteRaidEni.license;
      }
      ...
      //content fields
      protected  Point2DType location;
   ...
   public class NC1_FinAlerteRaidEni_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:finalerteraideni","NC1_FinAlerteRaidEni")
      };
      static NC1_FinAlerteRaidEni_CC() {
         XBUtil.license =  _NC1_FinAlerteRaidEni.license;
      }
      ...
      //content fields
      protected  NC1_FinAlerteRaidEni_ELEM nC1_FinAlerteRaidEni;

      //content methods

      public  NC1_FinAlerteRaidEni_ELEM NC1_FinAlerteRaidEni
      {
         get
         {
            if (this.nC1_FinAlerteRaidEni == null)
                throw new XBException("field nC1_FinAlerteRaidEni not set");

            return this.nC1_FinAlerteRaidEni;
         }
         set
         {
            this.nC1_FinAlerteRaidEni = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_FinAlerteRaidEni.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            // nC1_FinAlerteRaidEni
            bool moreContent_4 = true;
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_FinAlerteRaidEni = new  NC1_FinAlerteRaidEni_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_FinAlerteRaidEni.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_FinAlerteRaidEni");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_FinAlerteRaidEni",  _NC1_FinAlerteRaidEni.NS_URI,  _NC1_FinAlerteRaidEni.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_FinAlerteRaidEni.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_FinAlerteRaidEni {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:finalerteraideni";
      public static readonly String NS_PREFIX = "nc1finalertraideni";
 ...
 */
      ...
      public _NC1_FinAlerteRaidEni() {
      }
      static _NC1_FinAlerteRaidEni() {
         XBUtil.license = _NC1_FinAlerteRaidEni.license;
      }
   }
}
