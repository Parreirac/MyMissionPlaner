...
namespace NC1.Msg
{
   ...
   public class NC1_Apercu3D_ELEM_2_messageConsideration : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:apercu3d",
          "NC1_Apercu3D_ELEM_2_messageConsideration");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","isConsidered"),
         new XBQualifiedName("","part")
      };
      static NC1_Apercu3D_ELEM_2_messageConsideration() {
         XBUtil.license =  _NC1_Apercu3D.license;
      }
      ...
      //content fields
      protected bool isConsidered;
      protected string part;
      protected bool _set_part = false;
      ...
      {
         get { return this.isConsidered; }
         set { this.isConsidered = value; }
      }
      ...
      public string Part
      {
         get
         {
            if (!_set_part) throw new XBException("field part not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.isConsidered = XBSimpleType.parseBoolean(text);
               ...
               else throw new XBOccurrencesException(0, "isConsidered");
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.part =  MediumTextType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // isConsidered
         encoder.encodeStartElement("isConsidered", "", "");
         String text_3;
         text_3 = this.isConsidered.ToString().ToLower();
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // part
         if (_set_part)  {
            encoder.encodeStartElement("part", "", "");
            text_3 =  MediumTextType.encode(this.part, xbContext);
   ...
   public class NC1_Apercu3D_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:apercu3d",
          "NC1_Apercu3D_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","messageConsideration"),
         new XBQualifiedName("","comment")
      };
      static NC1_Apercu3D_ELEM() {
         XBUtil.license =  _NC1_Apercu3D.license;
      }
      ...
      //content fields
      protected  NC1_Apercu3D_ELEM_2_messageConsideration messageConsideration;
      ...
      public  NC1_Apercu3D_ELEM_2_messageConsideration MessageConsideration
      {
         get
         {
            if (this.messageConsideration == null)
                throw new XBException("field messageConsideration not set");

            return this.messageConsideration;
         }
         set
         {
            this.messageConsideration = value;
         }
      }
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // messageConsideration
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.messageConsideration = new  NC1_Apercu3D_ELEM_2_messageConsideration();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.messageConsideration.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "messageConsideration");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("messageConsideration", "", "");
         this.messageConsideration.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_Apercu3D_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:apercu3d","NC1_Apercu3D")
      };
      static NC1_Apercu3D_CC() {
         XBUtil.license =  _NC1_Apercu3D.license;
      }
      ...
      //content fields
      protected  NC1_Apercu3D_ELEM nC1_Apercu3D;

      //content methods

      public  NC1_Apercu3D_ELEM NC1_Apercu3D
      {
         get
         {
            if (this.nC1_Apercu3D == null)
                throw new XBException("field nC1_Apercu3D not set");

            return this.nC1_Apercu3D;
         }
         set
         {
            this.nC1_Apercu3D = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_Apercu3D.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_Apercu3D = new  NC1_Apercu3D_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_Apercu3D.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_Apercu3D");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_Apercu3D",  _NC1_Apercu3D.NS_URI,  _NC1_Apercu3D.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_Apercu3D.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_Apercu3D {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:apercu3d";
      public static readonly String NS_PREFIX = "nc1apercu3d";
 ...
 */
      ...
      public _NC1_Apercu3D() {
      }
      static _NC1_Apercu3D() {
         XBUtil.license = _NC1_Apercu3D.license;
      }
   }
}
