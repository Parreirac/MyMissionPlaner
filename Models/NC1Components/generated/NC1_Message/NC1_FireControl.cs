...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_FireControl_ELEM_2_fireMissionCommand_adjustment : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:firecontrol",
          "NC1_FireControl_ELEM_2_fireMissionCommand_adjustment");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","NS"),
         new XBQualifiedName("","EW"),
         new XBQualifiedName("","Z")
      };
      static NC1_FireControl_ELEM_2_fireMissionCommand_adjustment() {
         XBUtil.license =  _NC1_FireControl.license;
      }
      ...
      public short NS
      {
         get
         {
            if (!_set_nS) throw new XBException("field nS not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.nS =  IntMinus999To999Type.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.eW =  IntMinus999To999Type.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.z =  IntMinus999To999Type.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // nS
         if (_set_nS)  {
            encoder.encodeStartElement("NS", "", "");
            String text_4;
            text_4 =  IntMinus999To999Type.encode(this.nS, xbContext);
         ...
         if (_set_eW)  {
            ...
            String text_4;
            text_4 =  IntMinus999To999Type.encode(this.eW, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_z)  {
            ...
            String text_4;
            text_4 =  IntMinus999To999Type.encode(this.z, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_FireControl_ELEM_2_fireMissionCommand : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:firecontrol",
          "NC1_FireControl_ELEM_2_fireMissionCommand");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","missionCommandType"),
         new XBQualifiedName("","adjustment")
      };
      static NC1_FireControl_ELEM_2_fireMissionCommand() {
         XBUtil.license =  _NC1_FireControl.license;
      }
      ...
      protected int missionCommandType;
      protected  NC1_FireControl_ELEM_2_fireMissionCommand_adjustment adjustment;
            //optional
      ...
      public int MissionCommandType
      {
         get { return this.missionCommandType; }
         set { this.missionCommandType = value; }
      }

      public  NC1_FireControl_ELEM_2_fireMissionCommand_adjustment Adjustment
      {
         get
         {
            if (this.adjustment == null)
                throw new XBException("field adjustment not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.missionCommandType =  L114_30Code.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "missionCommandType");

               // adjustment
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.adjustment = new  NC1_FireControl_ELEM_2_fireMissionCommand_adjustment();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.adjustment.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // missionCommandType
         encoder.encodeStartElement("missionCommandType", "", "");
         String text_3;
         text_3 =  L114_30Code.encode(this.missionCommandType, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // adjustment
         if (this.adjustment != null)  {
            encoder.encodeStartElement("adjustment", "", "");
            this.adjustment.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_FireControl_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:firecontrol",
          "NC1_FireControl_ELEM");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","fireMissionCommand")
      };
      static NC1_FireControl_ELEM() {
         XBUtil.license =  _NC1_FireControl.license;
      }
      ...
      //content fields
      protected  NC1_FireControl_ELEM_2_fireMissionCommand fireMissionCommand;
      ...
      public  NC1_FireControl_ELEM_2_fireMissionCommand FireMissionCommand
      {
         get
         {
            if (this.fireMissionCommand == null)
                throw new XBException("field fireMissionCommand not set");

            return this.fireMissionCommand;
         }
         set
         {
            this.fireMissionCommand = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.fireMissionCommand = new  NC1_FireControl_ELEM_2_fireMissionCommand();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.fireMissionCommand.decode(reader, xbContext, false, false);

                  moreContent_4 = 
                     XMLStreamHelper.moveToContentElement(reader);
               }
               else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
               else throw new XBOccurrencesException(0, "fireMissionCommand");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("fireMissionCommand", "", "");
         this.fireMissionCommand.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   ...
   public class NC1_FireControl_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:firecontrol","NC1_FireControl")
      };
      static NC1_FireControl_CC() {
         XBUtil.license =  _NC1_FireControl.license;
      }
      ...
      //content fields
      protected  NC1_FireControl_ELEM nC1_FireControl;

      //content methods

      public  NC1_FireControl_ELEM NC1_FireControl
      {
         get
         {
            if (this.nC1_FireControl == null)
                throw new XBException("field nC1_FireControl not set");

            return this.nC1_FireControl;
         }
         set
         {
            this.nC1_FireControl = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_FireControl.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_FireControl = new  NC1_FireControl_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_FireControl.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_FireControl");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_FireControl",  _NC1_FireControl.NS_URI,  _NC1_FireControl.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_FireControl.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_FireControl {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:firecontrol";
      public static readonly String NS_PREFIX = "nc1firecontrol";
 ...
 */
      ...
      public _NC1_FireControl() {
      }
      static _NC1_FireControl() {
         XBUtil.license = _NC1_FireControl.license;
      }
   }
}
