...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_CreationItsAts_ELEM_2_createdITSorATS : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:creationitsats",
          "NC1_CreationItsAts_ELEM_2_createdITSorATS");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","createdITSorATS")
      };
      static NC1_CreationItsAts_ELEM_2_createdITSorATS() {
         XBUtil.license =  _NC1_CreationItsAts.license;
      }
      ...
      //content fields
      protected  AcmWezType createdITSorATS;

      //attribute methods

      //content methods

      public  AcmWezType CreatedITSorATS
      {
         get
         {
            if (this.createdITSorATS == null)
                throw new XBException("field createdITSorATS not set");

            return this.createdITSorATS;
         }
         set
         {
            this.createdITSorATS = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.createdITSorATS = new  AcmWezType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.createdITSorATS.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "createdITSorATS");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("createdITSorATS", "", "");
         this.createdITSorATS.encode(encoder, xbContext, null, false);
   ...
   public class NC1_CreationItsAts_ELEM_2_additionalInformation : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:creationitsats",
          "NC1_CreationItsAts_ELEM_2_additionalInformation");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","purpose"),
         new XBQualifiedName("","optReference"),
         new XBQualifiedName("","callsign"),
         new XBQualifiedName("","channelNumber"),
         new XBQualifiedName("","comment")
      };
      static NC1_CreationItsAts_ELEM_2_additionalInformation() {
         XBUtil.license =  _NC1_CreationItsAts.license;
      }
      ...
      protected bool _set_purpose = false;
      protected string optReference;
      protected bool _set_optReference = false;
      protected string callsign;
      protected byte channelNumber;
      protected bool _set_channelNumber = false;
      ...
      public string Purpose
      {
         get
         {
            if (!_set_purpose) throw new XBException("field purpose not set");
      ...
      public string OptReference
      {
         get
         {
            if (!_set_optReference)
                throw new XBException("field optReference not set");

            return this.optReference;
         }
         set
         {
            this.optReference = value;
            _set_optReference = true;
         }
      }
      ...
      public byte ChannelNumber
      {
         get
         {
            if (!_set_channelNumber)
                throw new XBException("field channelNumber not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.purpose =  LongTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.optReference =  MediumTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.callsign =  MediumTextType.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "callsign");
                  ...
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.channelNumber =  Int0To99Type.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // purpose
         if (_set_purpose)  {
            encoder.encodeStartElement("purpose", "", "");
            text_3 =  LongTextType.encode(this.purpose, xbContext);
         ...
         // optReference
         if (_set_optReference)  {
            encoder.encodeStartElement("optReference", "", "");
            text_3 =  MediumTextType.encode(this.optReference, xbContext);
            encoder.encodeChars(text_3);
            encoder.encodeEndElement();
         }

         // callsign
         encoder.encodeStartElement("callsign", "", "");
         text_3 =  MediumTextType.encode(this.callsign, xbContext);
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();

         // channelNumber
         if (_set_channelNumber)  {
            encoder.encodeStartElement("channelNumber", "", "");
            text_3 =  Int0To99Type.encode(this.channelNumber, xbContext);
            encoder.encodeCharsNoEscaping(text_3);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_CreationItsAts_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:creationitsats",
          "NC1_CreationItsAts_ELEM");
      ...
      static NC1_CreationItsAts_ELEM() {
         XBUtil.license =  _NC1_CreationItsAts.license;
      }
      ...
      //content fields
      protected  NC1_CreationItsAts_ELEM_2_createdITSorATS createdITSorATS;
         
      protected  NC1_CreationItsAts_ELEM_2_additionalInformation additionalInformation;
      ...
      public  NC1_CreationItsAts_ELEM_2_createdITSorATS CreatedITSorATS
      {
         get
         {
            if (this.createdITSorATS == null)
      ...
      public  NC1_CreationItsAts_ELEM_2_additionalInformation AdditionalInformation
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.createdITSorATS = new  NC1_CreationItsAts_ELEM_2_createdITSorATS();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.createdITSorATS.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.additionalInformation = new  NC1_CreationItsAts_ELEM_2_additionalInformation();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.additionalInformation.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "additionalInformation");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         this.additionalInformation.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_CreationItsAts_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:creationitsats","NC1_CreationItsAts")
      };
      static NC1_CreationItsAts_CC() {
         XBUtil.license =  _NC1_CreationItsAts.license;
      }
      ...
      //content fields
      protected  NC1_CreationItsAts_ELEM nC1_CreationItsAts;

      //content methods

      public  NC1_CreationItsAts_ELEM NC1_CreationItsAts
      {
         get
         {
            if (this.nC1_CreationItsAts == null)
                throw new XBException("field nC1_CreationItsAts not set");

            return this.nC1_CreationItsAts;
         }
         set
         {
            this.nC1_CreationItsAts = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CreationItsAts.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CreationItsAts = new  NC1_CreationItsAts_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CreationItsAts.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CreationItsAts");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CreationItsAts",  _NC1_CreationItsAts.NS_URI,  _NC1_CreationItsAts.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CreationItsAts.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CreationItsAts {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:creationitsats";
      public static readonly String NS_PREFIX = "nc1creationitsats";
 ...
 */
      ...
      public _NC1_CreationItsAts() {
      }
      static _NC1_CreationItsAts() {
         XBUtil.license = _NC1_CreationItsAts.license;
      }
   }
}
