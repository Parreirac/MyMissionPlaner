...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_EOINCREP_ELEM_2__2_reportingUnit : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:eoincrep",
          "NC1_EOINCREP_ELEM_2__2_reportingUnit");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","reportingUnitId"),
         new XBQualifiedName("","reportingUnitDescription")
      };

      public enum Choice  {
         None, reportingUnitId, reportingUnitDescription}
      protected Choice _whichField;
      static NC1_EOINCREP_ELEM_2__2_reportingUnit() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }
      ...
      //content fields
      protected  Nc1ObjectRefType reportingUnitId;
      protected string reportingUnitDescription;

      //attribute methods

      //content methods

      public  Nc1ObjectRefType ReportingUnitId
      {
         get
         {
            if (_whichField != Choice.reportingUnitId ) 
               throw new XBException("field reportingUnitId not set");
            return this.reportingUnitId;
         }
         set
         {
            this.reportingUnitId = value;
            _whichField = Choice.reportingUnitId;
         }
      }

      public string ReportingUnitDescription
      {
         get
         {
            if (_whichField != Choice.reportingUnitDescription ) 
               throw new XBException("field reportingUnitDescription not set");
            return this.reportingUnitDescription;
         }
         set
         {
            this.reportingUnitDescription = value;
            _whichField = Choice.reportingUnitDescription;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.reportingUnitId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.reportingUnitId.decode(reader, xbContext, false, false);
                  _whichField = Choice.reportingUnitId;
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  this.reportingUnitDescription =  MediumTextType.decode(text, xbContext);
                  _whichField = Choice.reportingUnitDescription;
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            // reportingUnitId
            case Choice.reportingUnitId: {
               if (_whichField != Choice.reportingUnitId ) 
                  throw new XBException("field reportingUnitId not set");
               encoder.encodeStartElement("reportingUnitId", "", "");
               this.reportingUnitId.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
               break;
            }

            // reportingUnitDescription
            case Choice.reportingUnitDescription: {
               if (_whichField != Choice.reportingUnitDescription ) 
                  throw new XBException("field reportingUnitDescription not set");
               encoder.encodeStartElement("reportingUnitDescription", "", "");
               String text_5;
               text_5 =  MediumTextType.encode(this.reportingUnitDescription, xbContext);
   ...
   public class NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription_type : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:eoincrep",
          "NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription_type");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","IEDType"),
         new XBQualifiedName("","UXOType")
      };

      public enum Choice  {
         None, iEDType, uXOType}
      protected Choice _whichField;
      static NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription_type() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }
      ...
      //content fields
      protected int iEDType;
      protected int uXOType;
      ...
      public int IEDType
      {
         get
         {
            if (_whichField != Choice.iEDType ) 
               throw new XBException("field iEDType not set");
            return this.iEDType;
         }
         set
         {
            this.iEDType = value;
            _whichField = Choice.iEDType;
         }
      }
      ...
      public int UXOType
      {
         get
         {
            if (_whichField != Choice.uXOType ) 
               throw new XBException("field uXOType not set");
            return this.uXOType;
         }
         set
         {
            this.uXOType = value;
            _whichField = Choice.uXOType;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.iEDType =  IEDTypeCode.decode(text, xbContext);
                  _whichField = Choice.iEDType;
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.uXOType =  UXOTypeCode.decode(text, xbContext);
                  _whichField = Choice.uXOType;
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            case Choice.iEDType: {
               if (_whichField != Choice.iEDType ) 
                  throw new XBException("field iEDType not set");
               encoder.encodeStartElement("IEDType", "", "");
               String text_5;
               text_5 =  IEDTypeCode.encode(this.iEDType, xbContext);
            ...
            case Choice.uXOType: {
               if (_whichField != Choice.uXOType ) 
                  throw new XBException("field uXOType not set");
               encoder.encodeStartElement("UXOType", "", "");
               String text_5;
               text_5 =  UXOTypeCode.encode(this.uXOType, xbContext);
               encoder.encodeCharsNoEscaping(text_5);
               encoder.encodeEndElement();
               break;
            }
   ...
   public class EOEmplacementCode
   {
      static EOEmplacementCode() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }

      //constructor
      private EOEmplacementCode() {} 
   ...
   public class NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:eoincrep",
          "NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","emplacement"),
         new XBQualifiedName("","shape"),
         new XBQualifiedName("","colour"),
         new XBQualifiedName("","description")
      };
      static NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }
      ...
      //content fields
      protected  NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription_type type;
      ...
      public  NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription_type Type
      {
         get
         {
            if (this.type == null)
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.type = new  NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription_type();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.emplacement =  EOEmplacementCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "emplacement");
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.shape =  EOShapeCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "shape");
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.colour =  EOColourCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "colour");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // emplacement
         encoder.encodeStartElement("emplacement", "", "");
         String text_3;
         text_3 =  EOEmplacementCode.encode(this.emplacement, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // shape
         encoder.encodeStartElement("shape", "", "");
         text_3 =  EOShapeCode.encode(this.shape, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // colour
         encoder.encodeStartElement("colour", "", "");
         text_3 =  EOColourCode.encode(this.colour, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();
         ...
         if (_set_description)  {
            ...
            text_3 =  MediumTextType.encode(this.description, xbContext);
   ...
   public class NC1_EOINCREP_ELEM_2__5_LULocation_RVPoint : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:eoincrep",
          "NC1_EOINCREP_ELEM_2__5_LULocation_RVPoint");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","tacticalPoint"),
         new XBQualifiedName("","point"),
         new XBQualifiedName("","unitLocation")
      };

      public enum Choice  {
         None, tacticalPoint, point, unitLocation}
      protected Choice _whichField;
      static NC1_EOINCREP_ELEM_2__5_LULocation_RVPoint() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }
      ...
      //content fields
      protected  TacPointType tacticalPoint;
      protected  PointType point;
      protected  UnitType unitLocation;

      //attribute methods

      //content methods

      public  TacPointType TacticalPoint
      {
         get
         {
            if (_whichField != Choice.tacticalPoint ) 
               throw new XBException("field tacticalPoint not set");
            return this.tacticalPoint;
         }
         set
         {
            this.tacticalPoint = value;
            _whichField = Choice.tacticalPoint;
         }
      }
      ...
      public  UnitType UnitLocation
      {
         get
         {
            if (_whichField != Choice.unitLocation ) 
               throw new XBException("field unitLocation not set");
            return this.unitLocation;
         }
         set
         {
            this.unitLocation = value;
            _whichField = Choice.unitLocation;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if ( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.tacticalPoint = new  TacPointType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.tacticalPoint.decode(reader, xbContext, false, false);
                  _whichField = Choice.tacticalPoint;
               ...
               // unitLocation
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.unitLocation = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.unitLocation.decode(reader, xbContext, false, false);
                  _whichField = Choice.unitLocation;
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            // tacticalPoint
            case Choice.tacticalPoint: {
               if (_whichField != Choice.tacticalPoint ) 
                  throw new XBException("field tacticalPoint not set");
               encoder.encodeStartElement("tacticalPoint", "", "");
               this.tacticalPoint.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
               break;
            }
            ...
            // unitLocation
            case Choice.unitLocation: {
               if (_whichField != Choice.unitLocation ) 
                  throw new XBException("field unitLocation not set");
               encoder.encodeStartElement("unitLocation", "", "");
               this.unitLocation.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
               break;
            }
            default: throw new XBException("no field set for choice group");
   ...
   public class NC1_EOINCREP_ELEM_2__5_LULocation : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:eoincrep",
          "NC1_EOINCREP_ELEM_2__5_LULocation");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","RVPoint"),
         new XBQualifiedName("","safeRouteToRV")
      };
      static NC1_EOINCREP_ELEM_2__5_LULocation() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }
      ...
      //content fields
      protected  NC1_EOINCREP_ELEM_2__5_LULocation_RVPoint rVPoint;
      protected  RouteType safeRouteToRV;   //optional

      //attribute methods

      //content methods

      public  NC1_EOINCREP_ELEM_2__5_LULocation_RVPoint RVPoint
      {
         get
         {
            if (this.rVPoint == null)
                throw new XBException("field rVPoint not set");
      ...
      public  RouteType SafeRouteToRV
      {
         get
         {
            if (this.safeRouteToRV == null)
                throw new XBException("field safeRouteToRV not set");

            return this.safeRouteToRV;
         }
         set
         {
            this.safeRouteToRV = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.rVPoint = new  NC1_EOINCREP_ELEM_2__5_LULocation_RVPoint();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.rVPoint.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "rVPoint");

               // safeRouteToRV
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.safeRouteToRV = new  RouteType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.safeRouteToRV.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("RVPoint", "", "");
         this.rVPoint.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // safeRouteToRV
         if (this.safeRouteToRV != null)  {
            encoder.encodeStartElement("safeRouteToRV", "", "");
            this.safeRouteToRV.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class EffectOnOperationCode
   {
      static EffectOnOperationCode() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }

      //constructor
      private EffectOnOperationCode() {} 
   ...
   public class NC1_EOINCREP_ELEM_2__7_tacticalSituation : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:eoincrep",
          "NC1_EOINCREP_ELEM_2__7_tacticalSituation");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","effectOnOperation"),
         new XBQualifiedName("","description")
      };
      static NC1_EOINCREP_ELEM_2__7_tacticalSituation() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }
      ...
      //content fields
      protected int effectOnOperation;
      protected bool _set_effectOnOperation = false;
      protected string description;
      protected bool _set_description = false;
      ...
      public int EffectOnOperation
      {
         get
         {
            if (!_set_effectOnOperation)
                throw new XBException("field effectOnOperation not set");

            return this.effectOnOperation;
         }
         set
         {
            this.effectOnOperation = value;
            _set_effectOnOperation = true;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.effectOnOperation =  EffectOnOperationCode.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // effectOnOperation
         if (_set_effectOnOperation)  {
            encoder.encodeStartElement("effectOnOperation", "", "");
            String text_4;
            text_4 =  EffectOnOperationCode.encode(this.effectOnOperation, xbContext);
   ...
   public class EOIncidentPriorityCode
   {
      static EOIncidentPriorityCode() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }

      //constructor
      private EOIncidentPriorityCode() {} 
   ...
   public class NC1_EOINCREP_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:eoincrep",
          "NC1_EOINCREP_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","_1_datetime"),
         new XBQualifiedName("","_2_reportingUnit"),
         new XBQualifiedName("","_3_EOTypeAndDescription"),
         new XBQualifiedName("","_4_EOLocation"),
         new XBQualifiedName("","_5_LULocation"),
         new XBQualifiedName("","_6_comData"),
         new XBQualifiedName("","_7_tacticalSituation"),
         new XBQualifiedName("","_8_collateralDamage"),
         new XBQualifiedName("","_9_protectiveActions"),
         new XBQualifiedName("","_10_priority"),
         new XBQualifiedName("","comment")
      };
      static NC1_EOINCREP_ELEM() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }
      ...
      //content fields
      protected string _1_datetime;
      protected  NC1_EOINCREP_ELEM_2__2_reportingUnit _2_reportingUnit;
      protected  NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription _3_EOTypeAndDescription;
         
      protected  PointType _4_EOLocation;
      protected  NC1_EOINCREP_ELEM_2__5_LULocation _5_LULocation;
      protected  UnitType _6_comData;
      protected  NC1_EOINCREP_ELEM_2__7_tacticalSituation _7_tacticalSituation;
         
      protected string _8_collateralDamage;
      protected string _9_protectiveActions;
      protected int _10_priority;
      ...
      public string _1_datetimeProperty
      {
         get { return this._1_datetime; }
         set { this._1_datetime = value; }
      }

      public  NC1_EOINCREP_ELEM_2__2_reportingUnit _2_reportingUnitProperty
      {
         get
         {
            if (this._2_reportingUnit == null)
                throw new XBException("field _2_reportingUnit not set");

            return this._2_reportingUnit;
         }
         set
         {
            this._2_reportingUnit = value;
         }
      }

      public  NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription _3_EOTypeAndDescriptionProperty
      {
         get
         {
            if (this._3_EOTypeAndDescription == null)
                throw new XBException("field _3_EOTypeAndDescription not set");

            return this._3_EOTypeAndDescription;
         }
         set
         {
            this._3_EOTypeAndDescription = value;
         }
      }

      public  PointType _4_EOLocationProperty
      {
         get
         {
            if (this._4_EOLocation == null)
                throw new XBException("field _4_EOLocation not set");

            return this._4_EOLocation;
         }
         set
         {
            this._4_EOLocation = value;
         }
      }

      public  NC1_EOINCREP_ELEM_2__5_LULocation _5_LULocationProperty
      {
         get
         {
            if (this._5_LULocation == null)
                throw new XBException("field _5_LULocation not set");

            return this._5_LULocation;
         }
         set
         {
            this._5_LULocation = value;
         }
      }

      public  UnitType _6_comDataProperty
      {
         get
         {
            if (this._6_comData == null)
                throw new XBException("field _6_comData not set");

            return this._6_comData;
         }
         set
         {
            this._6_comData = value;
         }
      }

      public  NC1_EOINCREP_ELEM_2__7_tacticalSituation _7_tacticalSituationProperty
      {
         get
         {
            if (this._7_tacticalSituation == null)
                throw new XBException("field _7_tacticalSituation not set");

            return this._7_tacticalSituation;
         }
         set
         {
            this._7_tacticalSituation = value;
         }
      }

      public string _8_collateralDamageProperty
      {
         get { return this._8_collateralDamage; }
         set { this._8_collateralDamage = value; }
      }

      public string _9_protectiveActionsProperty
      {
         get { return this._9_protectiveActions; }
         set { this._9_protectiveActions = value; }
      }

      public int _10_priorityProperty
      {
         get { return this._10_priority; }
         set { this._10_priority = value; }
      }
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               else throw new XBOccurrencesException(0, "_1_datetime");

               // _2_reportingUnit
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this._2_reportingUnit = new  NC1_EOINCREP_ELEM_2__2_reportingUnit();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._2_reportingUnit.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "_2_reportingUnit");

               // _3_EOTypeAndDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this._3_EOTypeAndDescription = new  NC1_EOINCREP_ELEM_2__3_EOTypeAndDescription();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._3_EOTypeAndDescription.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "_3_EOTypeAndDescription");

               // _4_EOLocation
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this._4_EOLocation = new  PointType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._4_EOLocation.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "_4_EOLocation");

               // _5_LULocation
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  this._5_LULocation = new  NC1_EOINCREP_ELEM_2__5_LULocation();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._5_LULocation.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "_5_LULocation");

               // _6_comData
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[5], elemNs, elemLocalName) )
               {
                  this._6_comData = new  UnitType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._6_comData.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "_6_comData");

               // _7_tacticalSituation
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[6], elemNs, elemLocalName) )
               {
                  this._7_tacticalSituation = new  NC1_EOINCREP_ELEM_2__7_tacticalSituation();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this._7_tacticalSituation.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "_7_tacticalSituation");
                  ...
                  (XBQualifiedName)particleInfo[7], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this._8_collateralDamage =  MediumTextType.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "_8_collateralDamage");

               // _9_protectiveActions
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[8], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this._9_protectiveActions =  MediumTextType.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "_9_protectiveActions");
                  ...
                  (XBQualifiedName)particleInfo[9], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this._10_priority =  EOIncidentPriorityCode.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "_10_priority");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // _1_datetime
         encoder.encodeStartElement("_1_datetime", "", "");
         String text_3;
         text_3 = this._1_datetime;
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("_2_reportingUnit", "", "");
         this._2_reportingUnit.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("_3_EOTypeAndDescription", "", "");
         this._3_EOTypeAndDescription.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("_4_EOLocation", "", "");
         this._4_EOLocation.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("_5_LULocation", "", "");
         this._5_LULocation.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("_6_comData", "", "");
         this._6_comData.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("_7_tacticalSituation", "", "");
         this._7_tacticalSituation.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // _8_collateralDamage
         encoder.encodeStartElement("_8_collateralDamage", "", "");
         text_3 =  MediumTextType.encode(this._8_collateralDamage, xbContext);
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();

         // _9_protectiveActions
         encoder.encodeStartElement("_9_protectiveActions", "", "");
         text_3 =  MediumTextType.encode(this._9_protectiveActions, xbContext);
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();

         // _10_priority
         encoder.encodeStartElement("_10_priority", "", "");
         text_3 =  EOIncidentPriorityCode.encode(this._10_priority, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();
   ...
   public class NC1_EOINCREP_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:eoincrep","NC1_EOINCREP")
      };
      static NC1_EOINCREP_CC() {
         XBUtil.license =  _NC1_EOINCREP.license;
      }
      ...
      //content fields
      protected  NC1_EOINCREP_ELEM nC1_EOINCREP;

      //content methods

      public  NC1_EOINCREP_ELEM NC1_EOINCREP
      {
         get
         {
            if (this.nC1_EOINCREP == null)
                throw new XBException("field nC1_EOINCREP not set");

            return this.nC1_EOINCREP;
         }
         set
         {
            this.nC1_EOINCREP = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_EOINCREP.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_EOINCREP = new  NC1_EOINCREP_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_EOINCREP.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_EOINCREP");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_EOINCREP",  _NC1_EOINCREP.NS_URI,  _NC1_EOINCREP.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_EOINCREP.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_EOINCREP {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:eoincrep";
      public static readonly String NS_PREFIX = "nc1eoincrep";
 ...
 */
      ...
      public _NC1_EOINCREP() {
      }
      static _NC1_EOINCREP() {
         XBUtil.license = _NC1_EOINCREP.license;
      }
   }
}
