...
namespace NC1.Msg
{
   ...
   public class NC1_Request_ELEM_3
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:request",
          "NC1_Request_ELEM_3");
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("","messageType"),
         new XBQualifiedName("","messageId"),
         new XBQualifiedName("","objectId"),
         new XBQualifiedName("","information")
      };
      ...
      public enum Choice  {
         None, messageType, messageId, objectId, information}
      protected Choice _whichField;
      static NC1_Request_ELEM_3() {
         XBUtil.license =  _NC1_Request.license;
      }
      ...
      protected  Nc1ObjectRefType objectId;
      ...
      public int MessageType
      {
         get
         {
            if (_whichField != Choice.messageType ) 
               throw new XBException("field messageType not set");
            return this.messageType;
         }
         set
         {
            this.messageType = value;
            _whichField = Choice.messageType;
         }
      }
      ...
      public uint MessageId
      {
         get
         {
            if (_whichField != Choice.messageId ) 
               throw new XBException("field messageId not set");
            return this.messageId;
         }
         set
         {
            this.messageId = value;
            _whichField = Choice.messageId;
         }
      }

      public  Nc1ObjectRefType ObjectId
      {
         get
         {
            if (_whichField != Choice.objectId ) 
               throw new XBException("field objectId not set");
            return this.objectId;
         }
         set
         {
            this.objectId = value;
            _whichField = Choice.objectId;
         }
      }
      ...
      public string Information
      {
         get
         {
            if (_whichField != Choice.information ) 
               throw new XBException("field information not set");
            return this.information;
         }
         set
         {
            this.information = value;
            _whichField = Choice.information;
         }
      }
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
               ...
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               ...
               this.messageType =  Nc1MessageTypeCode.decode(text, xbContext);
               _whichField = Choice.messageType;
               ...
               (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
            {
               ...
               String text = reader.ReadString();
               text = XBSimpleType.whitespaceCollapse(text);
               this.messageId =  Nc1MessageIdType.decode(text, xbContext);
               _whichField = Choice.messageId;
            ...
            // objectId
               ...
               (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
            {
               this.objectId = new  Nc1ObjectRefType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.objectId.decode(reader, xbContext, false, false);
               _whichField = Choice.objectId;
               ...
               (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
            {
               xbContext.decodeSchemaLocationAttrs(reader);
               String text = reader.ReadString();
               this.information =  LongTextType.decode(text, xbContext);
               _whichField = Choice.information;
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            // messageType
            case Choice.messageType: {
               if (_whichField != Choice.messageType ) 
                  throw new XBException("field messageType not set");
               encoder.encodeStartElement("messageType", "", "");
               String text_5;
               text_5 =  Nc1MessageTypeCode.encode(this.messageType, xbContext);
            ...
            // messageId
            case Choice.messageId: {
               if (_whichField != Choice.messageId ) 
                  throw new XBException("field messageId not set");
               encoder.encodeStartElement("messageId", "", "");
               String text_5;
               text_5 =  Nc1MessageIdType.encode(this.messageId, xbContext);
               encoder.encodeCharsNoEscaping(text_5);
               encoder.encodeEndElement();
               break;
            }
            ...
            // objectId
            case Choice.objectId: {
               if (_whichField != Choice.objectId ) 
                  throw new XBException("field objectId not set");
               encoder.encodeStartElement("objectId", "", "");
               this.objectId.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
               break;
            }
            ...
            case Choice.information: {
               if (_whichField != Choice.information ) 
                  throw new XBException("field information not set");
               encoder.encodeStartElement("information", "", "");
               String text_5;
               text_5 =  LongTextType.encode(this.information, xbContext);
   ...
   public class NC1_Request_ELEM_2_request : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:request",
          "NC1_Request_ELEM_2_request");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","additionalInformation"),
         new XBQualifiedName("","recipientCategory"),
         new XBQualifiedName("","responseRequestedDatetime"),
         new XBQualifiedName("","onTimeRequestCycleDuration")
      };
      static NC1_Request_ELEM_2_request() {
         XBUtil.license =  _NC1_Request.license;
      }
      ...
      //content fields
      protected  NC1_Request_ELEM_3 nC1_Request_ELEM_3;
      protected string additionalInformation;
      protected bool _set_additionalInformation = false;
      protected string recipientCategory;
      protected bool _set_recipientCategory = false;
      protected  QualifiedDatetimeType responseRequestedDatetime;
            //optional
      protected XBDuration onTimeRequestCycleDuration;   //optional

      //attribute methods

      //content methods

      public  NC1_Request_ELEM_3 NC1_Request_ELEM_3
      {
         get
         {
            if (this.nC1_Request_ELEM_3 == null)
                throw new XBException("field nC1_Request_ELEM_3 not set");

            return this.nC1_Request_ELEM_3;
         }
         set
         {
            this.nC1_Request_ELEM_3 = value;
         }
      }
      ...
      public string AdditionalInformation
      {
         get
         {
            if (!_set_additionalInformation)
                throw new XBException("field additionalInformation not set");
         ...
         set
         {
            ...
            _set_additionalInformation = true;
         }
      }
      ...
      public string RecipientCategory
      {
         get
         {
            if (!_set_recipientCategory)
                throw new XBException("field recipientCategory not set");
         ...
         set
         {
            ...
            _set_recipientCategory = true;
         }
      }

      public  QualifiedDatetimeType ResponseRequestedDatetime
      {
         get
         {
            if (this.responseRequestedDatetime == null)
                throw new XBException("field responseRequestedDatetime not set");

            return this.responseRequestedDatetime;
         }
         set
         {
            this.responseRequestedDatetime = value;
         }
      }

      public XBDuration OnTimeRequestCycleDuration
      {
         get
         {
            if (this.onTimeRequestCycleDuration == null)
                throw new XBException("field onTimeRequestCycleDuration not set");

            return this.onTimeRequestCycleDuration;
         }
         set
         {
            this.onTimeRequestCycleDuration = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // nC1_Request_ELEM_3
               if( moreContent_4 && 
                   NC1_Request_ELEM_3.acceptsElem(elemNs, elemLocalName)
                   )
               {
                  this.nC1_Request_ELEM_3 = new  NC1_Request_ELEM_3();
                  this.nC1_Request_ELEM_3.decode(reader, xbContext);
               ...
               else throw new XBOccurrencesException(0, "nC1_Request_ELEM_3");
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.additionalInformation =  MediumTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.recipientCategory =  ShortTextType.decode(text, xbContext);
               ...
               // responseRequestedDatetime
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.responseRequestedDatetime = new  QualifiedDatetimeType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.responseRequestedDatetime.decode(reader, xbContext, false, false);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.onTimeRequestCycleDuration =  Duration10YearsType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         this.nC1_Request_ELEM_3.encode(encoder, xbContext);

         // additionalInformation
         if (_set_additionalInformation)  {
            encoder.encodeStartElement("additionalInformation", "", "");
            String text_4;
            text_4 =  MediumTextType.encode(this.additionalInformation, xbContext);
         ...
         // recipientCategory
         if (_set_recipientCategory)  {
            encoder.encodeStartElement("recipientCategory", "", "");
            String text_4;
            text_4 =  ShortTextType.encode(this.recipientCategory, xbContext);
            encoder.encodeChars(text_4);
            encoder.encodeEndElement();
         }
         ...
         // responseRequestedDatetime
         if (this.responseRequestedDatetime != null)  {
            encoder.encodeStartElement("responseRequestedDatetime", "", "");
            this.responseRequestedDatetime.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }
         ...
         // onTimeRequestCycleDuration
         if (this.onTimeRequestCycleDuration != null)  {
            encoder.encodeStartElement("onTimeRequestCycleDuration", "", "");
            String text_4;
            text_4 =  Duration10YearsType.encode(this.onTimeRequestCycleDuration, xbContext);
   ...
   public class NC1_Request_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:request",
          "NC1_Request_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","request"),
         new XBQualifiedName("","comment")
      };
      static NC1_Request_ELEM() {
         XBUtil.license =  _NC1_Request.license;
      }
      ...
      //content fields
      protected  NC1_Request_ELEM_2_request request;
      ...
      public  NC1_Request_ELEM_2_request Request
      {
         get
         {
            if (this.request == null)
                throw new XBException("field request not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.request = new  NC1_Request_ELEM_2_request();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.request.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "request");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("request", "", "");
         this.request.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_Request_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:request","NC1_Request")
      };
      static NC1_Request_CC() {
         XBUtil.license =  _NC1_Request.license;
      }
      ...
      //content fields
      protected  NC1_Request_ELEM nC1_Request;

      //content methods

      public  NC1_Request_ELEM NC1_Request
      {
         get
         {
            if (this.nC1_Request == null)
                throw new XBException("field nC1_Request not set");

            return this.nC1_Request;
         }
         set
         {
            this.nC1_Request = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_Request.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_Request = new  NC1_Request_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_Request.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_Request");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_Request",  _NC1_Request.NS_URI,  _NC1_Request.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_Request.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_Request {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:request";
      public static readonly String NS_PREFIX = "nc1request";
