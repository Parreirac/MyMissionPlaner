...
namespace NC1.Msg
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class NC1_BDA_ELEM_2_battleDamageAssessment_fireReference : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:bda",
          "NC1_BDA_ELEM_2_battleDamageAssessment_fireReference");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","fireId"),
         new XBQualifiedName("","fireTno")
      };

      public enum Choice  {
         None, fireId, fireTno}
      protected Choice _whichField;
      static NC1_BDA_ELEM_2_battleDamageAssessment_fireReference() {
         XBUtil.license =  _NC1_BDA.license;
      }
      ...
      //content fields
      protected  Nc1ObjectRefType fireId;
      protected string fireTno;

      //attribute methods

      //content methods

      public  Nc1ObjectRefType FireId
      {
         get
         {
            if (_whichField != Choice.fireId ) 
               throw new XBException("field fireId not set");
            return this.fireId;
         }
         set
         {
            this.fireId = value;
            _whichField = Choice.fireId;
         }
      }

      public string FireTno
      {
         get
         {
            if (_whichField != Choice.fireTno ) 
               throw new XBException("field fireTno not set");
            return this.fireTno;
         }
         set
         {
            this.fireTno = value;
            _whichField = Choice.fireTno;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                  this.fireId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.fireId.decode(reader, xbContext, false, false);
                  _whichField = Choice.fireId;
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  this.fireTno =  TnoType.decode(text, xbContext);
                  _whichField = Choice.fireTno;
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            // fireId
            case Choice.fireId: {
               encoder.encodeStartElement("fireId", "", "");
               this.fireId.encode(encoder, xbContext, null, false);
            ...
            // fireTno
            case Choice.fireTno: {
               encoder.encodeStartElement("fireTno", "", "");
               String text_5;
               text_5 =  TnoType.encode(this.fireTno, xbContext);
   ...
   public class NC1_BDA_ELEM_2_battleDamageAssessment_fireObjectiveReference : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:bda",
          "NC1_BDA_ELEM_2_battleDamageAssessment_fireObjectiveReference");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","fireObjectiveId"),
         new XBQualifiedName("","fireObjectiveTno")
      };

      public enum Choice  {
         None, fireObjectiveId, fireObjectiveTno}
      protected Choice _whichField;
      static NC1_BDA_ELEM_2_battleDamageAssessment_fireObjectiveReference() {
         XBUtil.license =  _NC1_BDA.license;
      }
      ...
      //content fields
      protected  Nc1ObjectRefType fireObjectiveId;
      protected string fireObjectiveTno;

      //attribute methods

      //content methods

      public  Nc1ObjectRefType FireObjectiveId
      {
         get
         {
            if (_whichField != Choice.fireObjectiveId ) 
               throw new XBException("field fireObjectiveId not set");
            return this.fireObjectiveId;
         }
         set
         {
            this.fireObjectiveId = value;
            _whichField = Choice.fireObjectiveId;
         }
      }

      public string FireObjectiveTno
      {
         get
         {
            if (_whichField != Choice.fireObjectiveTno ) 
               throw new XBException("field fireObjectiveTno not set");
            return this.fireObjectiveTno;
         }
         set
         {
            this.fireObjectiveTno = value;
            _whichField = Choice.fireObjectiveTno;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if ( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.fireObjectiveId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.fireObjectiveId.decode(reader, xbContext, false, false);
                  _whichField = Choice.fireObjectiveId;
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.fireObjectiveTno =  TnoType.decode(text, xbContext);
                  _whichField = Choice.fireObjectiveTno;
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            // fireObjectiveId
            case Choice.fireObjectiveId: {
               encoder.encodeStartElement("fireObjectiveId", "", "");
               this.fireObjectiveId.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
               break;
            }

            // fireObjectiveTno
            case Choice.fireObjectiveTno: {
               encoder.encodeStartElement("fireObjectiveTno", "", "");
               String text_5;
               text_5 =  TnoType.encode(this.fireObjectiveTno, xbContext);
               encoder.encodeChars(text_5);
               encoder.encodeEndElement();
               break;
            }
   ...
   public class SourceType : com.objsys.xbinder.runtime.XBComplexType
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","observerId"),
      ...
      //content fields
      protected  Nc1ObjectRefType observerId;   //optional
      ...
      public  Nc1ObjectRefType ObserverId
      {
         get
         {
            if (this.observerId == null)
                throw new XBException("field observerId not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.observerId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.observerId.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // observerId
         if (this.observerId != null)  {
            encoder.encodeStartElement("observerId", "", "");
            this.observerId.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_BDA_ELEM_2_battleDamageAssessment : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:bda",
          "NC1_BDA_ELEM_2_battleDamageAssessment");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","fireReference"),
         new XBQualifiedName("","fireObjectiveReference"),
         new XBQualifiedName("","damage"),
         new XBQualifiedName("","damageDescription"),
         new XBQualifiedName("","source")
      };
      static NC1_BDA_ELEM_2_battleDamageAssessment() {
         XBUtil.license =  _NC1_BDA.license;
      }
      ...
      //content fields
      protected  NC1_BDA_ELEM_2_battleDamageAssessment_fireReference fireReference;
            //optional
      protected  NC1_BDA_ELEM_2_battleDamageAssessment_fireObjectiveReference fireObjectiveReference;
            //optional
      protected int damage;
      protected string damageDescription;
      protected bool _set_damageDescription = false;
      protected  SourceType source;   //optional

      //attribute methods

      //content methods

      public  NC1_BDA_ELEM_2_battleDamageAssessment_fireReference FireReference
      {
         get
         {
            if (this.fireReference == null)
                throw new XBException("field fireReference not set");

            return this.fireReference;
         }
         set
         {
            this.fireReference = value;
         }
      }

      public  NC1_BDA_ELEM_2_battleDamageAssessment_fireObjectiveReference FireObjectiveReference
      {
         get
         {
            if (this.fireObjectiveReference == null)
                throw new XBException("field fireObjectiveReference not set");

            return this.fireObjectiveReference;
         }
         set
         {
            this.fireObjectiveReference = value;
         }
      }
      ...
      public string DamageDescription
      {
         get
         {
            if (!_set_damageDescription)
                throw new XBException("field damageDescription not set");
      ...
      public  SourceType Source
      {
         ...
         {
            if (this.source == null)
                throw new XBException("field source not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.fireReference = new  NC1_BDA_ELEM_2_battleDamageAssessment_fireReference();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.fireReference.decode(reader, xbContext, false, false);
               ...
               // fireObjectiveReference
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.fireObjectiveReference = new  NC1_BDA_ELEM_2_battleDamageAssessment_fireObjectiveReference();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.fireObjectiveReference.decode(reader, xbContext, false, false);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  this.damage =  L114_37Code.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "damage");
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.damageDescription =  MediumTextType.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  ...
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.source.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // fireReference
         if (this.fireReference != null)  {
            encoder.encodeStartElement("fireReference", "", "");
            this.fireReference.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // fireObjectiveReference
         if (this.fireObjectiveReference != null)  {
            encoder.encodeStartElement("fireObjectiveReference", "", "");
            this.fireObjectiveReference.encode(encoder, xbContext, null, 
               false);
            encoder.encodeEndElement();
         }

         // damage
         encoder.encodeStartElement("damage", "", "");
         String text_3;
         text_3 =  L114_37Code.encode(this.damage, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // damageDescription
         if (_set_damageDescription)  {
            encoder.encodeStartElement("damageDescription", "", "");
            text_3 =  MediumTextType.encode(this.damageDescription, xbContext);
         ...
         // source
         if (this.source != null)  {
            encoder.encodeStartElement("source", "", "");
            this.source.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class NC1_BDA_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:bda",
          "NC1_BDA_ELEM");
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","battleDamageAssessment"),
      ...
      //content fields
      protected  NC1_BDA_ELEM_2_battleDamageAssessment battleDamageAssessment;
      ...
      public  NC1_BDA_ELEM_2_battleDamageAssessment BattleDamageAssessment
      {
         get
         {
            if (this.battleDamageAssessment == null)
                throw new XBException("field battleDamageAssessment not set");

            return this.battleDamageAssessment;
         }
         set
         {
            this.battleDamageAssessment = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.battleDamageAssessment = new  NC1_BDA_ELEM_2_battleDamageAssessment();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.battleDamageAssessment.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "battleDamageAssessment");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("battleDamageAssessment", "", "");
         this.battleDamageAssessment.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_BDA_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:bda","NC1_BDA")
      };
      static NC1_BDA_CC() {
         XBUtil.license =  _NC1_BDA.license;
      }
      ...
      //content fields
      protected  NC1_BDA_ELEM nC1_BDA;

      //content methods

      public  NC1_BDA_ELEM NC1_BDA
      {
         get
         {
            if (this.nC1_BDA == null)
                throw new XBException("field nC1_BDA not set");
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_BDA.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_BDA = new  NC1_BDA_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_BDA.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_BDA");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_BDA",  _NC1_BDA.NS_URI,  _NC1_BDA.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_BDA.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_BDA {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:bda";
      public static readonly String NS_PREFIX = "nc1bda";
