...
namespace NC1.Msg
{
   ...
   public class NC1_STR_ELEM :  BaseMessageType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:message:str",
          "NC1_STR_ELEM");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","enemyForcesSituation"),
         new XBQualifiedName("","ownForcesSituation"),
         new XBQualifiedName("","environment"),
         new XBQualifiedName("","comment")
      };
      static NC1_STR_ELEM() {
         XBUtil.license =  _NC1_STR.license;
      }
      ...
      //content fields
      protected  MixedAnyType enemyForcesSituation;
      protected  MixedAnyType ownForcesSituation;
      protected  MixedAnyType environment;   //optional
      ...
      public  MixedAnyType EnemyForcesSituation
      {
         get
         {
            if (this.enemyForcesSituation == null)
                throw new XBException("field enemyForcesSituation not set");

            return this.enemyForcesSituation;
         }
         set
         {
            this.enemyForcesSituation = value;
         }
      }

      public  MixedAnyType OwnForcesSituation
      {
         get
         {
            if (this.ownForcesSituation == null)
                throw new XBException("field ownForcesSituation not set");

            return this.ownForcesSituation;
         }
         set
         {
            this.ownForcesSituation = value;
         }
      }

      public  MixedAnyType Environment
      {
         get
         {
            if (this.environment == null)
                throw new XBException("field environment not set");
      ...
      protected override bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               else throw new XBOccurrencesException(0, "enemyForcesSituation");

               // ownForcesSituation
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.ownForcesSituation = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.ownForcesSituation.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "ownForcesSituation");

               // environment
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.environment = new  MixedAnyType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.environment.decode(reader, xbContext, false, false);
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("enemyForcesSituation", "", "");
         this.enemyForcesSituation.encode(encoder, xbContext, null, false);
         ...
         encoder.encodeStartElement("ownForcesSituation", "", "");
         this.ownForcesSituation.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // environment
         if (this.environment != null)  {
            encoder.encodeStartElement("environment", "", "");
            this.environment.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class NC1_STR_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:message:str","NC1_STR")
      };
      static NC1_STR_CC() {
         XBUtil.license =  _NC1_STR.license;
      }
      ...
      //content fields
      protected  NC1_STR_ELEM nC1_STR;

      //content methods

      public  NC1_STR_ELEM NC1_STR
      {
         get
         {
            if (this.nC1_STR == null)
                throw new XBException("field nC1_STR not set");
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_STR.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_STR = new  NC1_STR_ELEM();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_STR.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_STR");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_STR",  _NC1_STR.NS_URI,  _NC1_STR.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_STR.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_STR {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:message:str";
      public static readonly String NS_PREFIX = "nc1str";
