...
namespace NC1.Obj.airparticipant
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class AirParticipantType_2_specificData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:airparticipant",
          "AirParticipantType_2_specificData");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","autonomy"),
         new XBQualifiedName("","activity"),
         new XBQualifiedName("","specificType"),
         new XBQualifiedName("","size")
      };
      static AirParticipantType_2_specificData() {
         XBUtil.license =  _NC1_AirParticipant.license;
      }
      ...
      //content fields
      protected byte autonomy;
      protected bool _set_autonomy = false;
      ...
      public byte Autonomy
      {
         ...
         {
            if (!_set_autonomy)
                throw new XBException("field autonomy not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.autonomy =  Int0To255Type.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.specificType =  L110_81Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // autonomy
         if (_set_autonomy)  {
            encoder.encodeStartElement("autonomy", "", "");
            String text_4;
            text_4 =  Int0To255Type.encode(this.autonomy, xbContext);
         ...
         if (_set_specificType)  {
            ...
            String text_4;
            text_4 =  L110_81Code.encode(this.specificType, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
   ...
   public class AirParticipantType :  ParticipantType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:airparticipant",
          "AirParticipantType");
      ...
      protected  AirParticipantType_2_specificData specificData;
            //optional
      ...
      public  AirParticipantType_2_specificData SpecificData
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.specificData = new  AirParticipantType_2_specificData();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_AirParticipant_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:airparticipant","NC1_AirParticipant")
      };
      static NC1_AirParticipant_CC() {
         XBUtil.license =  _NC1_AirParticipant.license;
      }
      ...
      //content fields
      protected  AirParticipantType nC1_AirParticipant;

      //content methods

      public  AirParticipantType NC1_AirParticipant
      {
         get
         {
            if (this.nC1_AirParticipant == null)
                throw new XBException("field nC1_AirParticipant not set");

            return this.nC1_AirParticipant;
         }
         set
         {
            this.nC1_AirParticipant = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_AirParticipant.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_AirParticipant = new  AirParticipantType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_AirParticipant.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_AirParticipant");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_AirParticipant",  _NC1_AirParticipant.NS_URI,  _NC1_AirParticipant.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_AirParticipant.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_AirParticipant {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:airparticipant";
      public static readonly String NS_PREFIX = "nc1airparticipant";
 ...
 */
      ...
      public _NC1_AirParticipant() {
      }
      static _NC1_AirParticipant() {
         XBUtil.license = _NC1_AirParticipant.license;
      }
   }
}
