...
namespace NC1.Obj.groundparticipant
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class GroundParticipantType_2_specificData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:groundparticipant",
          "GroundParticipantType_2_specificData");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","staffCount")
      };
      static GroundParticipantType_2_specificData() {
         XBUtil.license =  _NC1_GroundParticipant.license;
      }
      ...
      protected byte vehiclesCount;
      protected bool _set_vehiclesCount = false;
      protected byte staffCount;
      protected bool _set_staffCount = false;
      ...
      public byte StaffCount
      {
         get
         {
            if (!_set_staffCount)
                throw new XBException("field staffCount not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.specificType =  L110_83Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.vehiclesCount =  Int0To99Type.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.staffCount =  Int0To99Type.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_activity)  {
            ...
            String text_4;
            text_4 =  L115_1Code.encode(this.activity, xbContext);
         ...
         if (_set_specificType)  {
            ...
            String text_4;
            text_4 =  L110_83Code.encode(this.specificType, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_vehiclesCount)  {
            ...
            String text_4;
            text_4 =  Int0To99Type.encode(this.vehiclesCount, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // staffCount
         if (_set_staffCount)  {
            encoder.encodeStartElement("staffCount", "", "");
            String text_4;
            text_4 =  Int0To99Type.encode(this.staffCount, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class GroundParticipantType_13
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:groundparticipant",
          "GroundParticipantType_13");
      ...
      static GroundParticipantType_13() {
         XBUtil.license =  _NC1_GroundParticipant.license;
      }
   ...
   public class GroundParticipantType_2_location : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:groundparticipant",
          "GroundParticipantType_2_location");
      ...
      static GroundParticipantType_2_location() {
         XBUtil.license =  _NC1_GroundParticipant.license;
      }
      ...
      protected  GroundParticipantType_13 groundParticipantType_13;
            //optional
      ...
      public  GroundParticipantType_13 GroundParticipantType_13
      {
         get
         {
            if (this.groundParticipantType_13 == null)
                throw new XBException("field groundParticipantType_13 not set");

            return this.groundParticipantType_13;
         }
         set
         {
            this.groundParticipantType_13 = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // groundParticipantType_13
               if( moreContent_4 && 
                   GroundParticipantType_13.acceptsElem(elemNs, elemLocalName)
                   )
               {
                  this.groundParticipantType_13 = new  GroundParticipantType_13();
                  this.groundParticipantType_13.decode(reader, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // groundParticipantType_13
         if (this.groundParticipantType_13 != null)  {
            this.groundParticipantType_13.encode(encoder, xbContext);
         }
         ...
         if (_set_qxy)  {
            ...
            String text_4;
            text_4 =  Int0To999Type.encode(this.qxy, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_qz)  {
            ...
            String text_4;
            text_4 =  Int0To999Type.encode(this.qz, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_fireDirection)  {
            ...
            String text_4;
            text_4 =  AngleType.encode(this.fireDirection, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_observationDirection)  {
            ...
            String text_4;
            text_4 =  AngleType.encode(this.observationDirection, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_rotation)  {
            ...
            String text_4;
            text_4 =  AngleType.encode(this.rotation, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
   ...
   public class GroundParticipantType :  ParticipantType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:groundparticipant",
          "GroundParticipantType");
      ...
      protected  GroundParticipantType_2_specificData specificData;
            //optional
      protected  ComDataType comData;   //optional
      protected  StatusType status;   //optional
      protected  GroundParticipantType_2_location location;   //optional
      ...
      public  GroundParticipantType_2_specificData SpecificData
      {
         get
         {
      ...
      public  GroundParticipantType_2_location Location
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.specificData = new  GroundParticipantType_2_specificData();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  this.location = new  GroundParticipantType_2_location();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_GroundParticipant_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:groundparticipant","NC1_GroundParticipant")
      };
      static NC1_GroundParticipant_CC() {
         XBUtil.license =  _NC1_GroundParticipant.license;
      }
      ...
      //content fields
      protected  GroundParticipantType nC1_GroundParticipant;

      //content methods

      public  GroundParticipantType NC1_GroundParticipant
      {
         get
         {
            if (this.nC1_GroundParticipant == null)
                throw new XBException("field nC1_GroundParticipant not set");

            return this.nC1_GroundParticipant;
         }
         set
         {
            this.nC1_GroundParticipant = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_GroundParticipant.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            // nC1_GroundParticipant
            bool moreContent_4 = true;
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_GroundParticipant = new  GroundParticipantType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_GroundParticipant.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_GroundParticipant");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_GroundParticipant",  _NC1_GroundParticipant.NS_URI,  _NC1_GroundParticipant.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_GroundParticipant.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_GroundParticipant {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:groundparticipant";
      public static readonly String NS_PREFIX = "nc1groundparticipant";
 ...
 */
      ...
      public _NC1_GroundParticipant() {
      }
      static _NC1_GroundParticipant() {
         XBUtil.license = _NC1_GroundParticipant.license;
      }
   }
}
