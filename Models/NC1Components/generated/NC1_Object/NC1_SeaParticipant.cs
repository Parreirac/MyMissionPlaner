...
namespace NC1.Obj.seaparticipant
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    using NC1.Logistics;
    public class SeaParticipantType_2_specificData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:seaparticipant",
          "SeaParticipantType_2_specificData");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","size"),
         new XBQualifiedName("","laydown")
      };
      static SeaParticipantType_2_specificData() {
         XBUtil.license =  _NC1_SeaParticipant.license;
      }
      ...
      protected byte size;
      protected bool _set_size = false;
      protected int laydown;
      protected bool _set_laydown = false;
      ...
      public byte Size
      {
         get
         {
            if (!_set_size) throw new XBException("field size not set");
      ...
      public int Laydown
      {
         get
         {
            if (!_set_laydown) throw new XBException("field laydown not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.activity =  L140_1Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.specificType =  L110_82Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.size =  Int0To15Type.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.laydown =  L135_11Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_activity)  {
            ...
            String text_4;
            text_4 =  L140_1Code.encode(this.activity, xbContext);
         ...
         if (_set_specificType)  {
            ...
            String text_4;
            text_4 =  L110_82Code.encode(this.specificType, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // size
         if (_set_size)  {
            encoder.encodeStartElement("size", "", "");
            String text_4;
            text_4 =  Int0To15Type.encode(this.size, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // laydown
         if (_set_laydown)  {
            encoder.encodeStartElement("laydown", "", "");
            String text_4;
            text_4 =  L135_11Code.encode(this.laydown, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class SeaParticipantType :  ParticipantType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:seaparticipant",
          "SeaParticipantType");
      ...
      protected  SeaParticipantType_2_specificData specificData;
            //optional
      ...
      public  SeaParticipantType_2_specificData SpecificData
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.specificData = new  SeaParticipantType_2_specificData();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_SeaParticipant_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:seaparticipant","NC1_SeaParticipant")
      };
      static NC1_SeaParticipant_CC() {
         XBUtil.license =  _NC1_SeaParticipant.license;
      }
      ...
      //content fields
      protected  SeaParticipantType nC1_SeaParticipant;

      //content methods

      public  SeaParticipantType NC1_SeaParticipant
      {
         get
         {
            if (this.nC1_SeaParticipant == null)
                throw new XBException("field nC1_SeaParticipant not set");

            return this.nC1_SeaParticipant;
         }
         set
         {
            this.nC1_SeaParticipant = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_SeaParticipant.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_SeaParticipant = new  SeaParticipantType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_SeaParticipant.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_SeaParticipant");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_SeaParticipant",  _NC1_SeaParticipant.NS_URI,  _NC1_SeaParticipant.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_SeaParticipant.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_SeaParticipant {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:seaparticipant";
      public static readonly String NS_PREFIX = "nc1seaparticipant";
 ...
 */
      ...
      public _NC1_SeaParticipant() {
      }
      static _NC1_SeaParticipant() {
         XBUtil.license = _NC1_SeaParticipant.license;
      }
   }
}
