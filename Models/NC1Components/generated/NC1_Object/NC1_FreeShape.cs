...
namespace NC1.Obj.freeshape
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    using NC1.Location;
    public class FreeShapeType_2_tacticalData_style_point : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:freeshape",
          "FreeShapeType_2_tacticalData_style_point");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","color")
      };
      static FreeShapeType_2_tacticalData_style_point() {
         XBUtil.license =  _NC1_FreeShape.license;
      }
      ...
      protected int color;
      protected bool _set_color = false;
      ...
      public int Color
      {
         get
         {
            if (!_set_color) throw new XBException("field color not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.type =  L150_7Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.color =  L150_2Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_type)  {
            ...
            String text_4;
            text_4 =  L150_7Code.encode(this.type, xbContext);
         ...
         // color
         if (_set_color)  {
            encoder.encodeStartElement("color", "", "");
            String text_4;
            text_4 =  L150_2Code.encode(this.color, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class FreeShapeType_2_tacticalData_style_line : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:freeshape",
          "FreeShapeType_2_tacticalData_style_line");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","type"),
         new XBQualifiedName("","arrowType"),
         new XBQualifiedName("","color"),
         new XBQualifiedName("","thikness")
      };
      static FreeShapeType_2_tacticalData_style_line() {
         XBUtil.license =  _NC1_FreeShape.license;
      }
      ...
      protected bool _set_arrowType = false;
      protected int color;
      protected bool _set_color = false;
      protected int thikness;
      protected bool _set_thikness = false;
      ...
      public int ArrowType
      {
         ...
         {
            if (!_set_arrowType)
                throw new XBException("field arrowType not set");
      ...
      public int Thikness
      {
         ...
         {
            if (!_set_thikness)
                throw new XBException("field thikness not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.type =  L150_3Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.arrowType =  L150_5Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.thikness =  L150_4Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_type)  {
            encoder.encodeStartElement("type", "", "");
            String text_4;
            text_4 =  L150_3Code.encode(this.type, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // arrowType
         if (_set_arrowType)  {
            encoder.encodeStartElement("arrowType", "", "");
            String text_4;
            text_4 =  L150_5Code.encode(this.arrowType, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // thikness
         if (_set_thikness)  {
            encoder.encodeStartElement("thikness", "", "");
            String text_4;
            text_4 =  L150_4Code.encode(this.thikness, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class FreeShapeType_2_tacticalData_style_area : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:freeshape",
          "FreeShapeType_2_tacticalData_style_area");
      ...
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","type"),
         new XBQualifiedName("","outlineType"),
         new XBQualifiedName("","outlineColor"),
         new XBQualifiedName("","fillColor")
      };
      static FreeShapeType_2_tacticalData_style_area() {
         XBUtil.license =  _NC1_FreeShape.license;
      }
      ...
      protected bool _set_outlineType = false;
      protected int outlineColor;
      protected bool _set_outlineColor = false;
      protected int fillColor;
      protected bool _set_fillColor = false;
      ...
      public int OutlineType
      {
         ...
         {
            if (!_set_outlineType)
                throw new XBException("field outlineType not set");

            return this.outlineType;
         }
         set
         {
            this.outlineType = value;
            _set_outlineType = true;
         }
      }
      ...
      public int OutlineColor
      {
         get
         {
            if (!_set_outlineColor)
                throw new XBException("field outlineColor not set");
      ...
      public int FillColor
      {
         ...
         {
            if (!_set_fillColor)
                throw new XBException("field fillColor not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.type =  L150_6Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.outlineType =  L150_3Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.outlineColor =  L150_2Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.fillColor =  L150_2Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_type)  {
            encoder.encodeStartElement("type", "", "");
            String text_4;
            text_4 =  L150_6Code.encode(this.type, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // outlineType
         if (_set_outlineType)  {
            encoder.encodeStartElement("outlineType", "", "");
            String text_4;
            text_4 =  L150_3Code.encode(this.outlineType, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // outlineColor
         if (_set_outlineColor)  {
            encoder.encodeStartElement("outlineColor", "", "");
            String text_4;
            text_4 =  L150_2Code.encode(this.outlineColor, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // fillColor
         if (_set_fillColor)  {
            encoder.encodeStartElement("fillColor", "", "");
            String text_4;
            text_4 =  L150_2Code.encode(this.fillColor, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class FreeShapeType_2_tacticalData_style : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:freeshape",
          "FreeShapeType_2_tacticalData_style");
      ...
      static FreeShapeType_2_tacticalData_style() {
         XBUtil.license =  _NC1_FreeShape.license;
      }
      ...
      //content fields
      protected  FreeShapeType_2_tacticalData_style_point point;
      protected  FreeShapeType_2_tacticalData_style_line line;
      protected  FreeShapeType_2_tacticalData_style_area area;

      //attribute methods

      //content methods

      public  FreeShapeType_2_tacticalData_style_point Point
      {
         get
         {
      ...
      public  FreeShapeType_2_tacticalData_style_line Line
      {
         get
         {
            if (_whichField != Choice.line ) 
               throw new XBException("field line not set");
            return this.line;
         }
         set
         {
            this.line = value;
            _whichField = Choice.line;
         }
      }

      public  FreeShapeType_2_tacticalData_style_area Area
      {
         get
         {
            if (_whichField != Choice.area ) 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if ( XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.point = new  FreeShapeType_2_tacticalData_style_point();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               // line
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.line = new  FreeShapeType_2_tacticalData_style_line();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.line.decode(reader, xbContext, false, false);
                  _whichField = Choice.line;
               ...
               // area
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.area = new  FreeShapeType_2_tacticalData_style_area();
                  xbContext.decodeSchemaLocationAttrs(reader);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            case Choice.line: {
               if (_whichField != Choice.line ) 
                  throw new XBException("field line not set");
               encoder.encodeStartElement("line", "", "");
               this.line.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
               break;
            }
   ...
   public class FreeShapeType_2_tacticalData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:freeshape",
          "FreeShapeType_2_tacticalData");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","style"),
         new XBQualifiedName("","displayPeriod"),
         new XBQualifiedName("","url"),
         new XBQualifiedName("","comment"),
         new XBQualifiedName("","extVersion")
      };
      static FreeShapeType_2_tacticalData() {
         XBUtil.license =  _NC1_FreeShape.license;
      }
      ...
      protected  FreeShapeType_2_tacticalData_style style;
      protected  PeriodType displayPeriod;   //optional
      ...
      public  FreeShapeType_2_tacticalData_style Style
      {
         get
         {
            if (this.style == null)
                throw new XBException("field style not set");
      ...
      public  PeriodType DisplayPeriod
      {
         get
         {
            if (this.displayPeriod == null)
                throw new XBException("field displayPeriod not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.style = new  FreeShapeType_2_tacticalData_style();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.style.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "style");

               // displayPeriod
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.displayPeriod = new  PeriodType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.displayPeriod.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // style
         if (this.style == null) throw new XBException("field style not set");

         encoder.encodeStartElement("style", "", "");
         this.style.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // displayPeriod
         if (this.displayPeriod != null)  {
            encoder.encodeStartElement("displayPeriod", "", "");
            this.displayPeriod.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
   ...
   public class FreeShapeType_23
   {
      ...
      public enum Choice  {
         None, point, polyline, polygon, rectangle, circle, ellipse, arcband, 
            corridor}
      protected Choice _whichField;
      static FreeShapeType_23() {
         XBUtil.license =  _NC1_FreeShape.license;
      }
      ...
      public  RectangleType Rectangle
      {
         get
         {
            if (_whichField != Choice.rectangle ) 
               throw new XBException("field rectangle not set");
            return this.rectangle;
         }
         set
         {
            this.rectangle = value;
            _whichField = Choice.rectangle;
         }
      }
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            // rectangle
               ...
               (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
            {
               this.rectangle = new  RectangleType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.rectangle.decode(reader, xbContext, false, false);
               _whichField = Choice.rectangle;
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            case Choice.rectangle: {
               if (_whichField != Choice.rectangle ) 
                  throw new XBException("field rectangle not set");
               encoder.encodeStartElement("rectangle", "", "");
               this.rectangle.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
               break;
            }
   ...
   public class FreeShapeType_2_location : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:freeshape",
          "FreeShapeType_2_location");
      ...
      static FreeShapeType_2_location() {
         XBUtil.license =  _NC1_FreeShape.license;
      }
      ...
      //content fields
      protected  FreeShapeType_23 freeShapeType_23;

      //attribute methods

      //content methods

      public  FreeShapeType_23 FreeShapeType_23
      {
         get
         {
            if (this.freeShapeType_23 == null)
                throw new XBException("field freeShapeType_23 not set");

            return this.freeShapeType_23;
         }
         set
         {
            this.freeShapeType_23 = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // freeShapeType_23
               if( moreContent_4 && 
                   FreeShapeType_23.acceptsElem(elemNs, elemLocalName) )
               {
                  this.freeShapeType_23 = new  FreeShapeType_23();
                  this.freeShapeType_23.decode(reader, xbContext);
                  moreContent_4 = !XMLStreamHelper.isEndContent(reader);
               }
               else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
               else throw new XBOccurrencesException(0, "freeShapeType_23");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         this.freeShapeType_23.encode(encoder, xbContext);
      }
   ...
   public class FreeShapeType :  LocalisedObjectType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:freeshape",
          "FreeShapeType");
      ...
      //content fields
      protected  FreeShapeType_2_tacticalData tacticalData;   //optional
      protected  FreeShapeType_2_location location;

      //attribute methods

      //content methods

      public  FreeShapeType_2_tacticalData TacticalData
      {
         get
         {
      ...
      public  FreeShapeType_2_location Location
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.tacticalData = new  FreeShapeType_2_tacticalData();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.location = new  FreeShapeType_2_location();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_FreeShape_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:freeshape","NC1_FreeShape")
      };
      static NC1_FreeShape_CC() {
         XBUtil.license =  _NC1_FreeShape.license;
      }
      ...
      //content fields
      protected  FreeShapeType nC1_FreeShape;

      //content methods

      public  FreeShapeType NC1_FreeShape
      {
         get
         {
            if (this.nC1_FreeShape == null)
                throw new XBException("field nC1_FreeShape not set");

            return this.nC1_FreeShape;
         }
         set
         {
            this.nC1_FreeShape = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_FreeShape.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_FreeShape = new  FreeShapeType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_FreeShape.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_FreeShape");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_FreeShape",  _NC1_FreeShape.NS_URI,  _NC1_FreeShape.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_FreeShape.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_FreeShape {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:freeshape";
      public static readonly String NS_PREFIX = "nc1freeshape";
 ...
 */
      ...
      public _NC1_FreeShape() {
      }
      static _NC1_FreeShape() {
         XBUtil.license = _NC1_FreeShape.license;
      }
   }
}
