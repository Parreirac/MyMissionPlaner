...
namespace NC1.Obj.organisation
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    using NC1.Logistics;
    public class OrganisationType_9
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:organisation",
          "OrganisationType_9");
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("","civilianOrganisationType"),
         new XBQualifiedName("","militaryOrganisationType")
      };
      ...
      public enum Choice  {
         None, civilianOrganisationType, militaryOrganisationType}
      protected Choice _whichField;
      static OrganisationType_9() {
         XBUtil.license =  _NC1_Organisation.license;
      }
      ...
      //content fields
      protected int civilianOrganisationType;
      protected int militaryOrganisationType;

      //content methods

      public int CivilianOrganisationType
      {
         get
         {
            if (_whichField != Choice.civilianOrganisationType ) 
               throw new XBException("field civilianOrganisationType not set");
            return this.civilianOrganisationType;
         }
         set
         {
            this.civilianOrganisationType = value;
            _whichField = Choice.civilianOrganisationType;
         }
      }

      public int MilitaryOrganisationType
      {
         get
         {
            if (_whichField != Choice.militaryOrganisationType ) 
               throw new XBException("field militaryOrganisationType not set");
            return this.militaryOrganisationType;
         }
         set
         {
            this.militaryOrganisationType = value;
            _whichField = Choice.militaryOrganisationType;
         }
      }
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
               ...
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               ...
               this.civilianOrganisationType =  L110_31Code.decode(text, xbContext);
               _whichField = Choice.civilianOrganisationType;
               ...
               (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
            {
               ...
               String text = reader.ReadString();
               text = XBSimpleType.whitespaceCollapse(text);
               this.militaryOrganisationType =  L110_32Code.decode(text, xbContext);
               _whichField = Choice.militaryOrganisationType;
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            // civilianOrganisationType
            case Choice.civilianOrganisationType: {
               encoder.encodeStartElement("civilianOrganisationType", "", "");
               String text_5;
               text_5 =  L110_31Code.encode(this.civilianOrganisationType, xbContext);
            ...
            // militaryOrganisationType
            case Choice.militaryOrganisationType: {
               encoder.encodeStartElement("militaryOrganisationType", "", "");
               String text_5;
               text_5 =  L110_32Code.encode(this.militaryOrganisationType, xbContext);
               encoder.encodeCharsNoEscaping(text_5);
               encoder.encodeEndElement();
               break;
            }
   ...
   public class OrganisationType_2_tacticalData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:organisation",
          "OrganisationType_2_tacticalData");
      ...
      static OrganisationType_2_tacticalData() {
         XBUtil.license =  _NC1_Organisation.license;
      }
      ...
      protected  OrganisationType_9 organisationType_9;   //optional
      ...
      public  OrganisationType_9 OrganisationType_9
      {
         get
         {
            if (this.organisationType_9 == null)
                throw new XBException("field organisationType_9 not set");

            return this.organisationType_9;
         }
         set
         {
            this.organisationType_9 = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // organisationType_9
               if( moreContent_4 && 
                   OrganisationType_9.acceptsElem(elemNs, elemLocalName)
                   )
               {
                  this.organisationType_9 = new  OrganisationType_9();
                  this.organisationType_9.decode(reader, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // organisationType_9
         if (this.organisationType_9 != null)  {
            this.organisationType_9.encode(encoder, xbContext);
         }
   ...
   public class OrganisationType_2_location : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:organisation",
          "OrganisationType_2_location");
      ...
      static OrganisationType_2_location() {
         XBUtil.license =  _NC1_Organisation.license;
      }
   ...
   public class OrganisationType :  AgentType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:organisation",
          "OrganisationType");
      ...
      //content fields
      protected  OrganisationType_2_tacticalData tacticalData;
            //optional
      protected  ComDataType comData;   //optional
      protected  OrganisationType_2_location location;   //optional

      //attribute methods

      //content methods

      public  OrganisationType_2_tacticalData TacticalData
      {
         get
         {
      ...
      public  OrganisationType_2_location Location
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.tacticalData = new  OrganisationType_2_tacticalData();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.location = new  OrganisationType_2_location();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_Organisation_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:organisation","NC1_Organisation")
      };
      static NC1_Organisation_CC() {
         XBUtil.license =  _NC1_Organisation.license;
      }
      ...
      //content fields
      protected  OrganisationType nC1_Organisation;

      //content methods

      public  OrganisationType NC1_Organisation
      {
         get
         {
            if (this.nC1_Organisation == null)
                throw new XBException("field nC1_Organisation not set");

            return this.nC1_Organisation;
         }
         set
         {
            this.nC1_Organisation = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_Organisation.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_Organisation = new  OrganisationType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_Organisation.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_Organisation");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_Organisation",  _NC1_Organisation.NS_URI,  _NC1_Organisation.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_Organisation.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_Organisation {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:organisation";
      public static readonly String NS_PREFIX = "nc1organisation";
 ...
 */
      ...
      public _NC1_Organisation() {
      }
      static _NC1_Organisation() {
         XBUtil.license = _NC1_Organisation.license;
      }
   }
}
