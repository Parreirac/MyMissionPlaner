...
namespace NC1.Obj.seatrack
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class SeaTrackType_2_specificData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:seatrack",
          "SeaTrackType_2_specificData");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","mobilityIndicator")
      };
      static SeaTrackType_2_specificData() {
         XBUtil.license =  _NC1_SeaTrack.license;
      }
      ...
      protected int mobilityIndicator;
      protected bool _set_mobilityIndicator = false;
      ...
      public int MobilityIndicator
      {
         get
         {
            if (!_set_mobilityIndicator)
                throw new XBException("field mobilityIndicator not set");

            return this.mobilityIndicator;
         }
         set
         {
            this.mobilityIndicator = value;
            _set_mobilityIndicator = true;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.generalType =  L140_2Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.specificType =  L140_3Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.mobilityIndicator =  L135_25Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_generalType)  {
            ...
            String text_4;
            text_4 =  L140_2Code.encode(this.generalType, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_specificType)  {
            ...
            String text_4;
            text_4 =  L140_3Code.encode(this.specificType, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         // mobilityIndicator
         if (_set_mobilityIndicator)  {
            encoder.encodeStartElement("mobilityIndicator", "", "");
            String text_4;
            text_4 =  L135_25Code.encode(this.mobilityIndicator, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class SeaTrackType :  TrackType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:seatrack",
          "SeaTrackType");
      ...
      protected  SeaTrackType_2_specificData specificData;   //optional
      ...
      public  SeaTrackType_2_specificData SpecificData
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.specificData = new  SeaTrackType_2_specificData();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_SeaTrack_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:seatrack","NC1_SeaTrack")
      };
      static NC1_SeaTrack_CC() {
         XBUtil.license =  _NC1_SeaTrack.license;
      }
      ...
      //content fields
      protected  SeaTrackType nC1_SeaTrack;

      //content methods

      public  SeaTrackType NC1_SeaTrack
      {
         get
         {
            if (this.nC1_SeaTrack == null)
                throw new XBException("field nC1_SeaTrack not set");

            return this.nC1_SeaTrack;
         }
         set
         {
            this.nC1_SeaTrack = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_SeaTrack.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_SeaTrack = new  SeaTrackType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_SeaTrack.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_SeaTrack");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_SeaTrack",  _NC1_SeaTrack.NS_URI,  _NC1_SeaTrack.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_SeaTrack.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_SeaTrack {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:seatrack";
      public static readonly String NS_PREFIX = "nc1seatrack";
 ...
 */
      ...
      public _NC1_SeaTrack() {
      }
      static _NC1_SeaTrack() {
         XBUtil.license = _NC1_SeaTrack.license;
      }
   }
}
