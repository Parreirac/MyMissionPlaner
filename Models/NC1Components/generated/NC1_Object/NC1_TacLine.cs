...
namespace NC1.Obj.tacline
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class TacLineFrSpecificCode
   {
      static TacLineFrSpecificCode() {
         XBUtil.license =  _NC1_TacLine.license;
      }

      //constructor
      private TacLineFrSpecificCode() {} 
   ...
   public class TacLineSymbolCode
   {
      static TacLineSymbolCode() {
         XBUtil.license =  _NC1_TacLine.license;
      }

      //constructor
      private TacLineSymbolCode() {} 
   ...
   public class TacLineType_2_tacticalData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:tacline",
          "TacLineType_2_tacticalData");
      ...
      static TacLineType_2_tacticalData() {
         XBUtil.license =  _NC1_TacLine.license;
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  this.frSpecificSymbol =  TacLineFrSpecificCode.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_frSpecificSymbol)  {
            ...
            text_3 =  TacLineFrSpecificCode.encode(this.frSpecificSymbol, xbContext);
   ...
   public class TacLineType_2_specificData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:tacline",
          "TacLineType_2_specificData");

      //particleInfo[i] provides information for the ith particle.
         //For elements, it is a XBQualifiedName, identifying the expected element.
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","leftUnitId"),
         new XBQualifiedName("","rightUnitId"),
         new XBQualifiedName("","crossingIndicator")
      };
      static TacLineType_2_specificData() {
         XBUtil.license =  _NC1_TacLine.license;
      }
      ...
      //content fields
      protected  Nc1ObjectRefType leftUnitId;   //optional
      protected  Nc1ObjectRefType rightUnitId;   //optional
      protected int crossingIndicator;
      protected bool _set_crossingIndicator = false;

      //attribute methods

      //content methods

      public  Nc1ObjectRefType LeftUnitId
      {
         get
         {
            if (this.leftUnitId == null)
                throw new XBException("field leftUnitId not set");

            return this.leftUnitId;
         }
         set
         {
            this.leftUnitId = value;
         }
      }

      public  Nc1ObjectRefType RightUnitId
      {
         get
         {
            if (this.rightUnitId == null)
                throw new XBException("field rightUnitId not set");

            return this.rightUnitId;
         }
         set
         {
            this.rightUnitId = value;
         }
      }

      public int CrossingIndicator
      {
         get
         {
            if (!_set_crossingIndicator)
                throw new XBException("field crossingIndicator not set");

            return this.crossingIndicator;
         }
         set
         {
            this.crossingIndicator = value;
            _set_crossingIndicator = true;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.leftUnitId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.leftUnitId.decode(reader, xbContext, false, false);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.rightUnitId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.rightUnitId.decode(reader, xbContext, false, false);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.crossingIndicator =  L135_10Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // leftUnitId
         if (this.leftUnitId != null)  {
            encoder.encodeStartElement("leftUnitId", "", "");
            this.leftUnitId.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // rightUnitId
         if (this.rightUnitId != null)  {
            encoder.encodeStartElement("rightUnitId", "", "");
            this.rightUnitId.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }

         // crossingIndicator
         if (_set_crossingIndicator)  {
            encoder.encodeStartElement("crossingIndicator", "", "");
            String text_4;
            text_4 =  L135_10Code.encode(this.crossingIndicator, xbContext);
   ...
   public class TacLineType_19
   {
      ...
      public enum Choice  {
         None, polyline, multipoint}
      protected Choice _whichField;
      static TacLineType_19() {
         XBUtil.license =  _NC1_TacLine.license;
      }
   ...
   public class TacLineType_2_location : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:tacline",
          "TacLineType_2_location");
      ...
      protected string name;
      protected bool _set_name = false;
      protected  TacLineType_19 tacLineType_19;
      ...
      public  TacLineType_19 TacLineType_19
      {
         get
         {
            if (this.tacLineType_19 == null)
                throw new XBException("field tacLineType_19 not set");

            return this.tacLineType_19;
         }
         set
         {
            this.tacLineType_19 = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // tacLineType_19
               if( moreContent_4 && 
                   TacLineType_19.acceptsElem(elemNs, elemLocalName) )
               {
                  this.tacLineType_19 = new  TacLineType_19();
                  this.tacLineType_19.decode(reader, xbContext);
               ...
               else throw new XBOccurrencesException(0, "tacLineType_19");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         this.tacLineType_19.encode(encoder, xbContext);
   ...
   public class TacLineType :  _2DCoordinationMeanType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:tacline",
          "TacLineType");
      ...
      //content fields
      protected  TacLineType_2_tacticalData tacticalData;   //optional
      protected  TacLineType_2_specificData specificData;   //optional
      protected  ComDataType comData;   //optional
      protected  TacLineType_2_location location;   //optional

      //attribute methods

      //content methods

      public  TacLineType_2_tacticalData TacticalData
      {
         get
         {
      ...
      public  TacLineType_2_specificData SpecificData
      {
         get
         {
      ...
      public  TacLineType_2_location Location
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.tacticalData = new  TacLineType_2_tacticalData();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.specificData = new  TacLineType_2_specificData();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.location = new  TacLineType_2_location();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_TacLine_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:tacline","NC1_TacLine")
      };
      static NC1_TacLine_CC() {
         XBUtil.license =  _NC1_TacLine.license;
      }
      ...
      //content fields
      protected  TacLineType nC1_TacLine;

      //content methods

      public  TacLineType NC1_TacLine
      {
         get
         {
            if (this.nC1_TacLine == null)
                throw new XBException("field nC1_TacLine not set");

            return this.nC1_TacLine;
         }
         set
         {
            this.nC1_TacLine = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_TacLine.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_TacLine = new  TacLineType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_TacLine.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_TacLine");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_TacLine",  _NC1_TacLine.NS_URI,  _NC1_TacLine.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_TacLine.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_TacLine {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:tacline";
      public static readonly String NS_PREFIX = "nc1tacline";
