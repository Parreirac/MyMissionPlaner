...
namespace NC1.Obj._2dcoordinationmean
{
    ...
    public class TacticalDataType : com.objsys.xbinder.runtime.XBComplexType
   {
      ...
      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:2dcoordinationmean",
          "TacticalDataType");
      ...
      static TacticalDataType() {
         XBUtil.license =  _2DCoordinationMean.license;
      }
   ...
   public class _2DCoordinationMeanType :  LocalisedObjectType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:2dcoordinationmean",
          "_2DCoordinationMeanType");
      static _2DCoordinationMeanType() {
         XBUtil.license =  _2DCoordinationMean.license;
      }
       ...
       * Factory method
       */
      public static new  _2DCoordinationMeanType createObject(XBQualifiedName type) 
      {
         if ( type == null || type.equals( _2DCoordinationMeanType.XSD_TYPE ) ) 
            return new  _2DCoordinationMeanType();
         else if ( type.equals(tacarea.TacAreaType.XSD_TYPE) ) 
            return new tacarea.TacAreaType();
         else if ( type.equals(tacline.TacLineType.XSD_TYPE) ) 
            return new tacline.TacLineType();
         else if ( type.equals(tacpoint.TacPointType.XSD_TYPE) ) 
            return new tacpoint.TacPointType();
   ...
   public class _2DCoordinationMean//:  LocalisedObjectType  //Modif pra : j'ajoute le LocalisedObjectType mais pourquoi manque t'il ???
 {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:2dcoordinationmean";
      public static readonly String NS_PREFIX = "nc12dcoord";
 ...
 */
      ...
      public _2DCoordinationMean() {
      }
      static _2DCoordinationMean() {
         XBUtil.license = _2DCoordinationMean.license;
      }
   }
}
