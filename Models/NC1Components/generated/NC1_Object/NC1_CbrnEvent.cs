...
namespace NC1.Obj.cbrnevent
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class CbrnEventType_2_tacticalData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:cbrnevent",
          "CbrnEventType_2_tacticalData");
      ...
      static CbrnEventType_2_tacticalData() {
         XBUtil.license =  _NC1_CbrnEvent.license;
      }
   ...
   public class CbrnEventType :  LocalisedObjectType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:cbrnevent",
          "CbrnEventType");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","delta"),
         new XBQualifiedName("","foxtrot"),
         new XBQualifiedName("","golf"),
         new XBQualifiedName("","india"),
         new XBQualifiedName("","miker"),
         new XBQualifiedName("","tango"),
         new XBQualifiedName("","yankee"),
         new XBQualifiedName("","zulu")
      };
      static CbrnEventType() {
         XBUtil.license =  _NC1_CbrnEvent.license;
      }
      ...
      //content fields
      protected  CbrnEventType_2_tacticalData tacticalData;   //optional
      protected  AlfaType alfa;
      protected  DeltaType delta;
      protected  FoxtrotType foxtrot;
      protected  GolfType golf;
      protected  IndiaType india;
      protected  MikerType miker;
      ...
      public  CbrnEventType_2_tacticalData TacticalData
      {
         get
         {
      ...
      public  DeltaType Delta
      {
         get
         {
            if (this.delta == null)
                throw new XBException("field delta not set");
      ...
      public  FoxtrotType Foxtrot
      {
         get
         {
            if (this.foxtrot == null)
                throw new XBException("field foxtrot not set");
      ...
      public  GolfType Golf
      {
         get
         {
            if (this.golf == null)
                throw new XBException("field golf not set");
      ...
      public  MikerType Miker
      {
         get
         {
            if (this.miker == null)
                throw new XBException("field miker not set");
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.tacticalData = new  CbrnEventType_2_tacticalData();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               else throw new XBOccurrencesException(0, "alfa");

               // delta
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.delta = new  DeltaType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.delta.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "delta");

               // foxtrot
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.foxtrot = new  FoxtrotType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.foxtrot.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "foxtrot");

               // golf
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  this.golf = new  GolfType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.golf.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "golf");
               ...
               {
                  this.miker = new  MikerType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.miker.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "miker");
      ...
      protected override void encodeContent(XBXmlEncoder encoder, 
         ...
         // alfa
         if (this.alfa == null) throw new XBException("field alfa not set");
         ...
         // delta
         if (this.delta == null) throw new XBException("field delta not set");

         encoder.encodeStartElement("delta", "", "");
         this.delta.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("foxtrot", "", "");
         this.foxtrot.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // golf
         if (this.golf == null) throw new XBException("field golf not set");

         encoder.encodeStartElement("golf", "", "");
         this.golf.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         // miker
         if (this.miker == null) throw new XBException("field miker not set");

         encoder.encodeStartElement("miker", "", "");
         this.miker.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
   ...
   public class NC1_CbrnEvent_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:cbrnevent","NC1_CbrnEvent")
      };
      static NC1_CbrnEvent_CC() {
         XBUtil.license =  _NC1_CbrnEvent.license;
      }
      ...
      //content fields
      protected  CbrnEventType nC1_CbrnEvent;

      //content methods

      public  CbrnEventType NC1_CbrnEvent
      {
         get
         {
            if (this.nC1_CbrnEvent == null)
                throw new XBException("field nC1_CbrnEvent not set");

            return this.nC1_CbrnEvent;
         }
         set
         {
            this.nC1_CbrnEvent = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_CbrnEvent.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_CbrnEvent = new  CbrnEventType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_CbrnEvent.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_CbrnEvent");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_CbrnEvent",  _NC1_CbrnEvent.NS_URI,  _NC1_CbrnEvent.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_CbrnEvent.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_CbrnEvent {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:cbrnevent";
      public static readonly String NS_PREFIX = "nc1cbrnevent";
 ...
 */
      ...
      public _NC1_CbrnEvent() {
      }
      static _NC1_CbrnEvent() {
         XBUtil.license = _NC1_CbrnEvent.license;
      }
   }
}
