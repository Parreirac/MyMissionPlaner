...
namespace NC1.Obj._event
{
   ...
   public class EventType_2_tacticalData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:event",
          "EventType_2_tacticalData");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","initiatorEntityId"),
         new XBQualifiedName("","involvedEntityId"),
         new XBQualifiedName("","responsibleUnitId"),
         new XBQualifiedName("","reliability"),
         new XBQualifiedName("","credibility"),
         new XBQualifiedName("","genericWeaponTypeDescription"),
         new XBQualifiedName("","personnelCasualties"),
         new XBQualifiedName("","datetime"),
         new XBQualifiedName("","url"),
         new XBQualifiedName("","comment"),
         new XBQualifiedName("","extVersion")
      };
      static EventType_2_tacticalData() {
         XBUtil.license =  _NC1_Event.license;
      }
      ...
      protected System.Collections.Generic.IList< Nc1ObjectRefType> initiatorEntityId;
         
      protected System.Collections.Generic.IList< Nc1ObjectRefType> involvedEntityId;
      ...
      protected string genericWeaponTypeDescription;
      protected bool _set_genericWeaponTypeDescription = false;
      protected System.Collections.Generic.IList< PersonnelCasualtiesType> personnelCasualties;
      ...
      public System.Collections.Generic.IList< Nc1ObjectRefType> InitiatorEntityId
      {
         get
         {
            if (this.initiatorEntityId == null) {
               this.initiatorEntityId = new List< Nc1ObjectRefType>();
            }
            return this.initiatorEntityId;
         }
      }

      public System.Collections.Generic.IList< Nc1ObjectRefType> InvolvedEntityId
      {
         get
         {
            if (this.involvedEntityId == null) {
               this.involvedEntityId = new List< Nc1ObjectRefType>();
            }
      ...
      public string GenericWeaponTypeDescription
      {
         get
         {
            if (!_set_genericWeaponTypeDescription)
                throw new XBException("field genericWeaponTypeDescription not set");

            return this.genericWeaponTypeDescription;
         }
         set
         {
            this.genericWeaponTypeDescription = value;
            _set_genericWeaponTypeDescription = true;
         }
      }

      public System.Collections.Generic.IList< PersonnelCasualtiesType> PersonnelCasualties
      {
         get
         {
            if (this.personnelCasualties == null) {
               this.personnelCasualties = 
                  new List< PersonnelCasualtiesType>();
            }
            return this.personnelCasualties;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               {
                   Nc1ObjectRefType _tmp_initiatorEntityId;
                  _tmp_initiatorEntityId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_initiatorEntityId.decode(reader, xbContext, false, false);
                  this.initiatorEntityId.Add(_tmp_initiatorEntityId);
               ...
               {
                   Nc1ObjectRefType _tmp_involvedEntityId;
                  _tmp_involvedEntityId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_involvedEntityId.decode(reader, xbContext, false, false);
                  this.involvedEntityId.Add(_tmp_involvedEntityId);
               ...
               // genericWeaponTypeDescription
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[8], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.genericWeaponTypeDescription =  MediumTextObjectType.decode(text, xbContext);
               ...
               {
                   PersonnelCasualtiesType _tmp_personnelCasualties;
                  _tmp_personnelCasualties = new  PersonnelCasualtiesType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  _tmp_personnelCasualties.decode(reader, xbContext, false, false);
                  this.personnelCasualties.Add(_tmp_personnelCasualties);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // initiatorEntityId
         if ( this.initiatorEntityId != null ){
            foreach ( Nc1ObjectRefType _tmp_initiatorEntityId in this.initiatorEntityId)
            {
               encoder.encodeStartElement("initiatorEntityId", "", "");
               _tmp_initiatorEntityId.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
         ...
         // involvedEntityId
         if ( this.involvedEntityId != null ){
            foreach ( Nc1ObjectRefType _tmp_involvedEntityId in this.involvedEntityId)
            {
               encoder.encodeStartElement("involvedEntityId", "", "");
               _tmp_involvedEntityId.encode(encoder, xbContext, null, false);
               encoder.encodeEndElement();
            }
         }
         ...
         // genericWeaponTypeDescription
         if (_set_genericWeaponTypeDescription)  {
            encoder.encodeStartElement("genericWeaponTypeDescription", "", "");
            text_3 =  MediumTextObjectType.encode(this.genericWeaponTypeDescription, xbContext);
            encoder.encodeChars(text_3);
            encoder.encodeEndElement();
         }
         ...
         // personnelCasualties
         if ( this.personnelCasualties != null ){
            foreach ( PersonnelCasualtiesType _tmp_personnelCasualties in this.personnelCasualties)
            {
               encoder.encodeStartElement("personnelCasualties", "", "");
               _tmp_personnelCasualties.encode(encoder, xbContext, null, 
                  false);
               encoder.encodeEndElement();
            }
         }
   ...
   public class EventType_2_location : com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:event",
          "EventType_2_location");
   ...
   public class EventType :  LocalisedObjectType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:event",
          "EventType");
      ...
      //content fields
      protected  EventType_2_tacticalData tacticalData;   //optional
      protected  EventType_2_location location;   //optional

      //attribute methods

      //content methods

      public  EventType_2_tacticalData TacticalData
      {
         get
         {
      ...
      public  EventType_2_location Location
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.tacticalData = new  EventType_2_tacticalData();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.location = new  EventType_2_location();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_Event_CC : XBDocumentCodec
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:event","NC1_Event")
      };
      static NC1_Event_CC() {
         XBUtil.license =  _NC1_Event.license;
      }
      ...
      //content fields
      protected  EventType nC1_Event;

      //content methods

      public  EventType NC1_Event
      {
         get
         {
            if (this.nC1_Event == null)
                throw new XBException("field nC1_Event not set");

            return this.nC1_Event;
         }
         set
         {
            this.nC1_Event = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_Event.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_Event = new  EventType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_Event.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_Event");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_Event",  _NC1_Event.NS_URI,  _NC1_Event.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_Event.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_Event {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:event";
      public static readonly String NS_PREFIX = "nc1event";
