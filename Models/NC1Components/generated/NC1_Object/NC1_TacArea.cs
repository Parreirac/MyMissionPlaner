...
namespace NC1.Obj.tacarea
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class TacAreaFrSpecificCode
   {
      static TacAreaFrSpecificCode() {
         XBUtil.license =  _NC1_TacArea.license;
      }

      //constructor
      private TacAreaFrSpecificCode() {} 
   ...
   public class TacAreaSymbolCode
   {
      static TacAreaSymbolCode() {
         XBUtil.license =  _NC1_TacArea.license;
      }

      //constructor
      private TacAreaSymbolCode() {} 
   ...
   public class TacAreaType_2_tacticalData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:tacarea",
          "TacAreaType_2_tacticalData");
      ...
      static TacAreaType_2_tacticalData() {
         XBUtil.license =  _NC1_TacArea.license;
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  this.frSpecificSymbol =  TacAreaFrSpecificCode.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_frSpecificSymbol)  {
            ...
            text_3 =  TacAreaFrSpecificCode.encode(this.frSpecificSymbol, xbContext);
   ...
   public class TacAreaType_15
   {
      ...
      public enum Choice  {
         None, multipoint, circle, polygon, ellipse, arcband, arrow}
      protected Choice _whichField;
      static TacAreaType_15() {
         XBUtil.license =  _NC1_TacArea.license;
      }
   ...
   public class TacAreaType_2_location : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:tacarea",
          "TacAreaType_2_location");
      ...
      protected string name;
      protected bool _set_name = false;
      protected  TacAreaType_15 tacAreaType_15;
      ...
      public  TacAreaType_15 TacAreaType_15
      {
         get
         {
            if (this.tacAreaType_15 == null)
                throw new XBException("field tacAreaType_15 not set");

            return this.tacAreaType_15;
         }
         set
         {
            this.tacAreaType_15 = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // tacAreaType_15
               if( moreContent_4 && 
                   TacAreaType_15.acceptsElem(elemNs, elemLocalName) )
               {
                  this.tacAreaType_15 = new  TacAreaType_15();
                  this.tacAreaType_15.decode(reader, xbContext);
               ...
               else throw new XBOccurrencesException(0, "tacAreaType_15");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         this.tacAreaType_15.encode(encoder, xbContext);
   ...
   public class TacAreaType :  _2DCoordinationMeanType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:tacarea",
          "TacAreaType");
      ...
      //content fields
      protected  TacAreaType_2_tacticalData tacticalData;   //optional
      protected  ComDataType comData;   //optional
      protected  TacAreaType_2_location location;   //optional

      //attribute methods

      //content methods

      public  TacAreaType_2_tacticalData TacticalData
      {
         get
         {
      ...
      public  TacAreaType_2_location Location
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.tacticalData = new  TacAreaType_2_tacticalData();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.location = new  TacAreaType_2_location();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_TacArea_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:tacarea","NC1_TacArea")
      };
      static NC1_TacArea_CC() {
         XBUtil.license =  _NC1_TacArea.license;
      }
      ...
      //content fields
      protected  TacAreaType nC1_TacArea;

      //content methods

      public  TacAreaType NC1_TacArea
      {
         get
         {
            if (this.nC1_TacArea == null)
                throw new XBException("field nC1_TacArea not set");

            return this.nC1_TacArea;
         }
         set
         {
            this.nC1_TacArea = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_TacArea.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_TacArea = new  TacAreaType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_TacArea.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_TacArea");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_TacArea",  _NC1_TacArea.NS_URI,  _NC1_TacArea.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_TacArea.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_TacArea {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:tacarea";
      public static readonly String NS_PREFIX = "nc1tacarea";
