...
namespace NC1.Obj.groundtrack
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class GroundTrackType_2_specificData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:groundtrack",
          "GroundTrackType_2_specificData");
      ...
      static GroundTrackType_2_specificData() {
         XBUtil.license =  _NC1_GroundTrack.license;
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.generalType =  L115_2Code.decode(text, xbContext);
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.specificType =  L115_3Code.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         if (_set_generalType)  {
            ...
            String text_4;
            text_4 =  L115_2Code.encode(this.generalType, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
         ...
         if (_set_specificType)  {
            ...
            String text_4;
            text_4 =  L115_3Code.encode(this.specificType, xbContext);
            encoder.encodeCharsNoEscaping(text_4);
            encoder.encodeEndElement();
         }
      }
   ...
   public class GroundTrackType_11
   {
   ...
   public class GroundTrackType_2_location : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:groundtrack",
          "GroundTrackType_2_location");
      ...
      static GroundTrackType_2_location() {
         XBUtil.license =  _NC1_GroundTrack.license;
      }
      ...
      protected  GroundTrackType_11 groundTrackType_11;   //optional
      ...
      public  GroundTrackType_11 GroundTrackType_11
      {
         get
         {
            if (this.groundTrackType_11 == null)
                throw new XBException("field groundTrackType_11 not set");

            return this.groundTrackType_11;
         }
         set
         {
            this.groundTrackType_11 = value;
         }
      }
      ...
      protected virtual bool decodeContent(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext, 
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               // groundTrackType_11
               if( moreContent_4 && 
                   GroundTrackType_11.acceptsElem(elemNs, elemLocalName)
                   )
               {
                  this.groundTrackType_11 = new  GroundTrackType_11();
                  this.groundTrackType_11.decode(reader, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         // groundTrackType_11
         if (this.groundTrackType_11 != null)  {
            this.groundTrackType_11.encode(encoder, xbContext);
         }
   ...
   public class GroundTrackType :  TrackType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:groundtrack",
          "GroundTrackType");
      ...
      protected  GroundTrackType_2_specificData specificData;
            //optional
      protected  ComDataType comData;   //optional
      protected  GroundTrackType_2_location location;   //optional
      ...
      public  GroundTrackType_2_specificData SpecificData
      {
         get
         {
      ...
      public  GroundTrackType_2_location Location
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.specificData = new  GroundTrackType_2_specificData();
                  xbContext.decodeSchemaLocationAttrs(reader);
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[3], elemNs, elemLocalName) )
               {
                  this.location = new  GroundTrackType_2_location();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_GroundTrack_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:groundtrack","NC1_GroundTrack")
      };
      static NC1_GroundTrack_CC() {
         XBUtil.license =  _NC1_GroundTrack.license;
      }
      ...
      //content fields
      protected  GroundTrackType nC1_GroundTrack;

      //content methods

      public  GroundTrackType NC1_GroundTrack
      {
         get
         {
            if (this.nC1_GroundTrack == null)
                throw new XBException("field nC1_GroundTrack not set");

            return this.nC1_GroundTrack;
         }
         set
         {
            this.nC1_GroundTrack = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_GroundTrack.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_GroundTrack = new  GroundTrackType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_GroundTrack.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_GroundTrack");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_GroundTrack",  _NC1_GroundTrack.NS_URI,  _NC1_GroundTrack.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_GroundTrack.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_GroundTrack {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:groundtrack";
      public static readonly String NS_PREFIX = "nc1groundtrack";
 ...
 */
      ...
      public _NC1_GroundTrack() {
      }
      static _NC1_GroundTrack() {
         XBUtil.license = _NC1_GroundTrack.license;
      }
   }
}
