...
namespace NC1.Obj.reinforcement
{
   ...
   using com.objsys.xbinder.runtime;
    ...
    public class GivenUnitDescriptionType : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:reinforcement",
          "GivenUnitDescriptionType");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","level"),
         new XBQualifiedName("","type")
      };
      static GivenUnitDescriptionType() {
         XBUtil.license =  _NC1_Reinforcement.license;
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
                  ...
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  ...
                  this.volume =  Int0To99Type.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "volume");
                  ...
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.level =  MediumTextObjectType.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "level");
                  ...
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  xbContext.decodeSchemaLocationAttrs(reader);
                  String text = reader.ReadString();
                  this.type =  MediumTextObjectType.decode(text, xbContext);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         String text_3;
         text_3 =  Int0To99Type.encode(this.volume, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();

         // level
         encoder.encodeStartElement("level", "", "");
         text_3 =  MediumTextObjectType.encode(this.level, xbContext);
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();

         // type
         encoder.encodeStartElement("type", "", "");
         text_3 =  MediumTextObjectType.encode(this.type, xbContext);
         encoder.encodeChars(text_3);
         encoder.encodeEndElement();
      }
   ...
   public class GivenUnitType : com.objsys.xbinder.runtime.XBComplexType
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static new Object[] particleInfo = {
         new XBQualifiedName("","givenUnitId"),
         new XBQualifiedName("","reinforcementId")
      };
      static GivenUnitType() {
         XBUtil.license =  _NC1_Reinforcement.license;
      }
      ...
      //content fields
      protected  Nc1ObjectRefType givenUnitId;
      protected  Nc1ObjectRefType reinforcementId;   //optional

      //attribute methods

      //content methods

      public  Nc1ObjectRefType GivenUnitId
      {
         get
         {
            if (this.givenUnitId == null)
                throw new XBException("field givenUnitId not set");

            return this.givenUnitId;
         }
         set
         {
            this.givenUnitId = value;
         }
      }

      public  Nc1ObjectRefType ReinforcementId
      {
         get
         {
            if (this.reinforcementId == null)
                throw new XBException("field reinforcementId not set");

            return this.reinforcementId;
         }
         set
         {
            this.reinforcementId = value;
         }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.givenUnitId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.givenUnitId.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "givenUnitId");

               // reinforcementId
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.reinforcementId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.reinforcementId.decode(reader, xbContext, false, false);
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("givenUnitId", "", "");
         this.givenUnitId.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();

         // reinforcementId
         if (this.reinforcementId != null)  {
            encoder.encodeStartElement("reinforcementId", "", "");
            this.reinforcementId.encode(encoder, xbContext, null, false);
            encoder.encodeEndElement();
         }
      }
   ...
   public class ReinforcementType_7
   {
      ...
      protected static  Object[] particleInfo = {
         new XBQualifiedName("","givenUnitDescription"),
         new XBQualifiedName("","givenUnitId")
      };
      ...
      public enum Choice  {
         None, givenUnitDescription, givenUnitId}
      protected Choice _whichField;
      static ReinforcementType_7() {
         XBUtil.license =  _NC1_Reinforcement.license;
      }
      ...
      //content fields
      protected  GivenUnitDescriptionType givenUnitDescription;
      protected  Nc1ObjectRefType givenUnitId;

      //content methods

      public  GivenUnitDescriptionType GivenUnitDescription
      {
         get
         {
            if (_whichField != Choice.givenUnitDescription ) 
               throw new XBException("field givenUnitDescription not set");
            return this.givenUnitDescription;
         }
         set
         {
            this.givenUnitDescription = value;
            _whichField = Choice.givenUnitDescription;
         }
      }
      ...
      public  Nc1ObjectRefType GivenUnitId
      {
         get
         {
            if (_whichField != Choice.givenUnitId ) 
               throw new XBException("field givenUnitId not set");
            return this.givenUnitId;
         }
         set
         {
            this.givenUnitId = value;
            _whichField = Choice.givenUnitId;
         }
      }
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            // givenUnitDescription
            if ( XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.givenUnitDescription = new  GivenUnitDescriptionType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.givenUnitDescription.decode(reader, xbContext, false, false);
               _whichField = Choice.givenUnitDescription;
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         switch( _whichField )  {
            ...
            // givenUnitDescription
            case Choice.givenUnitDescription: {
               if (_whichField != Choice.givenUnitDescription ) 
                  throw new XBException("field givenUnitDescription not set");
               encoder.encodeStartElement("givenUnitDescription", "", "");
               this.givenUnitDescription.encode(encoder, xbContext, null, 
                  false);
               encoder.encodeEndElement();
               break;
            }
   ...
   public class ReinforcementType_2_tacticalData : 
      com.objsys.xbinder.runtime.XBComplexType
   {

      public static readonly  XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:reinforcement",
          "ReinforcementType_2_tacticalData");
      ...
      protected static new Object[] particleInfo = {
         ...
         new XBQualifiedName("","providingUnitId"),
         new XBQualifiedName("","reinforcedUnitId"),
         new XBQualifiedName("","reinforcementId"),
         new XBQualifiedName("","commandRelationshipCategory"),
         new XBQualifiedName("","period"),
         new XBQualifiedName("","url"),
         new XBQualifiedName("","comment"),
         new XBQualifiedName("","extVersion")
      };
      static ReinforcementType_2_tacticalData() {
         XBUtil.license =  _NC1_Reinforcement.license;
      }
      ...
      protected  Nc1ObjectRefType providingUnitId;
      protected  Nc1ObjectRefType reinforcedUnitId;
      protected  Nc1ObjectRefType reinforcementId;   //optional
      protected  ReinforcementType_7 reinforcementType_7;
      protected int commandRelationshipCategory;
      ...
      public  Nc1ObjectRefType ProvidingUnitId
      {
         get
         {
            if (this.providingUnitId == null)
                throw new XBException("field providingUnitId not set");

            return this.providingUnitId;
         }
         set
         {
            this.providingUnitId = value;
         }
      }

      public  Nc1ObjectRefType ReinforcedUnitId
      {
         get
         {
            if (this.reinforcedUnitId == null)
                throw new XBException("field reinforcedUnitId not set");

            return this.reinforcedUnitId;
         }
         set
         {
            this.reinforcedUnitId = value;
         }
      }
      ...
      public  ReinforcementType_7 ReinforcementType_7
      {
         get
         {
            if (this.reinforcementType_7 == null)
                throw new XBException("field reinforcementType_7 not set");

            return this.reinforcementType_7;
         }
         set
         {
            this.reinforcementType_7 = value;
         }
      }

      public int CommandRelationshipCategory
      {
         get { return this.commandRelationshipCategory; }
         set { this.commandRelationshipCategory = value; }
      }
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[1], elemNs, elemLocalName) )
               {
                  this.providingUnitId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.providingUnitId.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "providingUnitId");

               // reinforcedUnitId
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[2], elemNs, elemLocalName) )
               {
                  this.reinforcedUnitId = new  Nc1ObjectRefType();
                  xbContext.decodeSchemaLocationAttrs(reader);
                  this.reinforcedUnitId.decode(reader, xbContext, false, false);
               ...
               else throw new XBOccurrencesException(0, "reinforcedUnitId");
               ...
               // reinforcementType_7
               if( moreContent_4 && 
                   ReinforcementType_7.acceptsElem(elemNs, elemLocalName)
                   )
               {
                  this.reinforcementType_7 = new  ReinforcementType_7();
                  this.reinforcementType_7.decode(reader, xbContext);
               ...
               else throw new XBOccurrencesException(0, "reinforcementType_7");

               // commandRelationshipCategory
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[4], elemNs, elemLocalName) )
               {
                  ...
                  String text = reader.ReadString();
                  text = XBSimpleType.whitespaceCollapse(text);
                  this.commandRelationshipCategory =  L135_16Code.decode(text, xbContext);
               ...
               else throw new XBOccurrencesException(0, "commandRelationshipCategory");
      ...
      protected virtual void encodeContent(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("providingUnitId", "", "");
         this.providingUnitId.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         encoder.encodeStartElement("reinforcedUnitId", "", "");
         this.reinforcedUnitId.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
         ...
         this.reinforcementType_7.encode(encoder, xbContext);

         // commandRelationshipCategory
         encoder.encodeStartElement("commandRelationshipCategory", "", "");
         String text_3;
         text_3 =  L135_16Code.encode(this.commandRelationshipCategory, xbContext);
         encoder.encodeCharsNoEscaping(text_3);
         encoder.encodeEndElement();
   ...
   public class ReinforcementType :  BaseObjectType
   {

      public static readonly new XBQualifiedName XSD_TYPE = new XBQualifiedName("urn:fra:nc1:objet:reinforcement",
          "ReinforcementType");
      ...
      //content fields
      protected  ReinforcementType_2_tacticalData tacticalData;
            //optional
      ...
      public  ReinforcementType_2_tacticalData TacticalData
      {
         get
         {
         ...
         try  {
            ...
            if ( moreContent_4 ) {
               ...
               if( moreContent_4 && XBQualifiedName.namesMatch(
                  (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
               {
                  this.tacticalData = new  ReinforcementType_2_tacticalData();
                  xbContext.decodeSchemaLocationAttrs(reader);
   ...
   public class NC1_Reinforcement_CC : XBDocumentCodec
   {
      ...
      //For element wildcards, it is a String[], listing the allowed namespaces
      protected static  Object[] particleInfo = {
         new XBQualifiedName("urn:fra:nc1:objet:reinforcement","NC1_Reinforcement")
      };
      static NC1_Reinforcement_CC() {
         XBUtil.license =  _NC1_Reinforcement.license;
      }
      ...
      //content fields
      protected  ReinforcementType nC1_Reinforcement;

      //content methods

      public  ReinforcementType NC1_Reinforcement
      {
         get
         {
            if (this.nC1_Reinforcement == null)
                throw new XBException("field nC1_Reinforcement not set");

            return this.nC1_Reinforcement;
         }
         set
         {
            this.nC1_Reinforcement = value;
         }
      }
      ...
      public void encodeDocument(XBXmlEncoder encoder) {
         ...
         //   encoder.setNamespaces(_NC1_Reinforcement.namespaceContext);
      ...
      public virtual void decode(XmlTextReader reader, com.objsys.xbinder.runtime.XBContext xbContext) 
      {
         ...
         try  {
            ...
            if( moreContent_4 && XBQualifiedName.namesMatch(
               (XBQualifiedName)particleInfo[0], elemNs, elemLocalName) )
            {
               this.nC1_Reinforcement = new  ReinforcementType();
               xbContext.decodeSchemaLocationAttrs(reader);
               this.nC1_Reinforcement.decode(reader, xbContext, false, false);

               moreContent_4 = XMLStreamHelper.moveToContentElement(reader);
            }
            else if (moreContent_4) throw new XBUnexpectedElementException(elemNs, elemLocalName);
            else throw new XBOccurrencesException(0, "nC1_Reinforcement");
      ...
      public virtual void encode(XBXmlEncoder encoder, 
         ...
         encoder.encodeStartElement("NC1_Reinforcement",  _NC1_Reinforcement.NS_URI,  _NC1_Reinforcement.NS_PREFIX);
         xbContext.encodeSchemaLocationAttrs(encoder);
         this.nC1_Reinforcement.encode(encoder, xbContext, null, false);
         encoder.encodeEndElement();
      }
   }
   /**
   ...
   public class _NC1_Reinforcement {
      ...
      public static readonly String NS_URI = "urn:fra:nc1:objet:reinforcement";
      public static readonly String NS_PREFIX = "nc1reinforcement";
 ...
 */
      ...
      public _NC1_Reinforcement() {
      }
      static _NC1_Reinforcement() {
         XBUtil.license = _NC1_Reinforcement.license;
      }
   }
}
