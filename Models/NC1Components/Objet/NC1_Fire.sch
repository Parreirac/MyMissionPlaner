...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:objet:fire" prefix="nc1fire" />
  <iso:pattern>
    <iso:title>NC1_Fire validation rules</iso:title>
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData/fireForEffect/location/polyline">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/@instance">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData/actors/otherEntityId/@id">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData/actors/requestingEntityId/@id">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData/actors/responsibleAuthorityId/@id">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData/adjustmentFire">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData/fireForEffect">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData/fireForEffect/synchronizedFireId/@id">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData/tacticalEffect/targetData/targetId/@id">
    ...
    <iso:rule context="/nc1fire:NC1_Fire/callForFireData/ammunitionEffect">
