...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:objet:tacpoint" prefix="nc1tacpoint" />
  <iso:pattern>
    <iso:title>NC1_TacPoint validation rules</iso:title>
    <iso:rule context="/nc1tacpoint:NC1_TacPoint/tacticalData">
    ...
    <iso:rule context="/nc1tacpoint:NC1_TacPoint/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1tacpoint:NC1_TacPoint/@id">
      <iso:assert test="matches(.,'^40:')" diagnostics="D26831-en">NC1_TacPoint.4: Le type de l'objet doit avoir pour valeur 40</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1tacpoint:NC1_TacPoint/tacticalData/responsibleUnitId/@id">
