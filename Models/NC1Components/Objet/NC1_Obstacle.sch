...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:objet:obstacle" prefix="nc1obstacle" />
  <iso:pattern>
    <iso:title>NC1_Obstacle validation rules</iso:title>
    <iso:rule context="/nc1obstacle:NC1_Obstacle/tacticalData">
    ...
    <iso:rule context="/nc1obstacle:NC1_Obstacle/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1obstacle:NC1_Obstacle/tacticalData/bypassRouteId/@id">
    ...
    <iso:rule context="/nc1obstacle:NC1_Obstacle/tacticalData/responsibleUnitId/@id">
