...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:objet:fireobjective" prefix="nc1fireobjective" />
  <iso:pattern>
    <iso:title>NC1_FireObjective validation rules</iso:title>
    <iso:rule context="/nc1fireobjective:NC1_FireObjective/location/polyline">
    ...
    <iso:rule context="/nc1fireobjective:NC1_FireObjective/@id">
    ...
    <iso:rule context="/nc1fireobjective:NC1_FireObjective/tacticalData/targetId/@id">
    ...
    <iso:rule context="/nc1fireobjective:NC1_FireObjective/tacticalData/synchronizedFireId/@id">
    ...
    <iso:rule context="/nc1fireobjective:NC1_FireObjective/tacticalData">
