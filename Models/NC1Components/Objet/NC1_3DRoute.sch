...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:objet:3droute" prefix="nc13droute" />
  <iso:pattern>
    <iso:title>NC1_3DRoute validation rules</iso:title>
    <iso:rule context="/nc13droute:NC1_3DRoute/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc13droute:NC1_3DRoute/tacticalData">
    ...
    <iso:rule context="/nc13droute:NC1_3DRoute/location/startPoint/timingInstructions">
    ...
    <iso:rule context="/nc13droute:NC1_3DRoute/location/segment/altitude">
