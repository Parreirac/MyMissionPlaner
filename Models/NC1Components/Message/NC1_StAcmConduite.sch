...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:stacmconduite" prefix="nc1stacmconduite" />
  <iso:pattern>
    <iso:title>NC1_StAcmConduite validation rules</iso:title>
    <iso:rule context="/nc1stacmconduite:NC1_StAcmConduite/typedACMs/acm/@id">
      <iso:assert test="matches(.,'^34:')" diagnostics="D26847-en">NC1_AcmWez.4: Le type de l'objet doit avoir pour valeur 34</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stacmconduite:NC1_StAcmConduite/typedACMs/acm/tacticalData/usageType">
    ...
    <iso:rule context="/nc1stacmconduite:NC1_StAcmConduite/typedACMs/acm/location/airtrack/segment/maxLevelReference">
    ...
    <iso:rule context="/nc1stacmconduite:NC1_StAcmConduite/typedACMs/acm/location/levels/maxLevelReference">
    ...
    <iso:rule context="/nc1stacmconduite:NC1_StAcmConduite/typedACMs/acm/tacticalData/controlPoint/levels/maxLevelReference">
