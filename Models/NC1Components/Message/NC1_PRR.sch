...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:prr" prefix="nc1prr" />
  <iso:pattern>
    <iso:title>NC1_PRR validation rules</iso:title>
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/intelRequirement/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/intelRequirement/location/tacAreaId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/intelRequirement/location/tacLineId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/intelRequirement/location/tacPointId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedRoute/location/endPoint/symbolCode">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedRoute/location/startPoint/symbolCode">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedRoute/@id">
      <iso:assert test="matches(.,'^38:')" diagnostics="D26860-en">NC1_Route.5: Le type de l'objet doit avoir pour valeur 38</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedRoute/location/endTacPointId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedRoute/location/startTacPointId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedRoute/location/segment/groundEntityId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacPoint/tacticalData">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacPoint/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacPoint/@id">
      <iso:assert test="matches(.,'^40:')" diagnostics="D26831-en">NC1_TacPoint.4: Le type de l'objet doit avoir pour valeur 40</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacPoint/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacLine/tacticalData">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacLine/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacLine/@id">
      <iso:assert test="matches(.,'^41:')" diagnostics="D26897-en">NC1_TacLine.6: Le type de l'objet doit avoir pour valeur 41</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacLine/specificData/leftUnitId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacLine/specificData/rightUnitId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacLine/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacLine/location/multipoint">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacArea/tacticalData">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacArea/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacArea/@id">
      <iso:assert test="matches(.,'^42:')" diagnostics="D26903-en">NC1_TacArea.4: Le type de l'objet doit avoir pour valeur 42.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedTacArea/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedEvent/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedEvent/@id">
      <iso:assert test="matches(.,'^30:')" diagnostics="D26827-en">NC1_Event.5: Le type de l'objet doit avoir pour valeur 30</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedEvent/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedEvent/tacticalData/initiatorEntityId/@id">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedEvent/tacticalData/involvedEntityId/@id">
      <iso:assert test="matches(.,'^[0-9]:') or matches(.,'^1[01235]:')" diagnostics="D26824-en">NC1_Event.8: L'acteur impliqué dans l'événement doit être un agent (NC1_Unit, NC1_Organisation ou NC1_Individual) ou une piste (NC1_GrountTrack, NC1_AirTrack ou NC1_SeaTrack) ou un participant (NC1_GrountParticipant, NC1_AirParticipant ou NC1_SeaParticipant).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedCbrnEvent/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedFreeShape/location">
    ...
    <iso:rule context="/nc1prr:NC1_PRR/intelCollectionPlan/involvedFreeShape/location/polyline">
