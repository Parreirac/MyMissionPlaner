...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:intreq" prefix="nc1intreq" />
  <iso:pattern>
    <iso:title>NC1_INTREQ validation rules</iso:title>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/intelRequirement/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/intelRequirement/location/tacAreaId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/intelRequirement/location/tacLineId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/intelRequirement/location/tacPointId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedRoute/location/endPoint/symbolCode">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedRoute/location/startPoint/symbolCode">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedRoute/@id">
      <iso:assert test="matches(.,'^38:')" diagnostics="D26860-en">NC1_Route.5: Le type de l'objet doit avoir pour valeur 38</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedRoute/location/endTacPointId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedRoute/location/startTacPointId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedRoute/location/segment/groundEntityId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacPoint/tacticalData">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacPoint/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacPoint/@id">
      <iso:assert test="matches(.,'^40:')" diagnostics="D26831-en">NC1_TacPoint.4: Le type de l'objet doit avoir pour valeur 40</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacPoint/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacLine/tacticalData">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacLine/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacLine/@id">
      <iso:assert test="matches(.,'^41:')" diagnostics="D26897-en">NC1_TacLine.6: Le type de l'objet doit avoir pour valeur 41</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacLine/specificData/leftUnitId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacLine/specificData/rightUnitId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacLine/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacLine/location/multipoint">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacArea/tacticalData">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacArea/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacArea/@id">
      <iso:assert test="matches(.,'^42:')" diagnostics="D26903-en">NC1_TacArea.4: Le type de l'objet doit avoir pour valeur 42.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedTacArea/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedEvent/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedEvent/@id">
      <iso:assert test="matches(.,'^30:')" diagnostics="D26827-en">NC1_Event.5: Le type de l'objet doit avoir pour valeur 30</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedEvent/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedEvent/tacticalData/initiatorEntityId/@id">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedEvent/tacticalData/involvedEntityId/@id">
      <iso:assert test="matches(.,'^[0-9]:') or matches(.,'^1[01235]:')" diagnostics="D26824-en">NC1_Event.8: L'acteur impliqué dans l'événement doit être un agent (NC1_Unit, NC1_Organisation ou NC1_Individual) ou une piste (NC1_GrountTrack, NC1_AirTrack ou NC1_SeaTrack) ou un participant (NC1_GrountParticipant, NC1_AirParticipant ou NC1_SeaParticipant).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedCbrnEvent/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedCbrnEvent/@id">
      <iso:assert test="matches(.,'^31:')" diagnostics="D26795-en">NC1_CbrnEvent.5: Le type de l'objet doit avoir pour valeur 31</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedFreeShape/tacticalData/style/line/type">
      <iso:assert test=". != 0">NC1_FreeShape.1: Le type de la forme libre de style ligne ne peut être égal à 0.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedFreeShape/@id">
      <iso:assert test="matches(.,'^44:')" diagnostics="D26752-en">NC1_FreeShape.4: Le type de l'objet doit avoir pour valeur 44</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedFreeShape/location/point">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedFreeShape/location">
    ...
    <iso:rule context="/nc1intreq:NC1_INTREQ/intelligenceRequest/involvedFreeShape/location/polyline">
