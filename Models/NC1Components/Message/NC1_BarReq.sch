...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:barreq" prefix="nc1barreq" />
  <iso:pattern>
    <iso:title>NC1_BarReq validation rules</iso:title>
    <iso:rule context="/nc1barreq:NC1_BarReq/friendlyObstacles/friendlyObstacle/tacticalData/symbolCode">
      <iso:assert test="matches(.,'^APP6B:.[AF]')" diagnostics="D26718-en">NC1_BarReq.2: Dans le paragraphe « Obstacles amis », l'identité des obstacles amis doit valoir « ASSUMED FRIEND », ou « FRIEND » (A ou F dans l'APP6B).</iso:assert>
    ...
    <iso:rule context="/nc1barreq:NC1_BarReq/friendlyObstacles/friendlyObstacle/tacticalData/achievementStatus">
      <iso:assert test="matches(., '1|2')" diagnostics="D26719-en">NC1_BarReq.3: Dans le paragraphe « Obstacles amis »,  les obstacles doivent être à l'état planifié (1 planifié de manoeuvre ou 2 planifié préliminaire).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1barreq:NC1_BarReq/friendlyObstacles/friendlyObstacle/tacticalData">
    ...
    <iso:rule context="/nc1barreq:NC1_BarReq/friendlyObstacles/friendlyObstacle/@id">
      <iso:assert test="matches(.,'^17:')" diagnostics="D26761-en">NC1_Obstacle.4: Le type de l'objet doit avoir pour valeur 17</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1barreq:NC1_BarReq/friendlyObstacles/friendlyObstacle/tacticalData/number9">
    ...
    <iso:rule context="/nc1barreq:NC1_BarReq/friendlyObstacles/friendlyObstacle/tacticalData/bypassRouteId/@id">
    ...
    <iso:rule context="/nc1barreq:NC1_BarReq/friendlyObstacles/friendlyObstacle/tacticalData/responsibleUnitId/@id">
  ...
  <iso:diagnostics>
    <iso:diagnostic xml:lang="en" id="D26718-en">NC1_BarReq.2: In the paragraph « friendly Obstacles », the identity of the friendly obstacles has to be worth « ASSUMED FRIEND » or « FRIEND » (In or F in the APP6B).</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26719-en">NC1_BarReq.3: In the paragraph « friendly Obstacles », the obstacles have to be in the planned state (1 planned of laborer or 2 planned preliminary).</iso:diagnostic>
