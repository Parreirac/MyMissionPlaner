...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:firereport" prefix="nc1firereport" />
  <iso:pattern>
    <iso:title>NC1_FireReport validation rules</iso:title>
    <iso:rule context="/nc1firereport:NC1_FireReport/@situation">
      <iso:assert test=". = 'STC'" diagnostics="D26504-en">NC1_FireReport.1: La situation de ce message doit être STC (Situation Tactique Courante).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/@instance">
      <iso:assert test=". = 'STC'" diagnostics="D26507-en">NC1_FireReport.2: L'instance du tir doit valoir STC (Situation Tactique Courante).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/tacticalData">
      <iso:assert test="count(status)=1" diagnostics="D26505-en">NC1_FireReport.3: L'état du tir doit être renseigné.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/involvedUnit/involvedUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26506-en">NC1_FireReport.4: L'unité engagée doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/firedAmmunitionSummary">
      <iso:assert test="if (type='6') then not(triggerMode) else triggerMode" diagnostics="D26508-en">NC1_FireReport.6: Le mode de déclenchement est interdit si Type de la synthèse des munitions tirées vaut LRU sinon il est obligatoire.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/involvedUnit/firedAmmunition">
      <iso:assert test="if (type='6') then not(triggerMode) else triggerMode" diagnostics="D26509-en">NC1_FireReport.6: Le mode de déclenchement est interdit si Type de la munition tirée vaut LRU sinon il est obligatoire.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire">
      <iso:assert test="if (fireMissionCommandAccepted=1) then not(fire/callForFireData) and not(fire/executiveReport) else true()" diagnostics="D26510-en">NC1_FireReport.7: Les bilans exécutants et les informations de demande de tir du compte rendu de tir sont interdits si la demande de directive est refusée.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/fireForEffect/location/polyline">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/@id">
      <iso:assert test="matches(.,'^37:')" diagnostics="D26819-en">NC1_Fire.3: Le type de l'objet doit avoir pour valeur 37</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/actors/executantEntityId/@id">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/actors/otherEntityId/@id">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/actors/requestingEntityId/@id">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/actors/responsibleAuthorityId/@id">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/adjustmentFire">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/fireForEffect">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/fireForEffect/synchronizedFireId/@id">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/adjustmentFire/adjustmentPoint">
      <iso:assert test="count(z)&gt;0" diagnostics="D26810-en">NC1_Fire.9: L'altitude (z) doit être renseignée.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/fireForEffect/location/circle/center">
      <iso:assert test="count(z)&gt;0" diagnostics="D26809-en">NC1_Fire.9: L'altitude (z) doit être renseignée.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/fireForEffect/location/point">
      <iso:assert test="count(z)&gt;0" diagnostics="D26808-en">NC1_Fire.9: L'altitude (z) doit être renseignée.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/fireForEffect/location/pointsMultiples/point">
      <iso:assert test="count(z)&gt;0" diagnostics="D26806-en">NC1_Fire.9: L'altitude (z) doit être renseignée.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/fireForEffect/location/polyline/point">
      <iso:assert test="count(z)&gt;0" diagnostics="D26805-en">NC1_Fire.9: L'altitude (z) doit être renseignée.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/fireForEffect/location/rectangle/center">
      <iso:assert test="count(z)&gt;0" diagnostics="D26807-en">NC1_Fire.9: L'altitude (z) doit être renseignée.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/ammunitionEffect/requestedAmmunition">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/tacticalEffect/targetData/targetId/@id">
    ...
    <iso:rule context="/nc1firereport:NC1_FireReport/reportedFire/fire/callForFireData/ammunitionEffect">
  ...
  <iso:diagnostics>
    <iso:diagnostic xml:lang="en" id="D26504-en">NC1_FireReport.1: The context of this message owes being STC (Current Tactical Situation).</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26505-en">NC1_FireReport.3: The fire status shall be provided.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26506-en">NC1_FireReport.4: The engaged unit shall be a unit (NC1_Unit).</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26507-en">NC1_FireReport.2: The fire context shall be STC.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26508-en">NC1_FireReport.6: The trigger mode is prohibited if Type of the synthesis of the ammunition fired is LRU otherwise it is mandatory.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26509-en">NC1_FireReport.6: The trigger mode is prohibited if the Type of the fired ammunition is LRU otherwise it is mandatory.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26510-en">NC1_FireReport.7: Performer reports and firing request information from the firing report are prohibited if the directive request is denied.</iso:diagnostic>
