...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:ewrtm" prefix="nc1ewrtm" />
  <iso:pattern>
    <iso:title>NC1_EWRTM validation rules</iso:title>
    <iso:rule context="/nc1ewrtm:NC1_EWRTM/taskedUnit/tacticalData">
    ...
    <iso:rule context="/nc1ewrtm:NC1_EWRTM/taskedUnit/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1ewrtm:NC1_EWRTM/taskedUnit/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26872-en">NC1_Unit.7: Le type de l'objet doit avoir pour valeur 0</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1ewrtm:NC1_EWRTM/taskedUnit/tacticalData/subordination/subordinationType">
    ...
    <iso:rule context="/nc1ewrtm:NC1_EWRTM/taskedUnit/tacticalData/subordination/superiorUnitId/@id">
    ...
    <iso:rule context="/nc1ewrtm:NC1_EWRTM/taskedUnit/status">
    ...
    <iso:rule context="/nc1ewrtm:NC1_EWRTM/taskedUnit/status/operationalStatus">
    ...
    <iso:rule context="/nc1ewrtm:NC1_EWRTM/taskedUnit/tacticalData/commandAndControlRole">
