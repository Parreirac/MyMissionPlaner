...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:propplanobstacles" prefix="nc1propplanobst" />
  <iso:pattern>
    <iso:title>NC1_PropositionPlanObstacles validation rules</iso:title>
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/obstacle/tacticalData">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/obstacle/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/obstacle/@id">
      <iso:assert test="matches(.,'^17:')" diagnostics="D26761-en">NC1_Obstacle.4: Le type de l'objet doit avoir pour valeur 17</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/obstacle/tacticalData/number9">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/obstacle/tacticalData/bypassRouteId/@id">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/obstacle/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/route/location/endPoint/symbolCode">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/route/location/startPoint/symbolCode">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/route/@id">
      <iso:assert test="matches(.,'^38:')" diagnostics="D26860-en">NC1_Route.5: Le type de l'objet doit avoir pour valeur 38</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/route/location/endTacPointId/@id">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/route/location/startTacPointId/@id">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/route/location/segment/groundEntityId/@id">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/facility/tacticalData">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/facility/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/facility/@id">
      <iso:assert test="matches(.,'^18:')" diagnostics="D26363-en">NC1_Facility.5: Le type de l'objet doit avoir pour valeur 18</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/facility/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/facility/medicalFacilityData/admittedIndividualId/@id">
    ...
    <iso:rule context="/nc1propplanobst:NC1_PropositionPlanObstacles/obstaclesAndWorks/groundEntity/@id">
