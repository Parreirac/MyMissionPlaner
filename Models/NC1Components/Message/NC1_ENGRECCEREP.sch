...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:engreccerep" prefix="nc1engreccerep" />
  <iso:pattern>
    <iso:title>NC1_ENGRECCEREP validation rules</iso:title>
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceCharacteristics/missionId/@id">
      <iso:assert test="matches(.,'^54:')" diagnostics="D26580-en">NC1_ENGRECCEREP.2: La mission du génie doit être un objet NC1 de type mission (NC1_Mission).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/facility/tacticalData">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/facility/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/facility/@id">
      <iso:assert test="matches(.,'^18:')" diagnostics="D26363-en">NC1_Facility.5: Le type de l'objet doit avoir pour valeur 18</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/facility/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/facility/medicalFacilityData/admittedIndividualId/@id">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/obstacle/tacticalData">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/obstacle/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/obstacle/@id">
      <iso:assert test="matches(.,'^17:')" diagnostics="D26761-en">NC1_Obstacle.4: Le type de l'objet doit avoir pour valeur 17</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/obstacle/tacticalData/number9">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/obstacle/tacticalData/bypassRouteId/@id">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/obstacle/tacticalData/responsibleUnitId/@id">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/route/location/endPoint/symbolCode">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/route/location/startPoint/symbolCode">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/route/@id">
      <iso:assert test="matches(.,'^38:')" diagnostics="D26860-en">NC1_Route.5: Le type de l'objet doit avoir pour valeur 38</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/route/location/endTacPointId/@id">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/route/location/startTacPointId/@id">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/route/location/segment/groundEntityId/@id">
    ...
    <iso:rule context="/nc1engreccerep:NC1_ENGRECCEREP/recceReport/groundEntity/@id">
  ...
  <iso:diagnostics>
    ...
    <iso:diagnostic xml:lang="en" id="D26580-en">NC1_ENGRECCEREP.2: The engineer mission shall be a mission NC1 object type (NC1_Mission).</iso:diagnostic>
