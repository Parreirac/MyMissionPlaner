...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:opordain" prefix="nc1opordain" />
  <iso:pattern>
    <iso:title>NC1_OPORD-AIN validation rules</iso:title>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN//mixedText/anyReference/@type">
      <iso:assert test=".=('refObject','localisedPoint','fileLink','datetime')" diagnostics="D26550-en">NC1_OPORD-AIN.2: L’attribut « type » est restreint aux valeurs suivantes : 'refObject', 'localisedPoint', 'datetime' et 'fileLink'.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN//mixedText/anyReference[@type='refObject']">
      <iso:assert test="count(@id)=1 and count(@datetime)=0 and count(@x)=0 and count(@y)=0 and count(@z)=0 and count(@attachedFile)=0" diagnostics="D26551-en">NC1_OPORD-AIN.3: Pour une référence à un objet, seuls les attributs « type », « id » et « instance » peuvent être renseignés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN//mixedText/anyReference[@type='datetime']">
      <iso:assert test="count(@id)=0 and count(@instance)=0 and count(@datetime)=1 and count(@x)=0 and count(@y)=0 and count(@z)=0 and count(@attachedFile)=0" diagnostics="D26552-en">NC1_OPORD-AIN.4: Pour un groupe date heure, seuls les attributs « type » et « datetime » doivent être renseignés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN//mixedText/anyReference[@type='localisedPoint']">
      <iso:assert test="count(@id)=0 and count(@instance)=0 and count(@datetime)=0 and count(@x)=1 and count(@y)=1 and count(@attachedFile)=0" diagnostics="D26553-en">NC1_OPORD-AIN.5: Pour un point localisé, seuls les attributs « type », « x », « y » et « z » peuvent être renseignés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN//mixedText/anyReference[@type='fileLink']">
      <iso:assert test="count(@id)=0 and count(@instance)=0 and count(@datetime)=0 and count(@x)=0 and count(@y)=0 and count(@z)=0 and count(@attachedFile)=1" diagnostics="D26554-en">NC1_OPORD-AIN.6: Pour un lien vers un fichier, seuls les attributs « type » et « attachedFile » doivent être renseignés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN//mixedText">
      <iso:assert test="matches(.,'^[A-Za-z0-9àâäéèêëïîôöùûüÿç .,\-\(\)?!@#$%^&amp;*=_+\[\]{}\\&quot;'';&lt;&gt;~|€/:\n\rÇåìÄÅÉæÆòÖÜøØáíóúñÑ¡«»ÁÂÀãÃðÐÊËÈÍÎÏÌÓßÔÒõÕµÚÛÙýÝ§°¿¢®&#x0009;&#x0060;&#x00A0;&#x0152;&#x0153;&#x2012;&#x2013;&#x2019;&#x2026;]*$')" diagnostics="D26555-en">NC1_OPORD-AIN.7: L'un des caractères utilisés n'est pas dans la liste des caractères autorisés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/unit/tacticalData">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/unit/tacticalData/symbolCode">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/unit/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26872-en">NC1_Unit.7: Le type de l'objet doit avoir pour valeur 0</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/unit/tacticalData/subordination/subordinationType">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/unit/tacticalData/subordination/superiorUnitId/@id">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/unit/status">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/unit/status/operationalStatus">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/unit/tacticalData/commandAndControlRole">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/reinforcement/@id">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/reinforcement/tacticalData/givenUnitId/@id">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/reinforcement/tacticalData/providingUnitId/@id">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/reinforcement/tacticalData/reinforcedUnitId/@id">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/reinforcement/tacticalData/reinforcementId/@id">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/taskOrganisation/member/reinforcement/tacticalData/commandRelationshipCategory">
    ...
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_1_situation/C_reinforcements/reinforcement/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26736-en">NC1_Reinforcement.3: Le type de l'objet doit avoir pour valeur 53</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_1_situation/C_reinforcements/reinforcement/tacticalData/givenUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26732-en">NC1_Reinforcement.4: L'unité donnée en renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_1_situation/C_reinforcements/reinforcement/tacticalData/providingUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26733-en">NC1_Reinforcement.4: L'unité donnant le renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_1_situation/C_reinforcements/reinforcement/tacticalData/reinforcedUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26734-en">NC1_Reinforcement.4: L'unité renforcée doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_1_situation/C_reinforcements/reinforcement/tacticalData/reinforcementId/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26735-en">NC1_Reinforcement.5: Le renforcement de référence doit être un renforcement (objet NC1_Reinforcement).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_1_situation/C_reinforcements/reinforcement/tacticalData/commandRelationshipCategory">
      <iso:assert test="not(.=0 or .=5)">NC1_Reinforcement.6: Le type de subordination tactique ne peut pas prendre les valeurs "COM" et "RATORG".</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_3_execution/D_artillerySupport/D1_fieldArtillery/reinforcements/reinforcement/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26736-en">NC1_Reinforcement.3: Le type de l'objet doit avoir pour valeur 53</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_3_execution/D_artillerySupport/D1_fieldArtillery/reinforcements/reinforcement/tacticalData/givenUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26732-en">NC1_Reinforcement.4: L'unité donnée en renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_3_execution/D_artillerySupport/D1_fieldArtillery/reinforcements/reinforcement/tacticalData/providingUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26733-en">NC1_Reinforcement.4: L'unité donnant le renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_3_execution/D_artillerySupport/D1_fieldArtillery/reinforcements/reinforcement/tacticalData/reinforcedUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26734-en">NC1_Reinforcement.4: L'unité renforcée doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_3_execution/D_artillerySupport/D1_fieldArtillery/reinforcements/reinforcement/tacticalData/reinforcementId/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26735-en">NC1_Reinforcement.5: Le renforcement de référence doit être un renforcement (objet NC1_Reinforcement).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_3_execution/D_artillerySupport/D1_fieldArtillery/reinforcements/reinforcement/tacticalData/commandRelationshipCategory">
      <iso:assert test="not(.=0 or .=5)">NC1_Reinforcement.6: Le type de subordination tactique ne peut pas prendre les valeurs "COM" et "RATORG".</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opordain:NC1_OPORD-AIN/_3_execution/D_artillerySupport/D2_airDefenceArtillery/miscellaneous/roe/@id">
      <iso:assert test="matches(.,'^52:')" diagnostics="D26835-en">NC1_Roe.2: Le type de l'objet doit avoir pour valeur 52</iso:assert>
    </iso:rule>
  ...
  <iso:diagnostics>
    ...
    <iso:diagnostic xml:lang="en" id="D26550-en">NC1_OPORD-AIN.2: The attribute « type » is restricted to the following values: 'refObject', 'localisedPoint', 'datetime' and  'fileLink'.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26551-en">NC1_OPORD-AIN.3: For a reference to an object, only the « type », « id » and «  context »  attributes can be informed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26552-en">NC1_OPORD-AIN.4: For a group date the hour, only the « type » and « datetime »  attributes must be informed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26553-en">NC1_OPORD-AIN.5: For a localized point, only the « type », « x », « y » and « z » attributes can be informed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26554-en">NC1_OPORD-AIN.6: For a link towards a file, only the ""type"" and ""url""attributes  must be informed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26555-en">NC1_OPORD-AIN.7: One character is not allowed.</iso:diagnostic>
