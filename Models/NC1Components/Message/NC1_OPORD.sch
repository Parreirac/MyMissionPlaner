...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:message:opord" prefix="nc1opord" />
  <iso:pattern>
    <iso:title>NC1_OPORD validation rules</iso:title>
    <iso:rule context="/nc1opord:NC1_OPORD/_2_mission/sectionStatus">
      <iso:assert test=". != 0" diagnostics="D26706-en">NC1_OPORD.2: Le paragraphe "_2_mission" ne peut pas être à la valeur "Néant".</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD">
      <iso:assert test="not(@referenceMessageId and reference)" diagnostics="D26707-en">NC1_OPORD.7: L'identifiant de référence et la description de référence ne peuvent être renseignés ensemble.</iso:assert>
      <iso:assert test="count(appendice) = count(distinct-values(appendice))" diagnostics="D26714-en">NC1_OPORD.10: Les valeurs de l'attribut "appendice" doivent toutes être différentes.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C1_landFires/C12_command/objects/object/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26715-en">NC1_OPORD.11: Seuls les objets de type NC1_Reinforcement (l'attribut id doit valoir 53) sont autorisés sous _3_execution/C_fires/C1_landFires/C12_command/objects</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/G_roadTraffic/G1_reinforcements/objects/object/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26716-en">NC1_OPORD.11: Seuls les objets de type NC1_Reinforcement (l'attribut id doit valoir 53) sont autorisés sous _3_execution/G_roadTraffic/G1_reinforcements/objects</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD//mixedText/anyReference/@type">
      <iso:assert test=".=('refObject','localisedPoint','fileLink','datetime')" diagnostics="D26708-en">NC1_OPORD.12: L’attribut « type » est restreint aux valeurs suivantes : 'refObject', 'localisedPoint', 'datetime' et 'fileLink'.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD//mixedText/anyReference[@type='refObject']">
      <iso:assert test="count(@id)=1 and count(@datetime)=0 and count(@x)=0 and count(@y)=0 and count(@z)=0 and count(@attachedFile)=0" diagnostics="D26709-en">NC1_OPORD.13: Pour une référence à un objet, seuls les attributs « type », « id » et « instance » peuvent être renseignés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD//mixedText/anyReference[@type='datetime']">
      <iso:assert test="count(@id)=0 and count(@instance)=0 and count(@datetime)=1 and count(@x)=0 and count(@y)=0 and count(@z)=0 and count(@attachedFile)=0" diagnostics="D26710-en">NC1_OPORD.14: Pour un groupe date heure, seuls les attributs « type » et « datetime » doivent être renseignés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD//mixedText/anyReference[@type='localisedPoint']">
      <iso:assert test="count(@id)=0 and count(@instance)=0 and count(@datetime)=0 and count(@x)=1 and count(@y)=1 and count(@attachedFile)=0" diagnostics="D26711-en">NC1_OPORD.15: Pour un point localisé, seuls les attributs « type », « x », « y » et « z » peuvent être renseignés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD//mixedText/anyReference[@type='fileLink']">
      <iso:assert test="count(@id)=0 and count(@instance)=0 and count(@datetime)=0 and count(@x)=0 and count(@y)=0 and count(@z)=0 and count(@attachedFile)=1" diagnostics="D26712-en">NC1_OPORD.16: Pour un lien vers un fichier, seuls les attributs « type » et « attachedFile » doivent être renseignés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD//mixedText">
      <iso:assert test="matches(.,'^[A-Za-z0-9àâäéèêëïîôöùûüÿç .,\-\(\)?!@#$%^&amp;*=_+\[\]{}\\&quot;'';&lt;&gt;~|€/:\n\rÇåìÄÅÉæÆòÖÜøØáíóúñÑ¡«»ÁÂÀãÃðÐÊËÈÍÎÏÌÓßÔÒõÕµÚÛÙýÝ§°¿¢®&#x0009;&#x0060;&#x00A0;&#x0152;&#x0153;&#x2012;&#x2013;&#x2019;&#x2026;]*$')" diagnostics="D26713-en">NC1_OPORD.17: L'un des caractères utilisés n'est pas dans la liste des caractères autorisés.</iso:assert>
    </iso:rule>
    ...
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/unit/tacticalData">
      <iso:assert test="if (frSpecificSymbol) then some $symbolCode in ($UnitFrSpecific//SimpleCodeList/Row/Value[@ColumnRef='code'][SimpleValue=current()/frSpecificSymbol]/../Value[@ColumnRef='codeSymbole']/SimpleValue) satisfies matches(symbolCode,$symbolCode) else some $symbolCode in ($UnitSymbol//SimpleCodeList/Row/Value[@ColumnRef='codeSymbole']/SimpleValue) satisfies matches(symbolCode,$symbolCode)" diagnostics="D26869-en">NC1_Unit.2: Si la spécialisation Fr du code symbole est renseignée alors le code du symbole renseigné doit être celui correspondant à la valeur du dictionnaire des codes symboles spécifiques sinon il doit appartenir à l'une des valeur du dictionnaire des codes symboles autorisés.</iso:assert>
      <iso:assert test="if (matches(symbolCode,':.[AF]')) then count(eisn) + count(tnl16) = 0 else count(urn) + count(stnl16) = 0" diagnostics="D26871-en">NC1_Unit.8: Pour une unité non amie, les identifiants URN et STNL16 ne doivent pas être renseignés et pour une unité amie, les identifiants EISN et TNL16 ne doivent pas être renseignés.</iso:assert>
      <iso:assert test="if (frSpecificSymbol) then true() else some $symbolCode in ($UnitSymbol//SimpleCodeList/Row/Value[@ColumnRef='code'][SimpleValue&gt;0]/../Value[@ColumnRef='codeSymbole']/SimpleValue) satisfies matches(symbolCode,$symbolCode)">NC1_Unit.23: Dans le cas où la spécialisation Fr du code symbole n'est pas renseignée alors le code symbole doit exister et appartenir à l'une des valeurs positives du dictionnaire des codes symboles autorisés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/unit/tacticalData/symbolCode">
      <iso:assert test="some $Pays in ($L105_2//SimpleCodeList/Row/Value[@ColumnRef='short']/SimpleValue) satisfies substring(.,19,2) = substring($Pays,1,2)" diagnostics="D26863-en">NC1_Unit.3: Les 13ème et 14ème caractères du Code du symbole doivent correspondre à une valeur du dictionnaire L105_2Code.</iso:assert>
      <iso:assert test="if (matches(.,':...A')) then count(../../location/datetime) + count(../../location/quality) = 0 else true()" diagnostics="D26864-en">NC1_Unit.9: Lorsque l'unité est anticipée, la qualité de la mesure de localisation et l'horodatage du relevé de sa position sur le terrain ne doivent pas être renseignés.</iso:assert>
      <iso:assert test="if (matches(.,':.[SHJK]')) then (matches(../../location/quality,'1') or not(../../location/quality)) else true()" diagnostics="D26870-en">NC1_Unit.16: La localisation d'une unité ennemie ne peut qu'être estimée.</iso:assert>
      <iso:assert test="matches(.,':...[AP]')">NC1_Unit.24: Le 4ème caractère du Code symbole doit correspondre aux valeurs 'A' ou 'P'.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/unit/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26872-en">NC1_Unit.7: Le type de l'objet doit avoir pour valeur 0</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/unit/tacticalData/subordination/subordinationType">
      <iso:assert test="if (.=5) then not(../detachmentPeriod) else ../detachmentPeriod" diagnostics="D26865-en">NC1_Unit.12: Pour un lien de subordination organique, i.e. égal à 5 (RATORG), la période de détachement ne doit pas être renseignée sinon cette période de détachement doit être renseignée.</iso:assert>
      <iso:assert test="../superiorUnitId" diagnostics="D26866-en">NC1_Unit.13: Lorsque le type de subordination est renseigné, le supérieur doit également être renseigné.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/unit/tacticalData/subordination/superiorUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26867-en">NC1_Unit.14: Le supérieur de l'unité doit également être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/unit/status">
      <iso:assert test="logisticStatus or operationalStatus" diagnostics="D26868-en">NC1_Unit.15: L'état opérationnel ou l'état logistique de l'unité doit être renseigné.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/unit/status/operationalStatus">
      <iso:assert test="effectif or personnelTiredness or equipment or fuel or ammunitions">NC1_Unit.15: L'effectif ou l'état de fatigue ou l'état matériel ou l'état carburant ou l'état munitions doit être renseigné.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/unit/tacticalData/commandAndControlRole">
      <iso:assert test="if (matches(../../@id,':0:')) then . &gt; 1 else true()" diagnostics="D26873-en">NC1_Unit.19: L'attribut "commandAndControlRole" ne doit pas avoir les valeurs 'Inconnu' et 'No statement' pour les unités issues des DQP.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/reinforcement/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26736-en">NC1_Reinforcement.3: Le type de l'objet doit avoir pour valeur 53</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/reinforcement/tacticalData/givenUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26732-en">NC1_Reinforcement.4: L'unité donnée en renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/reinforcement/tacticalData/providingUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26733-en">NC1_Reinforcement.4: L'unité donnant le renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/reinforcement/tacticalData/reinforcedUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26734-en">NC1_Reinforcement.4: L'unité renforcée doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/reinforcement/tacticalData/reinforcementId/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26735-en">NC1_Reinforcement.5: Le renforcement de référence doit être un renforcement (objet NC1_Reinforcement).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/taskOrganisation/member/reinforcement/tacticalData/commandRelationshipCategory">
      <iso:assert test="not(.=0 or .=5)">NC1_Reinforcement.6: Le type de subordination tactique ne peut pas prendre les valeurs "COM" et "RATORG".</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_1_situation/C_reinforcements/reinforcement/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26736-en">NC1_Reinforcement.3: Le type de l'objet doit avoir pour valeur 53</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_1_situation/C_reinforcements/reinforcement/tacticalData/givenUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26732-en">NC1_Reinforcement.4: L'unité donnée en renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_1_situation/C_reinforcements/reinforcement/tacticalData/providingUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26733-en">NC1_Reinforcement.4: L'unité donnant le renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_1_situation/C_reinforcements/reinforcement/tacticalData/reinforcedUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26734-en">NC1_Reinforcement.4: L'unité renforcée doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_1_situation/C_reinforcements/reinforcement/tacticalData/reinforcementId/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26735-en">NC1_Reinforcement.5: Le renforcement de référence doit être un renforcement (objet NC1_Reinforcement).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_1_situation/C_reinforcements/reinforcement/tacticalData/commandRelationshipCategory">
      <iso:assert test="not(.=0 or .=5)">NC1_Reinforcement.6: Le type de subordination tactique ne peut pas prendre les valeurs "COM" et "RATORG".</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/unit/tacticalData">
      <iso:assert test="if (frSpecificSymbol) then some $symbolCode in ($UnitFrSpecific//SimpleCodeList/Row/Value[@ColumnRef='code'][SimpleValue=current()/frSpecificSymbol]/../Value[@ColumnRef='codeSymbole']/SimpleValue) satisfies matches(symbolCode,$symbolCode) else some $symbolCode in ($UnitSymbol//SimpleCodeList/Row/Value[@ColumnRef='codeSymbole']/SimpleValue) satisfies matches(symbolCode,$symbolCode)" diagnostics="D26869-en">NC1_Unit.2: Si la spécialisation Fr du code symbole est renseignée alors le code du symbole renseigné doit être celui correspondant à la valeur du dictionnaire des codes symboles spécifiques sinon il doit appartenir à l'une des valeur du dictionnaire des codes symboles autorisés.</iso:assert>
      <iso:assert test="if (matches(symbolCode,':.[AF]')) then count(eisn) + count(tnl16) = 0 else count(urn) + count(stnl16) = 0" diagnostics="D26871-en">NC1_Unit.8: Pour une unité non amie, les identifiants URN et STNL16 ne doivent pas être renseignés et pour une unité amie, les identifiants EISN et TNL16 ne doivent pas être renseignés.</iso:assert>
      <iso:assert test="if (frSpecificSymbol) then true() else some $symbolCode in ($UnitSymbol//SimpleCodeList/Row/Value[@ColumnRef='code'][SimpleValue&gt;0]/../Value[@ColumnRef='codeSymbole']/SimpleValue) satisfies matches(symbolCode,$symbolCode)">NC1_Unit.23: Dans le cas où la spécialisation Fr du code symbole n'est pas renseignée alors le code symbole doit exister et appartenir à l'une des valeurs positives du dictionnaire des codes symboles autorisés.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/unit/tacticalData/symbolCode">
      <iso:assert test="some $Pays in ($L105_2//SimpleCodeList/Row/Value[@ColumnRef='short']/SimpleValue) satisfies substring(.,19,2) = substring($Pays,1,2)" diagnostics="D26863-en">NC1_Unit.3: Les 13ème et 14ème caractères du Code du symbole doivent correspondre à une valeur du dictionnaire L105_2Code.</iso:assert>
      <iso:assert test="if (matches(.,':...A')) then count(../../location/datetime) + count(../../location/quality) = 0 else true()" diagnostics="D26864-en">NC1_Unit.9: Lorsque l'unité est anticipée, la qualité de la mesure de localisation et l'horodatage du relevé de sa position sur le terrain ne doivent pas être renseignés.</iso:assert>
      <iso:assert test="if (matches(.,':.[SHJK]')) then (matches(../../location/quality,'1') or not(../../location/quality)) else true()" diagnostics="D26870-en">NC1_Unit.16: La localisation d'une unité ennemie ne peut qu'être estimée.</iso:assert>
      <iso:assert test="matches(.,':...[AP]')">NC1_Unit.24: Le 4ème caractère du Code symbole doit correspondre aux valeurs 'A' ou 'P'.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/unit/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26872-en">NC1_Unit.7: Le type de l'objet doit avoir pour valeur 0</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/unit/tacticalData/subordination/subordinationType">
      <iso:assert test="if (.=5) then not(../detachmentPeriod) else ../detachmentPeriod" diagnostics="D26865-en">NC1_Unit.12: Pour un lien de subordination organique, i.e. égal à 5 (RATORG), la période de détachement ne doit pas être renseignée sinon cette période de détachement doit être renseignée.</iso:assert>
      <iso:assert test="../superiorUnitId" diagnostics="D26866-en">NC1_Unit.13: Lorsque le type de subordination est renseigné, le supérieur doit également être renseigné.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/unit/tacticalData/subordination/superiorUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26867-en">NC1_Unit.14: Le supérieur de l'unité doit également être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/unit/status">
      <iso:assert test="logisticStatus or operationalStatus" diagnostics="D26868-en">NC1_Unit.15: L'état opérationnel ou l'état logistique de l'unité doit être renseigné.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/unit/status/operationalStatus">
      <iso:assert test="effectif or personnelTiredness or equipment or fuel or ammunitions">NC1_Unit.15: L'effectif ou l'état de fatigue ou l'état matériel ou l'état carburant ou l'état munitions doit être renseigné.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/unit/tacticalData/commandAndControlRole">
      <iso:assert test="if (matches(../../@id,':0:')) then . &gt; 1 else true()" diagnostics="D26873-en">NC1_Unit.19: L'attribut "commandAndControlRole" ne doit pas avoir les valeurs 'Inconnu' et 'No statement' pour les unités issues des DQP.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/reinforcement/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26736-en">NC1_Reinforcement.3: Le type de l'objet doit avoir pour valeur 53</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/reinforcement/tacticalData/givenUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26732-en">NC1_Reinforcement.4: L'unité donnée en renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/reinforcement/tacticalData/providingUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26733-en">NC1_Reinforcement.4: L'unité donnant le renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/reinforcement/tacticalData/reinforcedUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26734-en">NC1_Reinforcement.4: L'unité renforcée doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/reinforcement/tacticalData/reinforcementId/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26735-en">NC1_Reinforcement.5: Le renforcement de référence doit être un renforcement (objet NC1_Reinforcement).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/C_fires/C2_airDefence/C22_taskOrganisation/member/reinforcement/tacticalData/commandRelationshipCategory">
      <iso:assert test="not(.=0 or .=5)">NC1_Reinforcement.6: Le type de subordination tactique ne peut pas prendre les valeurs "COM" et "RATORG".</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/D_engineer/D3_reinforcements/reinforcement/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26736-en">NC1_Reinforcement.3: Le type de l'objet doit avoir pour valeur 53</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/D_engineer/D3_reinforcements/reinforcement/tacticalData/givenUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26732-en">NC1_Reinforcement.4: L'unité donnée en renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/D_engineer/D3_reinforcements/reinforcement/tacticalData/providingUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26733-en">NC1_Reinforcement.4: L'unité donnant le renforcement doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/D_engineer/D3_reinforcements/reinforcement/tacticalData/reinforcedUnitId/@id">
      <iso:assert test="matches(.,'^0:')" diagnostics="D26734-en">NC1_Reinforcement.4: L'unité renforcée doit être une unité (NC1_Unit).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/D_engineer/D3_reinforcements/reinforcement/tacticalData/reinforcementId/@id">
      <iso:assert test="matches(.,'^53:')" diagnostics="D26735-en">NC1_Reinforcement.5: Le renforcement de référence doit être un renforcement (objet NC1_Reinforcement).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1opord:NC1_OPORD/_3_execution/D_engineer/D3_reinforcements/reinforcement/tacticalData/commandRelationshipCategory">
      <iso:assert test="not(.=0 or .=5)">NC1_Reinforcement.6: Le type de subordination tactique ne peut pas prendre les valeurs "COM" et "RATORG".</iso:assert>
    </iso:rule>
  ...
  <iso:diagnostics>
    ...
    <iso:diagnostic xml:lang="en" id="D26706-en">NC1_OPORD.2: The paragraph "_2_mission" cannot have the value "None".</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26707-en">NC1_OPORD.7: One or several references of message must be informed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26708-en">NC1_OPORD.12: The attribute « type » is restricted to the following values: 'refObject', 'localisedPoint', 'datetime' and  'fileLink'.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26709-en">NC1_OPORD.13: For a reference to an object, only the « type », « id » and «  context »  attributes can be informed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26710-en">NC1_OPORD.14: For a group date the hour, only the « type » and « datetime »  attributes must be informed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26711-en">NC1_OPORD.15: For a localized point, only the « type », « x », « y » and « z » attributes can be informed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26712-en">NC1_OPORD.16: For a link towards a file, only the ""type"" and ""url""attributes  must be informed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26713-en">NC1_OPORD.17: One character is not allowed.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26714-en">NC1_OPORD.10: The values ??of the attribute "appendix" must all be different.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26715-en">NC1_OPORD.11: Only NC1_Reinforcement type objects (ID must be 53) are authorised within _3_execution/C_fires/C1_landFires/C12_command/objects</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26716-en">NC1_OPORD.11: Only NC1_Reinforcement type objects (ID must be 53) are authorised within _3_execution/G_roadTraffic/G1_reinforcements/objects</iso:diagnostic>
