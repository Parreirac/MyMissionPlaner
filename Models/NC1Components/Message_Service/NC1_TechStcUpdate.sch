...
<iso:schema queryBinding="xslt2" xmlns:iso="http://purl.oclc.org/dsdl/schematron">
  ...
  <iso:ns uri="urn:fra:nc1:service:stcupdate" prefix="nc1stcupdate" />
  <iso:pattern>
    <iso:title>NC1_TechStcUpdate validation rules</iso:title>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/@situation">
      <iso:assert test=". = 'STC'" diagnostics="D26874-en">NC1_TechStcUpdate.1: La situation doit être uniquement Situation tactique courante (STC).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/updatedObjects/object/@instance">
      <iso:assert test=". = 'STC'" diagnostics="D26875-en">NC1_TechStcUpdate.3: L'instance doit être uniquement Situation tactique courante (STC).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/desactivatedObjects/object/@activationStatus">
      <iso:assert test=".=0" diagnostics="D26876-en">NC1_TechStcUpdate.4: Un objet désactivé doit avoir son état d'activation à 0 (INACTIF).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/updatedObjects/object/@activationStatus">
      <iso:assert test=".=1" diagnostics="D26877-en">NC1_TechStcUpdate.4: Un objet mis à jour doit avoir son état d'activation à 1 (ACTIF).</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/desactivatedObjects/object[matches(@id,'^(17|20):')]">
      <iso:assert test="matches(../../type,'^[047]') or not(../../type)" diagnostics="D26887-en">NC1_TechStcUpdate.5: Les objets obstacles et entités terrain ne peuvent être utilisés que pour les valeurs 0, 4 et 7 du type d'information.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/desactivatedObjects/object[matches(@id,'^(9|10|11):')]">
      <iso:assert test="matches(../../type,'^[0127]') or not(../../type)" diagnostics="D26879-en">NC1_TechStcUpdate.5: Les objets participants ne peuvent être utilisés que pour les valeurs 0, 1, 2 et 7 du type d'information.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/desactivatedObjects/object[matches(@id,'^0:')]">
      <iso:assert test="if (matches(tacticalData/symbolCode,'^APP6B:.[AF]')) then matches(../../type,'^[0267]') or not(../../type) else matches(../../../../type,'^[037]') or not(../../type)" diagnostics="D26883-en">NC1_TechStcUpdate.5: Les objets unités ennemies ne peuvent être utilisés que pour les valeurs 0, 3 et 7 du type d'information et les amies pour les valeurs 0, 2, 6 et 7.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/desactivatedObjects/object[matches(@id,'^1(2|3|5):')]">
      <iso:assert test="if (matches(tacticalData/symbolCode,'^APP6B:.[AF]')) then matches(../../type,'^[0127]') or not(../../type) else matches(../../type,'^[037]') or not(../../type)" diagnostics="D26881-en">NC1_TechStcUpdate.5: Les objets pistes ennemies ne peuvent être utilisés que pour les valeurs 0, 3 et 7 du type d'information et les amies pour les valeurs 0, 1, 2 et 7.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/desactivatedObjects/object[matches(@id,'^18:')]">
      <iso:assert test="if (matches(tacticalData/symbolCode,'^APP6B:.[AF]')) then matches(../../type,'^[0267]') or not(../../type) else matches(../../type,'^[037]') or not(../../type)" diagnostics="D26885-en">NC1_TechStcUpdate.5: Les objets installations ennemies ne peuvent être utilisés que pour les valeurs 0, 3 et 7 du type d'information et les amies pour les valeurs 0, 2, 6 et 7.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/desactivatedObjects/object[matches(@id,'^4(0|1|2):')]">
      <iso:assert test="matches(../../type,'^[057]') or not(../../type)" diagnostics="D26888-en">NC1_TechStcUpdate.5: Les objets mesures de coordination ne peuvent être utilisés que pour les valeurs 0, 5 et 7 du type d'information.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/desactivatedObjects/object[not(matches(@id,'^(0|9|10|11|12|13|15|17|18|20|40|41|42):'))]">
      <iso:assert test="matches(../../type,'^[07]') or not(../../type)" diagnostics="D26890-en">NC1_TechStcUpdate.5: Il y a des objets désactivés qui ne correspondent pas au type d'information demandé.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/updatedObjects/object[matches(@id,'^(17|20):')]">
      <iso:assert test="matches(../../type,'^[047]') or not(../../type)" diagnostics="D26886-en">NC1_TechStcUpdate.5: Les objets obstacles et entités terrain ne peuvent être utilisés que pour les valeurs 0, 4 et 7 du type d'information.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/updatedObjects/object[matches(@id,'^(9|10|11):')]">
      <iso:assert test="matches(../../type,'^[0127]') or not(../../type)" diagnostics="D26878-en">NC1_TechStcUpdate.5: Les objets participants ne peuvent être utilisés que pour les valeurs 0, 1, 2 et 7 du type d'information.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/updatedObjects/object[matches(@id,'^0:')]">
      <iso:assert test="if (matches(tacticalData/symbolCode,'^APP6B:.[AF]')) then matches(../../type,'^[0267]') or not(../../type) else matches(../../type,'^[037]') or not(../../type)" diagnostics="D26882-en">NC1_TechStcUpdate.5: Les objets unités ennemies ne peuvent être utilisés que pour les valeurs 0, 3 et 7 du type d'information et les amies pour les valeurs 0, 2, 6 et 7.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/updatedObjects/object[matches(@id,'^1(2|3|5):')]">
      <iso:assert test="if (matches(tacticalData/symbolCode,'^APP6B:.[AF]')) then matches(../../type,'^[0127]') or not(../../type) else matches(../../type,'^[037]') or not(../../type)" diagnostics="D26880-en">NC1_TechStcUpdate.5: Les objets pistes ennemies ne peuvent être utilisés que pour les valeurs 0, 3 et 7 du type d'information et les amies pour les valeurs 0, 1, 2 et 7.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/updatedObjects/object[matches(@id,'^18:')]">
      <iso:assert test="if (matches(tacticalData/symbolCode,'^APP6B:.[AF]')) then matches(../../type,'^[0267]') or not(../../type) else matches(../../type,'^[037]') or not(../../type)" diagnostics="D26884-en">NC1_TechStcUpdate.5: Les objets installations ennemies ne peuvent être utilisés que pour les valeurs 0, 3 et 7 du type d'information et les amies pour les valeurs 0, 2, 6 et 7.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/updatedObjects/object[matches(@id,'^4(0|1|2):')]">
      <iso:assert test="matches(../../type,'^[057]') or not(../../type)" diagnostics="D26889-en">NC1_TechStcUpdate.5: Les objets mesures de coordination ne peuvent être utilisés que pour les valeurs 0, 5 et 7 du type d'information.</iso:assert>
    </iso:rule>
    <iso:rule context="/nc1stcupdate:NC1_TechStcUpdate/updatedObjects/object[not(matches(@id,'^(0|9|10|11|12|13|15|17|18|20|40|41|42):'))]">
      <iso:assert test="matches(../../type,'^[07]') or not(../../type)" diagnostics="D26891-en">NC1_TechStcUpdate.5: Il y a des objets modifiés qui ne correspondent pas au type d'information demandé.</iso:assert>
    </iso:rule>
  ...
  <iso:diagnostics>
    ...
    <iso:diagnostic xml:lang="en" id="D26874-en">NC1_TechStcUpdate.1: The context can only be the current tactical situation (STC).</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26875-en">NC1_TechStcUpdate.3: The context of the object can only be the current tactical situation (STC).</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26876-en">NC1_TechStcUpdate.4: A deactivated object has to have his state of activation in 0 (INACTIVE).</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26877-en">NC1_TechStcUpdate.4: An updated object has to have his state of activation in 1 (ACTIVE).</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26878-en">NC1_TechStcUpdate.5: Participants objects can only be used for values 0, 1, 2 and 7 of the information type.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26879-en">NC1_TechStcUpdate.5: Participants objects can only be used for values 0, 1, 2 and 7 of the information type.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26880-en">NC1_TechStcUpdate.5: Enemy tracks objects can only be used for information type values 0, 3 and 7, and friends can only be used for values 0, 1, 2 and 7.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26881-en">NC1_TechStcUpdate.5: Enemy tracks objects can only be used for information type values 0, 3 and 7, and friends can only be used for values 0, 1, 2 and 7.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26882-en">NC1_TechStcUpdate.5: Enemy unit objects can only be used for information type values 0, 3 and 7, and friends can only be used for values 0, 2, 6 and 7.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26883-en">NC1_TechStcUpdate.5: Enemy unit objects can only be used for information type values 0, 3 and 7, and friends can only be used for values 0, 2, 6 and 7.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26884-en">NC1_TechStcUpdate.5: Enemy facility objects can only be used for information type values 0, 3 and 7, and friends can only be used for values 0, 2, 6 and 7.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26885-en">NC1_TechStcUpdate.5: Enemy facility objects can only be used for information type values 0, 3 and 7, and friends can only be used for values 0, 2, 6 and 7.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26886-en">NC1_TechStcUpdate.5: Obstacle and Ground entity objects can only be used for values 0, 4 and 7 of the information type.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26887-en">NC1_TechStcUpdate.5: Obstacle and Ground entity objects can only be used for values 0, 4 and 7 of the information type.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26888-en">NC1_TechStcUpdate.5: Coordination means objects can only be used for values 0, 5 and 7 of the information type.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26889-en">NC1_TechStcUpdate.5: Coordination means objects can only be used for values 0, 5 and 7 of the information type.</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26890-en">NC1_TechStcUpdate.5: There are desactived objects which don't match with the requested information's type</iso:diagnostic>
    <iso:diagnostic xml:lang="en" id="D26891-en">NC1_TechStcUpdate.5: There are modified objects which don't match with the requested information's type</iso:diagnostic>
