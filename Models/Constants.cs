...
namespace MilitaryPlanner.Helpers
{
    static public class Constants
    {
        ...
        public const string ACTION_OPEN_MISSIONS = "OpenMissions"; // modif to allow multiplefiles
        ...
        public const string OOB_FILE = "D:/repos/MyMissionPlaner/data/oob/oobexample.xml";
        public const string LocalBasemap = "D:/repos/MyMissionPlaner/data/Basemap.tpk";
        public const string symbolFilePathMil2525d = "C:/Users/tof/ArcGIS/Runtime/Data/styles/arcade_style/mil2525d.stylx";
        public const int _imageSize = 96 ;  // il y a une ambiguité dans les appels entre la taille de l'image et sa densité (dots per inch)

        public const int _treeImageSize = 200 ;  
        public const double _imageDPI = 48.0;// 48.0 ;// 96
        public const char trimChar = '*';

        public const int _numPointForEllipse = 128;
    }
}
